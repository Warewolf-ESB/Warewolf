...
{
    public class TcpClientHost : NetworkHost, ITcpClientHost
    {
            ...
            : base("TcpClientHost")
        {
            ...
            if(!isAuxiliary)
            {
                ...
                _channels[1].Register(0, PacketTemplates.Both_OnNetworkMessageRevieved, OnNetworkMessageReceived);
            }
        ...
        public bool IsConnected
        {
            get
            {
                return _networkState == NetworkState.Online && _isLoggedIn;
            }
        }

        public IStudioNetworkMessageAggregator MessageAggregator
        {
            get
            {
        ...
        public INetworkMessageBroker MessageBroker
        {
            get
            {
        ...
        {
            return _messageBroker.Recieve(reader);
        }
        ...
        {
            return SendReceive(message, PacketTemplates.Both_OnNetworkMessageRevieved, true);
        }
        ...
        void OnNetworkMessageReceived(INetworkOperator op, ByteBuffer reader)
        {
            CompleteSendReceive(delegate
            {
                var message = _messageBroker.Recieve(reader);
        ...
        #region RaiseLogin/NetworkStateChanged

        void RaiseLoginStateChanged(AuthenticationResponse response, bool expectDisconnect = false)
        {
        ...
        void RaiseNetworkStateChanged(NetworkState toState, bool isError = false, string message = "")
        {
