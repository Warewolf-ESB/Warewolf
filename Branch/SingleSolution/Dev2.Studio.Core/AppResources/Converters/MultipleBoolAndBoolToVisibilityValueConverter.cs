...
{
    public class MultipleBoolAndBoolToVisibilityValueConverter : IMultiValueConverter
    {
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            var visibility = values.Cast<bool>().Any(b => !b) ? Visibility.Collapsed : Visibility.Visible;
            return visibility;
        }
