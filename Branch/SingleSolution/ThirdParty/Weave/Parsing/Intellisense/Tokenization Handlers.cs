...
namespace System.Parsing.Intellisense
{
    ...
    public sealed class DatalistNumericLiteralTokenizationHandler : TokenizationHandler<Token, TokenKind>
    {
        #region Constants
    ...
    public sealed class InfrigisticsNumericLiteralTokenizationHandler : TokenizationHandler<Token, TokenKind>
    {
        #region Constants
        private const byte FullStop = (byte)'.';
        #endregion
