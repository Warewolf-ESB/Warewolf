...
$.widget("ui.selectmenu", {
	_init: function() {
		...
		var tooltip = this.element.attr('title');
		
		if(tabindex){ this.newelement.attr('tabindex', tabindex); }
		if(tooltip){ this.newelement.attr('title', tooltip); }
		...
		//original selectmenu width, Travis Amended 
		var selectWidth = this.element.width()+50;
