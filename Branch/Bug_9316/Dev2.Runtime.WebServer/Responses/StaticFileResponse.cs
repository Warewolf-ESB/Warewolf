...
{
    public class StaticFileCommunicationResponseWriter : CommunicationResponseWriter
    {
        private string _contentType;
        private string _file;
        private int _chunkSize;

        public StaticFileCommunicationResponseWriter(string file, string mimeType, int chunkSize = 1024)
        {
            _file = file;
