...
namespace Unlimited.Framework
{
    ...
    public class LayoutGridViewModel : BaseViewModel, ILayoutGridViewModel
    {
        ...
        public LayoutGridViewModel(IWebActivity webActivity)
        {
            ...
            var websiteResource = webActivity.ResourceModel.Environment.Resources.All().FirstOrDefault(c => c.ResourceName.Equals((_webPageModelItem as dynamic).WebsiteServiceName, StringComparison.InvariantCultureIgnoreCase));
            if (websiteResource != null)
            {
                SelectedWebsite = websiteResource;
            }

            _websites = webActivity.ResourceModel.Environment.Resources.All().Where(c => c.Category.ToUpper().Equals("WEBSITE")).ToObservableCollection();
        }
        ...
        internal void InitializeGrid()
        {
            ...
            {
                SelectedWebsite =
                    _resourceModel.Environment.Resources.All().FirstOrDefault(
                        c =>
        ...
        private void BindLayoutObjectToXml(dynamic wp)
        {
            ...
            IEnumerable<IResourceModel> resourceMatch = _resourceModel.Environment.Resources.All().Where(c => c.ResourceName.Equals(LayoutObject.WebpartServiceName, StringComparison.InvariantCultureIgnoreCase));
        ...
        public void Deploy()
        {
            ...
            Mediator.SendMessage(MediatorMessages.BindViewToViewModel, _resourceModel);
