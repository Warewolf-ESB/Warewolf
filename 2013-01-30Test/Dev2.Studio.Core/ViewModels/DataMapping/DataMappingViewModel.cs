...
namespace Dev2.Studio.Core.ViewModels
{
    ...
    public class DataMappingViewModel : BaseViewModel, IDataMappingViewModel
    {
        ...
        public DataMappingViewModel(IWebActivity activity)
        {
            ...
            _dataMappingUpdatedMediatorToken = Mediator.RegisterToReceiveMessage(MediatorMessages.UpdateDataMapping, o => Initialize(_activity));
        ...
        {
            base.OnDispose();
            Mediator.DeRegister(MediatorMessages.UpdateDataMapping, _dataMappingUpdatedMediatorToken);
        }
