...
namespace Dev2.Studio.UI.Tests
{
    ...
    public class FeedbackUITests
    {
        ...
        // Feedback is under Help, and works
        [TestMethod]
        public void ClickHelpFeedback_Expected_FeedbackProcessBegins()
        {
            // Stuff put here does not work for some reason....
            //myTestBase.RibbonUIMap.ClickRibbonMenuItem("Home", "Workflow");
        }

        #endregion Coded UI Tests
