...
namespace Dev2.Tests
{
    ...
    public class Dev2RandomTests
    {
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void GenerateNumsWithFromIsGreaterThanToExpectedArgException()
        {
            _dev2Random.GetRandom(enRandomType.Numbers, -1, 100, 5);
        }
        ...
        public void GenerateWithNumber10TimesExpectedDifferentNumbersEachTime()
        {
            ...
            foreach (var elem in countDuplicates)
            {
                Assert.IsTrue(elem.Count < 5, elem.Count + " duplicate numbers where generated by Dev2Random class (out of 10)");
            }
        }
