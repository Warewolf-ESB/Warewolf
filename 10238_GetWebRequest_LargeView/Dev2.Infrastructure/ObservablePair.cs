...
namespace Dev2
{
    public class ObservablePair<TKey, TValue> : ObservableObject, IEquatable<ObservablePair<TKey, TValue>>
    {
        ...
        public TKey Key { get { return _key; } set { OnPropertyChanged("Key", ref _key, value); } }

        public TValue Value { get { return _value; } set { OnPropertyChanged("Value", ref _value, value); } }
