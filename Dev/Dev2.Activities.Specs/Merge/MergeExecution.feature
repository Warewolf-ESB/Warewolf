...
Scenario: Merge AssignOnlyWithNoOutput Workflow with Same Version
	 ...
	 And I Load workflow "AssignOnlyWithNoOutput" from "tst-ci-remote.dev2.local"	 
...
Scenario: Merge VersionHelloWorld Workflow 
	 ...
	 And I Load workflow "VersionHelloWorld" from "tst-ci-remote.dev2.local"	 
...
Scenario: Merge Workflow with Assign tool As First Tool And Split tool as Second tool count
	 ...
	 And I Load workflow "WorkflowWithDifferentToolSequence" from "tst-ci-remote.dev2.local"	 
...
Scenario: Merge Workflow Containing Same tools But disconnected Arms
	 ...
	 And I Load workflow "WorkflowWithAssignToolsWithDisconnectedArms" from "tst-ci-remote.dev2.local"	 
