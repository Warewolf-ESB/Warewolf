...
#line 13
   testRunner.And("\"Testing - mySql For Xml\" contains \"TestmySqlReturningXml\" from server \"localhost" +
                    "\" with mapping as", ((string)(null)), table606, "And ");
#line 15
...
#line hidden
            ...
            table607.AddRow(new string[] {
                        "[[Result]] = Passed"});
#line 17
   testRunner.And("the \"TestmySqlReturningXml\" in Workflow \"TestmySqlReturningXml\" debug outputs as", ((string)(null)), table607, "And ");
#line hidden
...
#line hidden
            ...
            table608.AddRow(new string[] {
                        ...
                        "hello"});
#line 23
  testRunner.And("\"TestAssignWithRemoteWF\" contains an Assign \"AssignData\" as", ((string)(null)), table608, "And ");
#line hidden
...
#line 26
 testRunner.And("\"TestAssignWithRemoteWF\" contains \"WorkflowUsedBySpecs\" from server \"Remote Conne" +
                    "ction Integration\" with mapping as", ((string)(null)), table609, "And ");
#line 31
...
#line hidden
            ...
            table610.AddRow(new string[] {
                        ...
                        "hello"});
#line 33
    testRunner.And("the \"AssignData\" in WorkFlow \"TestAssignWithRemoteWF\" debug inputs as", ((string)(null)), table610, "And ");
#line hidden
            ...
            table611.AddRow(new string[] {
                        ...
                        "[[inputData]] = hello"});
#line 36
   testRunner.And("the \"AssignData\" in Workflow \"TestAssignWithRemoteWF\" debug outputs as", ((string)(null)), table611, "And ");
#line hidden
            ...
            table612.AddRow(new string[] {
                        "[[inputData]] = hello"});
#line 39
    testRunner.And("the \"WorkflowUsedBySpecs\" in WorkFlow \"TestAssignWithRemoteWF\" debug inputs as", ((string)(null)), table612, "And ");
#line hidden
            ...
            table613.AddRow(new string[] {
                        ...
                        "[[in]] = hello"});
#line 42
   testRunner.And("the \"Setup Assign (1)\" in Workflow \"WorkflowUsedBySpecs\" debug outputs as", ((string)(null)), table613, "And ");
#line hidden
            ...
            table614.AddRow(new string[] {
                        ...
                        "[[in]] = HELLO"});
#line 45
   testRunner.And("the \"Convert Case (1)\" in Workflow \"WorkflowUsedBySpecs\" debug outputs as", ((string)(null)), table614, "And ");
#line hidden
            ...
            table615.AddRow(new string[] {
                        ...
                        "[[values(1).low]] = hello"});
#line 48
   testRunner.And("the \"Final Assign (3)\" in Workflow \"WorkflowUsedBySpecs\" debug outputs as", ((string)(null)), table615, "And ");
#line hidden
...
#line 53
   testRunner.And("the \"WorkflowUsedBySpecs\" in Workflow \"TestAssignWithRemoteWF\" unsorted debug out" +
                    "puts as", ((string)(null)), table616, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 61
   testRunner.And("\"Utility - Assign WF\" contains \"Utility - Assign\" from server \"localhost\" with ma" +
                    "pping as", ((string)(null)), table617, "And ");
#line 66
...
#line 68
   testRunner.And("the \"Utility - Assign\" in Workflow \"Utility - Assign WF\" debug outputs as", ((string)(null)), table618, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table619.AddRow(new string[] {
                        ...
                        "hello"});
#line 76
   testRunner.And("\"TestAssignWithRemoteOutputsErrors\" contains an Assign \"AssignData\" as", ((string)(null)), table619, "And ");
#line hidden
...
#line 79
   testRunner.And("\"TestAssignWithRemoteOutputsErrors\" contains \"WorkflowUsedBySpecs\" from server \"R" +
                    "emote Connection Integration\" with mapping as", ((string)(null)), table620, "And ");
#line 84
...
#line hidden
            ...
            table621.AddRow(new string[] {
                        ...
                        "hello"});
#line 86
   testRunner.And("the \"AssignData\" in WorkFlow \"TestAssignWithRemoteOutputsErrors\" debug inputs as", ((string)(null)), table621, "And ");
#line hidden
...
#line 92
    testRunner.And("the \"WorkflowUsedBySpecs\" in WorkFlow \"TestAssignWithRemoteOutputsErrors\" debug i" +
                    "nputs as", ((string)(null)), table623, "And ");
#line hidden
            ...
            table624.AddRow(new string[] {
                        ...
                        "[[in]] = hello"});
#line 95
   testRunner.And("the \"Setup Assign (1)\" in Workflow \"WorkflowUsedBySpecs\" debug outputs as", ((string)(null)), table624, "And ");
#line hidden
            ...
            table625.AddRow(new string[] {
                        ...
                        "[[in]] = HELLO"});
#line 98
   testRunner.And("the \"Convert Case (1)\" in Workflow \"WorkflowUsedBySpecs\" debug outputs as", ((string)(null)), table625, "And ");
#line hidden
            ...
            table626.AddRow(new string[] {
                        ...
                        "[[values(1).low]] = hello"});
#line 101
   testRunner.And("the \"Final Assign (3)\" in Workflow \"WorkflowUsedBySpecs\" debug outputs as", ((string)(null)), table626, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 109
testRunner.And(string.Format("\"{0}\" contains an Assign \"AssignData\" as", name), ((string)(null)), table627, "And ");
#line hidden
...
testRunner.And(string.Format("\"{0}\" contains \"WorkflowMappingsInnerWorkflow\" from server \"localhost\" with mappi" +
                        "ng as", name), ((string)(null)), table628, "And ");
#line 115
...
#line 117
testRunner.And(string.Format("the \"WorkflowMappingsInnerWorkflow\" in WorkFlow \"{0}\" debug inputs as", name), ((string)(null)), table629, "And ");
#line hidden
...
#line 120
testRunner.And(string.Format("the \"WorkflowMappingsInnerWorkflow\" in Workflow \"{0}\" debug outputs as", name), ((string)(null)), table630, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 139
  testRunner.And("\"Testing - Sql For Xml\" contains \"TestPostgresReturningXml\" from server \"localhos" +
                    "t\" with mapping as", ((string)(null)), table631, "And ");
#line 141
...
#line 143
  testRunner.And("the \"TestPostgresReturningXml\" in Workflow \"TestPostgresReturningXml\" debug outpu" +
                    "ts as", ((string)(null)), table632, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 149
   testRunner.And("\"Testing - Sql For Xml\" contains \"TestOracleReturningXml\" from server \"localhost\"" +
                    " with mapping as", ((string)(null)), table633, "And ");
#line 151
   testRunner.When("\"Testing - Sql For Xml\" is executed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 152
   testRunner.Then("the workflow execution has \"NO\" error", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
...
#line hidden
            ...
            table636.AddRow(new string[] {
                        "[[Result]] = Passed"});
#line 163
   testRunner.And("the \"TestSqlReturningXml\" in Workflow \"TestSqlReturningXml\" debug outputs as", ((string)(null)), table636, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 170
   testRunner.And("\"Testing - Advanced Recordset\" contains \"AdvancedRecordsetAcceptanceTest2\" from s" +
                    "erver \"localhost\" with mapping as", ((string)(null)), table637, "And ");
#line 172
   testRunner.When("\"Testing - Sql For Xml\" is executed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 173
   testRunner.Then("the workflow execution has \"NO\" error", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
...
#line 174
   testRunner.And("the \"AdvancedRecordsetAcceptanceTest2\" in Workflow \"AdvancedRecordsetAcceptanceTe" +
                    "st2\" debug outputs as", ((string)(null)), table638, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 180
   testRunner.And("\"Testing - Advanced Recordset\" contains \"AdvancedRecordsetAcceptanceTest\" from se" +
                    "rver \"localhost\" with mapping as", ((string)(null)), table639, "And ");
#line 182
   testRunner.When("\"Testing - Sql For Xml\" is executed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 183
   testRunner.Then("the workflow execution has \"NO\" error", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
...
#line 184
   testRunner.And("the \"AdvancedRecordsetAcceptanceTest\" in Workflow \"AdvancedRecordsetAcceptanceTes" +
                    "t\" debug outputs as", ((string)(null)), table640, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 190
   testRunner.And("\"Testing - Sql For Xml\" contains \"TestSqlExecutesOnce\" from server \"localhost\" wi" +
                    "th mapping as", ((string)(null)), table641, "And ");
#line 192
   testRunner.When("\"Testing - Sql For Xml\" is executed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 193
   testRunner.Then("the workflow execution has \"NO\" error", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            ...
            table642.AddRow(new string[] {
                        "[[Result]] = Passed"});
#line 194
   testRunner.And("the \"TestSqlExecutesOnce\" in Workflow \"TestSqlExecutesOnce\" debug outputs as", ((string)(null)), table642, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 200
   testRunner.And("\"Testing - Async Test Master Testc\" contains \"Async Test Master\" from server \"loc" +
                    "alhost\" with mapping as", ((string)(null)), table643, "And ");
#line 202
...
#line hidden
            ...
            table644.AddRow(new string[] {
                        "[[Result]] = Pass"});
#line 204
   testRunner.And("the \"Async Test Master\" in Workflow \"Async Test Master\" debug outputs as", ((string)(null)), table644, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table645.AddRow(new string[] {
                        ...
                        "dbo_GetCountries().Description"});
#line 210
 testRunner.And("\"MySQLMigration\" contains \"MySQLDATA\" from server \"localhost\" with mapping as", ((string)(null)), table645, "And ");
#line 214
...
#line hidden
            ...
            table646.AddRow(new string[] {
                        ...
                        "dbo_GetCountries().Description"});
#line 219
 testRunner.And("\"DataMigration\" contains \"DataCon\" from server \"localhost\" with mapping as", ((string)(null)), table646, "And ");
#line 223
...
#line hidden
            ...
            table647.AddRow(new string[] {
                        ...
                        "[[a]]"});
#line 228
 testRunner.And("\"OutterWolf1371\" contains \"Wolf-1371\" from server \"localhost\" with mapping as", ((string)(null)), table647, "And ");
#line 231
...
#line 245
         testRunner.And("\"Testing - TestRemoteTools\" contains \"TestRemoteTools\" from server \"Remote Connec" +
                    "tion Integration\" with mapping as", ((string)(null)), table649, "And ");
#line 247
...
#line 253
   testRunner.And("\"ForEach Output2\" contains \"TestInnerWFForEachOutputs\" from server \"localhost\" wi" +
                    "th mapping as", ((string)(null)), table650, "And ");
#line 256
...
#line hidden
            ...
            table651.AddRow(new string[] {
                        "[[Result]] = Pass"});
#line 258
 testRunner.And("the \"TestInnerWFForEachOutputs\" in Workflow \"ForEach Output2\" debug outputs as", ((string)(null)), table651, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table652.AddRow(new string[] {
                        ...
                        "[[Result]]"});
#line 265
 testRunner.And("\"PerfCounterTest\" contains \"PerfCounter\" from server \"localhost\" with mapping as", ((string)(null)), table652, "And ");
#line 268
...
#line hidden
            ...
            table653.AddRow(new string[] {
                        ...
                        "9"});
#line 269
 testRunner.Then("the perfcounter raw values are", ((string)(null)), table653, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 286
 testRunner.And("the \"Sharepoint Connectors Testing\" in Workflow \"Sharepoint Acceptance Tests Oute" +
                    "r\" debug outputs as", ((string)(null)), table655, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 292
   testRunner.And("\"Spec - Test For Each Shared Memory\" contains \"Test For Each Shared Memory\" from " +
                    "server \"localhost\" with mapping as", ((string)(null)), table656, "And ");
#line 295
...
#line 297
   testRunner.And("the \"Test For Each Shared Memory\" in Workflow \"Spec - Test For Each Shared Memory" +
                    "\" debug outputs as", ((string)(null)), table657, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 303
   testRunner.And("\"EndNestedWorkflows\" contains \"Testing/Bugs/wolf-402\" from server \"localhost\" wit" +
                    "h mapping as", ((string)(null)), table658, "And ");
#line 306
...
#line 327
   testRunner.And("\"Spec - Test For Each  Get\" contains \"GetRequestErrorHandling\" from server \"local" +
                    "host\" with mapping as", ((string)(null)), table661, "And ");
#line 330
...
#line 332
   testRunner.And("the \"GetRequestErrorHandling\" in Workflow \"Spec - Test For Each  Get\" debug outpu" +
                    "ts as", ((string)(null)), table662, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table663.AddRow(new string[] {
                        ...
                        "[[Error]]"});
#line 339
 testRunner.And("\"Wolf-1212_Test\" contains \"ErrorHandled\" from server \"localhost\" with mapping as", ((string)(null)), table663, "And ");
#line 343
...
#line 345
 testRunner.And("the \"ErrorHandled\" in Workflow \"Wolf-1212_Test\" debug outputs as", ((string)(null)), table664, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table665.AddRow(new string[] {
                        ...
                        "[[Result]]"});
#line 353
 testRunner.And("\"Wolf-1212_2\" contains \"ErrorBubbleUp\" from server \"localhost\" with mapping as", ((string)(null)), table665, "And ");
#line 356
...
#line hidden
            ...
            table666.AddRow(new string[] {
                        "[[Result]] = Pass"});
#line 358
 testRunner.And("the \"ErrorBubbleUp\" in Workflow \"Wolf-1212_2\" debug outputs as", ((string)(null)), table666, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table668.AddRow(new string[] {
                        "[[result]] = Pass"});
#line 370
 testRunner.And("the \"RabbitMQTest\" in Workflow \"RabbitMQ Tester WF\" debug outputs as", ((string)(null)), table668, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table670.AddRow(new string[] {
                        "[[Result]] = False"});
#line 381
   testRunner.And("the \"GetWebResult\" in Workflow \"GetWebResult\" debug outputs as", ((string)(null)), table670, "And ");
#line hidden
            this.ScenarioCleanup();
        }
    }
