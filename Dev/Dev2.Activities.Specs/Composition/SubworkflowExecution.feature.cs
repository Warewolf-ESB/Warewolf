...
#line 13
   testRunner.And("\"Testing - mySql For Xml\" contains \"TestmySqlReturningXml\" from server \"localhost" +
                    "\" with mapping as", ((string)(null)), table597, "And ");
#line 15
...
#line hidden
            ...
            table598.AddRow(new string[] {
                        "[[Result]] = Passed"});
#line 17
   testRunner.And("the \"TestmySqlReturningXml\" in Workflow \"TestmySqlReturningXml\" debug outputs as", ((string)(null)), table598, "And ");
#line hidden
...
#line hidden
            ...
            table599.AddRow(new string[] {
                        ...
                        "hello"});
#line 23
  testRunner.And("\"TestAssignWithRemoteWF\" contains an Assign \"AssignData\" as", ((string)(null)), table599, "And ");
#line hidden
...
#line 26
 testRunner.And("\"TestAssignWithRemoteWF\" contains \"WorkflowUsedBySpecs\" from server \"Remote Conne" +
                    "ction Integration\" with mapping as", ((string)(null)), table600, "And ");
#line 31
...
#line hidden
            ...
            table601.AddRow(new string[] {
                        ...
                        "hello"});
#line 33
    testRunner.And("the \"AssignData\" in WorkFlow \"TestAssignWithRemoteWF\" debug inputs as", ((string)(null)), table601, "And ");
#line hidden
            ...
            table602.AddRow(new string[] {
                        ...
                        "[[inputData]] = hello"});
#line 36
   testRunner.And("the \"AssignData\" in Workflow \"TestAssignWithRemoteWF\" debug outputs as", ((string)(null)), table602, "And ");
#line hidden
            ...
            table603.AddRow(new string[] {
                        "[[inputData]] = hello"});
#line 39
    testRunner.And("the \"WorkflowUsedBySpecs\" in WorkFlow \"TestAssignWithRemoteWF\" debug inputs as", ((string)(null)), table603, "And ");
#line hidden
            ...
            table604.AddRow(new string[] {
                        ...
                        "[[in]] = hello"});
#line 42
   testRunner.And("the \"Setup Assign (1)\" in Workflow \"WorkflowUsedBySpecs\" debug outputs as", ((string)(null)), table604, "And ");
#line hidden
            ...
            table605.AddRow(new string[] {
                        ...
                        "[[in]] = HELLO"});
#line 45
   testRunner.And("the \"Convert Case (1)\" in Workflow \"WorkflowUsedBySpecs\" debug outputs as", ((string)(null)), table605, "And ");
#line hidden
            ...
            table606.AddRow(new string[] {
                        ...
                        "[[values(1).low]] = hello"});
#line 48
   testRunner.And("the \"Final Assign (3)\" in Workflow \"WorkflowUsedBySpecs\" debug outputs as", ((string)(null)), table606, "And ");
#line hidden
...
#line 61
   testRunner.And("\"Utility - Assign WF\" contains \"Utility - Assign\" from server \"localhost\" with ma" +
                    "pping as", ((string)(null)), table608, "And ");
#line 66
...
#line 68
   testRunner.And("the \"Utility - Assign\" in Workflow \"Utility - Assign WF\" debug outputs as", ((string)(null)), table609, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table610.AddRow(new string[] {
                        ...
                        "hello"});
#line 76
   testRunner.And("\"TestAssignWithRemoteOutputsErrors\" contains an Assign \"AssignData\" as", ((string)(null)), table610, "And ");
#line hidden
...
#line 79
   testRunner.And("\"TestAssignWithRemoteOutputsErrors\" contains \"WorkflowUsedBySpecs\" from server \"R" +
                    "emote Connection Integration\" with mapping as", ((string)(null)), table611, "And ");
#line 84
...
#line hidden
            ...
            table612.AddRow(new string[] {
                        ...
                        "hello"});
#line 86
   testRunner.And("the \"AssignData\" in WorkFlow \"TestAssignWithRemoteOutputsErrors\" debug inputs as", ((string)(null)), table612, "And ");
#line hidden
...
#line 92
    testRunner.And("the \"WorkflowUsedBySpecs\" in WorkFlow \"TestAssignWithRemoteOutputsErrors\" debug i" +
                    "nputs as", ((string)(null)), table614, "And ");
#line hidden
            ...
            table615.AddRow(new string[] {
                        ...
                        "[[in]] = hello"});
#line 95
   testRunner.And("the \"Setup Assign (1)\" in Workflow \"WorkflowUsedBySpecs\" debug outputs as", ((string)(null)), table615, "And ");
#line hidden
            ...
            table616.AddRow(new string[] {
                        ...
                        "[[in]] = HELLO"});
#line 98
   testRunner.And("the \"Convert Case (1)\" in Workflow \"WorkflowUsedBySpecs\" debug outputs as", ((string)(null)), table616, "And ");
#line hidden
            ...
            table617.AddRow(new string[] {
                        ...
                        "[[values(1).low]] = hello"});
#line 101
   testRunner.And("the \"Final Assign (3)\" in Workflow \"WorkflowUsedBySpecs\" debug outputs as", ((string)(null)), table617, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 109
testRunner.And(string.Format("\"{0}\" contains an Assign \"AssignData\" as", name), ((string)(null)), table618, "And ");
#line hidden
...
testRunner.And(string.Format("\"{0}\" contains \"WorkflowMappingsInnerWorkflow\" from server \"localhost\" with mappi" +
                        "ng as", name), ((string)(null)), table619, "And ");
#line 115
...
#line 117
testRunner.And(string.Format("the \"WorkflowMappingsInnerWorkflow\" in WorkFlow \"{0}\" debug inputs as", name), ((string)(null)), table620, "And ");
#line hidden
...
#line 120
testRunner.And(string.Format("the \"WorkflowMappingsInnerWorkflow\" in Workflow \"{0}\" debug outputs as", name), ((string)(null)), table621, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 138
   testRunner.And("\"Testing - Sql For Xml\" contains \"TestPostgresReturningXml\" from server \"localhos" +
                    "t\" with mapping as", ((string)(null)), table622, "And ");
#line 140
...
#line 148
   testRunner.And("\"Testing - Sql For Xml\" contains \"TestOracleReturningXml\" from server \"localhost\"" +
                    " with mapping as", ((string)(null)), table624, "And ");
#line 150
   testRunner.When("\"Testing - Sql For Xml\" is executed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 151
   testRunner.Then("the workflow execution has \"NO\" error", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
...
#line hidden
            ...
            table627.AddRow(new string[] {
                        "[[Result]] = Passed"});
#line 162
   testRunner.And("the \"TestSqlReturningXml\" in Workflow \"TestSqlReturningXml\" debug outputs as", ((string)(null)), table627, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 169
   testRunner.And("\"Testing - Advanced Recordset\" contains \"AdvancedRecordsetAcceptanceTest2\" from s" +
                    "erver \"localhost\" with mapping as", ((string)(null)), table628, "And ");
#line 171
   testRunner.When("\"Testing - Sql For Xml\" is executed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 172
   testRunner.Then("the workflow execution has \"NO\" error", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
...
#line 173
   testRunner.And("the \"AdvancedRecordsetAcceptanceTest2\" in Workflow \"AdvancedRecordsetAcceptanceTe" +
                    "st2\" debug outputs as", ((string)(null)), table629, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 179
   testRunner.And("\"Testing - Advanced Recordset\" contains \"AdvancedRecordsetAcceptanceTest\" from se" +
                    "rver \"localhost\" with mapping as", ((string)(null)), table630, "And ");
#line 181
   testRunner.When("\"Testing - Sql For Xml\" is executed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 182
   testRunner.Then("the workflow execution has \"NO\" error", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
...
#line 183
   testRunner.And("the \"AdvancedRecordsetAcceptanceTest\" in Workflow \"AdvancedRecordsetAcceptanceTes" +
                    "t\" debug outputs as", ((string)(null)), table631, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 189
   testRunner.And("\"Testing - Sql For Xml\" contains \"TestSqlExecutesOnce\" from server \"localhost\" wi" +
                    "th mapping as", ((string)(null)), table632, "And ");
#line 191
   testRunner.When("\"Testing - Sql For Xml\" is executed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 192
   testRunner.Then("the workflow execution has \"NO\" error", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            ...
            table633.AddRow(new string[] {
                        "[[Result]] = Passed"});
#line 193
   testRunner.And("the \"TestSqlExecutesOnce\" in Workflow \"TestSqlExecutesOnce\" debug outputs as", ((string)(null)), table633, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 199
   testRunner.And("\"Testing - Async Test Master Testc\" contains \"Async Test Master\" from server \"loc" +
                    "alhost\" with mapping as", ((string)(null)), table634, "And ");
#line 201
...
#line hidden
            ...
            table635.AddRow(new string[] {
                        "[[Result]] = Pass"});
#line 203
   testRunner.And("the \"Async Test Master\" in Workflow \"Async Test Master\" debug outputs as", ((string)(null)), table635, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table636.AddRow(new string[] {
                        ...
                        "dbo_GetCountries().Description"});
#line 209
 testRunner.And("\"MySQLMigration\" contains \"MySQLDATA\" from server \"localhost\" with mapping as", ((string)(null)), table636, "And ");
#line 213
...
#line hidden
            ...
            table637.AddRow(new string[] {
                        ...
                        "dbo_GetCountries().Description"});
#line 218
 testRunner.And("\"DataMigration\" contains \"DataCon\" from server \"localhost\" with mapping as", ((string)(null)), table637, "And ");
#line 222
...
#line hidden
            ...
            table638.AddRow(new string[] {
                        ...
                        "[[a]]"});
#line 227
 testRunner.And("\"OutterWolf1371\" contains \"Wolf-1371\" from server \"localhost\" with mapping as", ((string)(null)), table638, "And ");
#line 230
...
#line 244
         testRunner.And("\"Testing - TestRemoteTools\" contains \"TestRemoteTools\" from server \"Remote Connec" +
                    "tion Integration\" with mapping as", ((string)(null)), table640, "And ");
#line 246
...
#line hidden
            ...
            table642.AddRow(new string[] {
                        "[[Result]] = Pass"});
#line 257
 testRunner.And("the \"TestInnerWFForEachOutputs\" in Workflow \"ForEach Output2\" debug outputs as", ((string)(null)), table642, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table643.AddRow(new string[] {
                        ...
                        "[[Result]]"});
#line 264
 testRunner.And("\"PerfCounterTest\" contains \"PerfCounter\" from server \"localhost\" with mapping as", ((string)(null)), table643, "And ");
#line 267
...
#line hidden
            ...
            table644.AddRow(new string[] {
                        ...
                        "9"});
#line 268
 testRunner.Then("the perfcounter raw values are", ((string)(null)), table644, "Then ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 284
   testRunner.And("the \"Sharepoint Connectors Testing\" in Workflow \"Sharepoint Acceptance Tests Oute" +
                    "r\" debug outputs as", ((string)(null)), table646, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line 290
   testRunner.And("\"Spec - Test For Each Shared Memory\" contains \"Test For Each Shared Memory\" from " +
                    "server \"localhost\" with mapping as", ((string)(null)), table647, "And ");
#line 293
...
#line 301
   testRunner.And("\"EndNestedWorkflows\" contains \"Testing/Bugs/wolf-402\" from server \"localhost\" wit" +
                    "h mapping as", ((string)(null)), table649, "And ");
#line 304
...
#line 309
 testRunner.And("\"XmlSerialisation\" contains \"Testing/Bugs/wolf-829\" from server \"localhost\" with " +
                    "mapping as", ((string)(null)), table650, "And ");
#line 312
...
#line 325
   testRunner.And("\"Spec - Test For Each  Get\" contains \"GetRequestErrorHandling\" from server \"local" +
                    "host\" with mapping as", ((string)(null)), table652, "And ");
#line 328
...
#line 330
   testRunner.And("the \"GetRequestErrorHandling\" in Workflow \"Spec - Test For Each  Get\" debug outpu" +
                    "ts as", ((string)(null)), table653, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table654.AddRow(new string[] {
                        ...
                        "[[Error]]"});
#line 337
 testRunner.And("\"Wolf-1212_Test\" contains \"ErrorHandled\" from server \"localhost\" with mapping as", ((string)(null)), table654, "And ");
#line 341
...
#line 343
 testRunner.And("the \"ErrorHandled\" in Workflow \"Wolf-1212_Test\" debug outputs as", ((string)(null)), table655, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table656.AddRow(new string[] {
                        ...
                        "[[Result]]"});
#line 351
 testRunner.And("\"Wolf-1212_2\" contains \"ErrorBubbleUp\" from server \"localhost\" with mapping as", ((string)(null)), table656, "And ");
#line 354
...
#line hidden
            ...
            table657.AddRow(new string[] {
                        "[[Result]] = Pass"});
#line 356
 testRunner.And("the \"ErrorBubbleUp\" in Workflow \"Wolf-1212_2\" debug outputs as", ((string)(null)), table657, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table659.AddRow(new string[] {
                        "[[result]] = Pass"});
#line 367
   testRunner.And("the \"RabbitMQTest\" in Workflow \"RabbitMQ Tester WF\" debug outputs as", ((string)(null)), table659, "And ");
#line hidden
            this.ScenarioCleanup();
        }
...
#line hidden
            ...
            table661.AddRow(new string[] {
                        "[[Result]] = False"});
#line 378
   testRunner.And("the \"GetWebResult\" in Workflow \"GetWebResult\" debug outputs as", ((string)(null)), table661, "And ");
#line hidden
            this.ScenarioCleanup();
        }
    }
