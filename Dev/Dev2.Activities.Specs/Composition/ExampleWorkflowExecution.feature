...
Scenario: Example Executing Utility - Gather System Information example workflow
	  ...
	  Then the workflow execution has "NO" error
	  And the "Gather System Information" in WorkFlow "Utility - System Information" debug inputs as
	 | #  |                     |                     |
	 ...
	 | 16 | [[Domain]] =        | Domain              |	 
	 And the "Gather System Information" in Workflow "Utility - System Information" debug outputs as    
	   | #  |                               |
	   | 1  | [[DateTime]]      =    String |
	   | 2  | [[OpSystem]]      =    String |
	   | 3  | [[SP]]            =    String |
