...
namespace Dev2.Activities.Specs.Composition
{
    ...
    public class WorkflowExecutionSteps : RecordSetBases
    {
        ...
        public void ThenTheHasAStartAndEndDuration(string workflowName)
        {
            ...
            Assert.IsTrue(end.Duration.Ticks > 0, "Workflow debug output end step duration of " + end.Duration.Ticks + " ticks is less than or equal to 0 ticks. All workflow no matter how simple do take some time to execute.");
        }
