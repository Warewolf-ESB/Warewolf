...
#line hidden
            ...
            table1070.AddRow(new string[] {
                        "[[a]]"});
#line 10
  testRunner.And("I have \"Workflow 1\" with inputs as", ((string)(null)), table1070, "And ");
#line hidden
            ...
            table1071.AddRow(new string[] {
                        "[[outputValue]]"});
#line 13
  testRunner.And("\"Workflow 1\" has outputs as", ((string)(null)), table1071, "And ");
#line hidden
            ...
            table1072.AddRow(new string[] {
                        "[[rec().b]]"});
#line 16
  testRunner.Given("I have \"Workflow 2\" with inputs as", ((string)(null)), table1072, "Given ");
#line hidden
            ...
            table1073.AddRow(new string[] {
                        "[[returnVal]]"});
#line 20
  testRunner.And("\"Workflow 2\" has outputs as", ((string)(null)), table1073, "And ");
#line hidden
            ...
            table1074.AddRow(new string[] {
                        "[[C]]"});
#line 23
  testRunner.Given("I have \"Workflow 3\" with inputs as", ((string)(null)), table1074, "Given ");
#line hidden
            ...
            table1075.AddRow(new string[] {
                        "[[message]]"});
#line 28
  testRunner.And("\"Workflow 3\" has outputs as", ((string)(null)), table1075, "And ");
#line hidden
            ...
            table1076.AddRow(new string[] {
                        "[[input]]"});
#line 31
  testRunner.Given("I have \"WorkflowWithTests\" with inputs as", ((string)(null)), table1076, "Given ");
#line hidden
            ...
            table1077.AddRow(new string[] {
                        "[[outputValue]]"});
#line 34
  testRunner.And("\"WorkflowWithTests\" has outputs as", ((string)(null)), table1077, "And ");
#line hidden
            ...
            table1078.AddRow(new string[] {
                        ...
                        "false"});
#line 37
  testRunner.And("\"WorkflowWithTests\" Tests as", ((string)(null)), table1078, "And ");
#line hidden
        }
...
#line 47
   testRunner.And("\"MySqlTestWF\" contains a mysql database service \"MySqlEmail\" with mappings for te" +
                    "sting as", ((string)(null)), table1079, "And ");
#line 51
...
#line 70
   testRunner.And("\"SqlTestWF\" contains a sqlserver database service \"dbo.Pr_CitiesGetCountries\" wit" +
                    "h mappings for testing as", ((string)(null)), table1081, "And ");
#line 73
...
#line 116
   testRunner.And("\"PostGreTestWF\" contains a postgre tool using \"get_countries\" with mappings for t" +
                    "esting as", ((string)(null)), table1085, "And ");
#line 119
...
#line hidden
            ...
            table1087.AddRow(new string[] {
                        ...
                        "30"});
#line 137
  testRunner.And("\"DecisionTestWF\" contains an Assign \"TestAssign\" as", ((string)(null)), table1087, "And ");
#line 140
...
#line hidden
            ...
            table1088.AddRow(new string[] {
                        ...
                        "Decision"});
#line 148
  testRunner.And("I add Assert steps as", ((string)(null)), table1088, "And ");
#line 151
  testRunner.When("I save", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 152
  testRunner.And("I run the test", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
...
#line 160
   testRunner.And("\"SqlBulkTestWF\" contains an SQL Bulk Insert \"BulkInsert\" using database \"NewSqlBu" +
                    ...
                    "lt set \"[[result]]\" for testing as", ((string)(null)), table1089, "And ");
#line 164
