...
#	And the debug inputs as  
#	| # | Input 1                | Input 2                | Input Format | Output In |
#	| # | 06/01/2014 08:00:01.00 | 30/01/2014 08:00:01.06 |              | Weeks |
#	And the debug output as 
#	|                |
#	| [[result]] = 3 |
...
#	And the debug inputs as  
#	| # | Input 1                | Input 2                | Input Format | Output In |
#	| # | 06/01/2014 08:00:01.00 | 30/01/2014 08:00:01.06 |              | Hours |
#	And the debug output as 
#	|                |
#	| [[result]] = 576 |
#
...
#	Given I have a first date "06/01/2014 08:00:01.00" 
#	And I have a second date "30/01/2014 08:00:01.68" 
#	And the date format as ""
#	And I selected output in "Minutes" 	
#	When the datetime difference tool is executed
...
#	And the debug inputs as  
#	| Input 1                | Input 2                | Input Format | Output In |
#	| 06/01/2014 08:00:01.00 | 30/01/2014 08:00:01.68 |              | Minutes   |
#	And the debug output as 
#	|                    |
#	| [[result]] = 34560 |
#
...
#	And the debug inputs as  
#	| Input 1                | Input 2                | Input Format | Output In |
#	| 06/01/2014 08:00:01.00 | 30/01/2014 08:00:01.68 |              | Seconds   |
#	And the debug output as 
#	|                      |
#	| [[result]] = 2073600 |
#
...
#	Given I have a first date "06/01/2014 08:00:01.00" 
#	And I have a second date "30/06/2016 08:00:01.68" 
#	And the date format as ""
#	And I selected output in "Days" 	
#	When the datetime difference tool is executed
#	Then the difference should be "906"
#	And the execution has "NO" error
#	And the debug inputs as  
#	| Input 1                | Input 2                | Input Format | Output In |
#	| 06/01/2014 08:00:01.00 | 30/01/2014 08:00:01.68 |              | Days   |
#	And the debug output as 
#	|                  |
#	| [[result]] = 906 |
#
...
#	And the debug inputs as  
#	| Input 1                | Input 2                | Input Format | Output In |
#	| 06/01/2014 08:00:01.00 | 30/01/2014 08:00:01.68 | Months       |           |
#	And the debug output as 
#	|                 |
#	| [[result]] = 29 |
#
...
#	And the debug inputs as  
#	| Input 1                | Input 2                | Input Format | Output In |
#	| 06/01/2014 08:00:01.00 | 30/01/2014 08:00:01.68 | Years        |           |
#	And the debug output as 
#	|                |
#	| [[result]] = 2 |
