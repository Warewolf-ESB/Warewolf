...
Scenario: Calculate Assign by evaluating variables with functions
	Given I have a calculate variable "x; y; z; rc(1).set; s; t"
	...
	| 4   | AND([[s]]<[[z]]<5)                                         | False                     |
	| 5   | AND([[y]]<5)                                               | True                      |
	| 7   | ASIN([[s]])                                                | -1.570796327              |
	| 8   | ASINH([[rc(1).set]])                                       | 2.312438341               |
	| 9   | ATAN([[s]])                                                | -0.785398163              |
	| 10  | ATAN2([[x]],[[s]])                                         | -0.785398163              |
	| 11  | ATANH([[t]])                                               | 0                         |
	| 12  | AVEDEV([[x]],[[z]])                                        | 4.5                       |
	| 13  | AVERAGE([[x]],[[y]],[[z]],[[rc(1).set]],[[s]],[[t]],[[e]]) | 145.2857143               |
	| 14  | BIN2DEC([[z]])                                             | 2                         |
	| 15  | BIN2HEX([[x]])                                             | 1                         |
	| 16  | BIN2OCT([[z]])                                             | 2                         |
	| 17  | CEILING([[z]],[[y]])                                       | 10                        |
	...
	| 24  | CONVERT([[z]],"m","in")                                    | 393.7007874               |
	| 25  | COS([[[[a]]]])                                             | 0.753902254               |
	| 26  | COSH([[z]])                                                | 11013.23292               |
	| 27  | COUNT([[x]],[[y]],[[[[a]]]])                               | 3                         |
	| 28  | COUNT([[x]],[[y]],[[[[a]]]],,,)                            | 6                         |
	| 29  | DATE(2000,[[y]],12)                                        | 2/12/2000                 |
	| 30  | DAY([[x]])                                                 | 1/10/1900                 |
	...
	| 38  | DEGREES([[z]])                                             | 572.96                    |
	| 39  | DELTA([[t]],[[x]])                                         | 0.00                      |
	| 40  | DOLLARDE([[z]],[[y]])                                      | 10.00                     |
	| 41  | DOLLARFR([[x]],[[z]])                                      | 1.00                      |
	| 42  | EDATE([[z]],[[[[a]]]])                                     | 223.00                    |
	| 43  | EOMONTH([[z]],[[[[a]]]])                                   | 244.00                    |
	| 44  | ERROR.TYPE(#NUM!)                                          | 6.00                      |
	| 45  | EVEN([[y]])                                                | 2                         |
	| 46  | EXP([[x]])                                                 | 2.718281828               |
	| 47  | FACT([[z]])                                                | 3628800                   |
	| 48  | FIND([[t]],[[e]])                                          | 2                         |
	| 49  | FACTDOUBLE([[z]])                                          | 3840                      |
	| 50  | FLOOR([[z]],[[z]])                                         | 10                        |
	| 51  | FV(10,12,100,10,1)                                         | (376,611,405,206,410.00)  |
	| 52  | GCD([[x]],[[z]])                                           | 1                         |
	| 53  | GESTEP([[[[a]]]],[[s]])                                    | 1                         |
	| 54  | HEX2BIN([[y]],[[y]])                                       | 10                        |
	...
	| 76  | INFO("OSVERSION")                                          | Windows (64-bit) NT 6.01  |
	| 77  | INT([[s]])                                                 | -1                        |
	...
	| 121 | OR(1,2)                                                    | True                      |
	| 122 | PI()                                                       | 3.141592654               |
	| 123 | PMT([[z]],[[x]],100,200,[[t]])                             | ($1,300.00)               |
	| 124 | POWER([[z]],[[y]])                                         | 100                       |
	| 125 | PPMT(10,1,1,1000,500,0)                                    | ($1,500.00)               |
	| 126 | PRODUCT([[x]],[[y]],[[z]])                                 | 20                        |
	| 127 | PV(5,1,10,100,0)                                           | ($18.33)                  |
	...
	| 142 | SIGN(50)                                                   | 1                         |
	| 143 | SIN([[z]])                                                 | -0.544021111              |
	| 144 | SINH([[z]])                                                | 11013.23287               |
	| 145 | SLN(100,10,[[x]])                                          | 90                        |
	| 146 | SQRT(16)                                                   | 4                         |
