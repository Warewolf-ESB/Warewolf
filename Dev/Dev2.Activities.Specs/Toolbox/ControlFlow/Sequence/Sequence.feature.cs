...
#line 529
    testRunner.And("call the web service \"http://tst-ci-remote:3142/services/OnError_WriteErrorSeq.xm" +
...
#line 532
    testRunner.And("the result from the web service \"http://tst-ci-remote:3142/services/OnError_ReadE" +
                    "rrorSeq.xml\" will have the same data as variable \"[[error]]\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
