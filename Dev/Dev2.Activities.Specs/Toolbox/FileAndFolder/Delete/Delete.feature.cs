...
#line hidden
        ...
        public virtual void DeleteFileAtLocation(string variable, string location, string username, string password, string resultVar, string result, string errorOccured, string[] exampleTags)
        {
...
#line hidden
        ...
        {
            this.DeleteFileAtLocation("[[path]]", "c:\\myfile.txt", "", "", "[[result]]", "Success", "NO", ((string[])(null)));
        }
        ...
        {
            this.DeleteFileAtLocation("[[path]]", "\\rsaklfsvrtfsbld\\testing\\test.txt", "", "", "[[result]]", "Success", "NO", ((string[])(null)));
        }
        ...
        {
            this.DeleteFileAtLocation("[[path]]", "ftp:\\dev2.co.za\\testing\\test.txt", "", "", "[[result]]", "Success", "NO", ((string[])(null)));
        }
        ...
        {
            this.DeleteFileAtLocation("[[path]]", "ftps:\\dev2ftps.dev2.local\\testing\\test.txt", "integrationtester", "I73573r0", "[[result]]", "Success", "NO", ((string[])(null)));
        }
        ...
        {
            this.DeleteFileAtLocation("[[path]]", "sftp:\\dev2.co.za\\testing\\test.txt", "dev2", "Q/ulw&]", "[[result]]", "Success", "NO", ((string[])(null)));
        }
    }
}
