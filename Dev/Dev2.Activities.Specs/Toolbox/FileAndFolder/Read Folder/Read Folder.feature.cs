...
#line hidden
        ...
        public virtual void ReadFolderFileAtLocation(string no, string name, string source, string sourceLocation, string read, string username, string password, string resultVar, string result, string errorOccured, string sourcePrivateKeyFile, string[] exampleTags)
        {
...
#line hidden
        ...
        public virtual void ReadFolderFileAtLocation_31()
        {
            this.ReadFolderFileAtLocation("31", "SFTP PK", "[[path]]", "sftp://localhost", "Files & Folders", "dev2", "Q/ulw&]", "[[result]]", "String", "NO", "C:\\Temp\\key.opk", ((string[])(null)));
        }
        
        public virtual void ReadFolderFileAtLocationUsingNullVariable(string no, string name, string source, string sourceLocation, string read, string username, string password, string resultVar, string result, string errorOccured, string sourcePrivateKeyFile, string[] exampleTags)
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Read Folder file at location using null variable", exampleTags);
#line 60
this.ScenarioSetup(scenarioInfo);
#line 61
 testRunner.Given(string.Format("I have a source path \'{0}\' with value \'{1}\'", source, sourceLocation), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Read Folder file at location using null variable")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Read Folder")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("fileFeature")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("VariantName", "1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:No", "1")]
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("Parameter:sourcePrivateKeyFile", "")]
        public virtual void ReadFolderFileAtLocationUsingNullVariable_1()
        {
            this.ReadFolderFileAtLocationUsingNullVariable("1", "Local Files", "[[path]]", "NULL", "Files", "\"\"", "\"\"", "[[result]]", "Error", "AN", "", ((string[])(null)));
        }
    }
}
