...
namespace Warewolf.UI.Tests.WebSource.WebSourceUIMapClasses
{
    ...
    public partial class WebSourceUIMap
    {
        ...
        {
            MainStudioWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.WebSourceTab.WorkSurfaceContext.AddressTextbox.Text = "http://TFSBLD.dev2.local:9810/api/products/Post";
        ...
        {
            MainStudioWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.WebSourceTab.WorkSurfaceContext.AddressTextbox.Text = "http://TFSBLD.dev2.local:9810/api/products/Delete";
        ...
        {
            MainStudioWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.WebSourceTab.WorkSurfaceContext.AddressTextbox.Text = "http://TFSBLD.dev2.local:9810/api/products/Put";
