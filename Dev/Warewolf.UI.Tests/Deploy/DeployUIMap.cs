...
namespace Warewolf.UI.Tests.Deploy.DeployUIMapClasses
{
    ...
    public partial class DeployUIMap
    {
        ...
        public void Select_RemoteContainer_From_Deploy_Tab_Destination_Server_Combobox()
        {
            ...
            Assert.IsTrue(MainStudioWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.DeployTab.WorkSurfaceContext.DockManager.DeployView.DestinationServerConectControl.Combobox.RemoteContainerText.Exists, "Selected destination server in deploy is not Remote Connection Integration.");
        }
