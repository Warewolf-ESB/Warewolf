...
namespace Warewolf.UI.Tests.Merge
{
    ...
    public class MergeDecisionConflictsTest
    {
        ...
        {
            MergeConflictsUIMap.RightClick_On_MergeWfWithVersion(MergeHelloWorldWithVersion);
            Assert.IsTrue(UIMap.MainStudioWindow.ExplorerContextMenu.Merge.Exists, "Merge option does not show after Right cliking " + MergeHelloWorldWithVersion);
        }
