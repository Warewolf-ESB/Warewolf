...
namespace Warewolf.UI.Tests.Merge
{
    ...
    public class MergeDecisionConflictsTest
    {
        ...
        public void Click_On_MergeDecision__Difference_Decision_Add_Decision_And_Assigns_On_Design_Surface()
        {
            ...
            Assert.IsTrue(MergeConflictsUIMap.MainWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.MergeTab.WorkSurfaceContext.ContentDockManager.MergeWorkflowView.UIUserControl_1Custom.UIScrollViewerPane.UIActivityBuilderCustom.UIWorkflowItemPresenteCustom.UIFlowchartCustom.Difference_Decision.Exists, "Assign from difference was not added to the design surface After checking Radio Button");
            Assert.IsTrue(MergeConflictsUIMap.MainWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.MergeTab.WorkSurfaceContext.ContentDockManager.MergeWorkflowView.UIUserControl_1Custom.UIScrollViewerPane.UIActivityBuilderCustom.UIWorkflowItemPresenteCustom.UIFlowchartCustom.FirstAssign_Diff_On_Surface.Exists, "Dicision from difference was not added to the design surface After checking Radio Button");
        }
