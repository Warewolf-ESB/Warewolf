...
namespace Warewolf.UI.Tests.Merge
{
    ...
    public class MergeSimpleToolsConflictsTests
    {
        ...
        {
            Assert.IsTrue(MergeConflictsUIMap.MainWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.MergeTab.WorkSurfaceContext.ContentDockManager.MergeWorkflowView.ScrollViewerPane.ConflictsTree.MergeTreeItem2.NoConflicts.Exists);
