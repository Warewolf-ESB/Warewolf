...
namespace Warewolf.UI.Tests.Merge
{
    ...
    public partial class MergeSimpleToolsConflictsTests
    {
        ...
        public void Click_On_Assign_From_The_Current_List_Removes_Assign_On_The_Workflow()
        {
            ...
            Assert.IsFalse(MergeConflictsUIMap.MainWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.MergeTab.WorkSurfaceContext.ContentDockManager.MergeWorkflowView.DesignerView.ScrollViewerPane.ActivityBuilder.WorkflowItemPresenter.Flowchart.EmptyAssign_On_Surface.Exists);
        }
