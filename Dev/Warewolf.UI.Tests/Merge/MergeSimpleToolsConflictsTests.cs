...
namespace Warewolf.UI.Tests.Merge
{
    ...
    public class MergeSimpleToolsConflictsTests
    {
        ...
        public void Click_On_Assign_From_The_Current_List_Removes_Assign_On_The_Workflow()
        {
            ...
            MergeConflictsUIMap.MainWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.MergeTab.WorkSurfaceContext.ContentDockManager.MergeWorkflowView.ScrollViewerPane.ConflictsTree.MergeTreeItem6.MergeItemExpander.MergeButton.DifferenceCheckBox.Checked = true;
