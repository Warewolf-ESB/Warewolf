...
namespace Warewolf.UI.Tests.WorkflowTab.WorkflowTabUIMapClasses
{
    ...
    public partial class WorkflowTabUIMap
    {
        ...
        {
            UIMap.MainStudioWindow.DockManager.SplitPaneLeft.ToolBox.SearchTextBox.Text = "Advanced";
            ...
            Mouse.StartDragging(UIMap.MainStudioWindow.DockManager.SplitPaneLeft.ToolBox.ToolListBox.Database.AdvancedRecordset, new Point(10, 15));
