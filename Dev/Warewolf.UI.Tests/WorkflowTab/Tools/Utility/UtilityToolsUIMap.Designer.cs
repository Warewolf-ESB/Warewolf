...
namespace Warewolf.UI.Tests.WorkflowTab.Tools.Utility.UtilityToolsUIMapClasses
{
    ...
    public class CreateJson : WpfCustom
    {
                ...
                base(searchLimitContainer)
        {
            ...
            this.SearchProperties[WpfControl.PropertyNames.AutomationId] = "Create JSON (0)(CreateJsonDesigner)";
    ...
    public class IntellisenseCombobox : WpfComboBox
    {
        ...
        {
            #region Search Criteria
            this.SearchProperties[WpfComboBox.PropertyNames.AutomationId] = "UI__Row1_DestinationName_AutoID";
            this.WindowTitles.Add("Warewolf (DEV2\\ASHLEY.LEWIS)");
            #endregion
        }
    ...
    public class InputCell1 : WpfCell
    {
        ...
        {
            #region Search Criteria
            this.SearchProperties[WpfCell.PropertyNames.ColumnHeader] = "Data";
            this.SearchProperties[WpfCell.PropertyNames.AutomationId] = "UI_CellColumn2";
            this.WindowTitles.Add("Warewolf (DEV2\\ASHLEY.LEWIS)");
            #endregion
        }
