...
namespace Warewolf.UI.Tests.OracleSource
{
    [CodedUITest]
    public class OracleSourceTests
    {
        ...
        {
            //Create Source
            ExplorerUIMap.Select_NewOracleSource_From_ExplorerContextMenu();
            ...
            DBSourceUIMap.Enter_Text_Into_DatabaseServer_Tab("SVRDEV.premier.local");
