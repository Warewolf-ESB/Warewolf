...
namespace Warewolf.UI.Tests.DBSource.DBSourceUIMapClasses
{
    ...
    public class ServerComboBox : WpfComboBox
    {
        ...
        #region Properties
        public WpfListItem SVRDEV
        {
            get
            {
                if ((this.mSVRDEV == null))
                {
                    this.mSVRDEV = new WpfListItem(this);
                    #region Search Criteria
                    this.mSVRDEV.SearchProperties[WpfListItem.PropertyNames.Name] = "SVRDEV";
                    this.mSVRDEV.WindowTitles.Add("Warewolf");
                    #endregion
                }
                return this.mSVRDEV;
            }
        ...
        public WpfListItem FirstItem
        {
            get
            {
                if ((this.mFirstItem == null))
                {
                    this.mFirstItem = new WpfListItem(this);
                    #region Search Criteria
                    this.mFirstItem.SearchProperties[WpfListItem.PropertyNames.Instance] = "1";
        ...
        #region Fields
        private WpfListItem mSVRDEV;
        
        private WpfListItem mFirstItem;
