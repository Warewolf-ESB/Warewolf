        ...
        public WpfText SelectedItemAsRemoteConnectionIntegration
        {
            get
            {
                if ((this.mSelectedItemAsRemoteConnectionIntegration == null))
                {
                    ...
                    #region Search Criteria
                    this.mSelectedItemAsRemoteConnectionIntegration.SearchProperties[WpfText.PropertyNames.Name] = "CI Remote Connection";
        ...
        public WpfText SelectedItemAsRemoteConnectionIntegrationConnected
        {
            get
            {
                if ((this.mSelectedItemAsRemoteConnectionIntegrationConnected == null))
                {
                    ...
                    #region Search Criteria
                    this.mSelectedItemAsRemoteConnectionIntegrationConnected.SearchProperties[WpfText.PropertyNames.Name] = "CI Remote Connection (Connected)";
        ...
        public WpfText LocalhostConnectedText
        {
            get
            {
                if ((this.mLocalhostConnectedText == null))
                {
                    ...
                    #region Search Criteria
                    this.mLocalhostConnectedText.SearchProperties.Add(new PropertyExpression(WpfText.PropertyNames.Name, "localhost", PropertyExpressionOperator.Contains));
        ...
        public WpfText RemoteConnectionIntegrationItemText
        {
            get
            {
                if ((this.mRemoteConnectionIntegrationItemText == null))
                {
                    ...
                    #region Search Criteria
                    this.mRemoteConnectionIntegrationItemText.SearchProperties[WpfText.PropertyNames.Name] = "CI Remote Connection";
