...
namespace Warewolf.UI.Tests.ServerSource
{
    ...
    public class ServerSourceTests
    {
        ...
        public void EditServerSource_LoadCorrectly()
        {
            ...
            ExplorerUIMap.Select_Source_From_ExplorerContextMenu(ExistingSourceName);
            Assert.IsTrue(ServerSourceUIMap.MainStudioWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.ServerSourceTab.WorkSurfaceContext.WindowsRadioButton.Selected, "Windows auth is not selected.");
        }
