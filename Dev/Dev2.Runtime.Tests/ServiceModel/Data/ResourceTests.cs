...
namespace Dev2.Tests.Runtime.ServiceModel.Data
{
    ...
    public class ResourceTests
    {
        ...
        string GetValidXMLStringWithMultipleDependenciesWithServiceDependencies_Plugin()
        {
            return "<Service Name=\"Bug6619\" ID=\"1736ca6e-b870-467f-8d25-262972d8c3e8\" ServerID=\"51a58300-7e9d-4927-a57b-e5d700b11b55\">" +
                "<Action Name=\"InvokeWorkflow\" Type=\"Workflow\">" +
                "<XamlDefinition>" +
                ...
                "</sap:WorkflowViewStateService.ViewState>" +
                "</uaba:DsfActivity>" +
               " <uaba:DsfDotNetDllActivity ActivityStateData=\"{x:Null}\" AuthorRoles=\"{x:Null}\" Category=\"{x:Null}\" Compiler=\"{x:Null}\" CurrentResult=\"{x:Null}\" DataObject=\"{x:Null}\" DataTags=\"{x:Null}\" " +
        ...
        string GetValidXMLStringWithMultipleDependenciesWithServiceDependencies_SqlServerDatabase()
        {
            return "<Service Name=\"Bug6619\" ID=\"1736ca6e-b870-467f-8d25-262972d8c3e8\" ServerID=\"51a58300-7e9d-4927-a57b-e5d700b11b55\">" +
                "<Action Name=\"InvokeWorkflow\" Type=\"Workflow\">" +
                "<XamlDefinition>" +
                ...
                "</sap:WorkflowViewStateService.ViewState>" +
                "</uaba:DsfActivity>" +
               " <uaba:DsfSqlServerDatabaseActivity ActivityStateData=\"{x:Null}\" AuthorRoles=\"{x:Null}\" Category=\"{x:Null}\" Compiler=\"{x:Null}\" CurrentResult=\"{x:Null}\" DataObject=\"{x:Null}\" DataTags=\"{x:Null}\" " +
                "ExplicitDataList=\"{x:Null}\" HelpLink=\"{x:Null}\" IconPath=\"{x:Null}\" InputTransformation=\"{x:Null}\" OnResumeKeepList=\"{x:Null}\" ParentServiceID=\"{x:Null}\" ParentServiceName=\"{x:Null}\" " +
                "ParentWorkflowInstanceId=\"{x:Null}\" ResultTransformation=\"{x:Null}\" ResultValidationExpression=\"{x:Null}\" ResultValidationRequiredTags=\"{x:Null}\" ScenarioID=\"{x:Null}\" " +
                "ScopingObject=\"{x:Null}\" SimulationOutput=\"{x:Null}\" Tags=\"{x:Null}\" ActionName=\"Connect\" Add=\"False\" DatabindRecursive=\"False\" DeferExecution=\"False\" " +
                "DisplayName=\"DEV2Plugin_SQLServer_Connect\" FriendlySourceName=\"DEV2Plugin_SQLServer\" HasError=\"[HasError]\" sap:VirtualizedContainerService.HintSize=\"250,104\" " +
                ...
                "InstructionList=\"[InstructionList]\" IsSimulationEnabled=\"False\" IsUIStep=\"False\" IsValid=\"[IsValid]\" IsWorkflow=\"False\" OnResumeClearAmbientDataList=\"False\" " +
                "OnResumeClearTags=\"FormView,InstanceId,Bookmark,ParentWorkflowInstanceId,ParentServiceName,WebPage\" OutputMapping=\"&lt;Outputs&gt;&lt;Output Name=&quot;Error&quot; MapsTo=&quot;Error&quot; Value=&quot;[[Error]]&quot; /&gt;&lt;Output Name=&quot;Connect&quot; MapsTo=&quot;Connect&quot; Value=&quot;[[Connect]]&quot; /&gt;&lt;/Outputs&gt;\" " +
                "RemoveInputFromOutput=\"False\" ServiceName=\"DEV2Plugin_SQLServer_Connect\" SimulationMode=\"OnDemand\" ToolboxFriendlyName=\"DEV2Plugin_SQLServer_Connect\" Type=\"\" " +
                "UniqueID=\"48869a05-7121-4e45-970e-a40f6a2f8fd9\">" +
                "<uaba:DsfActivity.AmbientDataList>" +
                "<InOutArgument x:TypeArguments=\"scg:List(x:String)\" />" +
                "</uaba:DsfActivity.AmbientDataList>" +
                ...
                "</scg:Dictionary>" +
                "</sap:WorkflowViewStateService.ViewState>" +
                "</uaba:DsfSqlServerDatabaseActivity>" +
                "</FlowStep>" +
                    "</Flowchart.StartNode>" +
                "<x:Reference>__ReferenceID0</x:Reference>" +
                "</Flowchart>" +
        ...
        string GetValidXMLStringWithMultipleDependenciesWithServiceDependencies_MySqlServerDatabase()
        {
            return "<Service Name=\"Bug6619\" ID=\"1736ca6e-b870-467f-8d25-262972d8c3e8\" ServerID=\"51a58300-7e9d-4927-a57b-e5d700b11b55\">" +
                "<Action Name=\"InvokeWorkflow\" Type=\"Workflow\">" +
                "<XamlDefinition>" +
                ...
                "</sap:WorkflowViewStateService.ViewState>" +
                "</uaba:DsfActivity>" +
               " <uaba:DsfMySqlDatabaseActivity ActivityStateData=\"{x:Null}\" AuthorRoles=\"{x:Null}\" Category=\"{x:Null}\" Compiler=\"{x:Null}\" CurrentResult=\"{x:Null}\" DataObject=\"{x:Null}\" DataTags=\"{x:Null}\" " +
                "ExplicitDataList=\"{x:Null}\" HelpLink=\"{x:Null}\" IconPath=\"{x:Null}\" InputTransformation=\"{x:Null}\" OnResumeKeepList=\"{x:Null}\" ParentServiceID=\"{x:Null}\" ParentServiceName=\"{x:Null}\" " +
                "ParentWorkflowInstanceId=\"{x:Null}\" ResultTransformation=\"{x:Null}\" ResultValidationExpression=\"{x:Null}\" ResultValidationRequiredTags=\"{x:Null}\" ScenarioID=\"{x:Null}\" " +
                "ScopingObject=\"{x:Null}\" SimulationOutput=\"{x:Null}\" Tags=\"{x:Null}\" ActionName=\"Connect\" Add=\"False\" DatabindRecursive=\"False\" DeferExecution=\"False\" " +
                "DisplayName=\"DEV2Plugin_SQLServer_Connect\" FriendlySourceName=\"DEV2Plugin_SQLServer\" HasError=\"[HasError]\" sap:VirtualizedContainerService.HintSize=\"250,104\" " +
        ...
        string GetValidXMLStringWithMultipleDependenciesWithServiceDependencies_WebGetActivity()
        {
            return "<Service Name=\"Bug6619\" ID=\"1736ca6e-b870-467f-8d25-262972d8c3e8\" ServerID=\"51a58300-7e9d-4927-a57b-e5d700b11b55\">" +
                "<Action Name=\"InvokeWorkflow\" Type=\"Workflow\">" +
                "<XamlDefinition>" +
                ...
                "</sap:WorkflowViewStateService.ViewState>" +
                "</uaba:DsfActivity>" +
               " <uaba:DsfWebGetActivity ActivityStateData=\"{x:Null}\" AuthorRoles=\"{x:Null}\" Category=\"{x:Null}\" Compiler=\"{x:Null}\" CurrentResult=\"{x:Null}\" DataObject=\"{x:Null}\" DataTags=\"{x:Null}\" " +
                "ExplicitDataList=\"{x:Null}\" HelpLink=\"{x:Null}\" IconPath=\"{x:Null}\" InputTransformation=\"{x:Null}\" OnResumeKeepList=\"{x:Null}\" ParentServiceID=\"{x:Null}\" ParentServiceName=\"{x:Null}\" " +
                "ParentWorkflowInstanceId=\"{x:Null}\" ResultTransformation=\"{x:Null}\" ResultValidationExpression=\"{x:Null}\" ResultValidationRequiredTags=\"{x:Null}\" ScenarioID=\"{x:Null}\" " +
                "ScopingObject=\"{x:Null}\" SimulationOutput=\"{x:Null}\" Tags=\"{x:Null}\" ActionName=\"Connect\" Add=\"False\" DatabindRecursive=\"False\" DeferExecution=\"False\" " +
                "DisplayName=\"DEV2Plugin_SQLServer_Connect\" FriendlySourceName=\"DEV2Plugin_SQLServer\" HasError=\"[HasError]\" sap:VirtualizedContainerService.HintSize=\"250,104\" " +
