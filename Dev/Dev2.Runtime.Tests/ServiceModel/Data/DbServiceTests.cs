...
namespace Dev2.Tests.Runtime.ServiceModel.Data
{
  ...
  <AuthorRoles></AuthorRoles>
        ...
        //2013.05.17: Ashley Lewis for bug 9453 - the user can leave outputs blank and they are not serialized
        [TestMethod]
        public void ToXmlWithBlankOutputsExpectedCorrectOutputTagsAreRemovedFromXml()
        {
            const string XmlDataString = @"<Service ID=""af8d2d38-22b5-4599-8357-adce196beb83"" Version=""1.0"" Name=""TravsTestService"" ResourceType=""DbService"">
              <Actions>
                <Action Name=""dbo.InsertDummyUser"" Type=""InvokeStoredProc"" SourceID=""ebba47dc-e5d4-4303-a203-09e2e9761d16"" SourceName=""testingDBSrc"" SourceMethod=""dbo.InsertDummyUser"">
                  <Inputs />
                  <Outputs>
                    <Output Name=""fname"" MapsTo=""FName"" Value=""[[dbo.InsertDummyUser().FName]]"" Recordset=""dbo.InsertDummyUser"" />
                    <Output Name=""lname"" MapsTo=""LName"" Value=""[[dbo.InsertDummyUser().LName]]"" Recordset=""dbo.InsertDummyUser"" />
                    <Output Name=""username"" MapsTo=""UserName"" Value=""[[dbo.InsertDummyUser().UserName]]"" Recordset=""dbo.InsertDummyUser"" />
                    <Output Name=""password"" MapsTo="""" Value=""[[dbo.InsertDummyUser().Password]]"" Recordset=""dbo.InsertDummyUser"" />
                    <Output Name=""lastAccessDate"" MapsTo="""" Value=""[[dbo.InsertDummyUser().LastAccessDate]]"" Recordset=""dbo.InsertDummyUser"" />
                  </Outputs>
                  <OutputDescription><![CDATA[<z:anyType xmlns:i=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:d1p1=""http://schemas.datacontract.org/2004/07/Unlimited.Framework.Converters.Graph.Ouput"" i:type=""d1p1:OutputDescription"" xmlns:z=""http://schemas.microsoft.com/2003/10/Serialization/""><d1p1:DataSourceShapes xmlns:d2p1=""http://schemas.microsoft.com/2003/10/Serialization/Arrays""><d2p1:anyType i:type=""d1p1:DataSourceShape""><d1p1:Paths /></d2p1:anyType></d1p1:DataSourceShapes><d1p1:Format>ShapedXML</d1p1:Format></z:anyType>]]></OutputDescription>
                </Action>
              </Actions>
            ...
            const string Expected = @"<Service ID=""af8d2d38-22b5-4599-8357-adce196beb83"" Version=""1.0"" Name=""TravsTestService"" ResourceType=""DbService"">
  <Actions>
    <Action Name=""dbo.InsertDummyUser"" Type=""InvokeStoredProc"" SourceID=""ebba47dc-e5d4-4303-a203-09e2e9761d16"" SourceName=""testingDBSrc"" SourceMethod=""dbo.InsertDummyUser"">
      <Inputs />
      <Outputs>
  ...
  <AuthorRoles></AuthorRoles>
            ...
            Assert.AreEqual(Expected, actual, "Blank outputs where not removed from db service xml");
        }
