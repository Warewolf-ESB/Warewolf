...
namespace Dev2.Integration.Tests.Services.Sql
{
    ...
    public class SqlServerTestUtils
    {
        ...
        public static void Verify_DataTable_CountriesPrefixIsA(DataTable countriesDataTable)
        {
        ...
        public static void Verify_FetchStoredProcedures_Pr_CitiesGetCountries(IDbCommand actualCommand, List<IDbDataParameter> actualParameters, string actualHelpText)
        {
...
";
        ...
        public static void Verify_FetchStoredProcedures_WarewolfRunForSql(List<IDbDataParameter> actualParameters, string actualHelpText)
        {
            Assert.IsNotNull(actualParameters);
            Assert.IsNotNull(actualHelpText);
        ...
        public static void Verify_FetchStoredProcedures_Fn_Greeting(IDbCommand actualCommand, List<IDbDataParameter> actualParameters, string actualHelpText)
        {
            Assert.IsNotNull(actualCommand);
            Assert.IsNotNull(actualParameters);
            Assert.IsNotNull(actualHelpText);
