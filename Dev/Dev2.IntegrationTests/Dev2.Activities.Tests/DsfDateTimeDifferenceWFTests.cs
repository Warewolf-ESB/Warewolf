...
namespace Dev2.Integration.Tests.Dev2.Activities.Tests
{
    ...
    public class DsfDateTimeDifferenceWFTests
    {
        ...
        {
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Acceptance Testing Resources/DateTimeDifference_Simple_Test");
        ...
        {
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Acceptance Testing Resources/DateTimeDifference_Complex_Test");
