...
namespace Dev2.Integration.Tests.Dev2.Activities.Tests
{
    ...
    public class DsfBaseConvertActivityWFTests
    {
        ...
        {
            string postData = String.Format("{0}{1}", ServerSettings.WebserverURI, "INTEGRATION TEST SERVICES/BaseConvertRecsetWithStar");
        ...
        {
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "INTEGRATION TEST SERVICES/BaseConvertRecsetWithIndex");
            string ResponseData = TestHelper.PostDataToWebserver(PostData);
        ...
        {
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "INTEGRATION TEST SERVICES/BaseConvertIntegrationTest");
        ...
        {
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "INTEGRATION TEST SERVICES/BaseConvertRecsetWithNoIndex");
            string ResponseData = TestHelper.PostDataToWebserver(PostData);
