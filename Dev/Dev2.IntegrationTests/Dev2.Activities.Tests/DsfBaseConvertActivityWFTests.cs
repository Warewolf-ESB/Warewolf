...
namespace Dev2.Integration.Tests.Dev2.Activities.Tests
{
    ...
    public class DsfBaseConvertActivityWFTests
    {
        ...
        {
            string postData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Integration Test Resources/BaseConvertRecsetWithStar");
        ...
        {
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Integration Test Resources/BaseConvertRecsetWithIndex");
            string ResponseData = TestHelper.PostDataToWebserver(PostData);
        ...
        {
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Integration Test Resources/BaseConvertIntegrationTest");
        ...
        {
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Integration Test Resources/BaseConvertRecsetWithNoIndex");
            string ResponseData = TestHelper.PostDataToWebserver(PostData);
