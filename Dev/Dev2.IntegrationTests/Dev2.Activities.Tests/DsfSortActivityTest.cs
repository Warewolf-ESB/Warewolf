...
namespace Dev2.Integration.Tests.Dev2.Activities.Tests
{
    ...
    public class DsfSortActivityTest
    {
        ...
        const string SortBackwardsWorkflow = "Acceptance Testing Resources/SortBackwardsTest";
        const string SortForwardsWorkflow = "Acceptance Testing Resources/SortForwardsTest";
        const string SortDateTimeWorkflow = "Acceptance Testing Resources/SortActivity_DateSort";
        /// <summary>
