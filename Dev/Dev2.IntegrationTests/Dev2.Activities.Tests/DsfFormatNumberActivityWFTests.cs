...
namespace Dev2.Integration.Tests.Dev2.Activities.Tests
{
    ...
    public class DsfFormatNumberActivityWFTests
    {
        ...
        {
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "INTEGRATION TEST SERVICES/FormatNumber_Rounding");
        ...
        {
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "INTEGRATION TEST SERVICES/FormatNumber_ShowDecimalPlaces");
