...
namespace Dev2.Integration.Tests.Dev2.Activities.Tests
{
    ...
    public class DsfReplaceActivityWFTests
    {
        ...
        {
            string PostData = String.Format("{0}{1}", WebserverURI, "INTEGRATION TEST SERVICES/ReplaceToolUsingRecordsetWithStar");
        ...
        {
            string PostData = String.Format("{0}{1}", WebserverURI, "INTEGRATION TEST SERVICES/ReplaceToolWithScalar");
