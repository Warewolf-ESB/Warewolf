...
namespace Dev2.Integration.Tests.Dev2.Activities.Tests
{
    ...
    public class DsfDateTimeActivityWFTest
    {
        ...
        {
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Integration Test Resources/DateAndTimeWithComplexLiteral");
        ...
        {
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Integration Test Resources/DateAndTimeWithNotOutputFormat");
        ...
        {
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Integration Test Resources/DefaultDateTimeInputFormatTest");
