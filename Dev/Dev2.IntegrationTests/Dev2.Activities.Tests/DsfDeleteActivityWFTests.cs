...
namespace Dev2.Integration.Tests.Dev2.Activities.Tests
{
    ...
    public class DsfDeleteActivityWFTests
    {
        ...
        {
            string PostData = String.Format("{0}{1}", WebserverURI, "Acceptance Testing Resources/DeleteRecordUsingRecordsetWithNumericIndex");
        ...
        {
            string PostData = String.Format("{0}{1}", WebserverURI, "Acceptance Testing Resources/DeleteRecordUsingRecsetWithBlankIndex");
        ...
        {
            string PostData = String.Format("{0}{1}", WebserverURI, "Acceptance Testing Resources/DeleteRecordUsingRecordsetWithStarIndex");
