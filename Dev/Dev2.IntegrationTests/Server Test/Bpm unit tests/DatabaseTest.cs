...
namespace Dev2.Integration.Tests.Server_Test.Bpm_unit_tests
{
    ...
    public class DatabaseTest
    {
        ...
        {
            //------------Setup for test--------------------------
            string postData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Acceptance Testing Resources/Bug_10247_Outter");
        ...
        {
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Acceptance Testing Resources/Bug9490");
            string ResponseData = TestHelper.PostDataToWebserver(PostData);
        ...
        {
            //------------Setup for test--------------------------
            string postData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Acceptance Testing Resources/ForEach DB Test");
        ...
        {
            //------------Setup for test--------------------------
            string postData = String.Format("{0}{1}?{2}", ServerSettings.WebserverURI, "Acceptance Testing Resources/Service Serialization Test", "");
        ...
        {
            string postData = String.Format("{0}{1}?{2}", ServerSettings.WebserverURI, "Acceptance Testing Resources/IntegrationTestDBEmptyToNull", "testType=insert");
            string result = TestHelper.PostDataToWebserver(postData);
        ...
        public void TestDBNullLogicNullValue_Expected_ZZZ_10Times()
        {
            ...
            for(int i = 0; i < 10; i++)
            {
                string postData = String.Format("{0}{1}?{2}", ServerSettings.WebserverURI, "Acceptance Testing Resources/IntegrationTestDBEmptyToNull", "testType=nullActive");
                string result = TestHelper.PostDataToWebserver(postData);
        ...
        {
            string postData = String.Format("{0}{1}?{2}", ServerSettings.WebserverURI, "Acceptance Testing Resources/IntegrationTestDBEmptyToNull", "testType=logic&nullLogicValue=dummy");
            string result = TestHelper.PostDataToWebserver(postData);
        ...
        {
            //------------Setup for test--------------------------
            string postData = String.Format("{0}{1}?{2}", ServerSettings.WebserverURI, "Acceptance Testing Resources/PBI9135DBServiceTest", "");
            //------------Execute Test---------------------------
            string result = TestHelper.PostDataToWebserver(postData);
            //------------Assert Results-------------------------
