...
namespace Dev2.Integration.Tests.Server_Test.Bpm_unit_tests
{
    ...
    public class WorkflowInvokeTest
    {
        ...
        {
            //------------Setup for test--------------------------
            string PostData = String.Format("{0}{1}", ServerSettings.WebserverURI, "INTERGRATION TEST SERVICES/ExecuteWithWorkspaceId.xml?<DataList><Cipher><char>a</char></Cipher><Cipher><char>b</char></Cipher><Cipher><char>c</char></Cipher></DataList>&wid=00000000-0000-0000-0000-000000000000");
