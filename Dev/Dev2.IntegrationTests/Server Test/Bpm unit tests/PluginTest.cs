...
namespace Dev2.Integration.Tests.Dev2.Application.Server.Tests.Bpm_unit_tests
{
    ...
    public class PluginTest
    {
        ...
        {
            //------------Setup for test--------------------------
            string postData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Acceptance Testing Resources/PrimitiveReturnTypeTest");
        ...
        {
            string postData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Acceptance Testing Resources/BUG_9966_RemotePlugins");
        ...
        {
            string postData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Acceptance Testing Resources/PluginsReturningXMLfromXML");
        ...
        {
            string postData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Acceptance Testing Resources/PluginsReturningXMLFromComplexType");
        ...
        {
            string postData = String.Format("{0}{1}", ServerSettings.WebserverURI, "Acceptance Testing Resources/PluginsReturningXMLFromJson");
