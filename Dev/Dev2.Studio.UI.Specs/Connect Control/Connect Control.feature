...
#	   And "Securitytab" with server permissions "Server Permission" is "visible"
...
#	   Then "Edit" is ""Enabled" in '<Servername>' connect control
...
#       Then I enter Address "http://RSAKLFREMOTE:3142/dsf" in “Edit” dialog
#       And I select "Authentication Type" "Windows" in “New Server” dialog
