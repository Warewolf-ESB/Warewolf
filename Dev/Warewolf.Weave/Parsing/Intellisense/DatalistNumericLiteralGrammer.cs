...
// Type: System.Parsing.Intellisense.DatalistNumericLiteralGrammer
...
namespace System.Parsing.Intellisense
{
  public class DatalistNumericLiteralGrammer : AbstractSyntaxTreeGrammer<Token, TokenKind, Node>
  {
    ...
    protected internal override void OnRegisterTriggers(ASTGrammerBehaviourRegistry triggerRegistry) => triggerRegistry.Register((TokenDefinition) TokenKind.IntegerNoSuffix);
    ...
    protected internal override void OnConfigureTokenizer(Tokenizer<Token, TokenKind> tokenizer)
    {
      ...
      tokenizer.Handlers.Add((TokenizationHandler<Token, TokenKind>) new DatalistNumericLiteralTokenizationHandler());
    }
  }
}
