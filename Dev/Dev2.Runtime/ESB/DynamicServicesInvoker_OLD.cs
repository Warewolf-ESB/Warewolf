...
//    /// </summary>
//    public class DynamicServicesInvoker_OLD : IDynamicServicesInvoker, IDisposable
//    {
//        #region Fields
...
//        private readonly IEsbChannel _dsfChannel;
...
//        public DynamicServicesInvoker_OLD()
//        {
//        }

//        public DynamicServicesInvoker_OLD(IEsbChannel dsfChannel,
//                                      IFrameworkDuplexDataChannel managementChannel = null,
...
//        /// <returns></returns>
//        public Guid Invoke(IDynamicServicesHost theHost, IDSFDataObject dataObject, out ErrorResultTO errors)
//        {
...
//                        DynamicService theService = sl.FindServiceByName(serviceName, theHost);

//                        if(theService.Actions.Count <= 1)
//                        {
//                            ServiceAction theStart = theService.Actions.FirstOrDefault();
//                            ErrorResultTO invokeErrors = new ErrorResultTO();
//                            // TODO : Invoke based upon type ;)
//                            EsbExecutionContainer container = GenerateInvokeContainer(theStart, dataObject, theHost);
//                            Guid executionResult = container.Execute(out invokeErrors);
//                            errors.MergeErrors(invokeErrors);

//                            // Ensure there are no errors so we can complete transaction
//                            if(!compiler.HasErrors(dataObject.DataListID) && executionResult != GlobalConstants.NullDataListID)
//                            {
...
//        private EsbExecutionContainer GenerateInvokeContainer(ServiceAction serviceAction, IDSFDataObject dataObj, IWorkspace theWorkspace)
//        {
...
//                    throw new Exception("Please just type to that of internal action!!!");
//                break;
...
//                    return new DatabaseServiceContainer(serviceAction, dataObj, theWorkspace);
//                break;
//                case enActionType.InvokeWebService:
//                    return new WebServiceContainer(serviceAction, dataObj, theWorkspace);
//                break;

//                case enActionType.Plugin:
//                    return new PluginServiceContainer(serviceAction, dataObj, theWorkspace);
//                break;

//                case enActionType.Workflow:
//                    return new WfExecutionContainer(serviceAction, dataObj, theWorkspace);
//                break;
//            }
//        }
...
//        //            if(result == GlobalConstants.NullDataListID)
//        //            {
//        //                errors.AddError("Failed to invoke service");
//        //            }
//        //            //xmlResponses.AddResponse();
//        //            //}
...
//        //                                                     Dev2.DataList.Contract.enActionType.System,
...
//        //    tmp = SvrCompiler.Evaluate(null, dataObj.DataListID, Dev2.DataList.Contract.enActionType.System,
...
//        /// <param name="xmlRequest">The data to pass to the service</param>
//        /// <returns>UnlimitedObject</returns>
...
//        /// <returns>Unlimited object</returns>
...
//        /// </summary>
//        /// <param name="plugin">The action of type Plugin</param>
//        /// <param name="xmlRequest">The request info</param>
...
//        //        DynamicService anonymousService;
...
//        //        anonymousService = new DynamicService();
...
//        private void LockReservedServices()
//        {
//        }

//        private void UnlockReservedServices()
//        {
//        }

//        private void LockSources()
//        {
//        }

//        private void UnlockSources()
//        {
//        }

//        private void LockActivities()
//        {
//        }

//        private void UnlockActivities()
//        {
//        }
...
//            try
//            {
//                dsfServices = Host.Services.Where(c => c.Actions.Where(d => d.SourceName == resourceName).Count() > 0);
//            }
//            finally
//            {
//                Host.UnlockServices();
...
//        private XmlElement GetData(string directoryName, XmlDocument document)
//        {
//            //create a new node for this directory
//            XmlElement element = document.CreateElement("Directory");
...
//                    //XmlElement ed = GetData(directoryName + "\\" + d.Name, document);
//                    XmlElement ed = document.CreateElement("Directory");
//                    ed.SetAttribute("Name", d.Name);
...
//                foreach(FileInfo f in directory.GetFiles())
//                {
//                    XmlElement ed = document.CreateElement("File");
//                    ed.SetAttribute("Name", f.Name);
//                    element.AppendChild(ed);
//                }
//            }
...
//                {
//                    (c as DynamicService).Actions.ForEach(action => Host.MapServiceActionDependencies(action));
//                }
