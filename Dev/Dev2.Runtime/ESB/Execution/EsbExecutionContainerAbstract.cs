...
namespace Dev2.Runtime.ESB.Execution
{
        ...
        where TService : Service
    {
        ...
        void MergeResultIntoDataList(object result, IOutputFormatter outputFormatter, IDataListCompiler compiler, out ErrorResultTO errors)
        {
            ...
            compiler.PopulateDataList(DataListFormat.CreateFormat(GlobalConstants._XML_Without_SystemTags), InstanceOutputDefinition, InstanceOutputDefinition, shapeDataListID, out invokeErrors);
            errors.MergeErrors(invokeErrors);
