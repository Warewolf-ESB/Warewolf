...
Scenario: TshepoCodedUISpecTestForMurali
	Given I click "RIBBONSETTINGS"
       ...
       And I click "SECURITYSAVE"
       Given I create a new remote connection "Server8" as
	| Address               | AuthType | UserName | Password |
	| http://localhost:3142 | Public   |          |          |
       Then I click "EXPLORER,UI_Server8 (http://localhost:3142/)_AutoID"   
       Given I click "EXPLORER,UI_Server8 (http://localhost:3142/)_AutoID,UI_BARNEY_AutoID,UI_Decision Testing_AutoID"
       Then "EXPLORER,UI_Server8 (http://localhost:3142/)_AutoID,UI_BARNEY_AutoID,UI_Decision Testing_AutoID,UI_CanEdit_AutoID" is visible
       Then "EXPLORER,UI_Server8 (http://localhost:3142/)_AutoID,UI_BARNEY_AutoID,UI_Decision Testing_AutoID,UI_CanExecute_AutoID" is visible
       When I double click "EXPLORER,UI_Server8 (http://localhost:3142/)_AutoID,UI_BARNEY_AutoID,UI_Decision Testing_AutoID"      
