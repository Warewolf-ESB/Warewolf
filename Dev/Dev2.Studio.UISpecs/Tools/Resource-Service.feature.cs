...
#line 20
 testRunner.And("\"RESOURCEPICKERFOLDERS,UI_DATABASE_AutoID,UI_bug9394DBServicesCall_AutoID\" is vis" +
                    "ible within \"2\" seconds", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line 21
 testRunner.And("I double click \"RESOURCEPICKERFOLDERS,UI_DATABASE_AutoID,UI_bug9394DBServicesCall" +
...
#line 23
 testRunner.And("\"WORKSURFACE,DATABASE\\bug9394DBServicesCall(ServiceDesigner)\" is visible within \"" +
