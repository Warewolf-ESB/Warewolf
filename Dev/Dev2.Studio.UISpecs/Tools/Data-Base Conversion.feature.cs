...
#line hidden
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("DragOnBaseCovert1")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "Data-Base Conversion")]
        public virtual void DragOnBaseCovert1()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("DragOnBaseCovert1", ((string[])(null)));
#line 6
...
#line 11
 testRunner.When("I drag \"TOOLBASECONVERT\" onto \"ACTIVETAB,UI_WorkflowDesigner_AutoID,UserControl_1" +
                    ",scrollViewer,ActivityTypeDesigner,WorkflowItemPresenter,StartSymbol\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 12
