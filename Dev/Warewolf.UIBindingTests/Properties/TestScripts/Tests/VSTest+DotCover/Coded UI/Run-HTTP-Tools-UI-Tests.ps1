...
$TestSettingsFile = "$PSScriptRoot\HTTPToolsUITesting.testsettings"
...
"@ + [guid]::NewGuid() + @"
`"
  name=`"HTTPToolsUITests`"
  enableDefaultDataCollectors=`"false`"
  xmlns=`"http://microsoft.com/schemas/VisualStudio/TeamTest/2010`">
  <Description>Run HTTP Tools UI Tests.</Description>
...
$FullArgsList = " `"" + $SolutionDir + "\Warewolf.UITests\bin\Debug\Warewolf.UITests.dll`" /logger:trx /Settings:`"" + $TestSettingsFile + "`"" + $TestList + " /TestCaseFilter:`"TestCategory=HTTP Tools`""
