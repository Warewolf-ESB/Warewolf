...
namespace Dev2.Core.Tests
{
    public static class Dev2MockFactory
    {
        ...
        static public Mock<IFilePersistenceProvider> SetupFilePersistenceProviderMock()
        {
            ...
            mockFilePersistenceProvider.Setup(filepro => filepro.Write(String.Format("{0}{1}", AppDomain.CurrentDomain.BaseDirectory, Warewolf.Studio.Resources.Languages.Core.DebugData_FilePath), "<xmlData/>")).Verifiable();
            mockFilePersistenceProvider.Setup(filepro => filepro.Read(String.Format("{0}{1}", AppDomain.CurrentDomain.BaseDirectory, Warewolf.Studio.Resources.Languages.Core.DebugData_FilePath))).Returns("<xmlData/>").Verifiable();
            mockFilePersistenceProvider.Setup(filepro => filepro.Delete(String.Format("{0}{1}", AppDomain.CurrentDomain.BaseDirectory, Warewolf.Studio.Resources.Languages.Core.DebugData_FilePath))).Verifiable();
