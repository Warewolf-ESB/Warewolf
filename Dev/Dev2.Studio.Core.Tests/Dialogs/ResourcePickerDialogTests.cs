...
//            //------------Execute Test---------------------------
//            var dialog = new TestResourcePickerDialog(ActivityType, envRepo, new Mock<IEventAggregator>().Object, new SynchronousAsyncWorker(), IsFromActivityDrop, repository)
//            {
...
//            var dialog = new TestResourcePickerDialog(ActivityType, envRepo, mockEventAggregator.Object, new SynchronousAsyncWorker(), IsFromActivityDrop, repository)
//            {
//                CreateDialogResult = dialogWindow.Object,
