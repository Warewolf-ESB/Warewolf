...
namespace Dev2.Core.Tests.Environments
{
    ...
    public class EnviromentRepositoryTest
    {
        ...
        public void EnvironmentRepositoryLookupEnvironmentsWithOneValidEnvironmentIDExpectedReturnsOneEnvironment()
        {
            ...
            {
                WorkflowXaml = new StringBuilder(@"<Source ID=""7e9eead4-d876-4bc1-a71d-66c76255795f"" Name=""bld"" Type=""Dev2Server"" ConnectionString=""AppServerUri=http://tst-ci-remote.premier.local:3142/dsf;WebServerPort=3142"" Version=""1.0"" ResourceType=""Server"" ServerID=""51a58300-7e9d-4927-a57b-e5d700b11b55"">
	...
	<DataList />
            ...
            Assert.AreEqual(1, result.Count);
            Assert.AreEqual("http://tst-ci-remote.premier.local:3142/", result[0].Connection.WebServerUri.AbsoluteUri);
        }
        ...
        public void EnvironmentRepositoryLookupEnvironmentsWithOneValidEnvironmentAuthenticationTypeExpectedReturnsOneEnvironment()
        {
            ...
            var rm = new ResourceModel(env.Object)
            {
                WorkflowXaml = new StringBuilder(@"<Source ID=""7e9eead4-d876-4bc1-a71d-66c76255795f"" Name=""bld"" Type=""Dev2Server"" ConnectionString=""AppServerUri=http://tst-ci-remote.premier.local:3142/dsf;WebServerPort=3142;AuthenticationType=User;UserName=dev2\hagashen.naidu;Password=hahaha"" Version=""1.0"" ResourceType=""Server"" ServerID=""51a58300-7e9d-4927-a57b-e5d700b11b55"">
	<TypeOf>Dev2Server</TypeOf>
	<DisplayName>bld</DisplayName>
	<Category/>
	<AuthorRoles />
