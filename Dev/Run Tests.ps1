...
$JobSpecs["Other Activities Specs"]		 		= "Dev2.Activities.Specs", "(TestCategory!=ExampleWorkflowExecution)&(TestCategory!=WorkflowExecution)&(TestCategory!=SubworkflowExecution)"
...
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.*.Specs,Warewolf.*.Specs", "(TestCategory=StudioTestFramework)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.*.Specs,Warewolf.*.Specs", "(TestCategory=StudioTestFrameworkWithUtilityTools)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.*.Specs,Warewolf.*.Specs", "(TestCategory=StudioTestFrameworkWithSubworkflow)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.*.Specs,Warewolf.*.Specs", "(TestCategory=StudioTestFrameworkWithScriptingTools)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.*.Specs,Warewolf.*.Specs", "(TestCategory=StudioTestFrameworkWithHTTPWebTools)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.*.Specs,Warewolf.*.Specs", "(TestCategory=StudioTestFrameworkWithHelloWorldWorkflow)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.*.Specs,Warewolf.*.Specs", "(TestCategory=TestFrameworkWithFileAndFolderTools)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.*.Specs,Warewolf.*.Specs", "(TestCategory=StudioTestFrameworkWithDropboxTools)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.*.Specs,Warewolf.*.Specs", "(TestCategory=StudioTestFrameworkWithDeletedResources)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.*.Specs,Warewolf.*.Specs", "(TestCategory=StudioTestFrameworkWithDataTools)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.*.Specs,Warewolf.*.Specs", "(TestCategory=StudioTestFrameworkWithDatabaseTools)"
$JobSpecs["Web Tests"]		 					= "Warewolf.Web.Tests", "(TestCategory=WorkflowExecution)"
#Coded UI
