...
$JobSpecs["File And Folder Copy Tools Specs"]	= "Warewolf.Tools.Specs", "(TestCategory=FileAndFolderCopy)"
$JobSpecs["File And FolderCreate Tools Specs"]	= "Warewolf.Tools.Specs", "(TestCategory=FileAndFolderCreate)"
$JobSpecs["File And Folder Delete Tools Specs"]	= "Warewolf.Tools.Specs", "(TestCategory=FileAndFolderDelete)"
$JobSpecs["File And Folder Move Tools Specs"]	= "Warewolf.Tools.Specs", "(TestCategory=FileAndFolderMove)"
$JobSpecs["Folder Read Tools Specs"]		 	= "Warewolf.Tools.Specs", "(TestCategory=ReadFolder)"
$JobSpecs["File Read Tools Specs"]		 		= "Warewolf.Tools.Specs", "(TestCategory=ReadFile)"
$JobSpecs["File And Folder Rename Tools Specs"]	= "Warewolf.Tools.Specs", "(TestCategory=FileAndFolderRename)"
$JobSpecs["Unzip Tools Specs"]		 			= "Warewolf.Tools.Specs", "(TestCategory=Unzip)"
$JobSpecs["WriteFile Tools Specs"]		 		= "Warewolf.Tools.Specs", "(TestCategory=WriteFile)"
$JobSpecs["Zip Tools Specs"]		 			= "Warewolf.Tools.Specs", "(TestCategory=Zip)"
...
$UnitTestJobNames = "Other Unit Tests,COMIPC Unit Tests,Studio View Models Unit Tests,Activity Designers Unit Tests,Activities Unit Tests,Scripting Tools Specs,Storage Tools Specs,Utility Tools Specs,ControlFlow Tools Specs,Data Tools Specs,Database Tools Specs,Email Tools Specs,FileAndFolder Tools Specs,LoopConstructs Tools Specs,Recordset Tools Specs,Resources Tools Specs,UI Binding Tests"
