...
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.Activities.Specs", "(TestCategory=WorkflowExecution)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.Activities.Specs", "(TestCategory=StudioTestFramework)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.Activities.Specs", "(TestCategory=StudioTestFrameworkWithUtilityTools)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.Activities.Specs", "(TestCategory=StudioTestFrameworkWithSubworkflow)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.Activities.Specs", "(TestCategory=StudioTestFrameworkWithScriptingTools)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.Activities.Specs", "(TestCategory=StudioTestFrameworkWithHTTPWebTools)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.Activities.Specs", "(TestCategory=StudioTestFrameworkWithHelloWorldWorkflow)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.Activities.Specs", "(TestCategory=TestFrameworkWithFileAndFolderTools)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.Activities.Specs", "(TestCategory=StudioTestFrameworkWithDropboxTools)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.Activities.Specs", "(TestCategory=StudioTestFrameworkWithDeletedResources)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.Activities.Specs", "(TestCategory=StudioTestFrameworkWithDataTools)"
$JobSpecs["Workflow Execution Specs"]		 	= "Dev2.Activities.Specs", "(TestCategory=StudioTestFrameworkWithDatabaseTools)"
