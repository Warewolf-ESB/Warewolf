...
{
    /// <summary>
    /// Interaction logic for ManageRedisSourceControl.xaml
    /// </summary>
    public partial class ManageRedisSourceControl : IView, ICheckControlEnabledView
    {
        public ManageRedisSourceControl()
        {
            InitializeComponent();
            ServerTextBox.Focus();
        }
