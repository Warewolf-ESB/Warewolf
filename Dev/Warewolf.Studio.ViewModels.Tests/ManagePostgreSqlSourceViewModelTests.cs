...
namespace Warewolf.Studio.ViewModels.Tests
{
    ...
    public partial class ManagePostgreSqlSourceViewModelTests
    {
        ...
        private ManagePostgreSqlSourceViewModel _targetAsyncWorker;
        private ManagePostgreSqlSourceViewModel _targetUpdateManagerAggregatorDbSource;
        private ManagePostgreSqlSourceViewModel _targetUpdateManagerRequestServiceName;
        ...
        public void TestInitialize()
        {
            ...
            _targetAsyncWorker = new ManagePostgreSqlSourceViewModel(_asyncWorkerMock.Object);
            ...
            _targetUpdateManagerAggregatorDbSource = new ManagePostgreSqlSourceViewModel(
        ...
        {
            new ManagePostgreSqlSourceViewModel(
                 null,
                 _requestServiceNameView,
                 _aggregatorMock.Object,
                 _asyncWorkerMock.Object);
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void TestManagePostgreSqlSourceViewModelAggregatorNull()
        {
            new ManagePostgreSqlSourceViewModel(
                 _updateManagerMock.Object,
                 _requestServiceNameView,
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void TestManagePostgreSqlSourceViewModelRequestServiceNameViewModelNull()
        {
            new ManagePostgreSqlSourceViewModel(
                 _updateManagerMock.Object,
                 null,
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void TestManagePostgreSqlSourceViewModelDbSourceNull()
        {
            new ManagePostgreSqlSourceViewModel(
                 _updateManagerMock.Object,
                 _aggregatorMock.Object,
        ...
        [TestMethod]
        public void TestPublicAuthenticationSelectedFalse()
        {
            //arrange
        ...
        public void TestOkCommandExecute_dbSourceNull()
        {
            ...
            var expectedType = enSourceType.PostgreSQL;
            ...
            //assert
            Assert.IsInstanceOfType(_targetUpdateManagerRequestServiceName.Item, typeof(PostgreSourceDefinition));
        ...
        public void TestOkCommandExecute_dbSourceNotNull()
        {
            ...
            //assert
            Assert.IsInstanceOfType(_targetUpdateManagerAggregatorDbSource.Item, typeof(PostgreSourceDefinition));
