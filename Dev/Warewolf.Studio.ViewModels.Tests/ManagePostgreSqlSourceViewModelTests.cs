...
namespace Warewolf.Studio.ViewModels.Tests
{
    ...
    public partial class ManagePostgreSqlSourceViewModelTests
    {
        ...
        ManagePostgreSqlSourceViewModel _targetAsyncWorker;
        ManagePostgreSqlSourceViewModel _targetUpdateManagerAggregatorDbSource;
        ManagePostgreSqlSourceViewModel _targetUpdateManagerRequestServiceName;
        ...
        [TestMethod]
        [Timeout(100)]
        public void TestPostgresSourceRequestServiceNameViewModel()
        {
        ...
        [TestMethod]
        [Timeout(500)]
        public void PostgresTestCommandExecuteAsyncWorkerSuccess()
        {
            //arrange
