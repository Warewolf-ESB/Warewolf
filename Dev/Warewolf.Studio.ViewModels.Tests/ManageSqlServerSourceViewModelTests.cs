...
namespace Warewolf.Studio.ViewModels.Tests
{
    ...
    public class ManageSqlServerSourceViewModelTests
    {
        ...
        [TestMethod]
        [Timeout(500)]
        public void SqlServerTestCommandExecuteAsyncWorkerSuccess()
        {
            //arrange
        ...
        [TestMethod]
        [Timeout(10000)]
        public void TestOkCommandCanExecute_OnSqlServerSourceViewModel()
        {
            //arrange
        ...
        [TestMethod]
        [Timeout(5000)]
        public void TestCancelSqlServerDBSourceTestCommandExecute()
        {
            //act
