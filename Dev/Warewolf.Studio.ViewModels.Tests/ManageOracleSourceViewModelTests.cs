...
namespace Warewolf.Studio.ViewModels.Tests
{
    ...
    public class ManageOracleSourceViewModelTests
    {
        ...
        [Timeout(100)]
        [ExpectedException(typeof(ArgumentNullException))]
        public void TestManageOracleDatabaseSourceViewModelRequestServiceNameViewModelNull()
        {
            new ManageOracleSourceViewModel(
                 _updateManagerMock.Object,
                 null,
        ...
        [Timeout(100)]
        [ExpectedException(typeof(ArgumentNullException))]
        public void TestManageOracleDatabaseSourceViewModelDbSourceNull()
        {
            new ManageOracleSourceViewModel(
                 _updateManagerMock.Object,
                 _aggregatorMock.Object,
        ...
        [TestMethod]
        [Timeout(250)]
        public void TestOracleSourceViewModelServerName()
        {
            //arrange
        ...
        [TestMethod]
        [Timeout(500)]
        public void OracleTestCommandExecuteAsyncWorkerSuccess()
        {
            //arrange
        ...
        [TestMethod]
        [Timeout(10000)]
        public void TestOkCommandCanExecute_OnOracleSourceViewModel()
        {
            //arrange
        ...
        [TestMethod]
        [Timeout(5000)]
        public void TestCancelOracleDBSourceTestCommandExecute()
        {
            //act
