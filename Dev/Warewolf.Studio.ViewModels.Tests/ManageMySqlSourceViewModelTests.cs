...
namespace Warewolf.Studio.ViewModels.Tests
{
    ...
    public class ManageMySqlSourceViewModelTests
    {
        ...
        private Mock<IMySqlSource> _dbSourceMock;
        ...
        private ManageMySqlSourceViewModel _targetAsyncWorker;
        private ManageMySqlSourceViewModel _targetUpdateManagerAggregatorDbSource;
        private ManageMySqlSourceViewModel _targetUpdateManagerRequestServiceName;
        ...
        public void TestInitialize()
        {
            ...
            _dbSourceMock = new Mock<IMySqlSource>();
        ...
        {
            //arrange
            var expectedValueMock = new Mock<IMySqlSource>();
        ...
        public void TestOkCommandExecute_dbSourceNull()
        {
            ...
            Assert.AreEqual(expectedPassword, ((IMySqlSource)_targetUpdateManagerRequestServiceName.Item).Password);
            Assert.AreEqual(expectedUsername, ((IMySqlSource)_targetUpdateManagerRequestServiceName.Item).UserName);
            ...
            Assert.AreEqual(expectedDbName, ((IMySqlSource)_targetUpdateManagerRequestServiceName.Item).DbName);
        ...
        public void TestOkCommandExecute_dbSourceNotNull()
        {
            ...
            Assert.AreEqual(expectedPassword, ((IMySqlSource)_targetUpdateManagerAggregatorDbSource.Item).Password);
            Assert.AreEqual(expectedUsername, ((IMySqlSource)_targetUpdateManagerAggregatorDbSource.Item).UserName);
            ...
            Assert.AreEqual(expectedDbName, ((IMySqlSource)_targetUpdateManagerAggregatorDbSource.Item).DbName);
        ...
        public void TestToModelItemNull()
        {
            ...
            //act
            var value = (IMySqlSource)_targetAsyncWorker.ToModel();
        ...
        {
            //arrange
            var dbSourceMock = new Mock<IMySqlSource>();
            var expectedId = Guid.NewGuid();
