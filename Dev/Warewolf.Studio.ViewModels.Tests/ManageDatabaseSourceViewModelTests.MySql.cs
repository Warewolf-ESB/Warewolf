...
namespace Warewolf.Studio.ViewModels.Tests
{
    ...
    public class ManageMySqlSourceViewModelTests
    {
        ...
        public void TestOkCommandExecute_dbSourceNull()
        {
            ...
            //assert
            Assert.IsInstanceOfType(_targetUpdateManagerRequestServiceName.Item, typeof(MySqlSourceDefination));
        ...
        public void TestOkCommandExecute_dbSourceNotNull()
        {
            ...
            //assert
            Assert.IsInstanceOfType(_targetUpdateManagerAggregatorDbSource.Item, typeof(MySqlSourceDefination));
