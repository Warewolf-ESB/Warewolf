...
namespace Warewolf.Studio.ViewModels.Tests
{
    ...
    public class DeployViewModelTests
    {
        ...
        public void DeployViewModel_Deploy_ASelectedItem_ConflictsNotHandles_ExpectCorrectCallsAreMade()
        {
            ...
            IList<IExplorerItemViewModel> items = new List<IExplorerItemViewModel>{new ExplorerItemViewModel(new Mock<IShellViewModel>().Object, new Mock<IServer>().Object,new Mock<IExplorerHelpDescriptorBuilder>().Object) {Checked = true,ResourceId = Guid.NewGuid()}};
            expSource.Setup(a => a.FindItems(It.IsAny<Func<IExplorerItemViewModel, bool>>())).Returns(items);
            var sourceModel = new Mock<IDeployModel>();
        ...
        public void DeployViewModel_Deploy_ASelectedItem_ConflictsHandled_CantDeploy_ExpectCorrectCallsAreMade()
        {
            ...
            IList<IExplorerItemViewModel> items = new List<IExplorerItemViewModel> { new ExplorerItemViewModel(new Mock<IShellViewModel>().Object, new Mock<IServer>().Object, new Mock<IExplorerHelpDescriptorBuilder>().Object) { Checked = true, ResourceId = id } };
            expSource.Setup(a => a.FindItems(It.IsAny<Func<IExplorerItemViewModel, bool>>())).Returns(items);
            var sourceModel = new Mock<IDeployModel>();
        ...
        public void DeployViewModel_SelectDependencies_ExpectStatsCalculatorCalled()
        {
            ...
            //------------Execute Test---------------------------
            var constructred = new DeployViewModel(expSource.Object, expDest.Object, prov.Object, new Collection<IDeployPredicate>(), conflictHandler.Object, deployFactory.Object);
            constructred.SelectDependencies(new ExplorerItemViewModel(new Mock<IShellViewModel>().Object, new Mock<IServer>().Object, new Mock<IExplorerHelpDescriptorBuilder>().Object) { Checked = true, ResourceId = id });
        }
