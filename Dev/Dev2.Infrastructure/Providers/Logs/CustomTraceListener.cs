...
namespace Dev2.Providers.Logs
{
    ...
    public class CustomTextWriter : TraceListener
    {
        ...
        {
            get { return Path.Combine(StudioLogPath, "Warewolf Studio.log"); }
        }
        ...
        public static string WarewolfAppPath
        {
            get
            {
                ...
                string warewolfAppPath = Path.Combine(appDataFolder, "Warewolf");
        ...
        public static string StudioLogPath
        {
            get
            {
                string studioLogPath = Path.Combine(WarewolfAppPath, "Studio Logs");
    ...
    public class Dev2LoggingTextWriter : TextWriter
    {
        ...
        ///     index of a format item is less than 0 (zero), or greater than or equal to the length of the <paramref name="arg" />
        ///     array.
        /// </exception>
