...
namespace Dev2.Services.Security
{
    public class WindowsGroupPermissionEqualityComparer : IEqualityComparer<WindowsGroupPermission>
    {
        ...
        public bool Equals(WindowsGroupPermission x, WindowsGroupPermission y) => x.Permissions.Equals(y.Permissions) && x.ResourceID.Equals(y.ResourceID) && x.WindowsGroup.Equals(y.WindowsGroup);
