...
namespace Dev2
{
    ...
    public static class VerifyArgument
    {
        ...
        [AssertionMethod]
        public static void IsNotNull([NotNull] string name,
        ...
        public static void AreNotNull(
            [AssertionCondition(AssertionConditionType.IS_NOT_NULL)] IDictionary<string, object> args)
        {
            if (args.Any(a => a.Value == null))
            {
                throw new ArgumentNullException("",
                    String.Format("The following arguments are not allowed to be null: {0}",
                        args.Where(a => a.Value == null)
                            .Aggregate("", (a, b) => string.Format("{0}{1}{2}", a, b.Key, Environment.NewLine))));
            }
        }
        ...
        public static void IsNotNullOrWhitespace([NotNull] string name, string value)
        {
            ...
            {
                throw new ArgumentNullException(name,
                    "The argument must not be null or empty and must contain non-whitespace characters must");
            }
        }
    }
