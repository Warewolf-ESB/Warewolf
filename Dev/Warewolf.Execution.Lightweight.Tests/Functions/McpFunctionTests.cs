...
namespace Warewolf.Execution.Lightweight.Tests.Functions
{
    ...
    public class McpFunctionTests
    {
        ...
        public async Task HandleMcp_ToolsList_ReturnsListWorkflowsTool_SchemaExcludesDiBoundParams()
        {
            ...
            // get_tool_schema, validate_workflow, create_workflow, edit_workflow, deploy_workflow,
            // add_step, add_source, edit_source, execute_workflow, and set_var are all registered.
            Assert.AreEqual(14, tools!.Count);
