...
#pragma warning restore S1541 // Methods and properties should not be too complex
        {
            ...
            {
                Dev2Logger.Error("Calculate Exception", ex, dataObject.ExecutionID?.ToString());
        ...
        public override void ToX6Json(Cell cell)
        {
            ...
            cell.shape = Constants.DSFCALCULATEACTIVITY;
            cell.data[Constants.TYPE] = Constants.DSFCALCULATEACTIVITY.ToLower();
            cell.data[Constants.DISPLAYNAME] = DisplayName ?? Constants.DISPLAYNAME_CALCULATE;
            cell.data[Constants.UNIQUEID] = UniqueID;

            cell.data[Constants.CALCULATE_EXPRESSION] = Expression ?? string.Empty;
            cell.data[Constants.CALCULATE_RESULT] = Result ?? string.Empty;
        }
