...
namespace Dev2.Activities.WF
{
    ...
    {
        public Cell CreateDateTimeDifferenceActivity(DsfDateTimeDifferenceActivity dateTimeDifferenceActivity, string nodeId)
        {
            var cell = new Cell
            {
                id = nodeId,
        ...
        public Cell CreateDotnetDateTimeDifferenceActivity(DsfDotNetDateTimeDifferenceActivity dateTimeDifferenceActivity, string nodeId)
        {
            var cell = new Cell
            {
                id = nodeId,
