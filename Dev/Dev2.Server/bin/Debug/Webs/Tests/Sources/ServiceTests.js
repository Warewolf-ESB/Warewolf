...
test("SerivceViewModel_With_InvalidResourcedID_Expected_TitleContainsNew", function () {

    var model = new SerivceViewModel("xxxx");
    ok(model.title().indexOf("New") != -1);
});

test("SerivceViewModel_With_ValidResourcedID_Expected_TitleContainsEdit", function () {

    var model = new SerivceViewModel("{97A9EFED-4127-4421-BCE8-1AC90CAFB7D4}");
    ok(model.title().indexOf("Edit") != -1);
});

test("SerivceViewModel_With_InvalidResourcedID_Expected_DataResourceIDIsEmptyGuid", function () {

    var model = new SerivceViewModel("xxxx");
    equal($.Guid.Empty(), model.data.resourceID());
});

test("SerivceViewModel_With_ValidResourcedID_Expected_DataResourceIDIsTheGivenResourceID", function () {
...
test("SerivceViewModel_With_ResourcedType_Expected_DataResourceTypeIsTheGivenResourceType", function () {
