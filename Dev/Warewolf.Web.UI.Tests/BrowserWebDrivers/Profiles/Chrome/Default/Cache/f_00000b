        ...
        t.Widget.prototype = {
            ...
            _createWidget: function (e, s) {
                s = t(s || this.defaultElement || this)[0],
                    ...
                    this.hoverable = t(),
                    this.focusable = t(),
                    s !== this && (t.data(s, this.widgetName, this), t.data(s, this.widgetFullName, this), this._on(!0, this.element, {
                        remove: function (t) {
        ...
        t.each({
            ...
            t.Widget.prototype["_" + e] = function (s, n, o) {
                ...
                n = n || {},
                    ...
                    a && t.effects && (t.effects.effect[r] || t.uiBackCompat !== !1 && t.effects[r]) ? s[e](n) : r !== e && s[r] ? s[r](n.duration, n.easing, o) : s.queue(function (i) {
                        t(this)[e](),
                            o && o.call(s[0]),
                            i()
                    })
            ...
            return 9 === y.nodeType ? (d = v.width(), f = v.height(), m = {
                ...
                t.each(["my", "at"], function () {
                    ...
                    1 === s.length && (s = l.test(s[0]) ? s.concat(["center"]) : h.test(s[0]) ? ["center"].concat(s) : ["center", "center"]),
                        ...
                        e[this] = [c.exec(s[0])[0], c.exec(s[1])[0]]
                }),
                1 === w.length && (w[1] = w[0]),
                "right" === e.at[0] ? g.left += d : "center" === e.at[0] && (g.left += d / 2),
                "bottom" === e.at[1] ? g.top += f : "center" === e.at[1] && (g.top += f / 2),
                n = i(x.at, d, f),
                g.left += n[0],
                g.top += n[1],
                this.each(function () {
                    ...
                    "right" === e.my[0] ? T.left -= c : "center" === e.my[0] && (T.left -= c / 2),
                        ...
                        e.using && (h = function (t) {
                            ...
                            c > d && d > a(i + s) && (l.horizontal = "center"),
                                p > f && f > a(n + r) && (l.vertical = "middle"),
                                l.important = o(a(i), a(s)) > o(a(n), a(r)) ? "horizontal" : "vertical",
                    ...
                    this.instance.positionAbs = s.positionAbs,
                        ...
                        this.instance._intersectsWith(this.instance.containerCache) && (o = !0, t.each(s.sortables, function () {
                            return this.instance.positionAbs = s.positionAbs,
                                this.instance.helperProportions = s.helperProportions,
                                this.instance.offset.click = s.offset.click,
                                this != a && this.instance._intersectsWith(this.instance.containerCache) && t.ui.contains(a.instance.element[0], this.instance.element[0]) && (o = !1),
                                o
                        })),
                    ...
                    if (a > c - o && d + o > a && h > p - o && f + o > h || a > c - o && d + o > a && l > p - o && f + o > l || r > c - o && d + o > r && h > p - o && f + o > h || r > c - o && d + o > r && l > p - o && f + o > l) {
                        if ("inner" != n.snapMode) {
                            ...
                            m && (i.position.top = s._convertPositionTo("relative", {
                                ...
                                _ && (i.position.left = s._convertPositionTo("relative", {
                                    top: 0,
                                    left: d
                                }).left - s.margins.left)
                        }
                        ...
                        s.snapElements[u].snapping && s.options.snap.release && s.options.snap.release.call(s.element, e, t.extend(s._uiHash(), {
                            snapItem: s.snapElements[u].item
                ...
                t: for (var a = 0; s.length > a; a++)
                    if (!(s[a].options.disabled || e && !s[a].accept.call(s[a].element[0], e.currentItem || e.element))) {
                        ...
                        s[a].visible = "none" != s[a].element.css("display"),
                            s[a].visible && ("mousedown" == n && s[a]._activate.call(s[a], i), s[a].offset = s[a].element.offset(), s[a].proportions = {
...
(function (t) {
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _mouseStart: function (i) {
            ...
            return t("body").css("cursor", "auto" == h ? this.axis + "-resize" : h),
        ...
        _respectSize: function (t, e) {
            ...
            r && (t.width = s.minWidth),
                h && (t.height = s.minHeight),
                o && (t.width = s.maxWidth),
                a && (t.height = s.maxHeight);
            var l = this.originalPosition.left + this.originalSize.width,
                u = this.position.top + this.size.height,
                c = /sw|nw|w/.test(n),
                d = /nw|ne|n/.test(n);
            r && c && (t.left = l - s.minWidth),
                o && c && (t.left = l - s.maxWidth),
                h && d && (t.top = u - s.minHeight),
                a && d && (t.top = u - s.maxHeight);
        ...
        t.ui.plugin.add("resizable", "containment", {
            start: function () {
                ...
                if (a)
                    if (i.containerElement = t(a), /document/.test(o) || o == document)
                        i.containerOffset = {
                            left: 0,
                            top: 0
                        },
            ...
            resize: function (e) {
                ...
                h[0] != document && /static/.test(h.css("position")) && (r = n),
                    o.left < (i._helper ? n.left : 0) && (i.size.width = i.size.width + (i._helper ? i.position.left - n.left : i.position.left - r.left), a && (i.size.height = i.size.width / i.aspectRatio), i.position.left = s.helper ? n.left : 0),
                    o.top < (i._helper ? n.top : 0) && (i.size.height = i.size.height + (i._helper ? i.position.top - n.top : i.position.top), a && (i.size.width = i.size.height * i.aspectRatio), i.position.top = i._helper ? n.top : 0),
                ...
                c && d && (l -= i.parentData.left),
                    l + i.size.width >= i.parentData.width && (i.size.width = i.parentData.width - l, a && (i.size.height = i.size.width / i.aspectRatio)),
                    u + i.size.height >= i.parentData.height && (i.size.height = i.parentData.height - u, a && (i.size.width = i.size.height * i.aspectRatio))
            },
            stop: function () {
                var e = t(this).data("resizable"),
                    i = e.options,
                ...
                return this.helper.css({
                    ...
                    this.selectees.each(function () {
                        ...
                        if (h && h.element != i.element[0]) {
                            var l = !1;
                            "touch" == s.tolerance ? l = !(h.left > a || n > h.right || h.top > r || o > h.bottom) : "fit" == s.tolerance && (l = h.left > n && a > h.right && h.top > o && r > h.bottom),
                                l ? (h.selected && (h.$element.removeClass("ui-selected"), h.selected = !1), h.unselecting && (h.$element.removeClass("ui-unselecting"), h.unselecting = !1), h.selecting || (h.$element.addClass("ui-selecting"), h.selecting = !0, i._trigger("selecting", e, {
                                    selecting: h.element
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _mouseDrag: function (e) {
            if (this.position = this._generatePosition(e), this.positionAbs = this._convertPositionTo("absolute"), this.lastPositionAbs || (this.lastPositionAbs = this.positionAbs), this.options.scroll) {
                var i = this.options,
                    s = !1;
                this.scrollParent[0] != document && "HTML" != this.scrollParent[0].tagName ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight - e.pageY < i.scrollSensitivity ? this.scrollParent[0].scrollTop = s = this.scrollParent[0].scrollTop + i.scrollSpeed : e.pageY - this.overflowOffset.top < i.scrollSensitivity && (this.scrollParent[0].scrollTop = s = this.scrollParent[0].scrollTop - i.scrollSpeed), this.overflowOffset.left + this.scrollParent[0].offsetWidth - e.pageX < i.scrollSensitivity ? this.scrollParent[0].scrollLeft = s = this.scrollParent[0].scrollLeft + i.scrollSpeed : e.pageX - this.overflowOffset.left < i.scrollSensitivity && (this.scrollParent[0].scrollLeft = s = this.scrollParent[0].scrollLeft - i.scrollSpeed)) : (e.pageY - t(document).scrollTop() < i.scrollSensitivity ? s = t(document).scrollTop(t(document).scrollTop() - i.scrollSpeed) : t(window).height() - (e.pageY - t(document).scrollTop()) < i.scrollSensitivity && (s = t(document).scrollTop(t(document).scrollTop() + i.scrollSpeed)), e.pageX - t(document).scrollLeft() < i.scrollSensitivity ? s = t(document).scrollLeft(t(document).scrollLeft() - i.scrollSpeed) : t(window).width() - (e.pageX - t(document).scrollLeft()) < i.scrollSensitivity && (s = t(document).scrollLeft(t(document).scrollLeft() + i.scrollSpeed))),
                    s !== !1 && t.ui.ddmanager && !i.dropBehaviour && t.ui.ddmanager.prepareOffsets(this, e)
            }
            ...
            for (var n = this.items.length - 1; n >= 0; n--) {
                ...
                if (r && o.instance === this.currentContainer && a != this.currentItem[0] && this.placeholder[1 == r ? "next" : "prev"]()[0] != a && !t.contains(this.placeholder[0], a) && ("semi-dynamic" == this.options.type ? !t.contains(this.element[0], a) : !0)) {
                    if (this.direction = 1 == r ? "down" : "up", "pointer" != this.options.tolerance && !this._intersectsWithSides(o))
                        break;
                    this._rearrange(e, o),
                    ...
                    for (var o = 1e4, a = null, r = this.containers[s].floating ? "left" : "top", h = this.containers[s].floating ? "width" : "height", l = this.positionAbs[r] + this.offset.click[r], u = this.items.length - 1; u >= 0; u--)
                        if (t.contains(this.containers[s].element[0], this.items[u].item[0]) && this.items[u].item[0] != this.currentItem[0]) {
                            ...
                            Math.abs(c - l) > Math.abs(c + this.items[u][h] - l) && (d = !0, c += this.items[u][h]),
                                o > Math.abs(c - l) && (o = Math.abs(c - l), a = this.items[u], this.direction = d ? "up" : "down")
                        }
...
(function ($, undefined) {
    ...
    $.extend(Datepicker.prototype, {
        ...
        _connectDatepicker: function (t, e) {
            ...
            e.append = $([]),
                e.trigger = $([]),
                i.hasClass(this.markerClassName) || (this._attachments(i, e), i.addClass(this.markerClassName).keydown(this._doKeyDown).keypress(this._doKeyPress).keyup(this._doKeyUp).bind("setData.datepicker", function (t, i, s) {
                    e.settings[i] = s
        ...
        _attachments: function (t, e) {
            ...
            e.append && e.append.remove(),
                i && (e.append = $('<span class="' + this._appendClass + '">' + i + "</span>"), t[s ? "before" : "after"](e.append)),
        ...
        _destroyDatepicker: function (t) {
            ...
            if (e.hasClass(this.markerClassName)) {
                ...
                $.removeData(t, PROP_NAME),
                    "input" == s ? (i.append.remove(), i.trigger.remove(), e.removeClass(this.markerClassName).unbind("focus", this._showDatepicker).unbind("keydown", this._doKeyDown).unbind("keypress", this._doKeyPress).unbind("keyup", this._doKeyUp)) : ("div" == s || "span" == s) && e.removeClass(this.markerClassName).empty()
            }
        },
        _enableDatepicker: function (t) {
            ...
            if (e.hasClass(this.markerClassName)) {
                var s = t.nodeName.toLowerCase();
                if ("input" == s)
                    t.disabled = !1, i.trigger.filter("button").each(function () {
                        this.disabled = !1
                    }).end().filter("img").css({
                        opacity: "1.0",
                        cursor: ""
        ...
        _disableDatepicker: function (t) {
            ...
            if (e.hasClass(this.markerClassName)) {
                var s = t.nodeName.toLowerCase();
                if ("input" == s)
                    t.disabled = !0, i.trigger.filter("button").each(function () {
                        this.disabled = !0
                    }).end().filter("img").css({
                        opacity: "0.5",
                        cursor: "default"
                ...
                if (s !== !1) {
                    ...
                    if ($.datepicker._pos = null, e.dpDiv.empty(), e.dpDiv.css({
                        ...
                        e.dpDiv.zIndex($(t).zIndex() + 1),
                            ...
                            $.effects && ($.effects.effect[a] || $.effects[a]) ? e.dpDiv.show(a, $.datepicker._get(e, "showOptions"), r, h) : e.dpDiv[a || "show"](a ? r : null, h),
                            a && r || h(),
        ...
        _checkOffset: function (t, e, i) {
            ...
            return e.left -= this._get(t, "isRTL") ? s - o : 0,
                ...
                e.top -= Math.min(e.top, e.top + n > h && h > n ? Math.abs(n + a) : 0),
                e
        },
        _findPos: function (t) {
                ...
                n = function (e) {
                    ...
                    for (var s = (e.toLowerCase().match(/^c/) ? $.datepicker._getDate(t) : null) || new Date, n = s.getFullYear(), o = s.getMonth(), a = s.getDate(), r = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, h = r.exec(e); h;) {
                        switch (h[2] || "d") {
                            ...
                            case "M":
                                o += parseInt(h[1], 10),
                                    a = Math.min(a, $.datepicker._getDaysInMonth(n, o));
                                break;
                            case "y":
                            case "Y":
                                n += parseInt(h[1], 10),
        ...
        _generateHTML: function (t) {
            ...
            if (0 > p && (p += 12, f--), d) {
                ...
                for (m = c && c > m ? c : m; this._daylightSavingAdjust(new Date(f, p, 1)) > m;)
                    p-- , 0 > p && (p = 11, f--)
            }
            t.drawMonth = p,
                t.drawYear = f;
            ...
            var M = this._get(t, "dayNamesMin"),
                ...
                z = this._get(t, "selectOtherMonths");
            this._get(t, "calculateWeek") || this.iso8601Week;
            for (var H = this._getDefaultDate(t), A = "", O = 0; a[0] > O; O++) {
                var E = "";
                this.maxRows = 4;
                for (var W = 0; a[1] > W; W++) {
                    var F = this._daylightSavingAdjust(new Date(f, p, t.selectedDay)),
                        ...
                        L = "";
                    if (l) {
                        if (L += '<div class="ui-datepicker-group', a[1] > 1)
                            switch (W) {
                                case 0:
                    ...
                    L += '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix' + R + '">' + (/all|left/.test(R) && 0 == O ? i ? b : v : "") + (/all|right/.test(R) && 0 == O ? i ? v : b : "") + this._generateMonthYearHeader(t, p, f, c, d, O > 0 || W > 0, I, S) + '</div><table class="ui-datepicker-calendar"><thead>' + "<tr>";
                    ...
                    for (var X = this._daylightSavingAdjust(new Date(f, p, 1 - K)), G = 0; V > G; G++) {
                        L += "<tr>";
                        for (var J = D ? '<td class="ui-datepicker-week-col">' + this._get(t, "calculateWeek")(X) + "</td>" : "", Y = 0; 7 > Y; Y++) {
                            var Q = P ? P.apply(t.input ? t.input[0] : null, [X]) : [!0, ""],
                                Z = X.getMonth() != p,
                                te = Z && !z || !Q[0] || c && c > X || d && X > d;
                            J += '<td class="' + ((Y + C + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + (Z ? " ui-datepicker-other-month" : "") + (X.getTime() == F.getTime() && p == t.selectedMonth && t._keyEvent || H.getTime() == X.getTime() && H.getTime() == F.getTime() ? " " + this._dayOverClass : "") + (te ? " " + this._unselectableClass + " ui-state-disabled" : "") + (Z && !N ? "" : " " + Q[1] + (X.getTime() == u.getTime() ? " " + this._currentClass : "") + (X.getTime() == e.getTime() ? " ui-datepicker-today" : "")) + '"' + (Z && !N || !Q[2] ? "" : ' title="' + Q[2] + '"') + (te ? "" : ' data-handler="selectDay" data-event="click" data-month="' + X.getMonth() + '" data-year="' + X.getFullYear() + '"') + ">" + (Z && !N ? "&#xa0;" : te ? '<span class="ui-state-default">' + X.getDate() + "</span>" : '<a class="ui-state-default' + (X.getTime() == e.getTime() ? " ui-state-highlight" : "") + (X.getTime() == u.getTime() ? " ui-state-active" : "") + (Z ? " ui-priority-secondary" : "") + '" href="#">' + X.getDate() + "</a>") + "</td>",
                    ...
                    p++ ,
                        p > 11 && (p = 0, f++),
                        L += "</tbody></table>" + (l ? "</div>" + (a[0] > 0 && W == a[1] - 1 ? '<div class="ui-datepicker-row-break"></div>' : "") : ""),
                        E += L
                }
                A += E
            }
            return A += k + ($.ui.ie6 && !t.inline ? '<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>' : ""),
                t._keyEvent = !1,
                A
        },
        _generateMonthYearHeader: function (t, e, i, s, n, o, a, r) {
            var h = this._get(t, "changeMonth"),
                ...
                d = "";
            if (o || !h)
                d += '<span class="ui-datepicker-month">' + a[e] + "</span>";
            else {
                var p = s && s.getFullYear() == i,
                    f = n && n.getFullYear() == i;
                d += '<select class="ui-datepicker-month" data-handler="selectMonth" data-event="change">';
                for (var m = 0; 12 > m; m++)
                    (!p || m >= s.getMonth()) && (!f || n.getMonth() >= m) && (d += '<option value="' + m + '"' + (m == e ? ' selected="selected"' : "") + ">" + r[m] + "</option>");
                d += "</select>"
            }
            if (u || (c += d + (!o && h && l ? "" : "&#xa0;")), !t.yearshtml)
                if (t.yearshtml = "", o || !l)
                    ...
                    var g = this._get(t, "yearRange").split(":"),
                        ...
                        b = _(g[0]),
                        y = Math.max(b, _(g[1] || ""));
                    for (b = s ? Math.max(b, s.getFullYear()) : b, y = n ? Math.min(y, n.getFullYear()) : y, t.yearshtml += '<select class="ui-datepicker-year" data-handler="selectYear" data-event="change">'; y >= b; b++)
    ...
    t.widget("ui.dialog", {
        ...
        _create: function () {
            ...
            s = (this.uiDialog = t("<div>")).addClass(i + l.dialogClass).css({
                ...
                o = t("<a href='#'></a>").addClass("ui-dialog-titlebar-close  ui-corner-all").attr("role", "button").click(function (t) {
                    t.preventDefault(),
                        h.close(t)
                }).appendTo(n),
                (this.uiDialogTitlebarCloseText = t("<span>")).addClass("ui-icon ui-icon-closethick").text(l.closeText).appendTo(o),
                a = t("<span>").uniqueId().addClass("ui-dialog-title").html(u).prependTo(n),
                r = (this.uiDialogButtonPane = t("<div>")).addClass("ui-dialog-buttonpane ui-widget-content ui-helper-clearfix"),
                (this.uiButtonSet = t("<div>")).addClass("ui-dialog-buttonset").appendTo(r),
                s.attr({
                    role: "dialog",
        ...
        open: function () {
            if (!this._isOpen) {
                ...
                return this._size(),
                    ...
                    e.length || (e = this.uiDialogButtonPane.find(":tabbable"), e.length || (e = s)),
                    e.eq(0).focus(),
                    this._isOpen = !0,
                    this._trigger("open"),
                    this
        ...
        _size: function () {
            ...
            this.element.show().css({
                ...
                "auto" === n.height ? t.support.minHeight ? this.element.css({
                    minHeight: i,
                    height: "auto"
                }) : (this.uiDialog.show(), s = this.element.css("height", "auto").height(), o || this.uiDialog.hide(), this.element.height(Math.max(s, i))) : this.element.height(Math.max(n.height - e, 0)),
    ...
    t.widget("ui.slider", t.ui.mouse, {
        ...
        _create: function () {
            ...
            for (this._keySliding = !1, this._mouseSliding = !1, this._animateOff = !0, this._handleIndex = null, this._detectOrientation(), this._mouseInit(), this.element.addClass("ui-slider ui-slider-" + this.orientation + " ui-widget" + " ui-widget-content" + " ui-corner-all" + (n.disabled ? " ui-slider-disabled ui-disabled" : "")), this.range = t([]), n.range && (n.range === !0 && (n.values || (n.values = [this._valueMin(), this._valueMin()]), n.values.length && 2 !== n.values.length && (n.values = [n.values[0], n.values[0]])), this.range = t("<div></div>").appendTo(this.element).addClass("ui-slider-range ui-widget-header" + ("min" === n.range || "max" === n.range ? " ui-slider-range-" + n.range : ""))), s = n.values && n.values.length || 1, i = o.length; s > i; i++)
                r.push(a);
            this.handles = o.add(t(r.join("")).appendTo(this.element)),
...
(function (t, e) {
    ...
    t.widget("ui.tabs", {
        ...
        _create: function () {
            ...
            this.running = !1,
                this.element.addClass("ui-tabs ui-widget ui-widget-content ui-corner-all").toggleClass("ui-tabs-collapsible", s.collapsible).delegate(".ui-tabs-nav > li", "mousedown" + this.eventNamespace, function (e) {
                    t(this).is(".ui-state-disabled") && e.preventDefault()
                }).delegate(".ui-tabs-anchor", "focus" + this.eventNamespace, function () {
                    t(this).closest("li").is(".ui-state-disabled") && this.blur()
                }),
                this._processTabs(),
                null === n && (o && this.tabs.each(function (i, s) {
                ...
                t.isArray(s.disabled) && (s.disabled = t.unique(s.disabled.concat(t.map(this.tabs.filter(".ui-state-disabled"), function (t) {
        ...
        t.uiBackCompat !== !1 && (t.ui.tabs.prototype._ui = function (t, e) {
            ...
            enable: function (e) {
                var i,
                    s = this.options;
                (e && s.disabled === !0 || t.isArray(s.disabled) && -1 !== t.inArray(e, s.disabled)) && (i = !0),
                    this._superApply(arguments),
            ...
            disable: function (e) {
                var i,
                    s = this.options;
                (e && s.disabled === !1 || t.isArray(s.disabled) && -1 === t.inArray(e, s.disabled)) && (i = !0),
                    this._superApply(arguments),
            ...
            add: function (i, s, n) {
                ...
                return h.addClass("ui-state-default ui-corner-top").data("ui-tabs-destroy", !0),
                    ...
                    o = n >= this.tabs.length,
                    a = this.element.find("#" + l),
                    a.length || (a = this._createPanel(l), o ? n > 0 ? a.insertAfter(this.panels.eq(-1)) : a.appendTo(this.element) : a.insertBefore(this.panels[n])),
                    a.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").hide(),
                    o ? h.appendTo(this.tablist) : h.insertBefore(this.tabs[n]),
            ...
            remove: function (e) {
                ...
                return s.hasClass("ui-tabs-active") && this.anchors.length > 2 && this._activate(e + (this.anchors.length > e + 1 ? 1 : -1)),
            ...
            _tabId: function (e) {
                ...
                return s = s[0],
                    t(s).closest("li").attr("aria-controls") || s.title && s.title.replace(/\s/g, "_").replace(/[^\w\u00c0-\uFFFF\-]/g, "") || this.options.idPrefix + i()
            }
        }), t.widget("ui.tabs", t.ui.tabs, {
            options: {
            ...
            t.widget("ui.tabs", t.ui.tabs, {
                ...
                (), t.widget("ui.tabs", t.ui.tabs, {
                    _trigger: function (e, i, s) {
                        var n = t.extend({}, s);
                        return "load" === e && (n.panel = n.panel[0], n.tab = n.tab.find(".ui-tabs-anchor")[0]),
                            this._super(e, i, n)
                    }
                }), t.widget("ui.tabs", t.ui.tabs, {
                    options: {
                    ...
                    _getFx: function () {
                        var e,
                            i,
                            s = this.options.fx;
                        return s && (t.isArray(s) ? (e = s[0], i = s[1]) : e = i = s),
                            s ? {
                                show: i,
                                hide: e
                            }
                    ...
                    _toggle: function (t, i) {
                        ...
                        function n() {
                            i.newTab.closest("li").addClass("ui-tabs-active ui-state-active"),
                                a.length && h.show ? a.animate(h.show, h.show.duration, function () {
                                    s()
                                }) : (a.show(), s())
                        }
                        var o = this,
            ...
            f.style.cssText = "background-color:rgba(1,1,1,.5)",
                ...
                u.fn = e.extend(u.prototype, {
                    parse: function (o, r, h, l) {
                        ...
                        var d = this,
                            p = e.type(o),
                            f = this._rgba = [];
                        return r !== i && (o = [o, r, h, l], p = "array"),
                            "string" === p ? this.parse(n(o) || a._default) : "array" === p ? (m(c.rgba.props, function (t, e) {
                                f[e.idx] = s(o[e.idx], e)
                ...
                m(c, function (t, n) {
                    var o = n.props,
                        ...
                        l = n.from;
                    u.fn[t] = function (t) {
                        if (r && !this[a] && (this[a] = r(this._rgba)), t === i)
                            return this[a].slice();
                        var n,
                            h = e.type(t),
            ...
            t.extend(t.effects, {
                ...
                restore: function (t, i) {
                    ...
                    for (o = 0; i.length > o; o++)
                        null !== i[o] && (n = t.data(s + i[o]), n === e && (n = ""), t.css(i[o], n))
                },
                ...
                t.fn.extend({
                    ...
                    toggle: function (e) {
                        if (o(e) || "boolean" == typeof e || t.isFunction(e))
...
(function (t) {
    t.effects.effect.bounce = function (e, i) {
        ...
        for ((u || l) && r.push("opacity"), t.effects.save(a, r), a.show(), t.effects.createWrapper(a), d || (d = a["top" === v ? "outerHeight" : "outerWidth"]() / 3), u && (o = {
            opacity: 1
        }, o[v] = 0, a.css("opacity", 0).css(v, _ ? 2 * -d : 2 * d).animate(o, m, g)), l && (d /= Math.pow(2, p - 1)), o = {}, o[v] = 0, s = 0; p > s; s++)
            n = {},
                n[v] = (_ ? "-=" : "+=") + d,
...
(function (t) {
    t.effects.effect.pulsate = function (e, i) {
        var s,
            ...
            d = n.queue(),
            p = d.length;
        for ((a || !n.is(":visible")) && (n.css("opacity", 0).show(), c = 1), s = 1; l > s; s++)
            n.animate({
                opacity: c
            }, u, e.easing), c = 1 - c;
        n.animate({
    ...
    t.effects.effect.puff = function (e, i) {
        ...
        t.effects.effect.size = function (e, i) {
            ...
            "show" === p && a.show(),
                ...
                ("box" === m || "both" === m) && (o.from.y !== o.to.y && (_ = _.concat(c), a.from = t.effects.setTransition(a, c, o.from.y, a.from), a.to = t.effects.setTransition(a, c, o.to.y, a.to)), o.from.x !== o.to.x && (_ = _.concat(d), a.from = t.effects.setTransition(a, d, o.from.x, a.from), a.to = t.effects.setTransition(a, d, o.to.x, a.to))),
                ("content" === m || "both" === m) && o.from.y !== o.to.y && (_ = _.concat(u).concat(l), a.from = t.effects.setTransition(a, u, o.from.y, a.from), a.to = t.effects.setTransition(a, u, o.to.y, a.to)),
                t.effects.save(a, _),
                a.show(),
                t.effects.createWrapper(a),
                a.css("overflow", "hidden").css(a.from),
                g && (n = t.effects.getBaseline(g, s), a.from.top = (s.outerHeight - a.outerHeight()) * n.y, a.from.left = (s.outerWidth - a.outerWidth()) * n.x, a.to.top = (s.outerHeight - a.to.outerHeight) * n.y, a.to.left = (s.outerWidth - a.to.outerWidth) * n.x),
                a.css(a.from),
                ("content" === m || "both" === m) && (c = c.concat(["marginTop", "marginBottom"]).concat(u), d = d.concat(["marginLeft", "marginRight"]), l = r.concat(c).concat(d), a.find("*[width]").each(function () {
                    var i = t(this),
                        s = {
                            height: i.height(),
                            width: i.width(),
...
(function (t) {
    t.effects.effect.shake = function (e, i) {
        var s,
            ...
            v = n.queue(),
            _ = v.length;
        for (t.effects.save(n, o), n.show(), t.effects.createWrapper(n), f[d] = (p ? "-=" : "+=") + h, m[d] = (p ? "+=" : "-=") + 2 * h, g[d] = (p ? "-=" : "+=") + 2 * h, n.animate(f, c, e.easing), s = 1; l > s; s++)
