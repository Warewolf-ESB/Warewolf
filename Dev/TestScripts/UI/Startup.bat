...
IF EXIST "Out\StudiobinDebug" GOTO RunDeployed
...
START "Out\ServerbinDebug\Warewolf Server.exe" /D "Out\ServerbinDebug" "Warewolf Server.exe"

REM  Wait 10 seconds ;)
ping -n 10 127.0.0.1 > nul

REM ** Start Warewolf studio from deployed binaries built in debug config**
START "Out\StudiobinDebug\Warewolf Studio.exe" /D "Out\StudiobinDebug" "Warewolf Studio.exe"
:exit
