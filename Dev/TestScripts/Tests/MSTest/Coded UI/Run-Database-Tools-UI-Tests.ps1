...
$TestSettingsFile = "$PSScriptRoot\DatabaseToolsUItests.testsettings"
...
if ($TestList -eq "") {
	...
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\DatabaseToolsUItestsResults.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + " /category:`"Database Tools`""
} else {
	# Create full MSTest argument string.
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\DatabaseToolsUItestsResults.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + $TestList
}
