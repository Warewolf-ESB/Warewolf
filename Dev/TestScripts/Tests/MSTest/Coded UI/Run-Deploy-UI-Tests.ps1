...
$TestSettingsFile = "$PSScriptRoot\DeployUITests.testsettings"
...
if ($TestList -eq "") {
	...
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\DeployUITestsResults.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + " /category:`"Deploy`""
} else {
	# Create full MSTest argument string.
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\DeployUITestsResults.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + $TestList
}
