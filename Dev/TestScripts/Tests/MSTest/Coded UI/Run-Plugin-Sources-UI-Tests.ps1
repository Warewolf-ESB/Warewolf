...
if ($TestList -eq "") {
	...
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\PluginSourcesUITests.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + " /category:`"Plugin Sources`""
} else {
	# Create full MSTest argument string.
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\PluginSourcesUITests.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + $TestList
}
