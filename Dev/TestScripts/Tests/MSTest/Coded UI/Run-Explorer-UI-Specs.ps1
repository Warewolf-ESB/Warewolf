...
if ($TestList -eq "") {
	...
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\ExplorerUISpecsResults.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + " /category:`"Explorer`""
} else {
	# Create full MSTest argument string.
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\ExplorerUISpecsResults.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + $TestList
}
