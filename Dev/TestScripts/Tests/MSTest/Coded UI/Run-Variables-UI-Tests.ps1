...
$TestSettingsFile = "$PSScriptRoot\VariablesUITests.testsettings"
...
if ($TestList -eq "") {
	...
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\VariablesUITestsResults.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + " /category:`"Variables`""
} else {
	# Create full MSTest argument string.
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\VariablesUITestsResults.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + $TestList
}
