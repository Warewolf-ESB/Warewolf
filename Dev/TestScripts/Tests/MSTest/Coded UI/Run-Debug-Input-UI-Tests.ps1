...
$FullArgsList = "/testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\DebugInputUITestingResults.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + $TestList + " /category:`"Debug Input`""
