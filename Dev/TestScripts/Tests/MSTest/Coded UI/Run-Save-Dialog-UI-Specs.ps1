...
$FullArgsList = "/testcontainer:`"" + $SolutionDir + "\Warewolf.UISpecs\bin\Debug\Warewolf.UISpecs.dll`" /resultsfile:TestResults\SaveDialogUISpecsResults.trx /testsettings:`"" + $TestSettingsFile + "`"" + $TestList + " /category:`"Save Dialog`""
