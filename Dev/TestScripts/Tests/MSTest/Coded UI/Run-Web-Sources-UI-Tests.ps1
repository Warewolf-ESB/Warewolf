...
if ($TestList -eq "") {
	...
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\WebSourcesUITests.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + " /category:`"Web Sources`""
} else {
	# Create full MSTest argument string.
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\WebSourcesUITests.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + $TestList
}
