...
$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\HTTPToolsUITestingResults.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + $TestList + " /category:`"HTTP Tools`""
