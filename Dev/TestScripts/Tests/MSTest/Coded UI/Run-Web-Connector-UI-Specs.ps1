...
$TestSettingsFile = "$PSScriptRoot\WebConnectorUISpecs.testsettings"
...
`"
  ...
  <Description>Run Web Connector UI Specs.</Description>
...
if ($TestList -eq "") {
	...
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\WebConnectorUISpecsResults.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + " /category:`"WebConnector`""
} else {
	# Create full MSTest argument string.
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\WebConnectorUISpecsResults.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + $TestList
}
