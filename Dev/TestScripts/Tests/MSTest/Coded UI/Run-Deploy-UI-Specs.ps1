...
$FullArgsList = "/testcontainer:`"" + $SolutionDir + "\Warewolf.UISpecs\bin\Debug\Warewolf.UISpecs.dll`" /resultsfile:TestResults\DeployUISpecsResults.trx /testsettings:`"" + $TestSettingsFile + "`"" + $TestList + " /category:`"Deploy`""
