...
if ($TestList -eq "") {
	...
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\DataToolsUITestingResults.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + " /category:`"Data Tools`""
} else {
	# Create full MSTest argument string.
	$FullArgsList = " /testcontainer:`"" + $TestAssemblyPath + "`" /resultsfile:`"" + $PSScriptRoot + "\TestResults\DataToolsUITestingResults.trx`" /testsettings:`"" + $TestSettingsFile + "`"" + $TestList
}
