...
$FullArgsList = "/testcontainer:`"" + $SolutionDir + "\Warewolf.UISpecs\bin\Debug\Warewolf.UISpecs.dll`" /resultsfile:TestResults\UISpecsResults.trx /testsettings:`"" + $TestSettingsFile + "`"" + $TestList + " /category:`"PluginConnector`""
