...
$FullArgsList = $TestAssembliesList + " /resultsfile:TestResults\WorkflowExecutionSpecsResults.trx /testsettings:`"" + $TestSettingsFile + "`"" + $TestList + " /category:`"SubworkflowExecution`""
