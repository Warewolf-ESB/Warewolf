...
$FullArgsList = "/testcontainer:`"" + $SolutionDir + "\Warewolf.UITests\bin\Debug\Warewolf.UISpecs.dll`" /resultsfile:UISpecsResults.trx /testsettings:`"" + $TestSettingsFile + "`"" + $TestList
