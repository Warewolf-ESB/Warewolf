...
$FullArgsList = $TestAssembliesList + " /resultsfile:OtherSpecsResults.trx /testsettings:`"" + $TestSettingsFile + "`"" + $TestList + " /category:`"!ExampleWorkflowExecution&!WorkflowExecution&!SubworkflowExecution`""
