...
$FullArgsList = $TestAssembliesList + " /resultsfile:TestResults\OtherSpecsResults.trx /testsettings:`"" + $TestSettingsFile + "`"" + $TestList + " /category:`"!ExampleWorkflowExecution&!WorkflowExecution&!SubworkflowExecution`""
