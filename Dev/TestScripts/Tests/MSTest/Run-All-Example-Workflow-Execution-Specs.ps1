...
$FullArgsList = $TestAssembliesList + " /resultsfile:ExampleWorkflowExecutionSpecsResults.trx /testsettings:`"" + $TestSettingsFile + "`"" + $TestList + " /category:`"ExampleWorkflowExecution`""
