...
# Write Test Runner
& "$SolutionDir\TestScripts\Tests\VSTest\CI\Run-Workflow-Execution-Specs.ps1"
...
<AnalyseParams>
	...
	<Output>$PSScriptRoot\WorkflowExecutionSpecsDotCoverOutput.dcvr</Output>
	<Scope>
		<ScopeEntry>$SolutionDir\Warewolf.Specs\**\*.dll</ScopeEntry>
		<ScopeEntry>$SolutionDir\Warewolf.Specs\**\*.exe</ScopeEntry>
	</Scope>
</AnalyseParams>
"@
