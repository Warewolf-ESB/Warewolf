...
# Write Test Runner
& "$SolutionDir\TestScripts\Tests\VSTest\CI\Run-Integration-Tests.ps1"
...
<AnalyseParams>
	...
	<Scope>
		<ScopeEntry>$SolutionDir\Dev2.IntegrationTests\bin\Debug\**\*.dll</ScopeEntry>
		<ScopeEntry>$SolutionDir\Dev2.IntegrationTests\bin\Debug\**\*.exe</ScopeEntry>
	</Scope>
</AnalyseParams>
"@
