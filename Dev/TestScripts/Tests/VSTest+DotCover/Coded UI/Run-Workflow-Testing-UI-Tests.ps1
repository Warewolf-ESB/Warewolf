...
`"
  ...
  <Description>Run Workflow Testing UI Tests.</Description>
...
$FullArgsList = " `"" + $SolutionDir + "\Warewolf.UITests\bin\Debug\Warewolf.UITests.dll`" /logger:trx /Settings:`"" + $TestSettingsFile + "`"" + $TestList + " /TestCaseFilter:`"TestCategory=Workflow Testing`""
...
<AnalyseParams>
	...
	<Output>$PSScriptRoot\WorkflowTestingUITestsDotCoverOutput.dcvr</Output>
	<Scope>
