...
$TestSettingsFile = "$PSScriptRoot\DeployUITesting.testsettings"
...
`"
  ...
  <Description>Run Deploy UI Tests.</Description>
...
$FullArgsList = " `"" + $SolutionDir + "\Warewolf.UITests\bin\Debug\Warewolf.UITests.dll`" /logger:trx /Settings:`"" + $TestSettingsFile + "`"" + $TestList + " /TestCaseFilter:`"TestCategory=Deploy`""
