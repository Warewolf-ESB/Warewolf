...
$TestSettingsFile = "$PSScriptRoot\VariablesUITesting.testsettings"
...
if ($TestList -eq "") {
	$FullArgsList = " `"" + $TestAssemblyPath + "`" /logger:trx /Settings:`"" + $TestSettingsFile + "`"" + " /TestCaseFilter:`"TestCategory=Variables`""
} else {
