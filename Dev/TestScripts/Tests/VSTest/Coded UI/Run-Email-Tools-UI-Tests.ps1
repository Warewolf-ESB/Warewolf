...
$TestSettingsFile = "$PSScriptRoot\EmailToolsUITesting.testsettings"
...
if ($TestList -eq "") {
	$FullArgsList = " `"" + $TestAssemblyPath + "`" /logger:trx /Settings:`"" + $TestSettingsFile + "`"" + " /TestCaseFilter:`"TestCategory=Email Tools`""
} else {
