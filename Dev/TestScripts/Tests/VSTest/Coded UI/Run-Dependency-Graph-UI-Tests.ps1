...
$TestSettingsFile = "$PSScriptRoot\DependencyGraphUITesting.testsettings"
...
if ($TestList -eq "") {
	$FullArgsList = " `"" + $TestAssemblyPath + "`" /logger:trx /Settings:`"" + $TestSettingsFile + "`"" + " /TestCaseFilter:`"TestCategory=Dependency Graph`""
} else {
