...
$TestSettingsFile = "$PSScriptRoot\NoConflictingPermissionsSecuritySpecs.testsettings"
...
"@ + [guid]::NewGuid() + @"
`"
  name="NoConflictingPermissionsSecuritySpecs"
  enableDefaultDataCollectors="false"
  xmlns=`"http://microsoft.com/schemas/VisualStudio/TeamTest/2010`">
  <Description>Run permissions security specs with no conflicting permissions.</Description>
