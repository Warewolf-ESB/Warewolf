...
$FullArgsList = " `"" + $SolutionDir + "\Warewolf.UISpecs\bin\Debug\Warewolf.UISpecs.dll`" /logger:trx /Settings:`"" + $TestSettingsFile + "`"" + $TestList + " /TestCaseFilter:`"TestCategory=WebConnector`""
...
<AnalyseParams>
	...
	<Output>$PSScriptRoot\WebConnectorUISpecsDotCoverOutput.dcvr</Output>
	<Scope>
