...
$TestSettingsFile = "$PSScriptRoot\TabsAndPanesUITesting.testsettings"
...
$FullArgsList = " `"" + $SolutionDir + "\Warewolf.UITests\bin\Debug\Warewolf.UITests.dll`" /logger:trx /Settings:`"" + $TestSettingsFile + "`"" + $TestList + " /TestCaseFilter:`"TestCategory=Tabs and Panes`""
...
<AnalyseParams>
	...
	<Output>$PSScriptRoot\TabsAndPanesUITestsDotCoverOutput.dcvr</Output>
	<Scope>
