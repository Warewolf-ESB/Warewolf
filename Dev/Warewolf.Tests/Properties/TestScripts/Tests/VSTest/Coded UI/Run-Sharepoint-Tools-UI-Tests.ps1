...
$TestSettingsFile = "$PSScriptRoot\SharepointToolsUITesting.testsettings"
...
<TestSettings
  ...
  <Description>Run Sharepoint Tools UI Tests.</Description>
...
$FullArgsList = " `"" + $SolutionDir + "\Warewolf.UITests\bin\Debug\Warewolf.UITests.dll`" /logger:trx /Settings:`"" + $TestSettingsFile + "`"" + $TestList + " /TestCaseFilter:`"TestCategory=Sharepoint Tools`""
