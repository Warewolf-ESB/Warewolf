...
#line hidden
        ...
        public virtual void EnsureInputsAreEnabledOnDecisionWindowLoad(string no, string inputs, string variable, string variable2, string value2, string variable3, string value3, string matchType, string[] exampleTags)
        {
            ...
            argumentsOfScenario.Add("MatchType", matchType);
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Ensure Inputs are enabled on decision window load", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 16
