...
{
	internal sealed class BlockDispatcherUnsplatProcN : BlockDispatcherN<Func<BlockParam, object, object[], RubyArray, Proc, object>>
	{
		...
		private object InvokeInternal(BlockParam param, object self, Proc procArg, object[] args)
		{
			...
			return _block(param, self, array, rubyArray, procArg);
		}
		...
		private object InvokeSplatInternal(BlockParam param, object self, Proc procArg, object[] args, IList splattee)
		{
			...
			return _block(param, self, args, rubyArray, procArg);
		}
	}
}
