...
{
	internal sealed class BlockDispatcher3 : BlockDispatcher<Func<BlockParam, object, object, object, object, object>>
	{
		...
		public override object Invoke(BlockParam param, object self, Proc procArg, object arg1)
		{
			...
			if (list != null)
			{
				...
				case 0:
					return _block(param, self, null, null, null);
				case 1:
					return _block(param, self, list[0], null, null);
				case 2:
					return _block(param, self, list[0], list[1], null);
				default:
					return _block(param, self, list[0], list[1], list[2]);
				}
			}
		...
		{
			args = BlockDispatcher.CreateArgumentsFromSplatteeAndRhs(3, args, splattee, rhs);
			return _block(param, self, args[0], args[1], args[2]);
		}
	}
}
