...
Scenario Outline: Create file at location
	...
	Examples: 
		...
		| 5  | FTPS       | [[path]]    | ftp://SVRPDC.premier.local:1002/FORCREATEFILETESTING/test.txt                                   | True     | IntegrationTester                  | I73573r0     | [[result]] | Success | NO           |                           |
...
Scenario Outline: Create file at location with overwrite disabled
	...
	Examples: 
		...
		| 5  | FTPS       | [[path]]    | ftp://SVRPDC.premier.local:1002/FORCREATEFILETESTING/test.txt                                   | False    | IntegrationTester | I73573r0     | [[result]] | Success | NO           |                           |
