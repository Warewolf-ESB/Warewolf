...
Scenario Outline: Create file at location
	...
	Examples: 
		...
		| 5  | SFTP       | [[path]]    | sftp://localhost/C:/Users/localsftpadmin/upload/test.txt                 | True     | LocalSFTPAdmin   | 987Sftp#@! | [[result]] | Success | NO           |                           |
		| 6  | SFTP       | [[path]]    | sftp://localhost/C:/Users/localsftpadmin/upload/test1.txt                | True     | LocalSFTPAdmin   | 987Sftp#@! | [[result]] | Success | NO           | C:\\Temp\\key.opk         |
...
Scenario Outline: Create file at location with overwrite disabled
	...
	Examples: 
		...
		| 5  | SFTP       | [[path]]    | sftp://localhost/C:/Users/localsftpadmin/upload/test.txt                 | False    | LocalSFTPAdmin | 987Sftp#@! | [[result]] | Success | NO           |                           |
		| 6  | SFTP       | [[path]]    | sftp://localhost/C:/Users/localsftpadmin/upload/test1.txt                | False    | LocalSFTPAdmin | 987Sftp#@! | [[result]] | Success | NO           | C:\\Temp\\key.opk         |
...
Scenario Outline: Create file at location Nulls
	...
	Examples: 
		...
		| 3  | SFTP  | [[path]]    | sftp://localhost/C:/Users/localsftpadmin/upload/test1.txt  | True     | ""             | 987Sftp#@! | [[result]] | Failure | AN           | C:\\Temp\                 |
