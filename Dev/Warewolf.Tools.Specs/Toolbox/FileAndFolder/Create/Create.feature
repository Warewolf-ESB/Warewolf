...
Scenario Outline: Create file at location
	...
	Examples: 
		...
		| 6  | SFTP       | [[path]]    | sftp://DEVOPSPDC.premier.local/test.txt                                                            | True     | dev2            | Q/ulw&]      | [[result]] | Success | NO           |                           |
		| 7  | SFTP       | [[path]]    | sftp://DEVOPSPDC.premier.local/test1.txt                                                           | True     | dev2            | Q/ulw&]      | [[result]] | Success | NO           | C:\\Temp\\key.opk         |
...
Scenario Outline: Create file at location with overwrite disabled
	...
	Examples: 
		...
		| 6  | SFTP       | [[path]]    | sftp://DEVOPSPDC.premier.local/test.txt                                                            | False    | dev2            | Q/ulw&]      | [[result]] | Success | NO           |                           |
		| 7  | SFTP       | [[path]]    | sftp://DEVOPSPDC.premier.local/test1.txt                                                           | False    | dev2            | Q/ulw&]      | [[result]] | Success | NO           | C:\\Temp\\key.opk         |
...
Scenario Outline: Create file at location Nulls
	...
	Examples: 
		...
		| 3  | SFTP       | [[path]]    | sftp://DEVOPSPDC.premier.local/test1.txt                                                          | True     | ""             | Q/ulw&]      | [[result]] | Failure | AN           | C:\\Temp\                 |
