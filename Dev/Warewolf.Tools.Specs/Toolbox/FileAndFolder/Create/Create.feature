...
Scenario Outline: Create file at location
	...
	Examples: 
		...
		| 4  | FTPS       | [[path]]    | ftp://localhost:1010/FORCREATEFILETESTING/test.txt              | True     | dev2             | Q/ulw&]                                            | [[result]] | Success | NO           |                           |
...
Scenario Outline: Create file at location with overwrite disabled
	...
	Examples: 
		...
		| 4  | FTPS       | [[path]]    | ftp://localhost:1010/FORCREATEFILETESTING/test.txt              | False    | dev2           | Q/ulw&]                                            | [[result]] | Success | NO           |                           |
