...
Scenario Outline: Create file at location
	...
	Examples: 
		...
		| 2  | UNC        | [[path]]    | \\\\RSAKLFSVRPDC.dev2.local\FileSystemShareTestingSite\FileCreateSharedTestingSite\test.txt        | True     | ""                           | ""       | [[result]] | Success | NO           |                           |
		| 3  | UNC Secure | [[path]]    | \\\\RSAKLFSVRPDC.dev2.local\FileSystemShareTestingSite\FileCreateSharedTestingSite\Secure\test.txt | True     | dev2.local\IntegrationTester | I73573r0 | [[result]] | Success | NO           |                           |
...
Scenario Outline: Create file at location with overwrite disabled
	...
	Examples: 
		...
		| 2  | UNC        | [[path]]    | \\\\RSAKLFSVRPDC.dev2.local\FileSystemShareTestingSite\FileCreateSharedTestingSite\test.txt        | False    | ""                           | ""       | [[result]] | Success | NO           |                           |
		| 3  | UNC Secure | [[path]]    | \\\\RSAKLFSVRPDC.dev2.local\FileSystemShareTestingSite\FileCreateSharedTestingSite\Secure\test.txt | False    | dev2.local\IntegrationTester | I73573r0 | [[result]] | Success | NO           |                           |
...
Scenario Outline: Create file at location Nulls
	...
	Examples: 
		...
		| 5  | UNC Secure | [[path]]    | \\\\RSAKLFSVRPDC.dev2.local\FileSystemShareTestingSite\FileCreateSharedTestingSite\Secure\test.tx | True     | dev2.local\IntegrationTesteru | I73573r0 | [[result]] | Failure | AN           |                           |
