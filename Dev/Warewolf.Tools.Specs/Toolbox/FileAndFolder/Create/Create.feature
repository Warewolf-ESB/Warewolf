...
Scenario Outline: Create file at location
	...
	Examples: 
		...
		| 5  | SFTP       | [[path]]    | sftp://localhost/upload/test.txt                                                            | True     | dev2            | Q/ulw&]      | [[result]] | Success | NO           |                           |
		| 6  | SFTP       | [[path]]    | sftp://localhost/upload/test1.txt                                                           | True     | dev2            | Q/ulw&]      | [[result]] | Success | NO           | C:\\Temp\\key.opk         |
...
Scenario Outline: Create file at location with overwrite disabled
	...
	Examples: 
		...
		| 5  | SFTP       | [[path]]    | sftp://localhost/upload/test.txt                                                        | False    | dev2            | Q/ulw&]      | [[result]] | Success | NO           |                           |
		| 6  | SFTP       | [[path]]    | sftp://localhost/upload/test1.txt                                                       | False    | dev2            | Q/ulw&]      | [[result]] | Success | NO           | C:\\Temp\\key.opk         |
...
Scenario Outline: Create file at location Nulls
	...
	Examples: 
		...
		| 3  | SFTP  | [[path]]    | sftp://localhost/upload/test1.txt                                                              | True     | ""             | Q/ulw&]      | [[result]] | Failure | AN           | C:\\Temp\                 |
