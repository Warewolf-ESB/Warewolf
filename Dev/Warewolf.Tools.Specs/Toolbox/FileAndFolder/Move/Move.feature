...
Scenario Outline: Move file at UNC location
	...
	Examples: 
	   ...
	   | 3  | UNC to FTPS      | [[sourcePath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileMoveSharedTestingSite\movefile2.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/moved1.txt                            | Administrator | Dev2@dmin123 | True     | [[result]] | Success | NO           |                      |                           |
...
Scenario Outline: Move file at FTP location
	...
	Examples: 
	   ...
	   | 2  | FTP to UNC       | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORMOVEFILETESTING/movefile1.txt | ""       | ""       | [[destPath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileMoveSharedTestingSite\moved2.txt | ""            | ""           | True     | [[result]] | Success | NO           |                      |                           |
...
Scenario Outline: Move file at FTPS location
	...
	Examples: 
	   ...
	   | 2  | FTPS to UNC   | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/movefile1.txt | Administrator | Dev2@dmin123 | [[destPath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileMoveSharedTestingSite\moved3.txt | ""            | ""           | True     | [[result]] | Success | NO           |                      |                           |
...
Scenario Outline: Move file at UNC location with overwrite disabled
	...
	Examples: 
	   ...
	   | 2  | UNC to FTP   | [[sourcePath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileMoveSharedTestingSite\movefile1.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORMOVEFILETESTING/moved1.txt                            | ""                | ""           | False    | [[result]] | Success | NO           |                      |                           |
	   | 3  | UNC to FTPS  | [[sourcePath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileMoveSharedTestingSite\movefile2.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/moved1.txt                            | Administrator     | Dev2@dmin123 | False    | [[result]] | Success | NO           |                      |                           |
...
Scenario Outline: Move file at FTP location with overwrite disabled
	...
	Examples: 
	   ...
	   | 2  | FTP to UNC   | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORMOVEFILETESTING/movefile1.txt | ""            | ""           | [[destPath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileMoveSharedTestingSite\moved2.txt | ""                | ""           | False    | [[result]] | Success | NO           |                      |                           |
...
Scenario Outline: Move file at FTPS location with overwrite disabled
	...
	Examples: 
	   ...
	   | 2  | FTPS to UNC   | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/movefile1.txt | Administrator | Dev2@dmin123 | [[destPath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileMoveSharedTestingSite\moved3.txt | ""                | ""           | False    | [[result]] | Success | NO           |                      |                           |
