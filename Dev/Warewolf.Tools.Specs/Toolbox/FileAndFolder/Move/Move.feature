...
Scenario Outline: Move file at local location
	...
	Examples: 
	   ...
	   | 4  | Local to SFTP    | [[sourcePath]] | c:\movefile3.txt | ""       | ""       | [[destPath]] | sftp://opswolf.com/moved0.txt                                                    | dev2          | Q/ulw&]      | True     | [[result]] | Success | NO           |                      |                           |
...
Scenario Outline: Move file at FTP location
	...
	Examples: 
	   ...
	   | 2  | FTP to FTPS      | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORMOVEFILETESTING/movefile2.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/moved2.txt                          | Administrator | Dev2@dmin123 | True     | [[result]] | Success | NO           |                      |                           |
	   | 3  | FTP to SFTP      | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORMOVEFILETESTING/movefile3.txt | ""       | ""       | [[destPath]] | sftp://opswolf.com/moved2.txt                                                    | dev2          | Q/ulw&]      | True     | [[result]] | Success | NO           |                      |                           |
...
Scenario Outline: Move file at FTPS location
	...
	Examples: 
	   ...
	   | 2  | FTPS to FTPS  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/movefile2.txt | Administrator | Dev2@dmin123 | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/moved3.txt                          | Administrator | Dev2@dmin123 | True     | [[result]] | Success | NO           |                      |                           |
	   | 3  | FTPS to SFTP  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/movefile3.txt | Administrator | Dev2@dmin123 | [[destPath]] | sftp://opswolf.com/moved3.txt                                                    | dev2          | Q/ulw&]      | True     | [[result]] | Success | NO           |                      |                           |
	   | 4  | FTPS to FTP   | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/movefile4.txt | Administrator | Dev2@dmin123 | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORMOVEFILETESTING/moved3.txt                          | ""            | ""           | True     | [[result]] | Success | NO           |                      |                           |
...
Scenario Outline: Move file at SFTP location
	...
	Examples: 
	   | No | Name             | source         | sourceLocation                             | username | password | destination  | destinationLocation                                                                       | destUsername  | destPassword | selected | resultVar  | result  | errorOccured | sourcePrivateKeyFile | destinationPrivateKeyFile |
	   | 1  | SFTP to Local    | [[sourcePath]] | sftp://opswolf.com/movefile0.txt  | dev2     | Q/ulw&]  | [[destPath]] | C:\moved4.txt                                                                             | ""            | ""           | True     | [[result]] | Success | NO           |                      |                           |
	   | 2  | SFTP to FTP      | [[sourcePath]] | sftp://opswolf.com/movefile2.txt  | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORMOVEFILETESTING/moved4.txt                          | ""            | ""           | True     | [[result]] | Success | NO           |                      |                           |
	   | 3  | SFTP to FTPS     | [[sourcePath]] | sftp://opswolf.com/movefile3.txt  | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/moved4.txt                          | Administrator | Dev2@dmin123 | True     | [[result]] | Success | NO           |                      |                           |
	   | 4  | SFTP to SFTP     | [[sourcePath]] | sftp://opswolf.com/movefile4.txt  | dev2     | Q/ulw&]  | [[destPath]] | sftp://opswolf.com/moved4.txt                                                    | dev2          | Q/ulw&]      | True     | [[result]] | Success | NO           |                      |                           |
	   | 5  | SFTP to Local PK | [[sourcePath]] | sftp://opswolf.com/movefile01.txt | dev2     | Q/ulw&]  | [[destPath]] | C:\moved41.txt                                                                            | ""            | ""           | True     | [[result]] | Success | NO           | C:\\Temp\\key.opk    |                           |
	   | 6  | SFTP to FTP  PK  | [[sourcePath]] | sftp://opswolf.com/movefile21.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORMOVEFILETESTING/moved41.txt                         | ""            | ""           | True     | [[result]] | Success | NO           | C:\\Temp\\key.opk    |                           |
	   | 7  | SFTP to FTPS PK  | [[sourcePath]] | sftp://opswolf.com/movefile31.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/moved41.txt                         | Administrator | Dev2@dmin123 | True     | [[result]] | Success | NO           | C:\\Temp\\key.opk    |                           |
	   | 8  | SFTP to SFTP PK  | [[sourcePath]] | sftp://opswolf.com/movefile41.txt | dev2     | Q/ulw&]  | [[destPath]] | sftp://opswolf.com/moved41.txt                                                   | dev2          | Q/ulw&]      | True     | [[result]] | Success | NO           | C:\\Temp\\key.opk    | C:\\Temp\\key.opk         |
...
Scenario Outline: Move file at local location with overwrite disabled
	...
	Examples: 
	   ...
	   | 4  | Local to SFTP    | [[sourcePath]] | c:\movefile3.txt | ""       | ""       | [[destPath]] | sftp://opswolf.com/moved0.txt                                                    | dev2              | Q/ulw&]      | False    | [[result]] | Success | NO           |                      |                           |
...
Scenario Outline: Move file at FTP location with overwrite disabled
	...
	Examples: 
	   ...
	   | 2  | FTP to FTPS  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORMOVEFILETESTING/movefile2.txt | ""            | ""           | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/moved2.txt                         | Administrator     | Dev2@dmin123 | False    | [[result]] | Success | NO           |                      |                           |
	   | 3  | FTP to SFTP  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORMOVEFILETESTING/movefile3.txt | ""            | ""           | [[destPath]] | sftp://opswolf.com/moved2.txt                                                   | dev2              | Q/ulw&]      | False    | [[result]] | Success | NO           |                      |                           |
...
Scenario Outline: Move file at FTPS location with overwrite disabled
	...
	Examples: 
	   ...
	   | 2  | FTPS to FTPS  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/movefile2.txt | Administrator | Dev2@dmin123 | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/moved3.txt                         | Administrator     | Dev2@dmin123 | False    | [[result]] | Success | NO           |                      |                           |
	   | 3  | FTPS to SFTP  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/movefile3.txt | Administrator | Dev2@dmin123 | [[destPath]] | sftp://opswolf.com/moved3.txt                                                   | dev2              | Q/ulw&]      | False    | [[result]] | Success | NO           |                      |                           |
	   | 4  | FTPS to FTP   | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/movefile4.txt | Administrator | Dev2@dmin123 | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORMOVEFILETESTING/moved3.txt                         | ""                | ""           | False    | [[result]] | Success | NO           |                      |                           |
...
Scenario Outline: Move file at SFTP location with overwrite disabled
	...
	Examples: 
	   | No | Name             | source         | sourceLocation                             | username | password | destination  | destinationLocation                                                                       | destUsername      | destPassword | selected | resultVar  | result  | errorOccured | sourcePrivateKeyFile | destinationPrivateKeyFile |
	   | 1  | SFTP to Local    | [[sourcePath]] | sftp://opswolf.com/movefile0.txt  | dev2     | Q/ulw&]  | [[destPath]] | C:\moved4.txt                                                                             | ""                | ""           | False    | [[result]] | Success | NO           |                      |                           |
	   | 2  | SFTP to FTP      | [[sourcePath]] | sftp://opswolf.com/movefile2.txt  | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORMOVEFILETESTING/moved4.txt                          | ""                | ""           | False    | [[result]] | Success | NO           |                      |                           |
	   | 3  | SFTP to FTPS     | [[sourcePath]] | sftp://opswolf.com/movefile3.txt  | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/moved4.txt                          | Administrator     | Dev2@dmin123 | False    | [[result]] | Success | NO           |                      |                           |
	   | 4  | SFTP to SFTP     | [[sourcePath]] | sftp://opswolf.com/movefile4.txt  | dev2     | Q/ulw&]  | [[destPath]] | sftp://opswolf.com/moved4.txt                                                    | dev2              | Q/ulw&]      | False    | [[result]] | Success | NO           |                      |                           |
	   | 5  | SFTP to Local PK | [[sourcePath]] | sftp://opswolf.com/movefile01.txt | dev2     | Q/ulw&]  | [[destPath]] | C:\moved41.txt                                                                            | ""                | ""           | False    | [[result]] | Success | NO           | C:\\Temp\\key.opk    |                           |
	   | 6  | SFTP to FTP  PK  | [[sourcePath]] | sftp://opswolf.com/movefile21.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORMOVEFILETESTING/moved41.txt                         | ""                | ""           | False    | [[result]] | Success | NO           | C:\\Temp\\key.opk    |                           |
	   | 7  | SFTP to FTPS PK  | [[sourcePath]] | sftp://opswolf.com/movefile31.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORMOVEFILETESTING/moved41.txt                         | Administrator     | Dev2@dmin123 | False    | [[result]] | Success | NO           | C:\\Temp\\key.opk    |                           |
	   | 8  | SFTP to SFTP PK  | [[sourcePath]] | sftp://opswolf.com/movefile41.txt | dev2     | Q/ulw&]  | [[destPath]] | sftp://opswolf.com/moved41.txt                                                   | dev2              | Q/ulw&]      | False    | [[result]] | Success | NO           | C:\\Temp\\key.opk    | C:\\Temp\\key.opk         |
...
Scenario Outline: Move file at location Null
	...
	Examples: 
	   ...
	   | 6  | Local to SFTP  | [[sourcePath]] | " "                                                                                         | ""       | ""       | [[destPath]] | sftp://opswolf.com/moved0.txt                           | dev2          | Q/ulw&]      | True     | [[result]] | Failure | AN           |                      |                           |
