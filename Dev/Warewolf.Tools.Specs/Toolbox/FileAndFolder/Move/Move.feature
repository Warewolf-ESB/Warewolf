...
Scenario Outline: Move file at UNC location
	...
	Examples: 
	   ...
	   | 4  | UNC to SFTP      | [[sourcePath]] | \\\\localhost\FileSystemShareTestingSite\FileMoveSharedTestingSite\movefile3.txt | ""       | ""       | [[destPath]] | sftp://SVRDEV.premier.local/moved1.txt                                                      | dev2          | Q/ulw&]      | True     | [[result]] | Success | NO           |                      |                           |
...
Scenario Outline: Move file at SFTP location
	...
	Examples: 
	   ...
	   | 2  | SFTP to UNC      | [[sourcePath]] | sftp://SVRDEV.premier.local/movefile1.txt  | dev2              | Q/ulw&]  | [[destPath]] | \\\\localhost\FileSystemShareTestingSite\FileMoveSharedTestingSite\moved4.txt  | ""            | ""           | True     | [[result]] | Success | NO           |                      |                           |
	   ...
	   | 7  | SFTP to UNC  PK  | [[sourcePath]] | sftp://SVRDEV.premier.local/movefile11.txt | dev2              | Q/ulw&]  | [[destPath]] | \\\\localhost\FileSystemShareTestingSite\FileMoveSharedTestingSite\moved41.txt | ""            | ""           | True     | [[result]] | Success | NO           | C:\\Temp\\key.opk    |                           |
...
Scenario Outline: Move file at UNC location with overwrite disabled
	...
	Examples: 
	   ...
	   | 4  | UNC to SFTP  | [[sourcePath]] | \\\\localhost\FileSystemShareTestingSite\FileMoveSharedTestingSite\movefile3.txt | ""       | ""       | [[destPath]] | sftp://SVRDEV.premier.local/moved1.txt                                                      | dev2              | Q/ulw&]      | False    | [[result]] | Success | NO           |                      |                           |
...
Scenario Outline: Move file at SFTP location with overwrite disabled
	...
	Examples: 
	   ...
	   | 2  | SFTP to UNC      | [[sourcePath]] | sftp://SVRDEV.premier.local/movefile1.txt  | dev2              | Q/ulw&]  | [[destPath]] | \\\\localhost\FileSystemShareTestingSite\FileMoveSharedTestingSite\moved4.txt  | ""                | ""           | False    | [[result]] | Success | NO           |                      |                           |
	   ...
	   | 7  | SFTP to UNC  PK  | [[sourcePath]] | sftp://SVRDEV.premier.local/movefile11.txt | dev2              | Q/ulw&]  | [[destPath]] | \\\\localhost\FileSystemShareTestingSite\FileMoveSharedTestingSite\moved41.txt | ""                | ""           | False    | [[result]] | Success | NO           | C:\\Temp\\key.opk    |                           |
