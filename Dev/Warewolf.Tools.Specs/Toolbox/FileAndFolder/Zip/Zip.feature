...
Scenario Outline: Zip file at FTP location
	...
	Examples:
		| No | Name            | source   | sourceLocation                                                  | username | password | destination | destinationLocation                                                                          | destUsername      | destPassword | selected | archivepassword | compression     | resultVar  | result    | errorOccured | sourcePrivateKeyFile | destinationPrivateKeyFile |
		| 1  | FTP to Local    | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip0.txt | ""       | ""       | [[destPath]]   | c:\My New2.zip                                                                               | ""                | ""           | True     |                 | Default         | [[result]] | "Success" | NO           |                      |                           |
		| 2  | FTP to UNC      | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip1.txt | ""       | ""       | [[destPath]]   | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip12.txt | ""                | ""           | True     |                 | BestCompression | [[result]] | "Success" | NO           |                      |                           |
		| 3  | FTP to SFTP     | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip4.txt | ""       | ""       | [[destPath]]   | sftp://SVRDEV.premier.local/filetozip.zip                                                    | dev2              | Q/ulw&]      | True     |                 | Default         | [[result]] | "Success" | NO           |                      |                           |
		| 4  | FTP to FTP      | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip2.txt | ""       | ""       | [[destPath]]   | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip12.txt                             | dev2              | Q/ulw&]      | True     |                 | None            | [[result]] | "Success" | NO           |                      |                           |
		| 5  | FTP to FTPS     | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip3.txt | ""       | ""       | [[destPath]]   | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip22.txt                             | dev2              | Q/ulw&]      | True     |                 | BestSpeed       | [[result]] | "Success" | NO           |                      |                           |
