...
Scenario Outline: Zip file at FTP location with overwrite disabled
	...
	Examples: 
		...
		| 2  | FTP to UNC      | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip1.txt | dev2              | Q/ulw&]  | [[destPath]]   | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip12.txt | ""            | ""           | False    |                 | BestCompression | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Zip file at FTPS location with overwrite disabled
	...
	Examples:
		...
		| 2  | FTPS to UNC     | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip1.txt | dev2              | Q/ulw&]      | [[destPath]]   | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip13.txt | ""            | ""           | False    |                 | None            | [[result]] | "Success" | NO           |                      |                           |
