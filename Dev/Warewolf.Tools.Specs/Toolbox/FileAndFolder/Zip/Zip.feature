...
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		| 3  | SFTP to FTP     | [[path]] | sftp://SVRDEV.premier.local/filetozip2.txt  | dev2 | Q/ulw&]  | [[path1]]   | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip14.txt                             | ""            | ""           | True     |                 | Default         | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		| 4  | SFTP to FTPS    | [[path]] | sftp://SVRDEV.premier.local/filetozip3.txt  | dev2 | Q/ulw&]  | [[path1]]   | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip24.txt                             | Administrator | Dev2@dmin123 | True     |                 | BestCompression | [[result]] | "Success" | NO           |                      |                           |
