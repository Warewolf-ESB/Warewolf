...
Scenario Outline: Zip file at local location
	...
	Examples:
		...
		| 4 | Local to SFTP   | [[sourcePath]] | c:\filetozip4.txt | ""       | ""       | [[destPath]]   | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip.zip                                                    | LocalSFTPAdmin              | 987Sftp#@!      | True     |                 | None            | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Zip file at FTP location
	...
	Examples:
		...
		| 3  | FTP to SFTP     | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip4.txt | dev2     | Q/ulw&]  | [[destPath]]   | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip.zip                                                    | LocalSFTPAdmin              | 987Sftp#@!      | True     |                 | Default         | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Zip file at FTPS location
	...
	Examples:
		...
		| 4  | FTPS to SFTP    | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip4.txt | dev2          | Q/ulw&]  | [[destPath]] | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip.zip                | LocalSFTPAdmin | 987Sftp#@!  | True     |                 | BestCompression | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Zip file at SFTP location
	...
	Examples:
		| No | Name            | source   | sourceLocation                              | username      | password | destination | destinationLocation                                              | destUsername  | destPassword | selected | archivepassword | compression     | resultVar  | result    | errorOccured | sourcePrivateKeyFile | destinationPrivateKeyFile |
		| 1  | SFTP to Local   | [[sourcePath]] | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip0.txt  | LocalSFTPAdmin              | 987Sftp#@!  | [[destPath]]   | c:\My New4.zip                                                   | ""            | ""           | True     |                 | None            | [[result]] | "Success" | NO           |                      |                           |
		| 2  | SFTP to SFTP PK | [[sourcePath]] | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip41.txt | LocalSFTPAdmin              | 987Sftp#@!  | [[destPath]]   | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip.zip                        | LocalSFTPAdmin              | 987Sftp#@!      | True     |                 | None            | [[result]] | "Success" | NO           | C:\\Temp\\key.opk    | C:\\Temp\\key.opk         |
		| 3  | SFTP to FTP     | [[sourcePath]] | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip2.txt  | LocalSFTPAdmin              | 987Sftp#@!  | [[destPath]]   | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip14.txt | dev2              | Q/ulw&]      | True     |                 | Default         | [[result]] | "Success" | NO           |                      |                           |
		| 4  | SFTP to FTPS    | [[sourcePath]] | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip3.txt  | LocalSFTPAdmin              | 987Sftp#@!  | [[destPath]]   | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip24.txt | dev2              | Q/ulw&]      | True     |                 | BestCompression | [[result]] | "Success" | NO           |                      |                           |
		| 5  | SFTP to SFTP    | [[sourcePath]] | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip4.txt  | LocalSFTPAdmin              | 987Sftp#@!  | [[destPath]]   | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip.zip                        | LocalSFTPAdmin              | 987Sftp#@!      | True     |                 | None            | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Zip file at local location with overwrite disabled
	...
	Examples: 
		...
		| 4  | Local to SFTP   | [[sourcePath]] | c:\filetozip4.txt | ""       | ""       | [[destPath]]   | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip.zip                        | LocalSFTPAdmin              | 987Sftp#@!      | False    |                 | None            | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Zip file at FTP location with overwrite disabled
	...
	Examples: 
		...
		| 5  | FTP to SFTP     | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip4.txt | dev2              | Q/ulw&]  | [[destPath]]  | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip.zip                                                       | LocalSFTPAdmin          | 987Sftp#@!      | False    |                 | Default         | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Zip file at FTPS location with overwrite disabled
	...
	Examples:
		...
		| 5  | FTPS to SFTP    | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip4.txt | dev2              | Q/ulw&]      | [[destPath]]   | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip.zip                                                    | LocalSFTPAdmin              | 987Sftp#@!      | False    |                 | BestCompression | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Zip file at SFTP location with overwrite disabled
	...
	Examples: 
		| No | Name            | source   | sourceLocation                              | username | password | destination | destinationLocation                                                                          | destUsername  | destPassword | selected | archivepassword | compression     | resultVar  | result    | errorOccured | sourcePrivateKeyFile | destinationPrivateKeyFile |
		| 1  | SFTP to Local   | [[sourcePath]] | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip0.txt  | LocalSFTPAdmin     | 987Sftp#@!  | [[destPath]]   | c:\My New4.zip                                                                               | ""            | ""           | False    |                 | None            | [[result]] | "Success" | NO           |                      |                           |
		| 2  | SFTP to UNC     | [[sourcePath]] | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip1.txt  | LocalSFTPAdmin     | 987Sftp#@!  | [[destPath]]   | \\\\localhost\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip14.txt | ""            | ""           | False    |                 | BestSpeed       | [[result]] | "Success" | NO           |                      |                           |
		| 3  | SFTP to FTP     | [[sourcePath]] | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip2.txt  | LocalSFTPAdmin     | 987Sftp#@!  | [[destPath]]   | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip14.txt                             | dev2              | Q/ulw&]      | False    |                 | Default         | [[result]] | "Success" | NO           |                      |                           |
		| 4  | SFTP to FTPS    | [[sourcePath]] | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip3.txt  | LocalSFTPAdmin     | 987Sftp#@!  | [[destPath]]   | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip24.txt                             | dev2              | Q/ulw&]      | False    |                 | BestCompression | [[result]] | "Success" | NO           |                      |                           |
		| 5  | SFTP to SFTP    | [[sourcePath]] | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip4.txt  | LocalSFTPAdmin     | 987Sftp#@!  | [[destPath]]   | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip.zip                                                    | LocalSFTPAdmin              | 987Sftp#@!      | False    |                 | None            | [[result]] | "Success" | NO           |                      |                           |
		| 6  | SFTP to SFTP PK | [[sourcePath]] | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip41.txt | LocalSFTPAdmin     | 987Sftp#@!  | [[destPath]]   | sftp://localhost/C:/Users/localsftpadmin/upload/filetozip.zip                                                    | LocalSFTPAdmin              | 987Sftp#@!      | False    |                 | None            | [[result]] | "Success" | NO           | C:\\Temp\\key.opk    | C:\\Temp\\key.opk         |
