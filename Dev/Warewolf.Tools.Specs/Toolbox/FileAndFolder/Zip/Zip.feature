...
Scenario Outline: Zip file at SFTP location with overwrite disabled
	...
	Examples: 
		...
		| 2  | SFTP to UNC     | [[sourcePath]] | sftp://SVRDEV.premier.local/filetozip1.txt  | dev2     | Q/ulw&]  | [[destPath]]   | \\\\localhost\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip14.txt | ""            | ""           | False    |                 | BestSpeed       | [[result]] | "Success" | NO           |                      |                           |
