...
Scenario Outline: Zip file at FTP location
	...
	Examples:
		...
		| 2  | FTP to UNC      | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip1.txt | dev2     | Q/ulw&]  | [[destPath]]   | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip12.txt | ""                | ""           | True     |                 | BestCompression | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Zip file at FTPS location
	...
	Examples:
		...
		| 2  | FTPS to UNC     | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip1.txt | dev2              | Q/ulw&]      | [[destPath]]   | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip13.txt | ""            | ""           | True     |                 | None            | [[result]] | "Success" | NO           |                      |                           |
...
#Broken by update to Specflow 3		| 3  | Local to FTPS   | [[sourcePath]] | c:\filetozip3.txt | ""       | ""       | [[destPath]]   | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip20.txt | dev2              | Q/ulw&]      | False    |                 | BestCompression | [[result]] | "Success" | NO           |                      |                           |
...
#Broken by update to Specflow 3		| 2  | FTP to UNC      | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip1.txt | dev2              | Q/ulw&]  | [[destPath]]   | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip12.txt | ""            | ""           | False    |                 | BestCompression | [[result]] | "Success" | NO           |                      |                           |
...
#Broken by update to Specflow 3		| 5  | FTP to SFTP     | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip4.txt | dev2              | Q/ulw&]  | [[destPath]]   | sftp://DEVOPSPDC.premier.local/filetozip.zip                                                    | dev2              | Q/ulw&]      | False    |                 | Default         | [[result]] | "Success" | NO           |                      |                           |
...
#Broken by update to Specflow 3		| 2  | FTPS to UNC     | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip1.txt | dev2              | Q/ulw&]      | [[destPath]]   | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip13.txt | ""            | ""           | False    |                 | None            | [[result]] | "Success" | NO           |                      |                           |
...
#Broken by update to Specflow 3		| 4  | FTPS to FTPS    | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip3.txt | dev2              | Q/ulw&]      | [[destPath]]   | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip23.txt                             | dev2              | Q/ulw&]      | False    |                 | Default         | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Zip file at SFTP location with overwrite disabled
	...
	Examples: 
		...
		| 2  | SFTP to UNC     | [[sourcePath]] | sftp://SVRDEV.premier.local/filetozip1.txt  | dev2     | Q/ulw&]  | [[destPath]]   | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip14.txt | ""            | ""           | False    |                 | BestSpeed       | [[result]] | "Success" | NO           |                      |                           |
...
#Broken by update to Specflow 3		| 4  | SFTP to FTPS    | [[sourcePath]] | sftp://SVRDEV.premier.local/filetozip3.txt  | dev2     | Q/ulw&]  | [[destPath]]   | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip24.txt                             | dev2              | Q/ulw&]      | False    |                 | BestCompression | [[result]] | "Success" | NO           |                      |                           |
