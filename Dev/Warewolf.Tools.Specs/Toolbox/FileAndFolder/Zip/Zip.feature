...
Scenario Outline: Zip file at SFTP location
	...
	Examples:
		...
		| 2  | SFTP to UNC     | [[path]] | sftp://SVRDEV.premier.local/filetozip1.txt  | dev2 | Q/ulw&]  | [[path1]]   | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip14.txt | ""            | ""           | True     |                 | BestSpeed       | [[result]] | "Success" | NO           |                      |                           |
		| 3  | SFTP to SFTP PK | [[path]] | sftp://SVRDEV.premier.local/filetozip41.txt | dev2 | Q/ulw&]  | [[path1]]   | sftp://SVRDEV.premier.local/filetozip.zip                                                    | dev2          | Q/ulw&]      | True     |                 | None            | [[result]] | "Success" | NO           | C:\\Temp\\key.opk    | C:\\Temp\\key.opk         |
		| 4  | SFTP to FTP     | [[path]] | sftp://SVRDEV.premier.local/filetozip2.txt  | dev2 | Q/ulw&]  | [[path1]]   | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip14.txt                             | ""            | ""           | True     |                 | Default         | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Zip file at local location with overwrite disabled
	...
	Examples: 
		...
		| 2  | Local to UNC    | [[path]] | c:\filetozip1.txt | ""       | ""       | [[path1]]   | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip10.txt | ""                | ""           | False    |                 | BestSpeed       | [[result]] | "Success" | NO           |                      |                           |
		| 3  | Local to FTP    | [[path]] | c:\filetozip2.txt | ""       | ""       | [[path1]]   | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip10.txt                                | ""                | ""           | False    |                 | Default         | [[result]] |           | NO           |                      |                           |
		| 4  | Local to FTPS   | [[path]] | c:\filetozip3.txt | ""       | ""       | [[path1]]   | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip20.txt                                | Administrator | Dev2@dmin123     | False    |                 | BestCompression | [[result]] |           | NO           |                      |                           |
...
Scenario Outline: Zip file at UNC location with overwrite disabled
	...
	Examples: 
		| No | Name            | source   | sourceLocation                                                                              | username | password | destination | destinationLocation                                                                          | destUsername  | destPassword | selected | archivepassword | compression     | resultVar  | result    | errorOccured | sourcePrivateKeyFile | destinationPrivateKeyFile |
		| 1  | UNC to Local    | [[path]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip0.txt | ""       | ""       | [[path1]]   | c:\My New1.zip                                                                               | ""            | ""           | False    |                 | BestSpeed       | [[result]] | "Success" | NO           |                      |                           |
		| 2  | UNC to UNC      | [[path]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip1.txt | ""       | ""       | [[path1]]   | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip11.txt | ""            | ""           | False    |                 | Default         | [[result]] | "Success" | NO           |                      |                           |
		| 3  | UNC to FTP      | [[path]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip2.txt | ""       | ""       | [[path1]]   | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip11.txt                             | ""            | ""           | False    |                 | BestCompression | [[result]] |           | NO           |                      |                           |
		| 4  | UNC to FTPS     | [[path]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\filetozip3.txt | ""       | ""       | [[path1]]   | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip21.txt                             | Administrator | Dev2@dmin123 | False    |                 | None            | [[result]] |           | NO           |                      |                           |
...
Scenario Outline: Zip file at FTP location with overwrite disabled
	...
	Examples: 
		...
		| 3  | FTP to FTP      | [[path]] | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip2.txt | ""                | ""       | [[path1]]   | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip12.txt                             | ""            | ""           | False    |                 | None            | [[result]] |           | NO           |                      |                           |
		| 4  | FTP to FTPS     | [[path]] | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip3.txt | ""                | ""       | [[path1]]   | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip22.txt                             | Administrator | Dev2@dmin123 | False    |                 | BestSpeed       | [[result]] |           | NO           |                      |                           |
...
Scenario Outline: Zip file at FTPS location with overwrite disabled
	...
	Examples:
		...
		| 3  | FTPS to FTP     | [[path]] | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip2.txt | Administrator | Dev2@dmin123 | [[path1]]   | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip13.txt                             | ""            | ""           | False    |                 | BestSpeed       | [[result]] |           | NO           |                      |                           |
		| 4  | FTPS to FTPS    | [[path]] | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip3.txt | Administrator | Dev2@dmin123 | [[path1]]   | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip23.txt                             | Administrator | Dev2@dmin123 | False    |                 | Default         | [[result]] |           | NO           |                      |                           |
...
Scenario Outline: Zip file at SFTP location with overwrite disabled
	...
	Examples: 
		...
		| 3  | SFTP to FTP     | [[path]] | sftp://SVRDEV.premier.local/filetozip2.txt  | dev2     | Q/ulw&]  | [[path1]]   | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip14.txt                             | ""            | ""           | False    |                 | Default         | [[result]] |           | NO           |                      |                           |
		| 4  | SFTP to FTPS    | [[path]] | sftp://SVRDEV.premier.local/filetozip3.txt  | dev2     | Q/ulw&]  | [[path1]]   | ftp://DEVOPSPDC.premier.local:1002/FORZIPTESTING/filetozip24.txt                             | Administrator | Dev2@dmin123 | False    |                 | BestCompression | [[result]] |           | NO           |                      |                           |
...
Scenario Outline: Zip file at location Null
	...
	Examples: 
		...
		| 3  | UNC to Local  | [[path]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileZipSharedTestingSite\ | ""       | ""           | [[path1]]   | c:\My New1.zip      | ""            | ""           | True     |                 | BestSpeed       | [[result]] | Error  | NO           |                      |                           |
		| 4  | FTP to Local  | [[path]] | ftp://DEVOPSPDC.premier.local:1001/FORZIPTESTING/filetozip0.txt               | ""       | ""           | [[path1]]   | " "                 | ""            | ""           | True     |                 | Default         | [[result]] | Error  | An           |                      |                           |
