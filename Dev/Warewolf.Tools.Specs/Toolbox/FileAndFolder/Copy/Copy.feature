...
Scenario Outline: Copy file at local location
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | c:\copyfile2.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied0.txt                            | Administrator     | Dev2@dmin123 | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 3  | [[sourcePath]] | c:\copyfile3.txt | ""       | ""       | [[destPath]] | sftp://SVRDEV.premier.local/copied0.txt                                                      | dev2              | Q/ulw&]      | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 4  | [[sourcePath]] | c:\copyfile4.txt | ""       | ""       | [[destPath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copied0.txt | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at UNC location
	...
	Examples:
		...
		| 2  | [[sourcePath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile2.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied1.txt                         | Administrator     | Dev2@dmin123 | True     | [[result]] | "Success" | NO           | "C:\\Temp\\key.opk"  |                           |
		| 3  | [[sourcePath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile3.txt | ""       | ""       | [[destPath]] | sftp://SVRDEV.premier.local/copied1.txt                                                   | dev2              | Q/ulw&]      | True     | [[result]] | "Success" | NO           |                      |                           |
		| 4  | [[sourcePath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile5.txt | ""       | ""       | [[destPath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copied1.txt | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at local location with overwrite disabled
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | c:\copyfile2.txt | ""                | ""           | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied0.txt                            | Administrator     | Dev2@dmin123 | False    | [[result]] | "Success" | NO           |                      |                           |
		 | 3  | [[sourcePath]] | c:\copyfile3.txt | ""                | ""           | [[destPath]] | sftp://SVRDEV.premier.local/copied0.txt                                                      | dev2              | Q/ulw&]      | False    | [[result]] | "Success" | NO           |                      |                           |
		 | 4  | [[sourcePath]] | c:\copyfile4.txt | ""                | ""           | [[destPath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copied0.txt | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at UNC location with overwrite disabled
	...
	Examples:
		...
		| 2  | [[sourcePath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile2.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied1.txt                         | Administrator     | Dev2@dmin123 | False    | [[result]] | "Success" | NO           | "C:\\Temp\\key.opk"  |                           |
		| 3  | [[sourcePath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile3.txt | ""       | ""       | [[destPath]] | sftp://SVRDEV.premier.local/copied1.txt                                                   | dev2              | Q/ulw&]      | False    | [[result]] | "Success" | NO           |                      |                           |
		| 4  | [[sourcePath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile5.txt | ""       | ""       | [[destPath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copied1.txt | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
