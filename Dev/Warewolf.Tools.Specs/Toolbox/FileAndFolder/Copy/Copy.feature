...
Scenario Outline: Copy file at local location
	...
	Examples: 
		 ...
		 | 4  | [[sourcePath]] | c:\copyfile3.txt | ""       | ""       | [[destPath]] | sftp://opswolf.com/copied0.txt                                                   | dev2              | Q/ulw&]      | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 5  | [[sourcePath]] | c:\copyfile5.txt | ""       | ""       | [[destPath]] | sftp://opswolf.com/copied61.txt                                                  | dev2              | Q/ulw&]      | True     | [[result]] | "Success" | NO           | C:\\Temp\\key.opk    |                           |
...
Scenario Outline: Copy file at FTP location
	...
	Examples: 
		 ...
		 | 3  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copyfile3.txt | ""                | ""           | [[destPath]] | sftp://opswolf.com/copied2.txt                                                   | dev2              | Q/ulw&]      | True     | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at FTPS location
	...
	Examples: 
		 ...
		 | 4  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copyfile4.txt | Administrator     | Dev2@dmin123 | [[destPath]] | sftp://opswolf.com/copied3.txt                                                   | dev2              | Q/ulw&]      | True     | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at SFTP location
	...
	Examples: 
		 | No | source         | sourceLocation                            | username | password | destination  | destinationLocation                                                                       | destUsername      | destPassword | selected | resultVar  | result    | errorOccured | sourcePrivateKeyFile | destinationPrivateKeyFile |
		 | 1  | [[sourcePath]] | sftp://opswolf.com/copyfile0.txt | dev2     | Q/ulw&]  | [[destPath]] | C:\copied40.txt                                                                           | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 2  | [[sourcePath]] | sftp://opswolf.com/copyfile2.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied4.txt                         | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 3  | [[sourcePath]] | sftp://opswolf.com/copyfile3.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied4.txt                         | Administrator     | Dev2@dmin123 | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 4  | [[sourcePath]] | sftp://opswolf.com/copyfile5.txt | dev2     | Q/ulw&]  | [[destPath]] | sftp://opswolf.com/copied4.txt                                                   | dev2              | Q/ulw&]      | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 5  | [[sourcePath]] | sftp://opswolf.com/copyfile6.txt | dev2     | Q/ulw&]  | [[destPath]] | sftp://opswolf.com/copied51.txt                                                  | dev2              | Q/ulw&]      | True     | [[result]] | "Success" | NO           | C:\\Temp\\key.opk    |                           |
		 | 6  | [[sourcePath]] | sftp://opswolf.com/copyfile7.txt | dev2     | Q/ulw&]  | [[destPath]] | sftp://opswolf.com/copied71.txt                                                  | dev2              | Q/ulw&]      | True     | [[result]] | "Success" | NO           | C:\\Temp\\key.opk    | C:\\Temp\\key.opk         |
...
Scenario Outline: Copy file at local location with overwrite disabled
	...
	Examples: 
		 ...
		 | 4  | [[sourcePath]] | c:\copyfile3.txt | ""                | ""           | [[destPath]] | sftp://opswolf.com/copied0.txt                                                   | dev2              | Q/ulw&]      | False    | [[result]] | "Success" | NO           |                      |                           |
		 | 5  | [[sourcePath]] | c:\copyfile5.txt | ""                | ""           | [[destPath]] | sftp://opswolf.com/copied61.txt                                                  | dev2              | Q/ulw&]      | False    | [[result]] | "Success" | NO           | C:\\Temp\\key.opk    |                           |
...
Scenario Outline: Copy file at FTP location with overwrite disabled
	...
	Examples: 
		 ...
		 | 3  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copyfile3.txt | ""       | ""       | [[destPath]] | sftp://opswolf.com/copied2.txt                                                   | dev2              | Q/ulw&]      | False    | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at FTPS location with overwrite disabled
	...
	Examples: 
		 ...
		 | 4  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copyfile4.txt | Administrator     | Dev2@dmin123 | [[destPath]] | sftp://opswolf.com/copied3.txt                                                   | dev2              | Q/ulw&]      | False    | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at SFTP location with overwrite disabled
	...
	Examples: 
		 | No | source         | sourceLocation                            | username | password | destination  | destinationLocation                                                                       | destUsername      | destPassword | selected | resultVar  | result    | errorOccured | sourcePrivateKeyFile | destinationPrivateKeyFile |
		 | 1  | [[sourcePath]] | sftp://opswolf.com/copyfile0.txt | dev2     | Q/ulw&]  | [[destPath]] | C:\copied40.txt                                                                           | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
		 | 2  | [[sourcePath]] | sftp://opswolf.com/copyfile2.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied4.txt                         | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
		 | 3  | [[sourcePath]] | sftp://opswolf.com/copyfile3.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied4.txt                         | Administrator     | Dev2@dmin123 | False    | [[result]] | "Success" | NO           |                      |                           |
		 | 4  | [[sourcePath]] | sftp://opswolf.com/copyfile5.txt | dev2     | Q/ulw&]  | [[destPath]] | sftp://opswolf.com/copied4.txt                                                   | dev2              | Q/ulw&]      | False    | [[result]] | "Success" | NO           |                      |                           |
		 | 5  | [[sourcePath]] | sftp://opswolf.com/copyfile6.txt | dev2     | Q/ulw&]  | [[destPath]] | sftp://opswolf.com/copied51.txt                                                  | dev2              | Q/ulw&]      | False    | [[result]] | "Success" | NO           | C:\\Temp\\key.opk    |                           |
		 | 6  | [[sourcePath]] | sftp://opswolf.com/copyfile7.txt | dev2     | Q/ulw&]  | [[destPath]] | sftp://opswolf.com/copied71.txt                                                  | dev2              | Q/ulw&]      | False    | [[result]] | "Success" | NO           | C:\\Temp\\key.opk    | C:\\Temp\\key.opk         |
