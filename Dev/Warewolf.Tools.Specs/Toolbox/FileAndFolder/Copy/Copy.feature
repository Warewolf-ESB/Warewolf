...
Scenario Outline: Copy file at local location
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | c:\copyfile1.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied0.txt                         | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 3  | [[sourcePath]] | c:\copyfile2.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied0.txt                         | Administrator     | Dev2@dmin123 | True     | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at UNC location
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile1.txt | ""                | ""           | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied1.txt                         | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 3  | [[sourcePath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile2.txt | ""                | ""           | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied1.txt                         | Administrator     | Dev2@dmin123 | True     | [[result]] | "Success" | NO           | "C:\\Temp\\key.opk"  |                           |
...
Scenario Outline: Copy file at SFTP location
	...
	Examples: 
		 ...
		 | 3  | [[sourcePath]] | sftp://SVRDEV.premier.local/copyfile2.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied4.txt                         | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 4  | [[sourcePath]] | sftp://SVRDEV.premier.local/copyfile3.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied4.txt                         | Administrator     | Dev2@dmin123 | True     | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at local location with overwrite disabled
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | c:\copyfile1.txt | ""                | ""           | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied0.txt                         | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
		 | 3  | [[sourcePath]] | c:\copyfile2.txt | ""                | ""           | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied0.txt                         | Administrator     | Dev2@dmin123 | False    | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at UNC location with overwrite disabled
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile1.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied1.txt                         | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
		 | 3  | [[sourcePath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile2.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied1.txt                         | Administrator     | Dev2@dmin123 | False    | [[result]] | "Success" | NO           | "C:\\Temp\\key.opk"  |                           |
...
Scenario Outline: Copy file at FTP location with overwrite disabled
	...
	Examples: 
		 ...
		 | 3  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copyfile2.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied2.txt                         | Administrator     | Dev2@dmin123 | False    | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at FTPS location with overwrite disabled
	...
	Examples: 
		 ...
		 | 3  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copyfile2.txt | Administrator     | Dev2@dmin123 | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied3.txt                         | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at SFTP location with overwrite disabled
	...
	Examples: 
		 ...
		 | 3  | [[sourcePath]] | sftp://SVRDEV.premier.local/copyfile2.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied4.txt                         | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
		 | 4  | [[sourcePath]] | sftp://SVRDEV.premier.local/copyfile3.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied4.txt                         | Administrator     | Dev2@dmin123 | False    | [[result]] | "Success" | NO           |                      |                           |
