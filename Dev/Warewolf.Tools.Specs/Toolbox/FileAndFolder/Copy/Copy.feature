...
Scenario Outline: Copy file at FTP location
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copyfile1.txt | ""                | ""           | [[destPath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copied2.txt | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at FTPS location
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copyfile1.txt | Administrator     | Dev2@dmin123 | [[destPath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copied3.txt | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at UNC location with overwrite disabled
	...
	Examples:
		...
		| 2  | [[sourcePath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile1.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied1.txt                         | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
		| 3  | [[sourcePath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile2.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied1.txt                         | Administrator     | Dev2@dmin123 | False    | [[result]] | "Success" | NO           | "C:\\Temp\\key.opk"  |                           |
...
Scenario Outline: Copy file at FTP location with overwrite disabled
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copyfile1.txt | ""       | ""       | [[destPath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copied2.txt | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at FTPS location with overwrite disabled
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copyfile1.txt | Administrator     | Dev2@dmin123 | [[destPath]] | \\\\DEVOPSPDC.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copied3.txt | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
