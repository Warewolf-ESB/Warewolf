...
Scenario Outline: Copy file at UNC location
	...
	Examples: 
		 | No | source         | sourceLocation                                                                              | username          | password     | destination  | destinationLocation                                                                       | destUsername      | destPassword | selected | resultVar  | result    | errorOccured | sourcePrivateKeyFile | destinationPrivateKeyFile |
		 | 1  | [[sourcePath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile0.txt | ""                | ""           | [[destPath]] | C:\copied10.txt                                                                           | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 2  | [[sourcePath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile1.txt | ""                | ""           | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied1.txt                         | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 3  | [[sourcePath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile2.txt | ""                | ""           | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied1.txt                         | Administrator     | Dev2@dmin123 | True     | [[result]] | "Success" | NO           | "C:\\Temp\\key.opk"  |                           |
...
Scenario Outline: Copy file at FTP location
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copyfile1.txt | ""                | ""           | [[destPath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copied2.txt | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 3  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copyfile2.txt | ""                | ""           | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied2.txt                         | Administrator     | Dev2@dmin123 | True     | [[result]] | "Success" | NO           |                      |                           |
...
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 5  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copyfile4.txt | ""                | ""           | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied2.txt                         | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at FTPS location
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copyfile1.txt | Administrator     | Dev2@dmin123 | [[destPath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copied3.txt | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 3  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copyfile2.txt | Administrator     | Dev2@dmin123 | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied3.txt                         | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 4  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copyfile3.txt | Administrator     | Dev2@dmin123 | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied3.txt                         | Administrator     | Dev2@dmin123 | True     | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at SFTP location
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | sftp://SVRDEV.premier.local/copyfile1.txt | dev2     | Q/ulw&]  | [[destPath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copied4.txt | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 3  | [[sourcePath]] | sftp://SVRDEV.premier.local/copyfile2.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied4.txt                         | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 4  | [[sourcePath]] | sftp://SVRDEV.premier.local/copyfile3.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied4.txt                         | Administrator     | Dev2@dmin123 | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 5  | [[sourcePath]] | sftp://SVRDEV.premier.local/copyfile5.txt | dev2     | Q/ulw&]  | [[destPath]] | sftp://SVRDEV.premier.local/copied4.txt                                                   | dev2              | Q/ulw&]      | True     | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at UNC location with overwrite disabled
	...
	Examples: 
		 | No | source         | sourceLocation                                                                              | username | password | destination  | destinationLocation                                                                       | destUsername      | destPassword | selected | resultVar  | result    | errorOccured | sourcePrivateKeyFile | destinationPrivateKeyFile |
		 | 1  | [[sourcePath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile0.txt | ""       | ""       | [[destPath]] | C:\copied10.txt                                                                           | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 2  | [[sourcePath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile1.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied1.txt                         | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 3  | [[sourcePath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile2.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied1.txt                         | Administrator     | Dev2@dmin123 | False    | [[result]] | "Success" | NO           | "C:\\Temp\\key.opk"  |                           |
...
Scenario Outline: Copy file at FTP location with overwrite disabled
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copyfile1.txt | ""       | ""       | [[destPath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copied2.txt | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 3  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copyfile2.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied2.txt                         | Administrator     | Dev2@dmin123 | False    | [[result]] | "Success" | NO           |                      |                           |
...
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 5  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copyfile4.txt | ""       | ""       | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied2.txt                         | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at FTPS location with overwrite disabled
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copyfile1.txt | Administrator     | Dev2@dmin123 | [[destPath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copied3.txt | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 3  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copyfile2.txt | Administrator     | Dev2@dmin123 | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied3.txt                         | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 4  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copyfile3.txt | Administrator     | Dev2@dmin123 | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied3.txt                         | Administrator     | Dev2@dmin123 | False    | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at SFTP location with overwrite disabled
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | sftp://SVRDEV.premier.local/copyfile1.txt | dev2     | Q/ulw&]  | [[destPath]] | \\\\SVRDEV.premier.local\FileSystemShareTestingSite\FileCopySharedTestingSite\copied4.txt | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 3  | [[sourcePath]] | sftp://SVRDEV.premier.local/copyfile2.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied4.txt                         | ""                | ""           | False    | [[result]] | "Success" | NO           |                      |                           |
#DevOps: Ignoring until DEVOPSPDC.premier.local is back online		 | 4  | [[sourcePath]] | sftp://SVRDEV.premier.local/copyfile3.txt | dev2     | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied4.txt                         | Administrator     | Dev2@dmin123 | False    | [[result]] | "Success" | NO           |                      |                           |
