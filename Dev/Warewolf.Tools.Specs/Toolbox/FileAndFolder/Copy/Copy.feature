...
Scenario Outline: Copy file at location
	...
	Examples: 
		 ...
		 | 8  | [[sourcePath]] | \\\\RSAKLFSVRPDC\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile1.txt | ""                | ""       | [[destPath]] | ftp://rsaklfsvrpdc:1001/FORTESTING/copied1.txt                                    | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 9  | [[sourcePath]] | \\\\RSAKLFSVRPDC\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile2.txt | ""                | ""       | [[destPath]] | ftp://rsaklfsvrpdc:1002/FORTESTING/copied1.txt                                    | integrationtester | I73573r0     | True     | [[result]] | "Success" | NO           | "C:\\Temp\\key.opk"  |                           |
		 | 10 | [[sourcePath]] | \\\\RSAKLFSVRPDC\FileSystemShareTestingSite\FileCopySharedTestingSite\copyfile3.txt | ""                | ""       | [[destPath]] | sftp://rsaklfsvrdev/copied1.txt                                                   | dev2              | Q/ulw&]      | True     | [[result]] | "Success" | NO           |                      |                           |
		 ...
		 | 13 | [[sourcePath]] | ftp://rsaklfsvrpdc:1001/FORTESTING/copyfile1.txt                                    | ""                | ""       | [[destPath]] | \\\\RSAKLFSVRPDC\FileSystemShareTestingSite\FileCopySharedTestingSite\copied2.txt | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
		 ...
		 | 18 | [[sourcePath]] | ftp://rsaklfsvrpdc:1002/FORTESTING/copyfile1.txt                                    | integrationtester | I73573r0 | [[destPath]] | \\\\RSAKLFSVRPDC\FileSystemShareTestingSite\FileCopySharedTestingSite\copied3.txt | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
		 ...
		 | 23 | [[sourcePath]] | sftp://rsaklfsvrdev/copyfile1.txt                                                   | dev2              | Q/ulw&]  | [[destPath]] | \\\\RSAKLFSVRPDC\FileSystemShareTestingSite\FileCopySharedTestingSite\copied4.txt | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
