...
Scenario Outline: Copy file at FTP location
	...
	Examples: 
		 ...
		 | 4  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copyfile3.txt | dev2     | Q/ulw&]  | [[destPath]] | sftp://3xhcmicj2djiu.southafricanorth.azurecontainer.io/upload/copied2.txt           | dev2         | Q/ulw&]      | True     | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at FTPS location
	...
	Examples: 
		 ...
		 | 5  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copyfile4.txt | dev2              | Q/ulw&]      | [[destPath]] | sftp://3xhcmicj2djiu.southafricanorth.azurecontainer.io/upload/copied3.txt                                                      | dev2         | Q/ulw&]      | True     | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at SFTP location
	...
	Examples: 
		 ...
		 | 2  | [[sourcePath]] | sftp://3xhcmicj2djiu.southafricanorth.azurecontainer.io/upload/copyfile2.txt | dev2              | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied4.txt                            | dev2         | Q/ulw&]      | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 3  | [[sourcePath]] | sftp://3xhcmicj2djiu.southafricanorth.azurecontainer.io/upload/copyfile3.txt | dev2              | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied4.txt                            | dev2         | Q/ulw&]      | True     | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at FTP location with overwrite disabled
	...
	Examples: 
		 ...
		 | 4  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copyfile3.txt | dev2              | Q/ulw&]  | [[destPath]] | sftp://3xhcmicj2djiu.southafricanorth.azurecontainer.io/upload/copied2.txt                                                      | dev2         | Q/ulw&]      | False    | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at FTPS location with overwrite disabled
	...
	Examples: 
		 ...
		 | 5  | [[sourcePath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copyfile4.txt | dev2     | Q/ulw&]  | [[destPath]] | sftp://3xhcmicj2djiu.southafricanorth.azurecontainer.io/upload/copied3.txt                                                      | dev2         | Q/ulw&]      | False    | [[result]] | "Success" | NO           |                      |                           |
...
Scenario Outline: Copy file at SFTP location with overwrite disabled
	...
	Examples: 
		 ...
		 | 3  | [[sourcePath]] | sftp://3xhcmicj2djiu.southafricanorth.azurecontainer.io/upload/copyfile2.txt | dev2              | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1001/FORCOPYFILETESTING/copied4.txt                            | dev2         | Q/ulw&]      | False    | [[result]] | "Success" | NO           |                      |                           |
		 | 4  | [[sourcePath]] | sftp://3xhcmicj2djiu.southafricanorth.azurecontainer.io/upload/copyfile3.txt | dev2              | Q/ulw&]  | [[destPath]] | ftp://DEVOPSPDC.premier.local:1002/FORCOPYFILETESTING/copied4.txt                            | dev2         | Q/ulw&]      | False    | [[result]] | "Success" | NO           |                      |                           |
