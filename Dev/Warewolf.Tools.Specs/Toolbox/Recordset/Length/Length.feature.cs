...
#line hidden
            ...
            else
            {
                ...
                table2329.AddRow(new string[] {
                            ...
                            "3"});
#line 8
 testRunner.Given("I get the length from a recordset that looks like with this shape", ((string)(null)), table2329, "Given ");
#line hidden
#line 13
...
#line hidden
                ...
                table2330.AddRow(new string[] {
                            "[[rs(5).row]] = 3"});
#line 17
 testRunner.And("the debug inputs as", ((string)(null)), table2330, "And ");
#line hidden
                ...
                table2331.AddRow(new string[] {
                            "[[result]] = 5"});
#line 22
 testRunner.And("the debug output as", ((string)(null)), table2331, "And ");
#line hidden
            }
...
#line hidden
            ...
            else
            {
                ...
                table2335.AddRow(new string[] {
                            ...
                            "8"});
#line 56
 testRunner.Given("I get the length from a recordset that looks like with this shape", ((string)(null)), table2335, "Given ");
#line hidden
#line 66
...
#line hidden
            ...
            else
            {
                ...
                table2338.AddRow(new string[] {
                            ...
                            "7"});
#line 75
 testRunner.Given("I get the length from a recordset that looks like with this shape", ((string)(null)), table2338, "Given ");
#line hidden
#line 84
 testRunner.And("get length on record \"[[rs().row]]\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
            ...
            else
            {
                ...
                table2341.AddRow(new string[] {
                            ...
                            "7"});
#line 93
 testRunner.Given("I get the length from a recordset that looks like with this shape", ((string)(null)), table2341, "Given ");
#line hidden
#line 102
 testRunner.And("get length on record \"[[rs()]]\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
...
#line hidden
            ...
            else
            {
                ...
                table2344.AddRow(new string[] {
                            ...
                            "8"});
#line 120
 testRunner.Given("I get the length from a recordset that looks like with this shape", ((string)(null)), table2344, "Given ");
#line hidden
#line 130
 testRunner.And("get length on record \"[[rs().&^]]\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
