...
Scenario: Aggregated Calculation using Recordset (*) input in an agregate function like SUM and output recordset star
	Given I have a calculate variable "[[var().int]]" equal to 
	| var().int	|
	| 1			|
	| 2			|
...
Scenario: Aggregated Calculation using Recordset (*) input in an agregate function like SUM and output recordset star complex
	Given I have a calculate variable "[[var().int]]" equal to 
	| var().int	|
	| 1			|
	| 2			|
...
Scenario Outline: Aggregated Calculation Assign by evaluating variables with functions
	...
	| 1   | abs([[e]])                                                 | 1000                                                                                        |
	| 2   | acos([[x]])                                                | 0                                                                                           |
	| 3   | acosh([[rc(1).set]])                                       | 2.2924316695611777                                                                            |
	| 4   | AND([[s]]<[[z]]<5)                                         | False                                                                                       |
	| 5   | AND([[y]]<5)                                               | True                                                                                        |
	| 7   | ASIN([[s]])                                                | -1.5707963267948966                                                                           |
	| 8   | ASINH([[rc(1).set]])                                       | 2.3124383412727525                                                                           |
	| 9   | ATAN([[s]])                                                | -0.7853981633974483                                                                          |
	| 10  | ATAN2([[x]],[[s]])                                         | -0.7853981633974483                                                                          |
	| 11  | ATANH([[t]])                                               | 0                                                                                           |
	| 12  | AVEDEV([[x]],[[z]])                                        | 4.5                                                                                         |
	| 13  | AVERAGE([[x]],[[y]],[[z]],[[rc(1).set]],[[s]],[[t]],[[e]]) | 145.28571428571428                                                                            |
	| 14  | BIN2DEC([[z]])                                             | 2                                                                                           |
	| 15  | BIN2HEX([[x]])                                             | 1                                                                                           |
	| 16  | BIN2OCT([[z]])                                             | 2                                                                                           |
	| 17  | CEILING([[z]],[[y]])                                       | 10                                                                                          |
	...
	| 25  | COS([[[[a]]]])                                             | -0.9899924966004454                                                                          |
	| 26  | COSH([[z]])                                                | 11013.232920103324                                                                          |
	| 27  | COUNT([[x]],[[y]],[[[[a]]]])                               | 3                                                                                           |
	| 29  | DATE(2000,[[y]],12)                                        | {2/12/2000 12:00:00.000 AM} or {2000/02/12 12:00:00.000 AM} or {12/02/2000 12:00:00.000 AM} |
	| 30  | DAY([[x]])                                                 | 1                                                                                           |
	| 31  | DAYS360([[x]],[[y]])                                       | 1                                                                                           |
	...
	| 38  | DEGREES([[z]])                                             | 572.9577951308232                                                                            |
	| 39  | DELTA([[t]],[[x]])                                         | 0                                                                                           |
	| 40  | DOLLARDE([[z]],[[y]])                                      | 10                                                                                          |
	| 41  | DOLLARFR([[x]],[[z]])                                      | 1                                                                                           |
	| 42  | EDATE([[z]],[[[[a]]]])                                     | {4/10/1900 12:00:00.000 AM} or {1900/04/10 12:00:00.000 AM} or {10/04/1900 12:00:00.000 AM} |
	| 43  | EOMONTH([[z]],[[[[a]]]])                                   | {4/30/1900 12:00:00.000 AM} or {1900/04/30 12:00:00.000 AM} or {30/04/1900 12:00:00.000 AM} |
	| 45  | EVEN([[y]])                                                | 2                                                                                           |
	| 46  | EXP([[x]])                                                 | 2.718281828459045                                                                            |
	| 47  | FACT([[z]])                                                | 3628800                                                                                     |
	| 48  | FIND([[t]],[[e]])                                          | 2                                                                                           |
	...
	| 94  | LEFT([[x]],[[e]])                                          | 1                                                                                           |
	| 95  | LEN([[z]])                                                 | 2                                                                                           |
	| 96  | LN([[rc(1).set]])                                          | 1.6094379124341005                                                                             |
	| 97  | LOG([[z]],[[y]])                                           | 3.321928094887362                                                                            |
	| 98  | LOG10([[z]])                                               | 1                                                                                           |
	| 99  | LOWER([[rc(1).set]])                                       | 5                                                                                           |
	...
	| 127 | PV(5,1,10,100,0)                                           | -18.333333333333336                                                                         |
	...
	| 142 | SIGN(50)                                                   | 1                                                                                           |
	| 143 | SIN([[z]])                                                 | -0.5440211108893698                                                                           |
	| 144 | SINH([[z]])                                                | 11013.232874703392                                                                            |
	| 145 | SLN(100,10,[[x]])                                          | 90                                                                                          |
	| 146 | SQRT(16)                                                   | 4                                                                                           |
	| 147 | SQRTPI(16)                                                 | 7.089815403622064                                                                            |
	| 148 | STDEV(1,10,5)                                              | 4.509249752822894                                                                            |
	...
	| 166 | WORKDAY([[rc(1).set]],[[rc(1).set]],[[z]])                 | {1/15/1900 12:00:00.000 AM} or {1900/01/15 12:00:00.000 AM} or {15/01/1900 12:00:00.000 AM} |
	| 167 | YEAR(11011)                                                | 1930                                                                                        |
