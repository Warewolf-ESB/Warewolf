...
Scenario: Enter a URL to download html  
	Given I have the url "http://TFSBLD.dev2.local:9810/api/products/Get" without timeout
...
Scenario: Enter a URL made up of text and variables with no header
	...
	And I have a web request variable "[[site]]" equal to "TFSBLD.dev2.local:9810/api/products/"	
...
Scenario: Enter a recordset star input and output
	Given I have a web request variable "[[urls().url]]" equal to "http://TFSBLD.dev2.local/IntegrationTestSite/Proxy.ashx"	
