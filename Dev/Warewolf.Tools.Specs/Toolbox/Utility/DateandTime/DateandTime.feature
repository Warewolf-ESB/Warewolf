...
Scenario Outline: Aggregated Calculation Assign by evaluating variables with functions
	...
	And The system short date format is "dd/MM/yyyy" and the long time format is "hh:mm:ss tt"
	When the aggregate calculate tool is executed
	...
	| 27  | COUNT([[x]],[[y]],[[[[a]]]])                               | 3                                                           |
	| 29  | DATE(2000,[[y]],12)                                        | {2/12/2000 12:00:00.000 AM} or {12/02/2000 12:00:00.000 AM} |
	| 30  | DAY([[x]])                                                 | 1                                                           |
	| 31  | DAYS360([[x]],[[y]])                                       | 1                                                           |
	...
	| 40  | DOLLARDE([[z]],[[y]])                                      | 10                                                          |
	| 41  | DOLLARFR([[x]],[[z]])                                      | 1                                                           |
	| 42  | EDATE([[z]],[[[[a]]]])                                     | {4/10/1900 12:00:00.000 AM} or {10/04/1900 12:00:00.000 AM} |
	| 43  | EOMONTH([[z]],[[[[a]]]])                                   | {4/30/1900 12:00:00.000 AM} or {30/04/1900 12:00:00.000 AM} |
	| 45  | EVEN([[y]])                                                | 2                                                           |
	...
	| 166 | WORKDAY([[rc(1).set]],[[rc(1).set]],[[z]])                 | {1/15/1900 12:00:00.000 AM} or {15/01/1900 12:00:00.000 AM} |
	| 167 | YEAR(11011)                                                | 1930                                                        |
