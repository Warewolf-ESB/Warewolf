...
#line hidden
        ...
        public virtual void TestInitialize()
        {
            ...
            {
                global::Warewolf.Tools.Specs.Toolbox.Utility.Redis.Cache.GetSetRedisFeature.FeatureSetup(null);
            }
        }
...
#line hidden
            ...
            table2774.AddRow(new string[] {
                        ...
                        "\"[[Var1]],Test1\""});
#line 15
 testRunner.Then("the cache will contain", ((string)(null)), table2774, "Then ");
#line hidden
            ...
            table2775.AddRow(new string[] {
                        ...
                        "\"Test1\""});
#line 18
 testRunner.And("output variables have the following values", ((string)(null)), table2775, "And ");
#line hidden
...
#line hidden
            ...
            table2776.AddRow(new string[] {
                        ...
                        "\"[[Var1]],Data in cache\""});
#line 26
 testRunner.And("data exists (TTL not hit) for key \"MyData\" as", ((string)(null)), table2776, "And ");
#line hidden
            ...
            table2777.AddRow(new string[] {
                        ...
                        "\"Test1\""});
#line 29
 testRunner.And("an assign \"dataToStore\" as", ((string)(null)), table2777, "And ");
#line 32
 testRunner.When("I execute the cache tool", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 33
...
#line hidden
            TechTalk.SpecFlow.Table table2779 = new TechTalk.SpecFlow.Table(new string[] {
                        ...
                        ""});
#line 42
 testRunner.And("data does not exist (TTL exceeded) for key \"MyData\" as", ((string)(null)), table2779, "And ");
#line hidden
            ...
            table2780.AddRow(new string[] {
                        ...
                        "\"Test1\""});
#line 44
 testRunner.And("an assign \"dataToStore\" as", ((string)(null)), table2780, "And ");
#line 47
 testRunner.When("I execute the cache tool", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 48
...
#line hidden
            ...
            table2781.AddRow(new string[] {
                        ...
                        "\"[[Var1]],Test1\""});
#line 49
 testRunner.Then("the cache will contain", ((string)(null)), table2781, "Then ");
#line hidden
            ...
            table2782.AddRow(new string[] {
                        ...
                        "\"Test1\""});
#line 52
 testRunner.And("output variables have the following values", ((string)(null)), table2782, "And ");
#line hidden
            this.ScenarioCleanup();
        }
    }
