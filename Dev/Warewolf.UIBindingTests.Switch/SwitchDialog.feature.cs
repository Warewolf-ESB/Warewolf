...
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "SwitchDialog", "\tIn order to create a switch function\r\n\tAs a Warewolf User\r\n\tI want to be shown t" +
                    "he switch window setup", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void TestInitialize()
        {
            if (((testRunner.FeatureContext != null) 
                        && (testRunner.FeatureContext.FeatureInfo.Title != "SwitchDialog")))
            {
                Warewolf.UIBindingTests.Switch.SwitchDialogFeature.FeatureSetup(null);
            }
        }
