...
namespace Dev2.Common.Interfaces.WindowsTaskScheduler.Wrappers
{
    public interface IRepetitionPattern : IDisposable, IWrappedObject<RepetitionPattern>
    {
        ...
        /// </summary>
        /// <value>
        ///     The duration that the pattern is repeated. The minimum time allowed is one minute. If <c>TimeSpan.Zero</c> is
        ///     specified, the pattern is repeated indefinitely.
        /// </value>
        ...
        /// </summary>
        /// <value>
        ///     The amount of time between each restart of the task. The maximum time allowed is 31 days, and the minimum time
        ///     allowed is 1 minute.
        /// </value>
        /// <remarks>If you specify a repetition duration for a task, you must also specify the repetition interval.</remarks>
        ...
        /// <summary>
        ///     Gets or sets a Boolean value that indicates if a running instance of the task is stopped at the end of repetition
        ///     pattern duration.
        /// </summary>
