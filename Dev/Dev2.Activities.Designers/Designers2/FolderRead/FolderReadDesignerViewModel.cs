...
namespace Dev2.Activities.Designers2.FolderRead
{
    public class FolderReadDesignerViewModel : FileActivityDesignerViewModel
    {
        public FolderReadDesignerViewModel(ModelItem modelItem)
