...
{
    public class OracleDatabaseDesignerViewModel : ActivityDesignerViewModel, IHandle<UpdateResourceMessage>, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty IsFixedProperty =
            DependencyProperty.Register("IsFixed", typeof(bool), typeof(OracleDatabaseDesignerViewModel), new PropertyMetadata(true));
        ...
        public static readonly DependencyProperty FriendlySourceNameValueProperty =
           DependencyProperty.Register("FriendlySourceNameValue", typeof(string), typeof(OracleDatabaseDesignerViewModel), new PropertyMetadata(null, OnFriendlyNameChanged));

        private static void OnFriendlyNameChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var viewModel = (OracleDatabaseDesignerViewModel)d;
            if (viewModel != null)
            {
        ...
        public static readonly DependencyProperty IsDeletedProperty =
            DependencyProperty.Register("IsDeleted", typeof(bool), typeof(OracleDatabaseDesignerViewModel), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty OutputMappingEnabledProperty =
            DependencyProperty.Register("OutputMappingEnabled", typeof(bool), typeof(OracleDatabaseDesignerViewModel), new PropertyMetadata(true));

        public static readonly DependencyProperty IsEditableProperty =
            DependencyProperty.Register("IsEditable", typeof(bool), typeof(OracleDatabaseDesignerViewModel), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty ImageSourceProperty =
            DependencyProperty.Register("ImageSource", typeof(string), typeof(OracleDatabaseDesignerViewModel), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty ShowParentProperty =
            DependencyProperty.Register("ShowParent", typeof(bool), typeof(OracleDatabaseDesignerViewModel), new PropertyMetadata(false, OnShowParentChanged));
        ...
        public static readonly DependencyProperty ButtonDisplayValueProperty = DependencyProperty.Register("ButtonDisplayValue", typeof(string), typeof(OracleDatabaseDesignerViewModel), new PropertyMetadata(default(string)));
        ...
        ~OracleDatabaseDesignerViewModel()
        {
