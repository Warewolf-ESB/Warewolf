...
namespace Dev2.Activities.Designers2.Script_Ruby
{
    public class RubyDesignerViewModel : ActivityDesignerViewModel
    {
        readonly IEventAggregator _eventPublisher;
        readonly IScriptChooser _scriptChooser;
        public RubyDesignerViewModel(ModelItem modelItem)
            : base(modelItem)
        {
            ...
            HelpText = Warewolf.Studio.Resources.Languages.HelpText.Tool_Ruby_Tag;
        }
