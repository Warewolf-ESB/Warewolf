...
{
    public class SharepointListCreateDesignerViewModel : ActivityCollectionDesignerViewModel<SharepointReadListTo>
    {
        ...
        public SharepointListCreateDesignerViewModel(ModelItem modelItem, IAsyncWorker asyncWorker, IEnvironmentModel environmentModel, IEventAggregator eventPublisher)
            : base(modelItem)
        {
            ...
            InitializeItems(mi.FieldValues);
        }
        ...
        public static readonly DependencyProperty IsSelectedSharepointServerFocusedProperty =
            DependencyProperty.Register("IsSelectedSharepointServerFocused", typeof(bool), typeof(SharepointListCreateDesignerViewModel), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty IsSelectedListFocusedProperty =
            DependencyProperty.Register("IsSelectedListFocused", typeof(bool), typeof(SharepointListCreateDesignerViewModel), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty SelectedSharepointServerProperty =
            DependencyProperty.Register("SelectedSharepointServer", typeof(SharepointSource), typeof(SharepointListCreateDesignerViewModel), new PropertyMetadata(null, OnSelectedSharepointServerChanged));

        static void OnSelectedSharepointServerChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var viewModel = (SharepointListCreateDesignerViewModel)d;
        ...
        public static readonly DependencyProperty IsRefreshingProperty =
            DependencyProperty.Register("IsRefreshing", typeof(bool), typeof(SharepointListCreateDesignerViewModel), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty SelectedListProperty =
            DependencyProperty.Register("SelectedList", typeof(SharepointListTo), typeof(SharepointListCreateDesignerViewModel), new PropertyMetadata(null, OnSelectedListChanged));
