...
namespace Dev2.Activities.Designers2.SharepointListDelete
{
    public class SharepointListDeleteDesignerViewModel : ActivityCollectionDesignerViewModel<SharepointSearchTo>
    {
        ...
        public SharepointListDeleteDesignerViewModel(ModelItem modelItem, IAsyncWorker asyncWorker, IEnvironmentModel environmentModel, IEventAggregator eventPublisher)
            : base(modelItem)
        {
        ...
        public static readonly DependencyProperty IsSelectedSharepointServerFocusedProperty =
            DependencyProperty.Register("IsSelectedSharepointServerFocused", typeof(bool), typeof(SharepointListDeleteDesignerViewModel), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty IsSelectedListFocusedProperty =
            DependencyProperty.Register("IsSelectedListFocused", typeof(bool), typeof(SharepointListDeleteDesignerViewModel), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty SelectedSharepointServerProperty =
            DependencyProperty.Register("SelectedSharepointServer", typeof(SharepointSource), typeof(SharepointListDeleteDesignerViewModel), new PropertyMetadata(null, OnSelectedSharepointServerChanged));
        ...
        public static readonly DependencyProperty IsRefreshingProperty =
            DependencyProperty.Register("IsRefreshing", typeof(bool), typeof(SharepointListDeleteDesignerViewModel), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty SelectedListProperty =
            DependencyProperty.Register("SelectedList", typeof(SharepointListTo), typeof(SharepointListDeleteDesignerViewModel), new PropertyMetadata(null, OnSelectedListChanged));
