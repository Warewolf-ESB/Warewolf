...
{
    public class SharepointListUpdateDesignerViewModel : ActivityCollectionDesignerViewModel<SharepointSearchTo>
    {
        ...
        public SharepointListUpdateDesignerViewModel(ModelItem modelItem, IAsyncWorker asyncWorker, IEnvironmentModel environmentModel, IEventAggregator eventPublisher)
            : base(modelItem)
        {
        ...
        public static readonly DependencyProperty IsSelectedSharepointServerFocusedProperty =
            DependencyProperty.Register("IsSelectedSharepointServerFocused", typeof(bool), typeof(SharepointListUpdateDesignerViewModel), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty IsSelectedListFocusedProperty =
            DependencyProperty.Register("IsSelectedListFocused", typeof(bool), typeof(SharepointListUpdateDesignerViewModel), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty SelectedSharepointServerProperty =
            DependencyProperty.Register("SelectedSharepointServer", typeof(SharepointSource), typeof(SharepointListUpdateDesignerViewModel), new PropertyMetadata(null, OnSelectedSharepointServerChanged));

        static void OnSelectedSharepointServerChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var viewModel = (SharepointListUpdateDesignerViewModel)d;
        ...
        public static readonly DependencyProperty IsRefreshingProperty =
            DependencyProperty.Register("IsRefreshing", typeof(bool), typeof(SharepointListUpdateDesignerViewModel), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty SelectedListProperty =
            DependencyProperty.Register("SelectedList", typeof(SharepointListTo), typeof(SharepointListUpdateDesignerViewModel), new PropertyMetadata(null, OnSelectedListChanged));
