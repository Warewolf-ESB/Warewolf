...
namespace Dev2.Activities.Designers2.Replace
{
    public class ReplaceDesignerViewModel : ActivityDesignerViewModel
    {
            ...
            : base(modelItem)
        {
            ...
            TimeModifierTypes = new List<string>(ReplaceFormatter.TimeModifierTypes);
        }

        public List<string> TimeModifierTypes { get; private set; }

        public string Dev2DefaultReplace { get { return GlobalConstants.Dev2CustomDefaultReplaceFormat; } }
        ...
        public static readonly DependencyProperty SelectedTimeModifierTypeProperty =
            DependencyProperty.Register("SelectedTimeModifierType", typeof(string), typeof(ReplaceDesignerViewModel), new PropertyMetadata(null, OnSelectedTimeModifierTypeChanged));

        static void OnSelectedTimeModifierTypeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var viewModel = (ReplaceDesignerViewModel)d;
