...
namespace Dev2.Activities.Designers.Tests.UniqueRecords
{
    ...
    public class UniqueRecordsDesignerViewModelTests
    {
        ...
        public void UniqueRecordsDesignerViewModel_ShouldCall_UpdateHelpDescriptor()
        {
            ...
            using (var viewModel = new UniqueRecordsDesignerViewModel(CreateModelItem(), mockMainViewModel.Object))
            {
                //------------Execute Test---------------------------
                viewModel.UpdateHelpDescriptor("help");
                //------------Assert Results-------------------------
                mockHelpViewModel.Verify(model => model.UpdateHelpText("help"), Times.Once());
                Assert.AreEqual(Warewolf.Studio.Resources.Languages.HelpText.Tool_Recordset_Unique_Records, viewModel.HelpText);
        ...
        {
            return ModelItemUtils.CreateModelItem(new DsfUniqueActivity());
        }
    }
}
