...
namespace Dev2.Activities.Designers.Tests.AdvancedRecordset
{
	...
	public class AdvancedRecordsetViewModelTests
	{
		...
		public void ParseTSQL_SelectStatementWithAllias_1_ReturnOutputs()
		{
			...
			var act = new AdvancedRecordsetActivity();
			string query = "select name as username,age,address_id from person";
			//------------Execute Test---------------------------
		...
		public void ParseTSQL_SelectStatementWithAllias_2_ReturnOutputs()
		{
			...
			string query = "select p.name as username,p.address_id as address from person p";
			//------------Execute Test---------------------------
			var viewModel = new AdvancedRecordsetDesignerViewModel(ModelItemUtils.CreateModelItem(act), new SynchronousAsyncWorker(), new ViewPropertyBuilder());
			viewModel.SqlQuery = query;
		...
		public void ParseTSQL_SelectStatementWithAllias_3_ReturnOutputs()
		{
			...
			DataListSingleton.SetDataList(dataListViewModel);
			var act = new AdvancedRecordsetActivity();
			string query = "select person.name as username,person.age as Age,person.address_id as Address from person";
			//------------Execute Test---------------------------
			var viewModel = new AdvancedRecordsetDesignerViewModel(ModelItemUtils.CreateModelItem(act), new SynchronousAsyncWorker(), new ViewPropertyBuilder());
			viewModel.SqlQuery = query;
			viewModel.GenerateOutputsCommand.Execute(query);
		...
		public void ParseTSQL_SelectStatementWithAllias_4_ReturnOutputs()
		{
			...
			DataListSingleton.SetDataList(dataListViewModel);
			var act = new AdvancedRecordsetActivity();
			string query = "select name as username,age as Age,address_id as Address from person";
			//------------Execute Test---------------------------
			var viewModel = new AdvancedRecordsetDesignerViewModel(ModelItemUtils.CreateModelItem(act), new SynchronousAsyncWorker(), new ViewPropertyBuilder());
			viewModel.SqlQuery = query;
			viewModel.GenerateOutputsCommand.Execute(query);
		...
		public void ParseTSQL_SelectStatementWithAllias_6_ReturnOutputs()
		{
            ...
            var act = new AdvancedRecordsetActivity();
			string query = "select name as username,age as age,address_id as Address from person;Select addr from address";
			//------------Execute Test---------------------------
			var viewModel = new AdvancedRecordsetDesignerViewModel(ModelItemUtils.CreateModelItem(act), new SynchronousAsyncWorker(), new ViewPropertyBuilder());
			viewModel.SqlQuery = query;
			viewModel.GenerateOutputsCommand.Execute(query);
		...
		public void ParseTSQL_SelectStatementWithAllias_5_ReturnOutputs()
		{
            ...
            var act = new AdvancedRecordsetActivity();
			string query = "Update person set age = 30 where name = 'bob'";
			//------------Execute Test---------------------------
			var viewModel = new AdvancedRecordsetDesignerViewModel(ModelItemUtils.CreateModelItem(act), new SynchronousAsyncWorker(), new ViewPropertyBuilder());
			viewModel.SqlQuery = query;
			viewModel.GenerateOutputsCommand.Execute(query);
		...
		public void ParseTSQL_SelectStatementWithAllias_7_ReturnOutputs()
		{
			...
			DataListSingleton.SetDataList(dataListViewModel);
			var act = new AdvancedRecordsetActivity();
			string query = "select name as username,age as Age,address_id as Address from person p;Select addr from address a";
			//------------Execute Test---------------------------
			var viewModel = new AdvancedRecordsetDesignerViewModel(ModelItemUtils.CreateModelItem(act), new SynchronousAsyncWorker(), new ViewPropertyBuilder());
			viewModel.SqlQuery = query;
			viewModel.GenerateOutputsCommand.Execute(query);
