...
namespace Dev2.Activities.Designers.Tests.DropBox2016.DropboxFiles
{
    ...
    public class DropboxFileListViewModelTest
    {
        ...
        private DropBoxFileListViewModel CreateMockViewModel()
        {
            ...
            var dropBoxDownloadViewModel = new DropBoxFileListViewModel(CreateModelItem(), env.Object, agg.Object);
        ...
        public void DropBoxFileListViewModel_GivenIsNew_ShouldReturnInstance()
        {
            ...
            var viewModel = new DropBoxFileListViewModel(CreateModelItem());
            //---------------Assert Precondition----------------
            //---------------Execute Test ----------------------
            //---------------Test Result -----------------------
        ...
        public void dropBoxFileListViewModel_EditSourcePublishesMessage()
        {
            ...
            //------------Setup for test--------------------------
            var dropBoxFileListViewModel = new DropBoxFileListViewModel(model, env.Object, agg.Object);
        ...
        public void downloadViewModel_EditSourceAvailableIfSourceSelected()
        {
            ...
            var model = CreateModelItem();
            //------------Setup for test--------------------------
            var boxUploadViewModel = new DropBoxFileListViewModel(model, env.Object, agg.Object);
        ...
        public void CreateOAuthSource_GivenCanPublish_ShouldResfreshSources()
        {
            ...
            //------------Setup for test--------------------------
            // ReSharper disable once UseObjectOrCollectionInitializer
            var mockVM = new DropBoxFileListViewModel(model, env.Object, agg.Object);
            //---------------Assert Precondition----------------
