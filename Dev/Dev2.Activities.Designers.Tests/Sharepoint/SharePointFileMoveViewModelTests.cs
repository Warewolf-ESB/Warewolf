...
namespace Dev2.Activities.Designers.Tests.Sharepoint
{
    ...
    public class SharePointFileMoveViewModelTests
    {
        ...
        public void SharePointMoveFileDesignerViewModel_Constructor_NullAsyncWorker_ThrowsException()
        {
            ...
            new SharePointMoveFileDesignerViewModel(CreateModelItem(), null, new Mock<IEnvironmentModel>().Object);
            //------------Assert Results-------------------------
        }
        ...
        public void SharePointMoveFileDesignerViewModel_InitilizeProperties_ReturnsSuccess()
        {
            ...
            //------------Execute Test---------------------------
            var sharepointFileMoveDesignerViewModel = new SharePointMoveFileDesignerViewModel(CreateModelItem(), new SynchronousAsyncWorker(), new Mock<IEnvironmentModel>().Object);
        ...
        public void SharePointMoveFileDesignerViewModel_SetProperties_ReturnsSuccess()
        {
            ...
            //------------Execute Test---------------------------
            var sharepointFileMoveDesignerViewModel = new SharePointMoveFileDesignerViewModel(modelItem, new SynchronousAsyncWorker(), new Mock<IEnvironmentModel>().Object);
            sharepointFileMoveDesignerViewModel.Errors = new List<IActionableErrorInfo> { new ActionableErrorInfo() { Message = "Please SharePoint source" } };
