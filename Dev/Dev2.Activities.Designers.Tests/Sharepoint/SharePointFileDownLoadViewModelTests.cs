...
namespace Dev2.Activities.Designers.Tests.Sharepoint
{
    ...
    public class SharePointFileDownLoadViewModelTests
    {
        ...
        public void SharepointFileDownloadDesignerViewModel_Constructor_NullAsyncWorker_ThrowsException()
        {
            ...
            new SharePointFileDownLoadDesignerViewModel(CreateModelItem(), null, new Mock<IEnvironmentModel>().Object);
            //------------Assert Results-------------------------
        }
        ...
        public void SharePointFileDownLoadDesignerViewModel_InitilizeProperties_ReturnsSuccess()
        {
            ...
            //------------Execute Test---------------------------
            var sharepointFileDownLoadDesignerViewModel = new SharePointFileDownLoadDesignerViewModel(CreateModelItem(), new SynchronousAsyncWorker(), new Mock<IEnvironmentModel>().Object);
