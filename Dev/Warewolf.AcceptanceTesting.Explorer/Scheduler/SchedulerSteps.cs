...
public void GivenSelectedServerIs(string p0)
{
    ScenarioContext.Current.Pending();
}
...
public void GivenUsernameIsAs(string p0)
{
    ScenarioContext.Current.Pending();
}

        [Given(@"Password is as ""(.*)""")]
public void GivenPasswordIsAs(string p0)
{
    ScenarioContext.Current.Pending();
}

        [Given(@"""(.*)"" task is selected")]
public void GivenTaskIsSelected(string p0)
{
    ScenarioContext.Current.Pending();
}
...
public void WhenIDelete(string p0)
{
    ScenarioContext.Current.Pending();
        ...
        [When(@"I select ""(.*)"" task")]
public void WhenISelectTask(string p0)
{
    ScenarioContext.Current.Pending();
}
...
public void ThenTheSettingsAre(Table table)
{
    ScenarioContext.Current.Pending();
}

        [Then(@"task settings are")]
public void ThenTaskSettingsAre(Table table)
{
    ScenarioContext.Current.Pending();
}
...
public void ThenPasswordIs(string p0)
{
    ScenarioContext.Current.Pending();
        ...
        [Then(@"username is as ""(.*)""")]
public void ThenUsernameIsAs(string p0)
{
    ScenarioContext.Current.Pending();
}

        [Then(@"Password is as ""(.*)""")]
public void ThenPasswordIsAs(string p0)
{
    ScenarioContext.Current.Pending();
}
