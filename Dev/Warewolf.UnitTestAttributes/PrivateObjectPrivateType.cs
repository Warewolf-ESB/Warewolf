    ...
    public class PrivateObject
    {
        ...
        public PrivateObject(Type type, Type[] parameterTypes, object[] args)
        {
            ...
            if (parameterTypes != null)
            {
                ...
                {
                    System.Diagnostics.Debug.Assert(e.InnerException != null, "Inner exception should not be null.");
        ...
        private Dictionary<string, LinkedList<MethodInfo>> GenericMethodCache
        {
            get
            {
                ...
                System.Diagnostics.Debug.Assert(this.methodCache != null, "Invalid method cache for type.");
        ...
        {
            System.Diagnostics.Debug.Assert(this.target != null, "target should not be null.");
        ...
        {
            System.Diagnostics.Debug.Assert(this.target != null, "Internal Error: Null reference is returned for internal object");
        ...
        {
            System.Diagnostics.Debug.Assert(t != null, "type should not be null.");
            ...
            foreach (MethodInfo member in members)
            {
                if (member.IsGenericMethod || member.IsGenericMethodDefinition)
                {
                    ...
                    System.Diagnostics.Debug.Assert(listByName != null, "list should not be null.");
        ...
        {
            System.Diagnostics.Debug.Assert(!string.IsNullOrEmpty(methodName), "Invalid method name.");
            System.Diagnostics.Debug.Assert(parameterTypes != null, "Invalid parameter type array.");
            System.Diagnostics.Debug.Assert(typeArguments != null, "Invalid type arguments array.");
        ...
        {
            System.Diagnostics.Debug.Assert(!string.IsNullOrEmpty(methodName), "methodName should not be null.");
            System.Diagnostics.Debug.Assert(parameterTypes != null, "parameterTypes should not be null.");
            System.Diagnostics.Debug.Assert(typeArguments != null, "typeArguments should not be null.");
            ...
            System.Diagnostics.Debug.Assert(methods != null, "methods should not be null.");
