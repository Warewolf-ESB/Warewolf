...
namespace Microsoft.Win32.TaskScheduler
{
    ...
    public partial class TaskPropertiesControl : UserControl
    {
        ...
        public TaskPropertiesControl()
        {
            ...
            taskMaintenancePeriodCombo.Items.AddRange(new[] { TimeSpan2.Zero, TimeSpan2.FromMinutes(1), TimeSpan2.FromMinutes(15), TimeSpan2.FromHours(1), TimeSpan2.FromHours(12), TimeSpan2.FromDays(1), TimeSpan2.FromDays(7) });
        ...
        public TaskDefinition TaskDefinition
        {
            ...
            private set
            {
                ...
                flagUserIsAnAdmin = NativeMethods.AccountUtils.CurrentUserIsAdmin(service.TargetServer);
                //this.flagExecutorIsCurrentUser = this.UserIsExecutor(td.Principal.UserId);
                flagExecutorIsServiceAccount = NativeMethods.AccountUtils.UserIsServiceAccount(service.UserName);
                ...
                {
                    taskAuthorText.Text = string.IsNullOrEmpty(td.RegistrationInfo.Author) ? windowsIdentity.Name : td.RegistrationInfo.Author;
                }
        ...
        {
            if((actionListView.SelectedIndices.Count == 1) && (actionListView.SelectedIndices[0] != (actionListView.Items.Count - 1)))
            {
        ...
        {
            if((actionListView.SelectedIndices.Count == 1) && (actionListView.SelectedIndices[0] != 0))
            {
                int index = actionListView.SelectedIndices[0];
                actionListView.BeginUpdate();
                ListViewItem lvi = actionListView.Items[index];
        ...
        private void tabControl_TabIndexChanged(object sender, EventArgs e)
        {
            ...
            if(tabControl.SelectedTab == historyTab)
                taskHistoryControl1.Activate(task);
        }
