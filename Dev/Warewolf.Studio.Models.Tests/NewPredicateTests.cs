...
{
    [TestClass]
    public class NewPredicateTests
    {
        [TestMethod]
        [Owner("Leon Rajindrapersadh")]
        [TestCategory("NewForDeployPredicate_Predicate")]
        // ReSharper disable InconsistentNaming
        public void NewForDeployPredicate_Predicate_SingleExists_ExpectNoNew()

        {
            //------------Setup for test--------------------------
            var pred = new NewForDeployPredicate();
        ...
        [TestCategory("NewForDeployPredicate_Predicate")]
        // ReSharper disable InconsistentNaming
        public void NewForDeployPredicate_Predicate_SingleNotExists_ExpectOneNew()
        {
            //------------Setup for test--------------------------
            var pred = new NewForDeployPredicate();
        ...
        [TestCategory("NewForDeployPredicate_Predicate")]
        // ReSharper disable InconsistentNaming
        public void NewForDeployPredicate_Predicate_SingleNotExists_NotChecked_ExpectNoNew()
        {
            //------------Setup for test--------------------------
            var pred = new NewForDeployPredicate();
        ...
        [TestMethod]
        [Owner("Leon Rajindrapersadh")]
        [TestCategory("NewForDeployPredicate_Ctor")]
        // ReSharper disable InconsistentNaming
        public void NewForDeployPredicate_Predicate_Ctor()  
        {
            //------------Setup for test--------------------------
            var pred = new NewForDeployPredicate();
            Assert.AreEqual( "New Resources",pred.Name);
        }
