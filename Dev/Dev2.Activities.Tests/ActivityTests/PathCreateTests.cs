...
namespace Dev2.Tests.Activities.ActivityTests
{
    ...
    public class PathCreateTests : BaseActivityUnitTest
    {
        ...
        [TestMethod]
        [Owner("Njabulo Nxele")]
        [TestCategory("DsfPathCreate_Credentials")]
        public void DsfPathCreate_TryExecuteConcreteAction_Credential_Variable()
        {
            ...
            var act = new TestDsfPathCreate { OutputPath = outputPath, Result = "CompanyName" };
            act.Username = "[[val1]]";
    ...
    internal class TestDsfPathCreate : DsfPathCreate
    {
