...
namespace ActivityUnitTests.ActivityTests
{
    ...
    public class PathMoveTests : BaseActivityUnitTest
    {
        ...
        {
            DsfPathMove act = new DsfPathMove { InputPath = "[[CompanyName]]", OutputPath = "[[CompanyName]]", Result = "[[CompanyName]]" };
        ...
        // ReSharper restore InconsistentNaming
        {
            DsfPathMove act = new DsfPathMove { InputPath = "[[Numeric(*).num]]", OutputPath = "[[Numeric(*).num]]", Result = "[[CompanyName]]" };
