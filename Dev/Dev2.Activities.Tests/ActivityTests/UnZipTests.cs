...
namespace ActivityUnitTests.ActivityTests
{
    ...
    public class UnZipTests : BaseActivityUnitTest
    {
        ...
        {
            DsfUnZip act = new DsfUnZip { InputPath = "[[CompanyName]]", OutputPath = "[[CompanyName]]", Result = "[[CompanyName]]" };
        ...
        // ReSharper restore InconsistentNaming
        {
            DsfUnZip act = new DsfUnZip { InputPath = "[[Numeric(*).num]]", OutputPath = "[[Numeric(*).num]]", Result = "[[CompanyName]]" };
            IList<IDebugItem> inRes;
            IList<IDebugItem> outRes;
