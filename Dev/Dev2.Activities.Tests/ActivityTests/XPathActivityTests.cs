...
namespace Dev2.Tests.Activities.ActivityTests
{
    ...
    {
        List<XPathDTO> _resultsCollection = new List<XPathDTO>();
        ...
        void SetupArguments(string currentDL, string testData, string sourceString, List<XPathDTO> resultCollection)
        {
