...
namespace Dev2.Tests.Activities.ActivityTests.Web
{
    ...
    public class DsfWebPuttActivityTests
    {
        ...
        public void DsfWebPutActivity_Execute_ErrorResponse_ShouldSetVariables()
        {
            ...
            var dependency = new Depends(Depends.ContainerType.WebApi);
        ...
        [Owner("Siphamandla Dube")]
        [TestCategory(nameof(DsfWebPutActivity))]
        public void DsfWebPutActivity_ExecutionImpl_ResponseManager_PushResponseIntoEnvironment_GivenJsonResponse_MappedToRecodSet_ShouldSucess()
        {
            //-----------------------Arrange-------------------------
