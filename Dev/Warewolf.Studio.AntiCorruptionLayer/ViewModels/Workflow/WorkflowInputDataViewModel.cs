...
using Warewolf.Studio.AntiCorruptionLayer.ViewModels.Workflow;

// ReSharper disable CheckNamespace
namespace Dev2.Studio.ViewModels.Workflow
// ReSharper restore CheckNamespace
{
    public class WorkflowInputDataViewModel : BindableBase
    {
        #region Fields
        ...
        void RequestClose(ViewModelDialogResults cancel)
        {
        }
...
//            }
        ...
        protected void OnViewAttached(object view, object context)
        {
            LoadWorkflowInputs();
        }
