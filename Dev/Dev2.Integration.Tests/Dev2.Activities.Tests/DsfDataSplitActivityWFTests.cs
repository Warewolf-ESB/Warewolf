...
namespace Dev2.Integration.Tests.Dev2.Activities.Tests
{
    ...
    // ReSharper restore InconsistentNaming
    {
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "INTEGRATION TEST SERVICES/DataSplitTestWithRecordsetUsingStar");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "INTEGRATION TEST SERVICES/DataSplitTestWithRecordsetWithIndex");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "INTEGRATION TEST SERVICES/DataSplitTestWithRecordsetsWithNoIndexes");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "INTEGRATION TEST SERVICES/DataSplitTestAppendingToDifferentRecordsets");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "INTEGRATION TEST SERVICES/DataSplitTestWithScalar");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "INTEGRATION TEST SERVICES/DataSplitAllDifferentTypesOfSplits");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "INTEGRATION TEST SERVICES/DataSplitVariableInSource");
