...
// ReSharper restore InconsistentNaming
    {
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "DataSplitTestWithRecordsetUsingStar");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "DataSplitTestWithRecordsetWithIndex");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "DataSplitTestWithRecordsetsWithNoIndexes");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "DataSplitTestAppendingToDifferentRecordsets");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "DataSplitTestWithScalar");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "DataSplitAllDifferentTypesOfSplits");
        ...
        {
            string postData = String.Format("{0}{1}", _webserverUri, "DataSplitVariableInSource");
