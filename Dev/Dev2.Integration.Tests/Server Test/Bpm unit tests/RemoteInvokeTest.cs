...
namespace Dev2.Integration.Tests.Dev2.Application.Server.Tests.Bpm_unit_tests
{
    ...
    public class RemoteInvokeTest
    {
        ...
        public void CanInvokeARemoteService()
        {
            ...
            const string expected = @"</remoteResult><localResult>6</localResult><dbo_spGetCountries rowID=""1""><CountryID>11</CountryID><Description>Bahrain</Description></dbo_spGetCountries><dbo_spGetCountries rowID=""2""><CountryID>12</CountryID><Description>Bangladesh</Description></dbo_spGetCountries><dbo_spGetCountries rowID=""3""><CountryID>13</CountryID><Description>Barbados</Description></dbo_spGetCountries><dbo_spGetCountries rowID=""4""><CountryID>14</CountryID><Description>Belarus</Description></dbo_spGetCountries><dbo_spGetCountries rowID=""5""><CountryID>15</CountryID><Description>Belgium</Description></dbo_spGetCountries><dbo_spGetCountries rowID=""6""><CountryID>16</CountryID><Description>Belize</Description></dbo_spGetCountries><dbo_spGetCountries rowID=""7""><CountryID>17</CountryID><Description>Benin</Description></dbo_spGetCountries><dbo_spGetCountries rowID=""8""><CountryID>18</CountryID><Description>Bhutan</Description></dbo_spGetCountries><dbo_spGetCountries rowID=""9""><CountryID>19</CountryID><Description>Bolivia</Description></dbo_spGetCountries><dbo_spGetCountries rowID=""10""><CountryID>20</CountryID><Description>Bosnia and Herzegovina</Description></dbo_spGetCountries><dbo_spGetCountries rowID=""11""><CountryID>21</CountryID><Description>Brazil</Description></dbo_spGetCountries><dbo_spGetCountries rowID=""12""><CountryID>22</CountryID><Description>Brunei</Description></dbo_spGetCountries><dbo_spGetCountries rowID=""13""><CountryID>23</CountryID><Description>Bulgaria</Description></dbo_spGetCountries></DataList>";
