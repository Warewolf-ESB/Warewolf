...
{
    /// <summary>
    /// Summary description for XmlInputsOnlyTranslatorTest
    /// </summary>
    [TestClass]
    public class XmlInputsOnlyTranslatorTest
    {
        /// <summary>
        ...
        public void DataListXMLTranslatorWithOutSystemTags_ConvertAndOnlyMapInputs_WhenCallingNormally_ExpectNotImplementedException()
        {
            ...
            //------------Execute Test---------------------------
            compiler.ConvertAndOnlyMapInputs(DataListFormat.CreateFormat(GlobalConstants._XML_Inputs_Only), new StringBuilder(), new StringBuilder(), out errors);
