...
{
    public class ServerProxyWithChunking :  IEnvironmentConnection
    {
        ...
        public ServerProxyWithChunking(Uri serverUri)
        ...
        public ServerProxyWithChunking(string webAddress, string userName, string password)
