...
namespace Dev2.Studio.Core
{
    public static class ResourceHelper
    {
        ...
        {
            return string.Format("{0}{1}", Warewolf.Studio.Resources.Languages.Core.Uri_Application_Image_Website, imageUri);
        }
...
";
        ...
        public static string GetIconPath(IContextualResourceModel resource)
        {
            ...
            if(string.IsNullOrEmpty(resource.UnitTestTargetWorkflowService))
            {
                ...
                else if (!resource.IconPath.Contains(Warewolf.Studio.Resources.Languages.Core.Pack_Uri_Application_Image))
                {
