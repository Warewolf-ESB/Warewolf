...
namespace Dev2.Studio.Core.Models
{
    public class EnvironmentModel : IEnvironmentModel
    {
        ...
        public EnvironmentModel(IEnvironmentConnection environmentConnection, IEventAggregator eventAggregator)
        {
        ...
        public Uri DsfAddress
        {
            get
            {
                if(Connection != null)
                {
                    return Connection.AppServerUri;
                }
                return null;
            }
            set
        ...
        public void Connect(IEnvironmentModel model)
        {
            ...
            if(Connection is WrappedEnvironmentConnection)
            {
                Connection.Connect();
            }
            else
            {
                Connection = new WrappedEnvironmentConnection(model);
                Connection.Connect();
            }
        }
        ...
        private void OnConnectionLoginStateChanged(object sender, LoginStateEventArgs e)
        {
            ...
            //
            WrappedEnvironmentConnection connection = Connection as WrappedEnvironmentConnection;
            if(connection != null && connection.IsAuxiliary)
            {
                return;
            }
        ...
        private sealed class WrappedEnvironmentConnection : IEnvironmentConnection
        {
            ...
            public WrappedEnvironmentConnection(IEnvironmentModel underlying)
            {
                ...
                AppServerUri = underlying.Connection.AppServerUri;
                Alias = underlying.Connection.Alias;
                DisplayName = underlying.Connection.DisplayName;
                SecurityContext = underlying.Connection.SecurityContext;
            }
            ...
            public void Connect()
            {
                ...
                AppServerUri = _underlying.Connection.AppServerUri;
