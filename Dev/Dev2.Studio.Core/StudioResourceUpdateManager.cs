...
namespace Dev2.Studio.Core
{
    public class StudioResourceUpdateManager : IStudioUpdateManager
    {
        ...
        public void TestConnection(IElasticsearchServiceSource elasticServiceSource) => UpdateManagerProxy.TestConnection(elasticServiceSource);
        ...
        public void Save(IElasticsearchServiceSource elasticsearchServiceSource) => UpdateManagerProxy.SaveElasticsearchServiceSource(elasticsearchServiceSource, GlobalConstants.ServerWorkspaceID);
