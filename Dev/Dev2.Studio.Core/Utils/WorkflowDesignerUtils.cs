...
namespace Dev2.Utils
{
    ...
    public class WorkflowDesignerUtils
    {
        ...
        public static void ShowExampleWorkflow(string activityName, IEnvironmentModel environment, IPopupController popupController)
        {
            ...
            if(resource == null)
            {
                if(popupController == null)
                {
                    var message =
                        string.Format(
                            Resources.Languages.Core.ExampleWorkflowNotFound,
                ...
                else
                {
                    ...
                    popupController.Description = string.Format(Resources.Languages.Core.ExampleWorkflowNotFound, resourceID);
        ...
        {
            var exampleIDString = Resources.Languages.ExampleResource
                .ResourceManager
        ...
        {
            return Resources.Languages.ExampleResourceNames
                .ResourceManager
                .GetString(activityName);
        }
    }
