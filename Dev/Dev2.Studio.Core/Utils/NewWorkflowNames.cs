...
namespace Dev2.Studio.Core.Utils
{
    ...
    public class NewWorkflowNames
    {
        ...
        {
            string newWorkflowBaseName = Warewolf.Studio.Resources.Languages.Core.NewWorkflowBaseName;

            int counter = 1;
            string fullName = Warewolf.Studio.Resources.Languages.Core.NewWorkflowBaseName + " " + counter;
        ...
        public bool Add(string newWorkflowName)
        {
            ...
            if (newWorkflowName.IndexOf(Warewolf.Studio.Resources.Languages.Core.NewWorkflowBaseName, StringComparison.Ordinal) == 0)
            {
