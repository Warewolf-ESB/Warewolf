...
namespace Dev2.Security
{
    public class ClientAuthorizationService : AuthorizationServiceBase
    {
        ...
        public override bool IsAuthorized(Common.Interfaces.Enums.AuthorizationContext context, Guid resourceId)
        {
            var x =IsAuthorized(_environmentConnection.Principal, context, resourceId);
            return x;
        }

        public override bool IsAuthorized(Common.Interfaces.Enums.AuthorizationContext context, IWarewolfResource resource)
        {
