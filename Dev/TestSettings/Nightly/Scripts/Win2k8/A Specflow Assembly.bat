...
"C:\Program Files (Workgroup)\Microsoft Visual Studio 11.0\Common7\IDE\MSTest.exe" /testcontainer:"%CD%\%assembly%\bin\Debug\%assembly%.dll" /testSettings:"SpecFlow.testsettings"
