...
namespace Dev2.Runtime.ESB.Management.Services
{
    public class FetchExchangeSources : IEsbManagementEndpoint
    {
        ...
        public StringBuilder Execute(Dictionary<string, StringBuilder> values, IWorkspace theWorkspace)
        {
            ...
            List<ExchangeSourceDefinition> list = Resources.GetResourceList(GlobalConstants.ServerWorkspaceID).Where(a => a.ResourceType == ResourceType.ExchangeSource).Select(a =>
            {
