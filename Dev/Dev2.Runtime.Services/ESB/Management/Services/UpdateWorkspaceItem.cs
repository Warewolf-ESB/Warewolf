...
namespace Dev2.Runtime.ESB.Management.Services
{
    ...
    public class UpdateWorkspaceItem : IEsbManagementEndpoint
    {
        ...
        {
            var workspaceItemService = new DynamicService { Name = HandlesType(), DataListSpecification = "<DataList><ItemXml/><Roles/><Dev2System.ManagmentServicePayload ColumnIODirection=\"Both\"></Dev2System.ManagmentServicePayload></DataList>" };
