...
namespace Dev2.Runtime.ESB.Management.Services
{
    public class GetVersion : DefaultEsbManagementEndpoint
    {
        ...
        {
            get => _serverExplorerRepository ?? new ServerVersionRepository(new VersionStrategy(), Hosting.ResourceCatalog.Instance, new DirectoryWrapper(), EnvironmentVariables.GetWorkspacePath(GlobalConstants.ServerWorkspaceID), new FileWrapper(), new PathWrapper());
