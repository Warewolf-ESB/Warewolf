...
{
    public class GetPersistenceSettings : DefaultEsbManagementEndpoint
    {
        public override StringBuilder Execute(Dictionary<string, StringBuilder> values, IWorkspace theWorkspace)
        {
            ...
            var settings = Config.Persistence.Get();
        ...
        public override string HandlesType() => nameof(Warewolf.Service.GetPersistenceSettings);
    }
}