...
namespace Dev2.Runtime.ESB.Management.Services
{
    public class DeleteScheduledResource : IEsbManagementEndpoint
    {
        ...
        public StringBuilder Execute(Dictionary<string, StringBuilder> values, IWorkspace theWorkspace)
        {
            ...
            Dev2Logger.Info("Delete Scheduled Resource Service", "Warewolf Info");
            StringBuilder tmp;
            ...
            if (tmp != null)
            {
                ...
                Dev2Logger.Info("Delete Scheduled Resource Service." + res, "Warewolf Info");
            ...
            {
                Dev2Logger.Info("Delete Scheduled Resource Service. No Resource Selected", "Warewolf Info");
