...
namespace Dev2.Runtime.Configuration
{
    ...
    public class SettingsProvider
    {
        ...
        private static string GetAssemblyHashCode()
        {
            byte[] assemblyBytes = GetAssemblyBytes();

            SHA256 hashAlgorithm = SHA256.Create();
            byte[] hash = hashAlgorithm.ComputeHash(assemblyBytes);
        ...
        {
            Assembly assembly = Assembly.GetAssembly(typeof (IConfigurationAssemblyMarker));
        ...
        private Settings.Configuration ReadConfiguration()
        {
        ...
        //
        private static volatile SettingsProvider _instance;
