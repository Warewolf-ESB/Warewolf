...
namespace Dev2.Runtime.Security
{
    ...
    public class RSAKey
    {
        ...
        public RSAKey(ICspAsymmetricAlgorithm csp)
        {
            ...
            byte[] publicKey = csp.ExportCspBlob(false);
            byte[] privateKey = csp.ExportCspBlob(true);
        ...
        ///     If <c>true</c> uses the <see cref="Private" /> key; otherwise uses the <see cref="Public" />
        ///     key.
        /// </param>
        /// <returns>
        ...
        {
            byte[] cspBlob = Convert.FromBase64String(usePrivate ? Private : Public);
