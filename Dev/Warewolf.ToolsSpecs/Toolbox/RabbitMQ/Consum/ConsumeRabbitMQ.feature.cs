...
#line hidden
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "ConsumeRabbitMQ", "In order to consume a message from a queue\r\nAs a Warewolf user\r\nI want a tool tha" +
                    "t performs this action", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void TestInitialize()
        {
            if (((TechTalk.SpecFlow.FeatureContext.Current != null) 
                        && (TechTalk.SpecFlow.FeatureContext.Current.FeatureInfo.Title != "ConsumeRabbitMQ")))
            {
                Warewolf.ToolsSpecs.Toolbox.RabbitMQ.Consum.ConsumeRabbitMQFeature.FeatureSetup(null);
            }
        }
