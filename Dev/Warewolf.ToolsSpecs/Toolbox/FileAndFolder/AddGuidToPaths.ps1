...
"$FileAndFolderSpecsDir\Copy\Copy.feature.cs", "$FileAndFolderSpecsDir\Move\Move.feature.cs", "$FileAndFolderSpecsDir\Zip\Zip.feature.cs", "$FileAndFolderSpecsDir\Unzip\Unzip.feature.cs" |
    Foreach-Object {
        $PreviousLine = ""
        (Get-Content $_) | 
            Foreach-Object {
