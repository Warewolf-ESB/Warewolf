...
"$FileAndFolderSpecsDir\Copy\Copy.feature.cs", "$FileAndFolderSpecsDir\Move\Move.feature.cs", "$FileAndFolderSpecsDir\Zip\Zip.feature.cs", "$FileAndFolderSpecsDir\Rename\Rename.feature.cs" |
    Foreach-Object {
        $PreviousLine = ""
        (Get-Content $_) | 
            Foreach-Object {
