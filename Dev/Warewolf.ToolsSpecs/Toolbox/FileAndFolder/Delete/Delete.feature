...
Scenario Outline: Delete file at location Null
	...
	| UNC			| [[path]]	| \\\\RSAKLFSVRSBSPDC\FileSystemShareTestingSite\Memo.txt					| ""							| ""       | [[result]] | Success	| NO           |						|
	...
	| FTP			| [[path]]	| ftp://rsaklfsvrsbspdc:1001/FORTESTING/filetodelete.xtx					| ""							| ""       | [[result]] | 			| NO           |						|
	| FTPS			| [[path]]	| ftp://rsaklfsvrsbspdc:1002/FORTESTING/filetodelet.txt						| IntegrationTester				| I73573r0 | [[result]] | 			| NO           |						|
	| SFTP			| [[path]]	| sftp://localhost/Memo.txt													| dev2.local					| Q/ulw&]  | [[result]] | 			| AN           |						|
...
Scenario Outline: Delete file Validation
	...
	And the debug output as
		...
		| <resultVar> = <result> |
	Examples: 
		| No | File or Folder                 | Val1                                           | Val2               | sourceLocation                                                          | username              | resultVar  | result  | errorOccured | ValidationResult | DesignValidation                                                         | OutputError                                                                | sourcePrivateKeyFile |
		...
		| 6  | [[rec(1).a]]                   | c:\filetodelete13.txt                          |                    | c:\filetodelete13.txt                                                   | ""                    | [[result]] | Success | NO           | False            | ""                                                                       | ""                                                                         |                      |
		...
		| 16 | [[a]]                          | C:\copyfile0.txt                               |                    | C:\copyfile0.txt                                                        | ""                    | [[result]] | Success | NO           | False            | ""                                                                       | ""                                                                         |                      |
		| 17 | [[a]]                          | C:\filetodelete16.txt                          | filetodelete16.txt | C:\filetodelete16.txt                                                   | ""                    | [[result]] | Success | NO           | False            | ""                                                                       | ""                                                                         |                      |
		| 18 | [[a&]]                         |                                                |                    |                                                                         | user1                 | [[result]] | ""      | AN           | True             | File or Folder - Variable name [[a&]] contains invalid character(s)      | 1.File or Folder - Variable name [[a&]] contains invalid character(s)      |                      |
		...
		| 21 | [[a]]                          | C:\\\\\gvh                                     |                    | C:\\\\\gvh                                                              | ""                    | [[result]] | Failure | NO           | False            | ""                                                                       | ""                                                                         |                      |
		...
		| 24 | [[sourcePath]]                 |                                                |                    | c:\filetodelete1.txt                                                    | [[$#]]                | [[result]] | Failure | AN           | True             | Username - Variable name [[$#]] contains invalid character(s)            | 1.Username - Variable name [[$#]] contains invalid character(s)            |                      |
		...
		| 29 | [[sourcePath]]                 |                                                |                    | c:\filetodelete1.txt                                                    | ""                    | ""         | Success      | AN           | True             | The result field only allows a single result                             | 1.The result field only allows a single result                             |                      |
		...
		| 33 | [[sourcePath]]                 |                                                |                    | c:\filetodelete3.txt                                                    | ""                    | [[var@]]               | ""      | AN           | True             | Result - Variable name [[var@]] contains invalid character(s)                                                                 | 1.Result - Variable name [[var@]] contains invalid character(s)                                                                  |                      |
