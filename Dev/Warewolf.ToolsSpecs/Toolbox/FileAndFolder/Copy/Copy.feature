...
Scenario Outline: Copy file at location
	...
	Examples: 
		 ...
		 | 8  | [[sourcePath]] | \\\\RSAKLFSVRPDC\FileSystemShareTestingSite\copyfile1.txt | ""                | ""       | [[destPath]] | ftp://rsaklfsvrpdc:1001/FORTESTING/copied1.txt          | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 9  | [[sourcePath]] | \\\\RSAKLFSVRPDC\FileSystemShareTestingSite\copyfile2.txt | ""                | ""       | [[destPath]] | ftp://rsaklfsvrpdc:1002/FORTESTING/copied1.txt          | integrationtester | I73573r0     | True     | [[result]] | "Success" | NO           | "C:\\Temp\\key.opk"  |                           |
		 ...
		 | 13 | [[sourcePath]] | ftp://rsaklfsvrpdc:1001/FORTESTING/copyfile1.txt          | ""                | ""       | [[destPath]] | \\\\RSAKLFSVRPDC\FileSystemShareTestingSite\copied2.txt | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
		 ...
		 | 15 | [[sourcePath]] | ftp://rsaklfsvrpdc:1001/FORTESTING/copyfile3.txt          | ""                | ""       | [[destPath]] | sftp://rsaklfsvrgendev/copied2.txt                               | dev2              | Q/ulw&]      | True     | [[result]] | "Success" | NO           |                      |                           |
		 ...
		 | 18 | [[sourcePath]] | ftp://rsaklfsvrpdc:1002/FORTESTING/copyfile1.txt          | integrationtester | I73573r0 | [[destPath]] | \\\\RSAKLFSVRPDC\FileSystemShareTestingSite\copied3.txt | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
		 ...
		 | 21 | [[sourcePath]] | ftp://rsaklfsvrpdc:1002/FORTESTING/copyfile4.txt          | integrationtester | I73573r0 | [[destPath]] | sftp://rsaklfsvrgendev/copied3.txt                               | dev2              | Q/ulw&]      | True     | [[result]] | "Success" | NO           |                      |                           |
		 ...
		 | 24 | [[sourcePath]] | sftp://rsaklfsvrgendev/copyfile2.txt                      | dev2              | Q/ulw&]  | [[destPath]] | ftp://rsaklfsvrpdc:1001/FORTESTING/copied4.txt          | ""                | ""           | True     | [[result]] | "Success" | NO           |                      |                           |
		 | 25 | [[sourcePath]] | sftp://rsaklfsvrgendev/copyfile3.txt                      | dev2              | Q/ulw&]  | [[destPath]] | ftp://rsaklfsvrpdc:1002/FORTESTING/copied4.txt          | integrationtester | I73573r0     | True     | [[result]] | "Success" | NO           |                      |                           |
