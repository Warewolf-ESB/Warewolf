...
Scenario Outline: Create file at location
	...
	Examples: 
		...
		| 6  | SFTP       | [[path]]    | sftp://rsaklfsvrsbspdc/test.txt                                      | True     | dev2                         | Q/ulw&]  | [[result]] | Success | NO           |                           |
		| 7  | SFTP       | [[path]]    | sftp://rsaklfsvrsbspdc/test1.txt                                     | True     | dev2                         | Q/ulw&]  | [[result]] | Success | NO           | C:\\Temp\\key.opk         |
...
Scenario Outline: Create file at location Nulls
	...
	Examples: 
		...
		| 3  | SFTP       | [[path]]    | sftp://rsaklfsvrsbspdc/test1.txt                                    | True     | ""                            | Q/ulw&]  | [[result]] | Failure | AN           | C:\\Temp\                 |
