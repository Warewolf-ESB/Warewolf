...
Scenario Outline: Create file at location
	...
	Examples: 
		...
		| 2  | UNC        | [[path]]    | \\\\RSAKLFSVRGENDEV\FileSystemShareTestingSite\test.txt        | True     | ""                           | ""       | [[result]] | Success | NO           |                           |
		| 3  | UNC Secure | [[path]]    | \\\\RSAKLFSVRGENDEV\FileSystemShareTestingSite\Secure\test.txt | True     | dev2.local\IntegrationTester | I73573r0 | [[result]] | Success | NO           |                           |
		| 4  | FTP        | [[path]]    | ftp://RSAKLFSVRGENDEV:1001/FORTESTING/test.txt                 | True     | ""                           | ""       | [[result]] | Success | NO           |                           |
		| 5  | FTPS       | [[path]]    | ftp://RSAKLFSVRGENDEV:1002/FORTESTING/test.txt                 | True     | IntegrationTester            | I73573r0 | [[result]] | Success | NO           |                           |
...
Scenario Outline: Create file at location Nulls
	...
	Examples: 
		...
		| 5  | UNC Secure | [[path]]    | \\\\RSAKLFSVRGENDEV\FileSystemShareTestingSite\Secure\test.tx | True     | dev2.local\IntegrationTesteru | I73573r0 | [[result]] | Failure | AN           |                           |
