...
class AssemblyRef
{
	public const string BaseResourceName = "Infragistics.Windows.Design.OutlookBar.strings;Infragistics.Windows.Design.OutlookBar.AdornerStrings.strings";
...
#region Infragistics Source Cleanup (Region)
    ...
    internal const string AssemblyName = "InfragisticsWPF4.OutlookBar.v" + AssemblyVersion.MajorMinor + ".Design.VS2012";
    ...
    internal const string AssemblyDescriptionBase = "OutlookBar Component for WPF - Design Assembly";
