...
class AssemblyRef
{
	public const string BaseResourceName = "Infragistics.Controls.Schedules.Design.strings";
...
#region Infragistics Source Cleanup (Region)
	...
	internal const string AssemblyName = "InfragisticsWPF4.Controls.SchedulesExchangeConnector.v" + AssemblyVersion.MajorMinor + ".Design.VS2012";



	internal const string AssemblyDescriptionBase = "ExchangeConnector Component for WPF - Design Assembly";
