...
{
    /// <summary>
    /// A read-only collection of <see cref="FieldLayoutGroupByInfo"/>s for use in the <see cref="GroupByAreaMulti"/>.
    /// </summary>
    ...
    public class FieldLayoutGroupByInfoCollection : ReadOnlyObservableCollection<FieldLayoutGroupByInfo>
    {
        private ObservableCollection<FieldLayoutGroupByInfo> _list;

        #region Constructor

        internal FieldLayoutGroupByInfoCollection(ObservableCollection<FieldLayoutGroupByInfo> list) : base(list)
        {
            this._list = list;
        }
