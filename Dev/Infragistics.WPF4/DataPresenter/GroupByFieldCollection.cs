...
{
    /// <summary>
    /// A read-only collection of all <see cref="Field"/>s that a specific <see cref="FieldLayout"/> is grouped by.
    /// </summary>
    ...
    public class GroupByFieldCollection : ReadOnlyObservableCollection<Field>
    {
        private ObservableCollection<Field> _list;

        #region Constructor

        internal GroupByFieldCollection(ObservableCollection<Field> list) : base(list)
        {
            this._list = list;
        }
