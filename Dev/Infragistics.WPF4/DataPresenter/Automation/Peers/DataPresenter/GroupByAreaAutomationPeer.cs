...
{
	/// <summary>
	/// Exposes <see cref="GroupByArea"/> types to UI Automation
	/// </summary>
    public class GroupByAreaAutomationPeer : GroupByAreaBaseAutomationPeer
	{
		#region Constructor
		/// <summary>
		/// Creates a new instance of the <see cref="GroupByAreaAutomationPeer"/> class
		/// </summary>
		/// <param name="owner">The <see cref="GroupByArea"/> for which the peer is being created</param>
		public GroupByAreaAutomationPeer(GroupByArea owner)
			: base(owner)
		{
		}
		...
		/// <summary>
		/// Returns the name of the <see cref="GroupByArea"/>
		/// </summary>
		/// <returns>A string that contains 'GroupByArea'</returns>
