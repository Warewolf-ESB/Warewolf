...
//       below.
//-----------------------------------------------------------------
namespace Infragistics.Windows.DataPresenter // change this line only to the unigue namespace of this assembly
{
	/// <summary>
...
#pragma warning restore 436
		...
		/// <summary>
        /// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource used in the filter drop down as the default for loading indicator string that appears at the bottom of the drop down./>
        /// </summary>
        public static DynamicResourceString FilterDropDownLoadingIndicator
        {
			get { return GetDynamicResourceString("FilterDropDownLoadingIndicator"); }
        }
		...
		/// <summary>
		/// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource used for the tooltip of the Collapse Card button in the <see cref="CardHeaderPresenter"/>./>
		/// </summary>
		public static DynamicResourceString CollapseCardToolTip
		{
			get { return GetDynamicResourceString("CardHeaderPresenter_CollapseCardToolTip"); }
		}

		/// <summary>
		/// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource used for the tooltip of the Collapse Card button in the <see cref="CardHeaderPresenter"/>./>
		/// </summary>
		public static DynamicResourceString UnCollapseCardToolTip
		{
			get { return GetDynamicResourceString("CardHeaderPresenter_UnCollapseCardToolTip"); }
		}

		/// <summary>
		/// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource used for the tooltip of the Collapse Empty Cells button in the <see cref="CardHeaderPresenter"/>./>
		/// </summary>
		public static DynamicResourceString CollapseEmptyCellsToolTip
		{
			get { return GetDynamicResourceString("CardHeaderPresenter_CollapseEmptyCellsToolTip"); }
		}

		/// <summary>
		/// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource used for the tooltip of the Collapse Empty Cells button in the <see cref="CardHeaderPresenter"/>./>
		/// </summary>
		public static DynamicResourceString UnCollapseEmptyCellsToolTip
		{
			get { return GetDynamicResourceString("CardHeaderPresenter_UnCollapseEmptyCellsToolTip"); }
		}

		// AS 3/3/11 NA 2011.1 - Async Exporting
		/// <summary>
		/// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource used for status of the <see cref="RecordExportStatusControl"/> when the <see cref="RecordExportStatusControl.Status"/> is 'Exporting'.
		/// </summary>
		[InfragisticsFeature(Version = FeatureInfo.Version_11_1, FeatureName = FeatureInfo.FeatureName_WordWriter)]
		public static DynamicResourceString ExportStatusExportingMessage
		{
			get { return GetDynamicResourceString("RecordExportStatus_Message_Exporting"); }
		}

		/// <summary>
		/// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource used for status of the <see cref="RecordExportStatusControl"/> when the <see cref="RecordExportStatusControl.Status"/> is 'Pending'.
		/// </summary>
		[InfragisticsFeature(Version = FeatureInfo.Version_11_1, FeatureName = FeatureInfo.FeatureName_WordWriter)]
		public static DynamicResourceString ExportStatusPendingMessage
		{
			get { return GetDynamicResourceString("RecordExportStatus_Message_Pending"); }
		}

		/// <summary>
		/// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource used for status of the <see cref="RecordExportStatusControl"/> when the <see cref="RecordExportStatusControl.Status"/> is 'Initializing'.
		/// </summary>
		[InfragisticsFeature(Version = FeatureInfo.Version_11_1, FeatureName = FeatureInfo.FeatureName_WordWriter)]
		public static DynamicResourceString ExportStatusInitializingMessage
		{
			get { return GetDynamicResourceString("RecordExportStatus_Message_Initializing"); }
		}

		/// <summary>
		/// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource used for 'Cancel Export' button in the <see cref="RecordExportStatusControl"/>
		/// </summary>
		[InfragisticsFeature(Version = FeatureInfo.Version_11_1, FeatureName = FeatureInfo.FeatureName_WordWriter)]
		public static DynamicResourceString CancelExportToolTip
		{
			get { return GetDynamicResourceString("RecordExportStatus_CancelExportToolTip"); }
		}

		/// <summary>
		/// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource used in the <see cref="RecordFilterTreeControl"/> when the entered search does not result in any matching items.
		/// </summary>
		[InfragisticsFeature(Version = FeatureInfo.Version_11_1, FeatureName = FeatureInfo.FeatureName_WordWriter)]
		public static DynamicResourceString RecordFilterTreeNoSearchMatches
		{
			get { return GetDynamicResourceString("RecordFilterTreeNoSearchMatches"); }
		}

        /// <summary>
        /// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource used in the custom filter dialog for the caption of the OK button.
        /// </summary>
        [InfragisticsFeature(Version = FeatureInfo.Version_11_1, FeatureName = FeatureInfo.FeatureName_WordWriter)]
        public static DynamicResourceString CustomFilterSelectionControlOkButtonLabel
        {
            get { return GetDynamicResourceString("CustomFilterSelectionControl_OkButtonLabelProperty"); }
        }

        /// <summary>
        /// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource used in the custom filter dialog for the caption of the Cancel button.
        /// </summary>
        [InfragisticsFeature(Version = FeatureInfo.Version_11_1, FeatureName = FeatureInfo.FeatureName_WordWriter)]
        public static DynamicResourceString CustomFilterSelectionControlCancelButtonLabel
        {
            get { return GetDynamicResourceString("CustomFilterSelectionControl_CancelButtonLabelProperty"); }
        }
