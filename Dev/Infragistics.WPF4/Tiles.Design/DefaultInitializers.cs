...
using Infragistics.Windows.Design;
using Microsoft.Windows.Design.Metadata;

namespace Infragistics.Windows.VisualStudio.Design.Tiles
{
    #region XamTilesControlDefaultInitializer Class

    /// <summary>
    /// Provides default values for various XamTilesControl properties.
    /// </summary>
    public class XamTilesControlDefaultInitializer : DefaultInitializer
    {
        /// <summary>
...
#region Infragistics Source Cleanup (Region)
    ...
    #endregion //XamTilesControlDefaultInitializer Class
}
