...
namespace Infragistics.Windows.Design.Tiles
{
    ...
    public class CommonAdornerProvider : GenericAdornerProvider
    {
		...
		public CommonAdornerProvider()
        {
            ...
            string resourceFileName = @"SmartTags/Tiles/CustomEditors/CustomPropertyEditors.xaml";
		...
		{
			get { return new Type [] { typeof(MaximizedModeSettings),
										typeof(NormalModeSettings),
										typeof(Tile),
										typeof(TileConstraints),
										typeof(XamTilesControl),
									};
			}
		}
