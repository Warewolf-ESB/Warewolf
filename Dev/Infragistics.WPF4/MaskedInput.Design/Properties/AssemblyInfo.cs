...
[assembly: StringResourceLocation("Infragistics.Controls.Editors.Design.Strings")]

class AssemblyRef
{
	public const string BaseResourceName = "Infragistics.Controls.Editors.Design.strings";
	...
	internal const string AssemblyName = AssemblyNamePrefix + ".Controls.Editors.XamMaskedInput.v" + AssemblyVersion.MajorMinor + ".Design.VS2012";



	internal const string AssemblyDescriptionBase = "MaskedInput Component for " + Platform + " - Design Assembly";
	internal const string AssemblyProduct = "Infragistics NetAdvantage for " + Platform;
