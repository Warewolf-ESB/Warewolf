...
[assembly: Guid("ff45fb47-99a9-4b5b-8383-6caeeb893a75")]
...
class AssemblyRef
{
    internal const string AssemblyName = AssemblyRef.AssemblyNamePrefix + ".Controls.Editors.XamColorPicker" + AssemblyRef.AssemblyNameSuffix;


    internal const string AssemblyProduct = "Infragistics NetAdvantage for WPF";
    internal const string AssemblyDescriptionBase = "Infragistics XamColorPicker for WPF";
