...
{
    internal class SelectedDateAutomationPeer: AutomationPeerProxy,
        ISelectionItemProvider 
    {
        ...
        /// </summary>
        /// <param name="xamMonthCalendar">An <see cref="XamMonthCalendar"/> instance</param>
        /// <param name="dateTime">An <see cref="DateTime"/> structure</param>
        public SelectedDateAutomationPeer(XamMonthCalendar xamMonthCalendar, DateTime dateTime)
        {
            Utils.ValidateNull("xamMonthCalendar", xamMonthCalendar);

            this._xamMonthCalendar = xamMonthCalendar;
        ...
        protected override AutomationPeer GetUnderlyingPeer()
        {
            ...
            if (this._xamMonthCalendar.IsMinCalendarMode)
            {
                CalendarItem item = this._xamMonthCalendar.GetItem(this._dateTime);

                if (null != item)
                    peer = UIElementAutomationPeer.CreatePeerForElement(item);
            }
        ...
        void ISelectionItemProvider.AddToSelection()
        {
            ...
            if (this._xamMonthCalendar.SelectedDates.Contains(this._dateTime) == false)
            {
                this._xamMonthCalendar.SelectedDates.Add(this._dateTime);
            }
        }
        ...
        bool ISelectionItemProvider.IsSelected
        {
            get 
            {
                return this._xamMonthCalendar.SelectedDates.Contains(this._dateTime); 
            }
        }
        ...
        void ISelectionItemProvider.RemoveFromSelection()
        {
            ...
            this._xamMonthCalendar.SelectedDates.Remove(this._dateTime);
        }
        ...
        void ISelectionItemProvider.Select()
        {
            ...
            this._xamMonthCalendar.SelectedDate = this._dateTime;
        ...
        IRawElementProviderSimple ISelectionItemProvider.SelectionContainer
        {
            get
            {
                AutomationPeer peer = UIElementAutomationPeer.CreatePeerForElement(this._xamMonthCalendar);
