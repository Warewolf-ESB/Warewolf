...
namespace Infragistics.Windows.Automation.Peers.Editors
{
        ...
        ISelectionProvider
    {
        ...
        public CalendarItemGroupAutomationPeer(CalendarItemGroup owner)
            : base(owner)
        {
            this._xamMonthCalendar = XamMonthCalendar.GetMonthCalendar(owner);
        }
        ...
        bool ISelectionProvider.CanSelectMultiple
        {
            get
            {
                return SelectionStrategyBase.IsMultiSelectStrategy(this._xamMonthCalendar.SelectionTypeResolved);
            ...
            if (calendarItemGroup.Items != null)
            {
                ...
                for (int i = 0; i < calendarItemGroup.Items.Count; i++)
                {
                    if (calendarItemGroup.Items[i].IsSelected == true)
                    {
                        ...
                        AutomationPeer peer = UIElementAutomationPeer.CreatePeerForElement(calendarItem);
