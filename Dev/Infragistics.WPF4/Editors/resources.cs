...
//       below.
//-----------------------------------------------------------------
namespace Infragistics.Windows.Editors // change this line only to the unigue namespace of this assembly
{
	/// <summary>
...
#pragma warning restore 436
        ...
        /// <summary>
        /// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource for the content of the today button in the <see cref="XamMonthCalendar"/>
        /// </summary>
        public static DynamicResourceString TodayButtonCaption
        {
            get { return GetDynamicResourceString("TodayButtonCaption"); }
        }
