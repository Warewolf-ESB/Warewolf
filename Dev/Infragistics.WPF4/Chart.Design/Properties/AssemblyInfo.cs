...
class AssemblyRef
{
	public const string BaseResourceName = "Infragistics.Windows.Design.Chart.strings";
...
#region Infragistics Source Cleanup (Region)
	...
	internal const string AssemblyName = "InfragisticsWPF4.Chart.v" + AssemblyVersion.MajorMinor + ".Design";
	...
	internal const string AssemblyDescriptionBase = "Infragistics Chart for WPF - Design Assembly";
