...
{
	/// <summary>
	/// A panel that organizes the <see cref="CellBase"/>s of a <see cref="ChildBand"/>.
	/// </summary>
	public class ChildBandCellsPanel : CellsPanel
	{
		/// <summary>
		...
		protected override Size RenderCells(double availableWidth)
		{
			...
			width += this.RenderCell(this.Row.ColumnLayout.Columns.ExpansionIndicatorColumn, starColumns, ref maxHeight, false, this.VisibleFixedLeftCells, double.IsPositiveInfinity(availableWidth));
			width += this.RenderCell(((ChildBandRowsManager)this.Row.Manager).Column, starColumns, ref maxHeight, false, this.VisibleCells, double.IsPositiveInfinity(availableWidth));
