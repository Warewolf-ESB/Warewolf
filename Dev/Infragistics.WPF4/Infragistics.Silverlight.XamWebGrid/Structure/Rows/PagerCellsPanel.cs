...
{
	/// <summary>
	/// An object that visually represents the PagerRow of the <see cref="XamGrid"/>.
	/// </summary>
	public class PagerCellsPanel : CellsPanel
	{
		/// <summary>
		...
		protected override Size RenderCells(double availableWidth)
		{
			...
			width += this.RenderCell(((PagerRow)this.Row).Column, starColumns, ref maxHeight, false, this.VisibleFixedLeftCells, double.IsPositiveInfinity(availableWidth));
