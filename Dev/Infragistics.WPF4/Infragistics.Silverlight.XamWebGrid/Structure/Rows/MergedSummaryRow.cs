...
{
    /// <summary>
    /// A <see cref="RowBase"/> which acts as a row that displays summaries for indvidual groupings for Merged Columns
    /// </summary>
    public class MergedSummaryRow : SummaryRow
    {
        #region Constructor

        /// <summary>
        /// Initializes a new instance of the <see cref="MergedSummaryRow"/> class.
        /// </summary>
		/// <param name="manager"></param>
        protected internal MergedSummaryRow(RowsManager manager)
			: base(manager)
		{
		}
        ...
        {
            get { return RowType.MergedSummaryRow; }
        }
        ...
        /// <summary>
        /// Gets/Sets the <see cref="MergedColumnInfo"/> associated with the <see cref="MergedSummaryRow"/>
        /// </summary>
        public MergedColumnInfo MergedColumnInfo
        {
            get;
