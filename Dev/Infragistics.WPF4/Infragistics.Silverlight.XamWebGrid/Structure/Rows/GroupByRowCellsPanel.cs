...
{
	/// <summary>
	/// A panel that organizes the <see cref="CellBase"/>s of a <see cref="GroupByRow"/>.
	/// </summary>
	public class GroupByRowCellsPanel : CellsPanel
	{
		/// <summary>
		...
		protected override Size RenderCells(double availableWidth)
		{
			...
			width += this.RenderCell(manager.GroupByColumn, starColumns, ref maxHeight, false, this.VisibleCells, double.IsPositiveInfinity(availableWidth));
