...
namespace Infragistics.Controls.Grids.Primitives
{
	...
	/// </summary>
	public class SummaryRowSelectorCell : RowSelectorCell
	{
		#region Constructor
		/// <summary>
		/// Initializes a new instance of the <see cref="AddNewRowSelectorCell"/> class.
		/// </summary>
		/// <param propertyName="row">The <see cref="RowBase"/> object that owns the <see cref="SummaryRowSelectorCell"/></param>
		/// <param propertyName="column">The <see cref="Column"/> object that the <see cref="SummaryRowSelectorCell"/> represents.</param>
		protected internal SummaryRowSelectorCell(RowBase row, Column column)
			: base(row, column)
		{
		}
		...
		protected override Style ResolveStyle
		{
			get
			{
				return this.Row.ColumnLayout.SummaryRowSettings.RowSelectorStyleResolved;
			}
		}
		...
		protected override Type RecyclingElementType
		{
			get
			{
				return typeof(SummaryRowSelectorCellControl);
			}
		}
		...
		{
			return new SummaryRowSelectorCellControl();
		}
