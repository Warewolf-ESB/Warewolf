...
{
	/// <summary>
	/// Visual object for the <see cref="ColumnLayoutTemplateCell"/> object.
	/// </summary>
	public class ColumnLayoutTemplateCellControl : CellControl
	{
		...
		{
			DataTemplate template = this.Cell.Column.ColumnLayout.InternalTemplate;

			if (template != null)
			{
				this.Content = this.Cell.Row.Data;
