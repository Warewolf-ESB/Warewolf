...
namespace Infragistics.Controls.Grids.Primitives
{
	...
	/// </summary>
	public class AddNewRowSelectorCell : RowSelectorCell
	{
		#region Constructor
		/// <summary>
		/// Initializes a new instance of the <see cref="AddNewRowSelectorCell"/> class.
		/// </summary>
		/// <param propertyName="row">The <see cref="RowBase"/> object that owns the <see cref="AddNewRowSelectorCell"/></param>
		/// <param propertyName="column">The <see cref="Column"/> object that the <see cref="AddNewRowSelectorCell"/> represents.</param>
		protected internal AddNewRowSelectorCell(RowBase row, Column column)
			: base(row, column)
		{
		}
		...
		protected override Style ResolveStyle
		{
			get
			{
				...
				return this.Row.ColumnLayout.AddNewRowSettings.RowSelectorStyleResolved;
			}
		}
		...
		protected override Type RecyclingElementType
		{
			get
			{
				return typeof(AddNewRowSelectorCellControl);
			}
		}
		...
		{
			return new AddNewRowSelectorCellControl();
		}
