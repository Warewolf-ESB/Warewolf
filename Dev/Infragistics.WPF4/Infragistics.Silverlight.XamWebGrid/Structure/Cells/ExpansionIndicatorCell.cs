...
namespace Infragistics.Controls.Grids.Primitives
{
	...
	/// </summary>
	public class ExpansionIndicatorCell : CellBase
	{
		#region Static

		static Type _recyclingElementType = typeof(ExpansionIndicatorCellControl);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ExpansionIndicatorCell"/> class.
		/// </summary>
		...
		protected internal ExpansionIndicatorCell(RowBase row, Column column)
			: base(row, column)
		{
		}
		...
		protected override Style ResolveStyle
		{
			get
			{
				...
				return this.Row.ColumnLayout.ExpansionIndicatorSettings.StyleResolved;
			}
		}
		...
		/// <summary>
		/// Gets the Type of control that should be created for the <see cref="ExpansionIndicatorCell"/>.
		/// </summary>
		protected override Type RecyclingElementType
		{
			get
			{
				return ExpansionIndicatorCell._recyclingElementType;
			}
		}
		...
		/// <summary>
		/// Creates a new instance of a <see cref="ExpansionIndicatorCellControl"/> for the <see cref="ExpansionIndicatorCell"/>.
		/// </summary>
		/// <returns>A new <see cref="ExpansionIndicatorCellControl"/></returns>
		...
		{
			return new ExpansionIndicatorCellControl();
		}
