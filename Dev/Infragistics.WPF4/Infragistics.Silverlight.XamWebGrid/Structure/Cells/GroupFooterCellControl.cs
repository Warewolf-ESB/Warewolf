...
{
    /// <summary>
    /// The visual representation of the <see cref="GroupFooterCell"/>
    /// </summary>
    public class GroupFooterCellControl : FooterCellControl
    {
        GroupColumnPanel _panel;

        #region Constructor
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupFooterCellControl"/> class.
        /// </summary>
        public GroupFooterCellControl()
        {
            base.DefaultStyleKey = typeof(GroupFooterCellControl);
        }
        ...
        /// <summary>
        /// Builds the visual tree for the <see cref="GroupFooterCellControl"/>
        /// </summary>
        ...
        /// <summary>
        /// Measures the Content of the <see cref="GroupFooterCellControl"/>
        /// </summary>
