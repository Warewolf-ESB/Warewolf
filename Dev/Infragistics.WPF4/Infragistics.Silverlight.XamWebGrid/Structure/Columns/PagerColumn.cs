...
{
	/// <summary>
	/// A <see cref="ColumnBase"/> that represents a particular level of <see cref="PagerCell"/> objects.
	/// </summary>
	internal sealed class PagerColumn : Column
	{
		#region Members
		ColumnWidth _width;
		#endregion // Members
		...
		#region Width
		/// <summary>
		/// The width of a <see cref="PagerColumn"/> is always *. 
		/// </summary>
		...
		/// <summary>
		/// If given a <see cref="PagerRow"/> a <see cref="PagerCell"/> will be returned.
		/// </summary>
		/// <param propertyName="row"></param>
		/// <returns></returns>
		protected internal override CellBase GenerateCell(RowBase row)
		{
			CellBase pagerCell = null;

			if (row is PagerRow)
				pagerCell = new PagerCell(row, this);
		...
		#region IsResizable
		/// <summary>
		/// A <see cref="PagerColumn"/>  is not Resizable.
		/// </summary>
