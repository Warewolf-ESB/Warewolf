...
{
	/// <summary>
	/// An Abstract class that controls the settings for an object that have a Style aspect on the <see cref="ColumnLayout"/>.
	/// </summary>
	public abstract class StyleSettingsOverrideBase : SettingsOverrideBase 
	{
		#region Properties
		...
		/// </summary>
		public static readonly DependencyProperty StyleProperty = DependencyProperty.Register("Style", typeof(Style), typeof(StyleSettingsOverrideBase), new PropertyMetadata(new PropertyChangedCallback(StyleChanged)));
		...
		{
			StyleSettingsOverrideBase settings = (StyleSettingsOverrideBase)obj;
		...
		public Style StyleResolved
		{
			get
			{
				if (this.Style == null && this.SettingsObject != null)
					return ((StyleSettingsBase)this.SettingsObject).Style;
				else
					return this.Style;
			}
		}

		#endregion // TemplateResolved
