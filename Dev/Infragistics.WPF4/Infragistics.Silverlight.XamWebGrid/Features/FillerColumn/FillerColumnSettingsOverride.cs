...
{
	/// <summary>
	/// An object that contains settings for the <see cref="FillerColumn"/> of a particular <see cref="ColumnLayout"/>.
	/// </summary>
	...
	public class FillerColumnSettingsOverride : StyleSettingsOverrideBase
	{
		#region Overrides
		...
		protected override SettingsBase SettingsObject
		{
			get
			{
				...
				if (this.ColumnLayout != null && this.ColumnLayout.Grid != null)
					settings = this.ColumnLayout.Grid.FillerColumnSettings;
				return settings;
			}
		}
		...
		/// </summary>
		public static readonly DependencyProperty HeaderStyleProperty = DependencyProperty.Register("HeaderStyle", typeof(Style), typeof(FillerColumnSettingsOverride), new PropertyMetadata(new PropertyChangedCallback(HeaderStyleChanged)));

		/// <summary>
		/// Gets/sets the <see cref="Style"/> that will be used on the <see cref="HeaderCellControl"/> object of the <see cref="FillerColumn"/>  on a particular <see cref="ColumnLayout"/>.
		/// </summary>
		...
		{
			FillerColumnSettingsOverride settings = (FillerColumnSettingsOverride)obj;
		...
		public Style HeaderStyleResolved
		{
			get
			{
				if (this.HeaderStyle == null && this.SettingsObject != null)
					return ((FillerColumnSettings)this.SettingsObject).HeaderStyle;
				else
		...
		/// Identifies the <see cref="Style"/> dependency property. 
		/// </summary>
		public static readonly DependencyProperty FooterStyleProperty = DependencyProperty.Register("FooterStyle", typeof(Style), typeof(FillerColumnSettingsOverride), new PropertyMetadata(new PropertyChangedCallback(FooterStyleChanged)));

		/// <summary>
		/// Gets/sets the <see cref="Style"/> that will be used on the <see cref="FooterCellControl"/> object of the <see cref="FillerColumn"/>  on a particular <see cref="ColumnLayout"/>.
		/// </summary>
		...
		public Style FooterStyleResolved
		{
			get
			{
				if (this.FooterStyle == null && this.SettingsObject != null)
					return ((FillerColumnSettings)this.SettingsObject).FooterStyle;
				else
