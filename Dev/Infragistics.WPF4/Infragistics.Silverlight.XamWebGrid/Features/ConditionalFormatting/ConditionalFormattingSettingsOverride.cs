...
{
	/// <summary>
	/// An object that contains settings for the conditional formatting of a particular <see cref="ColumnLayout"/>.
	/// </summary>
	public class ConditionalFormattingSettingsOverride : SettingsOverrideBase
	{
		#region Overrides
