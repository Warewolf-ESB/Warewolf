...
namespace Infragistics.Controls.Grids
{
	...
	/// </summary>
	public class LessThanOrEqualToConditionalFormatRule : EqualToConditionalFormatRule
	{
		#region Overrides
		...
		{
            return new LessThanOrEqualToConditionalFormatRuleProxy() { Value = this.Value };
		}
	...
	/// <summary>
	/// The execution proxy for the <see cref="LessThanOrEqualToConditionalFormatRule"/>.
	/// </summary>
    public class LessThanOrEqualToConditionalFormatRuleProxy: EqualToConditionalFormatRuleProxy
	{
		#region Overrides
