...
namespace Infragistics.Controls.Grids
{
	...
	/// </summary>
	public class BeginningWithConditionalFormatRule : StringConditionalFormatRule
	{
		#region Overrides
		/// <summary>
		...
		{
			return new BeginningWithConditionalFormatRuleProxy();
		}
		#endregion // Overrides
	}

	/// <summary>
	/// The execution proxy for the <see cref="BeginningWithConditionalFormatRule"/>.
	/// </summary>
	public class BeginningWithConditionalFormatRuleProxy : StringConditionalFormatRuleProxy
	{
		#region Overrides
		...
		protected override Style EvaluateCondition(object sourceDataObject, object sourceDataValue)
		{
			...
			StringConditionalFormatRule ruleBase = this.Parent as StringConditionalFormatRule;

			if (ruleBase == null || string.IsNullOrEmpty(dataValue) || string.IsNullOrEmpty(ruleBase.Value))
				return null;

			return (dataValue.StartsWith(ruleBase.Value, StringComparison.InvariantCulture) ? ruleBase.StyleToApply : null);
		}
