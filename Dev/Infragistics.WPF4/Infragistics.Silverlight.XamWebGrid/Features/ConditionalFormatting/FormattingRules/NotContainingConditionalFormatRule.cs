...
namespace Infragistics.Controls.Grids
{
	...
	/// </summary>
	public class NotContainingConditionalFormatRule : StringConditionalFormatRule
	{
		#region Overrides
		/// <summary>
		...
		{
			return new NotContainingConditionalFormatRuleProxy();
		}
		#endregion // Overrides
	}

	/// <summary>
	/// The execution proxy for the <see cref="NotContainingConditionalFormatRule"/>.
	/// </summary>
	public class NotContainingConditionalFormatRuleProxy : StringConditionalFormatRuleProxy
	{
		#region Overrides
		...
		protected override Style EvaluateCondition(object sourceDataObject, object sourceDataValue)
		{
			...
			if (string.IsNullOrEmpty(dataValue) || string.IsNullOrEmpty(baseObj.Value))
				return null;
