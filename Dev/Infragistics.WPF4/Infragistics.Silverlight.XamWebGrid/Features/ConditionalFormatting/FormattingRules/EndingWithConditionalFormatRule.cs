...
namespace Infragistics.Controls.Grids
{
	...
	/// </summary>
	public class EndingWithConditionalFormatRule : StringConditionalFormatRule
	{
		#region Overrides
		/// <summary>
		...
		{
			return new EndingWithConditionalFormatRuleProxy();
		}
		#endregion // Overrides
	}

	/// <summary>
	/// The execution proxy for the <see cref="EndingWithConditionalFormatRuleProxy"/>.
	/// </summary>
	public class EndingWithConditionalFormatRuleProxy : StringConditionalFormatRuleProxy
	{
		#region Overrides
		...
		protected override Style EvaluateCondition(object sourceDataObject, object sourceDataValue)
		{
			...
			return (dataValue.EndsWith(baseObj.Value) ? baseObj.StyleToApply : null);
		}
