...
namespace Infragistics.Controls.Grids
{
	...
	/// </summary>
	public class NotEqualToConditionalFormatRule : EqualToConditionalFormatRule
	{
		#region Overrides
		/// <summary>
		...
		{
			return new NotEqualToConditionalFormatRuleProxy() { Value = this.Value };
		}
	...
	/// <summary>
	/// The execution proxy for the <see cref="NotEqualToConditionalFormatRule"/>.
	/// </summary>
	public class NotEqualToConditionalFormatRuleProxy : EqualToConditionalFormatRuleProxy
	{
		#region Overrides
		...
		protected override Style EvaluateCondition(object sourceDataObject, object sourceDataValue)
		{
			...
			{
				if (!sourceDataValue.Equals(this.ResolvedValue))
				{
