...
namespace Infragistics.Controls.Grids
{
	...
	/// </summary>
	public class GreaterThanOrEqualToConditionalFormatRule : EqualToConditionalFormatRule
	{
		#region Overrides
		...
		{
			return new GreaterThanOrEqualToConditionalFormatRuleProxy() { Value = this.Value };
		}
	...
	/// <summary>
	/// The execution proxy for the <see cref="GreaterThanOrEqualToConditionalFormatRule"/>.
	/// </summary>
	public class GreaterThanOrEqualToConditionalFormatRuleProxy : EqualToConditionalFormatRuleProxy
	{
		#region Overrides
