...
namespace Infragistics.Controls.Grids
{
	...
	/// </summary>
	public class MinimumValueConditionalFormatRule : EqualToConditionalFormatRule
	{
		#region Overrides
		/// <summary>
		...
		{
			MinimumValueConditionalFormatRuleProxy proxy = new MinimumValueConditionalFormatRuleProxy();
	...
	/// <summary>
	/// The execution proxy for the <see cref="MinimumValueConditionalFormatRule"/>.
	/// </summary>
	public class MinimumValueConditionalFormatRuleProxy : EqualToConditionalFormatRuleProxy
	{
		#region Overrides
		...
		protected override void GatherData(IQueryable query)
		{
			...
			SummaryContext sc = SummaryContext.CreateGenericSummary(col.ColumnLayout.ObjectDataTypeInfo, col.Key, LinqSummaryOperator.Minimum);
