...
namespace Infragistics.Controls.Grids
{
	...
	/// </summary>
	public class LessThanConditionalFormatRule : EqualToConditionalFormatRule
	{
		#region Overrides
		/// <summary>
		...
		{
			return new LessThanConditionalFormatRuleProxy() { Value = this.Value };
		}
	...
	/// <summary>
	/// The execution proxy for the <see cref="LessThanConditionalFormatRule"/>.
	/// </summary>
	public class LessThanConditionalFormatRuleProxy : EqualToConditionalFormatRuleProxy
	{
		#region Overrides
