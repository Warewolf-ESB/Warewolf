...
namespace Infragistics.Controls.Grids.Primitives
{
	...
	/// </summary>
	public class NullableFloatConverter : TypeConverter
	{
		/// <summary>
		...
		public override bool CanConvertFrom(ITypeDescriptorContext context, Type sourceType)
		{
			...
			{
				return typeof(float?).IsAssignableFrom(sourceType);
			}
		...
		public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
		{
			...
			if (value != null)
			{
                ...
                if (s != null)
                {
                    return (!string.IsNullOrEmpty(s) ? new float?(float.Parse(s, System.Globalization.CultureInfo.InvariantCulture)) : null);
                }
			}
			return null;
		}
