...

{
	...
	internal static class Utilities
	{
		...
		public static int GetBits(int value, int firstBitIndex, int lastBitIndex)
		{
		...
		internal static System.Text.RegularExpressions.RegexOptions RegexOptionsCompiled
		{
			get
			{
		...
		// MD 6/7/11 - TFS78166
		internal static double MidpointRoundingAwayFromZero(double value)
		{
		...
		// MD 6/7/11 - TFS78166
		internal static double MidpointRoundingAwayFromZero(double value, int digits)
		{
