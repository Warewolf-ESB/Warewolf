...
namespace Infragistics.Controls.Maps
{
    ...
    /// <summary>
    /// Represents a specialized multiscale tile source used by the XamMap control.
    /// </summary>
    [DontObfuscate]
    public abstract class MapTileSource : XamMultiScaleTileSource
    {
        /// <summary>
        ...
        protected MapTileSource(int imageWidth, int imageHeight, int tileWidth, int tileHeight, int tileOverlap) :
