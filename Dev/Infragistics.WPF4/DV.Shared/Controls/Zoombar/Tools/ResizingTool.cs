...
namespace Infragistics.Controls
{
    ...
    /// </summary>
    public class ResizingTool : Tool, ICancelableTool
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResizingTool"/> class.
        /// </summary>
        public ResizingTool(InteractiveControl view)
            : base(view)
        {
        ...
        {
            Point docPoint = this.LastInput.DocMousePosition;

            InteractiveElement element = this.View.HitTest(docPoint);
            if (element != null)
            {
                ThumbNode thumbNode = element as ThumbNode;
                if (thumbNode != null)
                {
                    ShapeElement shape = thumbNode.HitResizeThumb(docPoint);

                    if (shape != null)
                    {
                        this.ThumbNode = thumbNode;
                        this.PrevPoint = docPoint;
        ...
        public override void MouseMove()
        {
            ...
            this.ThumbNode.DoResize(offset);
