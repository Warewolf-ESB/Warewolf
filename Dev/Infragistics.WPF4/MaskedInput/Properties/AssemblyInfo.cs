...
[assembly: Guid( "D2DE3F3E-D23A-4E5C-9167-44A477BCA484" )]
...
[assembly: InternalsVisibleTo("InfragisticsWPF4.Controls.MaskedInput.UnitTests.v" + AssemblyVersion.MajorMinor)]
...
class AssemblyRef
{
	...
	internal const string AssemblyName = AssemblyNamePrefix + ".Controls.Editors.XamMaskedInput.v" + AssemblyVersion.MajorMinor;
	internal const string AssemblyProduct = "Infragistics NetAdvantage for " + Platform;
	internal const string AssemblyDescriptionBase = "XamMaskedInput Component for " + Platform;
