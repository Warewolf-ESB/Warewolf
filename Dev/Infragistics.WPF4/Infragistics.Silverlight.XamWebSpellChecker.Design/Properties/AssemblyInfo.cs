...
[assembly: StringResourceLocation("Infragistics.Controls.Interactions.XamSpellChecker.Design.Strings")]
#pragma warning disable 436
class AssemblyRef
{
    internal const string AssemblyName = AssemblyRef.AssemblyNamePrefix + ".Controls.Interactions.XamSpellChecker.Design" + AssemblyRef.AssemblyNameSuffix;


    internal const string AssemblyProduct = "Infragistics NetAdvantage for WPF";
    internal const string AssemblyDescriptionBase = "Infragistics XamSpellChecker Design for WPF";
