...
namespace Infragistics.Windows.Themes.Internal
{
    ...
    /// </summary>
    public class ReportingAssemblyResourceSetLoader : AssemblyResourceSetLoader
    {
        /// <summary>
        ...
        protected override void OnRegisterResourceSets(string groupingName)
        {
            ...
            if (groupingName == ReportingGeneric.GroupingName || null == groupingName)
            {
                AssemblyResourceSetLoader.RegisterResourceSet(ReportingGeneric.Location);
            }
        }
    }
}
