...
class AssemblyRef
{
	public const string BaseResourceName = "Infragistics.Windows.Design.DockManager.strings";
...
#region Infragistics Source Cleanup (Region)
    ...
    internal const string AssemblyName = "InfragisticsWPF4.DockManager.v" + AssemblyVersion.MajorMinor + ".Design.VS2012";
