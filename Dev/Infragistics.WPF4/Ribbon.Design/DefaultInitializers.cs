...
{
	#region XamRibbonDefaultInitializer Class

	/// <summary>
	/// Provides default values for various XamRibbon properties.
	/// </summary>
	public class XamRibbonDefaultInitializer : DefaultInitializer
	{
		/// <summary>
		...
		public override void InitializeDefaults(ModelItem item)
		{
			...
			DesigntimeUtilities.SetPropValueHelper(item.Properties["ApplicationMenu"], new ApplicationMenu());
			DesigntimeUtilities.SetPropValueHelper(item.Properties["QuickAccessToolbar"], new QuickAccessToolbar());
		}
	}

	#endregion //XamRibbonDefaultInitializer Class
}
