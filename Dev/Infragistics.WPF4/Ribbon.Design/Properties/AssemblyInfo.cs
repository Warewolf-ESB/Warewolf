...
class AssemblyRef
{
	public const string BaseResourceName = "Infragistics.Windows.Design.Ribbon.strings";
...
#region Infragistics Source Cleanup (Region)
    ...
    internal const string AssemblyName = "InfragisticsWPF4.Ribbon.v" + AssemblyVersion.MajorMinor + ".Design.VS2012";
	...
	internal const string AssemblyDescriptionBase = "Infragistics XamRibbon for WPF - Design Assembly";
