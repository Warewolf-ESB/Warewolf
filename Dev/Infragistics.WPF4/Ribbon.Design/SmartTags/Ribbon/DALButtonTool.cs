...
namespace Infragistics.Windows.Design.Ribbon
{
    ...
    /// </summary>
    public class DALButtonTool : DesignerActionList
    {
        #region Constructors
		...
		public DALButtonTool(EditingContext context, ModelItem modelItem, List<string> itemsToShow, string alternateAdornerTitle)
			: base(context, modelItem, itemsToShow, alternateAdornerTitle)
        {
			//You can set the title of the smart tag. By default it is "Tasks".
			this.GenericAdornerTitle = string.IsNullOrEmpty(alternateAdornerTitle) ? SR.GetString("SmartTag_T_ButtonTool") : alternateAdornerTitle;
			...
			DALHelpers.AddButtonGroup(typeof(ButtonTool), this.Items, true, ref groupSequence);

			#endregion //Button Group

			#region Strings Group

			DALHelpers.AddStringsGroup(typeof(ButtonTool), this.Items, true, ref groupSequence);

			#endregion //Strings Group

			#region Images Group

			DALHelpers.AddImagesGroup(typeof(ButtonTool), this.Items, true, ref groupSequence);

			#endregion //Images Group

			#region QAT Group

			DesignerActionItemGroup groupQat = DALHelpers.AddQatGroup(typeof(ButtonTool), this.Items, false, ref groupSequence);
