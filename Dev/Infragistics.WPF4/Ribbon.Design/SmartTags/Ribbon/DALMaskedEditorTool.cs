...
namespace Infragistics.Windows.Design.Ribbon
{
    ...
    /// </summary>
    public class DALMaskedEditorTool : DesignerActionList
    {
        #region Constructors
		...
		public DALMaskedEditorTool(EditingContext context, ModelItem modelItem, List<string> itemsToShow, string alternateAdornerTitle)
			: base(context, modelItem, itemsToShow, alternateAdornerTitle)
        {
			//You can set the title of the smart tag. By default it is "Tasks".
			this.GenericAdornerTitle = string.IsNullOrEmpty(alternateAdornerTitle) ? SR.GetString("SmartTag_T_MaskedEditorTool") : alternateAdornerTitle;
			...
			using (PropertyItemCreator pic = new PropertyItemCreator(typeof(MaskedEditorTool), groupEditors))
			{
				this.Items.Add(pic.GetPropertyActionItem("AllowShiftingAcrossSections"));
				this.Items.Add(pic.GetPropertyActionItem("AlwaysValidate"));
				this.Items.Add(pic.GetPropertyActionItem("AutoFillDate"));
				this.Items.Add(pic.GetPropertyActionItem("ClipMode"));
				this.Items.Add(pic.GetPropertyActionItem("DataMode"));
				this.Items.Add(pic.GetPropertyActionItem("DisplayMode"));
				this.Items.Add(pic.GetPropertyActionItem("EditAreaWidth"));
				this.Items.Add(pic.GetPropertyActionItem("Format"));
				this.Items.Add(pic.GetPropertyActionItem("InsertMode"));
				this.Items.Add(pic.GetPropertyActionItem("IsAlwaysInEditMode"));
				this.Items.Add(pic.GetPropertyActionItem("Mask"));
				this.Items.Add(pic.GetPropertyActionItem("PadChar"));
				this.Items.Add(pic.GetPropertyActionItem("PromptChar"));
				this.Items.Add(pic.GetPropertyActionItem("SelectAllBehavior"));
				this.Items.Add(pic.GetPropertyActionItem("SpinButtonDisplayMode"));
				this.Items.Add(pic.GetPropertyActionItem("SpinIncrement"));
				this.Items.Add(pic.GetPropertyActionItem("SpinWrap"));
				this.Items.Add(pic.GetPropertyActionItem("TabNavigation"));
			...
			DALHelpers.InitializeDALForEditorTool(typeof(MaskedEditorTool), this, this.Items, groupSequence);
		}
