...
namespace Infragistics.Windows.Design.Ribbon
{
    ...
    /// </summary>
    public class DALToggleButtonTool : DesignerActionList
    {
        #region Constructors
		...
		public DALToggleButtonTool(EditingContext context, ModelItem modelItem, List<string> itemsToShow, string alternateAdornerTitle)
			: base(context, modelItem, itemsToShow, alternateAdornerTitle)
        {
			//You can set the title of the smart tag. By default it is "Tasks".
			this.GenericAdornerTitle = string.IsNullOrEmpty(alternateAdornerTitle) ? SR.GetString("SmartTag_T_ToggleButtonTool") : alternateAdornerTitle;
