...
namespace Infragistics.Windows.Design.Editors
{
    ...
    /// </summary>
    public class DALXamNumericEditor : DesignerActionList
    {
        #region Constructors
		...
		public DALXamNumericEditor(EditingContext context, ModelItem modelItem, List<string> itemsToShow, string alternateAdornerTitle)
			: base(context, modelItem, itemsToShow, alternateAdornerTitle)
        {
			//You can set the title of the smart tag. By default it is "Tasks".
			this.GenericAdornerTitle = string.IsNullOrEmpty(alternateAdornerTitle) ? SR.GetString("SmartTag_T_XamNumericEditor") : alternateAdornerTitle;
			...
			DALHelpers.AddAppearancePropertiesGroup(typeof(XamNumericEditor), this.Items, true, ref groupSequence);

			#endregion //AppearanceProperties group

			#region MaskedEditorProperties group

			DALHelpers.AddMaskedEditorPropertiesGroup(typeof(XamDateTimeEditor), this.Items, true, ref groupSequence, SR.GetString("SmartTag_G_GeneralMasked"));

			#endregion //MaskedEditorProperties group

			#region TextEditorBaseProperties group

			DALHelpers.AddTextEditorBasePropertiesGroup(typeof(XamDateTimeEditor), this.Items, false, ref groupSequence);

			#endregion //TextEditorBaseProperties group

			#region ValueEditorProperties group

			DALHelpers.AddValueEditorPropertiesGroup(typeof(XamDateTimeEditor), this.Items, false, ref groupSequence);
