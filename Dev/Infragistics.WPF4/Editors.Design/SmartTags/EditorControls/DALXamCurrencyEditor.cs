...
namespace Infragistics.Windows.Design.Editors
{
    ...
    /// </summary>
    public class DALXamCurrencyEditor : DesignerActionList
    {
        #region Constructors
		...
		public DALXamCurrencyEditor(EditingContext context, ModelItem modelItem, List<string> itemsToShow, string alternateAdornerTitle)
			: base(context, modelItem, itemsToShow, alternateAdornerTitle)
        {
			//You can set the title of the smart tag. By default it is "Tasks".
			this.GenericAdornerTitle = string.IsNullOrEmpty(alternateAdornerTitle) ? SR.GetString("SmartTag_T_XamCurrencyEditor") : alternateAdornerTitle;
			...
			DALHelpers.AddAppearancePropertiesGroup(typeof(XamCurrencyEditor), this.Items, true, ref groupSequence);
