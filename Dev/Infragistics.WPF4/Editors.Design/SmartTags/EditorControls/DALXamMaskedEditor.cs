...
namespace Infragistics.Windows.Design.Editors
{
    ...
    /// </summary>
    public class DALXamMaskedEditor : DesignerActionList
    {
        #region Constructors
		...
		public DALXamMaskedEditor(EditingContext context, ModelItem modelItem, List<string> itemsToShow, string alternateAdornerTitle)
			: base(context, modelItem, itemsToShow, alternateAdornerTitle)
        {
			//You can set the title of the smart tag. By default it is "Tasks".
			this.GenericAdornerTitle = string.IsNullOrEmpty(alternateAdornerTitle) ? SR.GetString("SmartTag_T_XamMaskedEditor") : alternateAdornerTitle;
			...
			DALHelpers.AddAppearancePropertiesGroup(typeof(XamMaskedEditor), this.Items, true, ref groupSequence);

			#endregion //AppearanceProperties group

			#region MaskedEditorProperties group

			DALHelpers.AddMaskedEditorPropertiesGroup(typeof(XamMaskedEditor), this.Items, true, ref groupSequence, SR.GetString("SmartTag_G_XamMaskedEditor"));

			#endregion //MaskedEditorProperties group

			#region TextEditorBaseProperties group

			DALHelpers.AddTextEditorBasePropertiesGroup(typeof(XamMaskedEditor), this.Items, false, ref groupSequence);

			#endregion //TextEditorBaseProperties group

			#region ValueEditorProperties group

			DALHelpers.AddValueEditorPropertiesGroup(typeof(XamMaskedEditor), this.Items, false, ref groupSequence);
