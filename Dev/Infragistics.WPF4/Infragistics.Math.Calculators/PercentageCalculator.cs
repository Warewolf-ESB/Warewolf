...
{
    /// <summary>
    /// Represents the class that calculates the percentage of value
    /// </summary>
    public class PercentageCalculator : DependencyObject, IErrorBarCalculator
    {
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(double), typeof(PercentageCalculator),
            new PropertyMetadata(0.0, new PropertyChangedCallback(OnValueChanged)));

        private static void OnValueChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((PercentageCalculator)d).OnValueChanged(e);
        }
        ...
        {
            return ErrorBarCalculatorType.Percentage;
        }
