...
namespace Infragistics.Math.Calculators 
{
    ...
    /// </summary>
    public class StandardErrorCalculator : ValueCalculator, IErrorBarCalculator
    {
        /// <summary>
        ...
        public override double Calculate(System.Collections.Generic.IList<double> input)
        {
            ...
            return Compute.StandardError(vector);
        }
        ...
        {
            return ErrorBarCalculatorType.StandardError;
        }
