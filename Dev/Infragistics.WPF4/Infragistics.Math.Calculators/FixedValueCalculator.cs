...
{
    /// <summary>
    /// Represents the class that holds a fixed value for error bars
    /// </summary>
    public class FixedValueCalculator : DependencyObject, IErrorBarCalculator
    {
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value", typeof(double), typeof(FixedValueCalculator),
            new PropertyMetadata(0.0, new PropertyChangedCallback(OnValueChanged)));

        private static void OnValueChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((FixedValueCalculator)d).OnValueChanged(e);
        }
        ...
        {
            return ErrorBarCalculatorType.Fixed;
        }
