...

{
	...
	internal partial class MetadataStore : IProvideAttributeTable
	{
		...
		{
			// JM 10-10-11 TFS91218
			builder.AddCustomAttributes(typeof(XamMultiColumnComboEditor), "Columns", new NewItemTypesAttribute(
				typeof(CheckboxComboColumn),
				typeof(DateComboColumn),
				typeof(ImageComboColumn),
				typeof(TextComboColumn)));
		}
