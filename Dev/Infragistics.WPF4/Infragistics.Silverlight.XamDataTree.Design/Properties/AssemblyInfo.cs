...
[assembly: StringResourceLocation("Infragistics.Controls.Menus.XamDataTree.Design.Strings")]

#pragma warning disable 436
class AssemblyRef
{
    internal const string AssemblyName = AssemblyRef.AssemblyNamePrefix + ".Controls.Menus.XamDataTree.Design" + AssemblyRef.AssemblyNameSuffix;


    internal const string AssemblyProduct = "Infragistics NetAdvantage for WPF";
    internal const string AssemblyDescriptionBase = "Infragistics XamDataTree Design for WPF";
