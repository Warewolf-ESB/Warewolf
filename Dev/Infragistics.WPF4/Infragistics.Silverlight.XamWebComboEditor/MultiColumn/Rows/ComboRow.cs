...
{
    /// <summary>
    /// An object that represents a data row in the ItemsSource of the <see cref="XamMultiColumnComboEditor"/>
    /// </summary>

	[InfragisticsFeature(FeatureName = FeatureInfo.FeatureName_MultiColumnCombo, Version = FeatureInfo.Version_11_2)]

	public class ComboRow : ComboRowBase
    {
        #region Constructor

        /// <summary>
        /// Initializes a new instance of the <see cref="ComboRow"/> class.
        /// </summary>
        ...
        internal ComboRow(object data, XamMultiColumnComboEditor xamWebComboEditor)
