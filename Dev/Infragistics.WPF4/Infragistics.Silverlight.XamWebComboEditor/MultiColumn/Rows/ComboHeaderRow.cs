...
{
	/// <summary>
	/// An object that represents a header row in a <see cref="XamMultiColumnComboEditor"/>
	/// </summary>

	[InfragisticsFeature(FeatureName = FeatureInfo.FeatureName_MultiColumnCombo, Version = FeatureInfo.Version_11_2)]

	public class ComboHeaderRow : ComboRowBase
	{
	    #region Constructor

        /// <summary>
        /// Initializes a new instance of the <see cref="ComboHeaderRow"/> class.
        /// </summary>
		...
		internal ComboHeaderRow(object data, XamMultiColumnComboEditor xamWebComboEditor)
            : base(data, xamWebComboEditor)
        {
        }
