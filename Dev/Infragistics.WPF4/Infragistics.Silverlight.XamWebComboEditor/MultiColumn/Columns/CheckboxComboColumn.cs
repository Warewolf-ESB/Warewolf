...
{
    /// <summary>
    /// A <see cref="ComboColumn"/> that uses <see cref="CheckBox"/> elements to represent data.
    /// </summary>

	[InfragisticsFeature(FeatureName = FeatureInfo.FeatureName_MultiColumnCombo, Version = FeatureInfo.Version_11_2)]

	public class CheckboxComboColumn : ComboColumn
    {
        #region Overrides
        ...
        {
            return new CheckboxComboColumnContentProvider();
        }
