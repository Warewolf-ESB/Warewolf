...
{
	/// <summary>
	/// An automation peer for the <see cref="ComboCellsPanel"/>.
	/// </summary>
	public class ComboCellsPanelAutomationPeer : FrameworkElementAutomationPeer, IValueProvider, ISelectionItemProvider
	{
		#region Constructors
		/// <summary>
		...
		public ComboCellsPanelAutomationPeer(ComboCellsPanel owner)
			: base(owner)
		{
			if (owner == null)
				throw new ArgumentNullException("owner");

			if (this.OwningComboCellsPanel.Row != null)
				this.OwningComboCellsPanel.Row.PropertyChanged += Row_PropertyChanged;
		}
		...
		{
			return this.OwningComboCellsPanel.GetType().Name;
		}
		...
		#region OwningComboCellsPanel

		private ComboCellsPanel OwningComboCellsPanel
		{
			get
			{
				return (ComboCellsPanel)Owner;
			}
		}

		#endregion //OwningComboCellsPanel

		#region Panel

		private ItemsPanelBase<ComboRow, ComboCellsPanel> Panel
		{
			get
			{
				return this.OwningComboCellsPanel.Row.ComboEditor.Panel;
			}
		}
		...
		public string Value
		{
			get
			{
				// JM 02-16-12 TFS102057 - Add null checks
				if (this.OwningComboCellsPanel			!= null &&
					this.OwningComboCellsPanel.Row		!= null	&&
					this.OwningComboCellsPanel.Row.Data != null)
				{
					return this.OwningComboCellsPanel.Row.Data.ToString();
				}
		...
		{
			if (this.OwningComboCellsPanel != null && this.OwningComboCellsPanel.Row != null)
				this.OwningComboCellsPanel.Row.IsSelected = true;
		}
		...
		{
			if (this.OwningComboCellsPanel != null && this.OwningComboCellsPanel.Row != null)
				this.OwningComboCellsPanel.Row.IsSelected = false;
		}
		...
		public bool IsSelected
		{
			...
			{
				if (this.OwningComboCellsPanel != null && this.OwningComboCellsPanel.Row != null)
					return this.OwningComboCellsPanel.Row.IsSelected;
