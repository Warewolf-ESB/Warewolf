...
namespace Infragistics.Windows.Tiles
{
	...
	public class TileDragIndicator : ContentControl
	{
		...
		static TileDragIndicator( )
		{
			...
			FrameworkElement.FocusableProperty.OverrideMetadata( typeof( TileDragIndicator ), new FrameworkPropertyMetadata( KnownBoxes.FalseBox ) );
		}
        ...
        internal static readonly DependencyPropertyKey ContainerPropertyKey =
          DependencyProperty.RegisterReadOnly("Container", 
          typeof(FrameworkElement), typeof(TileDragIndicator), new FrameworkPropertyMetadata(null));

        /// <summary>
        /// Identifies the <see cref="Container"/> dependency property
        /// </summary>
