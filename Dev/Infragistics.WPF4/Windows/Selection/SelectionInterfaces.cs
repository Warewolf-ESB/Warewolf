...
namespace Infragistics.Windows.Selection
{
    ...
    public struct AutoScrollInfo
    {
		...
		// AS 4/12/11 TFS62951
		// The selection strategy makes some assumptions about the area in which 
		// scrolling is necessary. Basically if you're over the hosting element 
		// then it figures you don't need scrolling. However in the grid this 
		// isn't the case - particularly when you have fixed fields. This callback 
		// allows the selection host to override the scroll information.
		//
		private AdjustScrollInfoCallback _adjustScrollInfoCallback;
        ...
        public AutoScrollInfo(FrameworkElement scrollArea, bool canScrollDown, bool canScrollLeft, bool canScrollRight, bool canScrollUp)
		{
			...
			// AS 4/12/11 TFS62951
			this._adjustScrollInfoCallback = null;
        }
		...
		/// <summary>
		/// Returns or sets a delegate used to customize the scroll info for an auto scroll operation.
		/// </summary>
		public AdjustScrollInfoCallback AdjustScrollInfoCallback
		{
			get { return _adjustScrollInfoCallback; }
			set { _adjustScrollInfoCallback = value; }
		} 
	...
	// AS 4/12/11 TFS62951
	#region AutoScrollInfoCallback

	/// <summary>
	/// Helper method used to adjust the scrolling direction during an autoscroll operation.
	/// </summary>
	/// <param name="isHorizontal">Boolean indicating if a horizontal scrolling operation is being queried.</param>
	/// <param name="mouseArgs">The mouse event arguments</param>
	/// <param name="item">The currently selectable item for the strategy</param>
	/// <param name="scrollDirection">By reference member indicating the calculated scroll direction</param>
	/// <param name="timerInterval">By reference member indicating the calculated timer interval.</param>
	/// <seealso cref="AutoScrollInfo.AdjustScrollInfoCallback"/>
	...
	#endregion //AutoScrollInfoCallback
