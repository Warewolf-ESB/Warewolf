...
namespace Infragistics.Windows.Scrolling
{
	...
	/// </summary>
	public interface IDeferredScrollPanel
	{
		/// <summary>
		...
		bool SupportsDeferredScrolling(Orientation scrollBarOrientation, ScrollViewer scrollViewer);
		...
		/// <param name="scrollBarOrientation">Orientation of the scrollbar whose thumb is being dragged</param>
		void OnThumbDragStart(Thumb thumb, Orientation scrollBarOrientation);
		...
		void OnThumbDragComplete(bool cancelled);
	}
}
