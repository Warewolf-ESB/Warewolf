...
namespace Infragistics.Windows.Automation.Peers
{
    ...
    /// </summary>
    public class ComparisonOperatorSelectorAutomationPeer : FrameworkElementAutomationPeer
    {
        #region Constructor
        /// <summary>
        /// Initializes a new <see cref="ComparisonOperatorSelectorAutomationPeer"/>
        /// </summary>
        /// <param name="element">The associated element</param>
        public ComparisonOperatorSelectorAutomationPeer(ComparisonOperatorSelector element)
            : base(element)
        {
        }
        ...
        /// <summary>
        /// Returns the name of the <see cref="ComparisonOperatorSelector"/>
        /// </summary>
