...
{
    /// <summary>
    /// Exposes XamContextMenu types to UI Automation.
    /// </summary>
    public class XamContextMenuAutomationPeer : ItemsControlAutomationPeer
    {
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="XamContextMenuAutomationPeer"/> class.
        /// </summary>
        /// <param name="owner">The owner.</param>
        public XamContextMenuAutomationPeer(XamContextMenu owner) : base(owner)
        {
            if (owner == null)
            {
        ...
        {
            ItemCollection items = this.OwningContextMenu.Items;
            if (items.Count <= 0)
            {
                return null;
            }
            ...
            {
                UIElement element = this.OwningContextMenu.ItemContainerGenerator.ContainerFromIndex(i) as UIElement;
                if (element != null)
                {
        ...
        protected override string GetNameCore()
        {
            ...
            if (string.IsNullOrEmpty(nameCore) && (this.OwningContextMenu.Header is string))
            {
                nameCore = (string)this.OwningContextMenu.Header;
            }
        ...
        private XamContextMenu OwningContextMenu
        {
            get
            {
                return (XamContextMenu)Owner;
            }
        }
