...
namespace Infragistics.Windows.Chart
{
    ...
    /// </summary>
    internal class StackedCylinderBarChart3D : CylinderBarChart3D
    {
        ...
        protected override void Draw3D(Model3DGroup model3DGroup, RotateTransform3D rotateTransform3D)
        {
            ...
            int numOfPoints = GetStackedNumberOfPoints(ChartType.StackedCylinderBar, seriesList);
            ...
            for (int pointIndx = 0; pointIndx < numOfPoints; pointIndx++)
            {
                ...
                {
                    if (seriesList[seriesIndx].ChartType != ChartType.StackedCylinderBar || seriesList[seriesIndx].DataPoints.Count <= pointIndx)
                    {
                        continue;
                    }
