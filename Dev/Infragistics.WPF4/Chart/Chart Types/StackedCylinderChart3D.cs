...
namespace Infragistics.Windows.Chart
{
    ...
    /// </summary>
    internal class StackedCylinderChart3D : CylinderChart3D
    {
        ...
        protected override void Draw3D(Model3DGroup model3DGroup, RotateTransform3D rotateTransform3D)
        {
            ...
            int numOfPoints = GetStackedNumberOfPoints(ChartType.StackedCylinder, seriesList);
            ...
            for (int pointIndx = 0; pointIndx < numOfPoints; pointIndx++)
            {
                ...
                {
                    if (seriesList[seriesIndx].ChartType != ChartType.StackedCylinder || seriesList[seriesIndx].DataPoints.Count <= pointIndx)
                    {
                        continue;
                    }
