...
namespace Infragistics.Windows.Chart
{
    ...
    /// </summary>
    internal class Stacked100ColumnChart3D : ColumnChart3D
    {
        ...
        protected override void Draw3D(Model3DGroup model3DGroup, RotateTransform3D rotateTransform3D)
        {
            ...
            int numOfPoints = GetStackedNumberOfPoints(ChartType.Stacked100Column, seriesList);
            ...
            for (int pointIndx = 0; pointIndx < numOfPoints; pointIndx++)
            {
                ...
                {
                    if (seriesList[seriesIndx].ChartType != ChartType.Stacked100Column || seriesList[seriesIndx].DataPoints.Count <= pointIndx)
                    {
