...
namespace Infragistics.Windows.Chart
{
    ...
    /// </summary>
    public class ChartParameterCollection : ObservableCollection<ChartParameter>
    {
        #region Fields
        ...
        public void Add(ChartParameterType type, object value)
        {
            ChartParameter item = new ChartParameter();
            item.Type = type;
            item.Value = value;
        ...
        /// </summary>
        public ChartParameterCollection()
        {
        }
        ...
        protected override void InsertItem(int index, ChartParameter item)
        {
            item.ChartParent = this;
        ...
        protected override void OnCollectionChanged(System.Collections.Specialized.NotifyCollectionChangedEventArgs e)
        {
            ...
            if (e.NewItems != null)
            {
                foreach (ChartParameter item in e.NewItems)
                {
