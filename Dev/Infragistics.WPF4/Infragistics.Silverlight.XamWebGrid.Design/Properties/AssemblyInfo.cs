...
[assembly: StringResourceLocation("Infragistics.Controls.Grids.XamGrid.Design.Strings")]

#pragma warning disable 436
class AssemblyRef
{
    internal const string AssemblyName = AssemblyRef.AssemblyNamePrefix + ".Controls.Grids.XamGrid.Design" + AssemblyRef.AssemblyNameSuffix;


    internal const string AssemblyProduct = "Infragistics NetAdvantage for WPF";
    internal const string AssemblyDescriptionBase = "Infragistics XamGrid Design for WPF";
