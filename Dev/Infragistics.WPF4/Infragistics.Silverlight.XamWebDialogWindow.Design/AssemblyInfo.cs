...
[assembly: StringResourceLocation("Infragistics.Controls.Interactions.XamDialogWindow.Design.Strings")]

#pragma warning disable 436
class AssemblyRef
{
    internal const string AssemblyName = AssemblyRef.AssemblyNamePrefix + ".Controls.Interactions.XamDialogWindow.Design" + AssemblyRef.AssemblyNameSuffix;


    internal const string AssemblyProduct = "Infragistics NetAdvantage for WPF";
    internal const string AssemblyDescriptionBase = "Infragistics XamDialogWindow Design for WPF";
