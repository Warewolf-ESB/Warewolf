...
{
	/// <summary>
	/// Exposes <see cref="DayViewDayHeaderArea"/> types to UI Automation
	/// </summary>
	public class DayViewDayHeaderAreaAutomationPeer : FrameworkElementAutomationPeer, IRawElementProviderSource
	{
		...
		#region Constructor
		/// <summary>
		/// Initializes a new <see cref="DayViewDayHeaderAreaAutomationPeer"/>
		/// </summary>
		/// <param name="owner">The <see cref="DayViewDayHeaderArea"/> that the peer represents</param>
		public DayViewDayHeaderAreaAutomationPeer(DayViewDayHeaderArea owner)
			: base(owner)
		{
		}
		...
		/// <summary>
		/// Returns the name of the <see cref="DayViewDayHeaderArea"/>
		/// </summary>
		/// <returns>A string that contains 'DayViewDayHeaderArea'</returns>
		protected override string GetClassNameCore()
		{
			return "DayViewDayHeaderArea";
		}
		...
		private ScrollInfoAutomationProvider ScrollProvider
		{
			get
			{
				...
				{
					var ctrl = ScheduleControlBase.GetControl(this.Owner) as XamDayView;

					ScrollInfo vScroll = ctrl == null ? null : ctrl.DayHeaderActivityScrollInfo;

					_scrollProvider = new ScrollInfoAutomationProvider(this, null, vScroll);
				}
