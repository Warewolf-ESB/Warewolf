...
{
	#region ReminderSubscriber Class

	/// <summary>
	/// A class used to get notified of reminders.
	/// </summary>
	/// <seealso cref="ScheduleDataConnectorBase.SubscribeToReminders"/>
	public abstract class ReminderSubscriber
	{
		/// <summary>
		...
		/// </para>
		/// </remarks>
		public abstract void DeliverReminder( ReminderInfo reminderInfo );

		/// <summary>
		/// Call to remove a reminder.
		/// </summary>
		/// <param name="reminderInfo">Contains information regarding the reminder.</param>
		public abstract void RemoveReminder(ReminderInfo reminderInfo);
	} 

	#endregion // ReminderSubscriber Class
