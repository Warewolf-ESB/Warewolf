...

{
        ...
        where TViewItem: class
	{
			...
			)
		{
			...
			if ( null == accessor )
			{
				if ( null == propDescriptorAccessorFactoryCache )
					propDescriptorAccessorFactoryCache = new PropertyDescriptorValueAccessorFactory( _list );

				var factory = (PropertyDescriptorValueAccessorFactory)propDescriptorAccessorFactoryCache;
				accessor = factory.CreateHelper( mappedField, converterInfo );
			}
