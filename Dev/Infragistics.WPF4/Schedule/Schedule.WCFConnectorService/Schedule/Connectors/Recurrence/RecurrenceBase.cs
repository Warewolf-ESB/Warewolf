...

{
	...
	/// <remarks>
	/// <para class="body">
	/// <see cref="DateRecurrence"/> class derives from this class which is used to specify rules that define recurring date-time.
	/// </para>
	/// </remarks>
	/// <seealso cref="DateRecurrence"/>
	public abstract class RecurrenceBase : PropertyChangeNotifierExtended
	{
		#region Member Vars
		...
		internal abstract RecurrenceBase Clone( );
