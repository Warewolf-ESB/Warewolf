...
{
	internal class MultiDayActivityAreaAdapter : DayPresenterBaseAdapter
	{
		#region Constructor
		internal MultiDayActivityAreaAdapter(DateTime logicalDate, DateTime start, DateTime end)
		...
		{
			return new MultiDayActivityArea();
		} 
		...
		protected override Type RecyclingElementType
		{
			get
			{
				return typeof(MultiDayActivityArea);
			}
		}
