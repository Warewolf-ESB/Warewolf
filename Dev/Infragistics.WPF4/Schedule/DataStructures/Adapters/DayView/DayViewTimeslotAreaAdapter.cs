...
{
	internal class DayViewTimeslotAreaAdapter : TimeslotAreaAdapter
	{
		#region Constructor
		internal DayViewTimeslotAreaAdapter( XamDayView control,
		...
		{
			return new DayViewTimeslotArea();
		}
		...
		protected override Type RecyclingElementType
		{
			get
			{
				return typeof(DayViewTimeslotArea);
			}
		}
