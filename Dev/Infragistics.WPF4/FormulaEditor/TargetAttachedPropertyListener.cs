...
{
	internal class TargetAttachedPropertyListener :
			ITypedPropertyChangeListener<object, string>
	{
		private FormulaEditorBase _editor;
		private object _target;

		public TargetAttachedPropertyListener(FormulaEditorBase editor, object target)
		{
			_editor = editor;
			_target = target;
		}
		...
		{
			if (dataItem == _target)
				_editor.OnTargetAttachedPropertyChanged(property);
		}
