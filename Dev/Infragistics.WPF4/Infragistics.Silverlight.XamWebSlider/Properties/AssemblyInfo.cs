...
[assembly: Guid("169bc7b2-99b2-444f-8ed3-1482e9ffeef0")]
...
{
    internal const string AssemblyName = AssemblyRef.AssemblyNamePrefix + ".Controls.Editors.XamSlider" + AssemblyRef.AssemblyNameSuffix;


    internal const string AssemblyProduct = "Infragistics NetAdvantage for WPF";
    internal const string AssemblyDescriptionBase = "Infragistics XamSlider for WPF";
