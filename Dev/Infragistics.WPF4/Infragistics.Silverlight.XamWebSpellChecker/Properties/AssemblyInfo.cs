...
[assembly: Guid("154727da-e17e-4d91-99f5-a6b5565660d8")]
...
class AssemblyRef
{
    internal const string AssemblyName = AssemblyRef.AssemblyNamePrefix + ".Controls.Interactions.XamSpellChecker" + AssemblyRef.AssemblyNameSuffix;


    internal const string AssemblyProduct = "Infragistics NetAdvantage for WPF";
    internal const string AssemblyDescriptionBase = "Infragistics XamSpellChecker for WPF";
