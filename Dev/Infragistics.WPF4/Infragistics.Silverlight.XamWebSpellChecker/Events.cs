...
namespace Infragistics.Controls.Interactions
{
    ...
    /// <summary>
    /// Event args for the <see cref="Infragistics.Controls.Interactions.XamSpellChecker.SpellCheckCompleted"/> event.
    /// </summary>
    public class SpellCheckCompletedEventArgs : AsyncCompletedEventArgs
    {
        /// <summary>
        /// Creates a new <see cref="SpellCheckCompletedEventArgs"/> instance. 
        /// </summary>
		...
		public SpellCheckCompletedEventArgs(Exception error,
            bool canceled,
            object state) : base(error, canceled, state)
