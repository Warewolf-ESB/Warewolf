...
[assembly: AssemblyCopyright( "Copyright(c) 2003-" + AssemblyVersion.EndCopyrightYear + " Infragistics, Inc." )]
...
//[assembly: System.Windows.Markup.XmlnsDefinition("http://infragistics.com/IO", "Infragistics.Documents.IO")]
...
{
    // MRS 6/17/2008
	//public const string BaseResourceName = "Infragistics.Documents.IO.strings";
    public const string BaseResourceName = "Infragistics.Documents.IO.strings";

	internal const string AssemblyName = AssemblyVersion.AssemblyNamePrefix + ".Documents.IO" + AssemblyVersion.AssemblyNameSuffix;
	internal const string AssemblyProduct = AssemblyVersion.AssemblyNamePrefix + ".Documents.IO";
	internal const string AssemblyDescriptionBase = "Infragistics Documents IO class library";
    ...
    //public const string GrammaticaResourceName = "Infragistics.Documents.IO.UltraCalcEngine.Compiler.Grammatica";
}
