...
namespace Infragistics.Persistence
{
	...
	public class PropertyPersistenceExceptionDetails
	{
		#region Constructor
		/// <summary>
		/// Creates a new instance of the <see cref="PropertyPersistenceExceptionDetails"/>
		/// </summary>
		/// <param name="ex"></param>
		/// <param name="pi"></param>
		/// <param name="path"></param>
		public PropertyPersistenceExceptionDetails(Exception ex, PropertyInfo pi, string path)
		{
			this.Exception = ex;
