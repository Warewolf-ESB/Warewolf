...
namespace Infragistics.Documents.Excel
{
	...
	public
		 ...
		 sealed class ExcelResourceCustomizer
	{
		#region Private Members

        private Dictionary<string, string> customizedStrings;
        ...
        private Dictionary<string, string> CustomizedStrings
		{
			get 
			{
				if ( this.customizedStrings == null )
                    this.customizedStrings = new Dictionary<string, string>();
		...
		{
			if ( this.CustomizedStrings.ContainsKey(name) )
