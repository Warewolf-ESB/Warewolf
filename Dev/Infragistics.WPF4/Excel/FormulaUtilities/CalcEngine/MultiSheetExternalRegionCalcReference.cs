...
namespace Infragistics.Documents.Excel.FormulaUtilities.CalcEngine
{
	...
	internal sealed class MultiSheetExternalRegionCalcReference : ExcelRefBase
	{
		...
		public MultiSheetExternalRegionCalcReference(WorksheetReferenceExternal firstWorksheetReference, WorksheetReferenceExternal lastWorksheetReference, WorksheetRegionAddress address)
		{
		...
		public override bool Equals(object obj)
		{
			...
			MultiSheetExternalRegionCalcReference other = ExcelCalcEngine.GetResolvedReference(reference) as MultiSheetExternalRegionCalcReference;
			if (other == null)
				return false;
