...
namespace Infragistics.Documents.Excel.FormulaUtilities.CalcEngine
{
	...
	internal sealed class MultiSheetRegionCalcReference : ExcelRefBase
	{
		...
		public MultiSheetRegionCalcReference(Worksheet firstWorksheetReference, Worksheet lastWorksheetReference, WorksheetRegionAddress regionAddress)
		{
		...
		public override bool ContainsReference(IExcelCalcReference inReference)
		{
			...
			for (int i = 0; i < regionGroup.Count; i++)
			{
				...
				if (region.Address.IntersectsWith(this.regionAddress))
					return true;
			}
		...
		public override string ElementName
		{
			get
			{
				return
					...
					this.regionAddress.ToString(false, false, this.firstWorksheetReference.CurrentFormat, CellReferenceMode.A1);
			}
		}
		...
		public override bool Equals(object obj)
		{
			...
			MultiSheetRegionCalcReference other = ExcelCalcEngine.GetResolvedReference(reference) as MultiSheetRegionCalcReference;
			if (other == null)
				return false;
			...
			return
				...
				this.regionGroup == other.regionGroup;
		}
		...
		public override int GetHashCode()
		{
			return
				...
				this.regionGroup.GetHashCode() << 2;
		}
		...
		{
			get { return this.firstWorksheetReference.Rows[this.regionAddress.FirstRowIndex]; }
		}
