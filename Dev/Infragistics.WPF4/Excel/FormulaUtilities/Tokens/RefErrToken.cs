...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Deleted cell reference operand. Indicates a reference to a cell in the same worksheet 
	//    /// which was deleted.
	//    /// </summary> 
	//#endif
	//    // MD 5/18/07 - BR23022
	//    //internal class RefErrToken : FormulaToken
	//    internal class RefErrToken : CellReferenceToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public RefErrToken( Formula formula, TokenClass tokenClass )
	//        //    : base( formula, tokenClass ) { }
	//        public RefErrToken(TokenClass tokenClass)
	//            : base(tokenClass) { }
	...
	//        //{
	//        //    return new RefErrToken( newOwningFormula, this.TokenClass );
	//        //}
	...
	//                {
	//                    case TokenClass.Array:		return Token.RefErrA;
	//                    case TokenClass.Reference:	return Token.RefErrR;
	//                    case TokenClass.Value:		return Token.RefErrV;
