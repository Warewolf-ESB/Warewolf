...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Unary minus operator.  Negates the operand on the top of the stack.
	//    /// </summary> 
	//#endif
	//    internal class UminusOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public UminusOperator( Formula formula )
	//        //    : base( formula, TokenClass.Value ) { }
	//        public UminusOperator()
	...
	//        //{
	//        //    return new UminusOperator( newOwningFormula );
	//        //}
