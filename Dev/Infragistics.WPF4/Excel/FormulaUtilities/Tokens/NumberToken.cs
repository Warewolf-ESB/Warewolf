...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Number operand. Indicates an 8-byte IEEE floating-point number constant.
	//    /// </summary> 
	//#endif
	//    // MD 8/18/08 - Excel formula solving
	//    //internal class NumberToken : FormulaToken
	//    internal class NumberToken : OperandToken
	//    {
	//        private double value;

	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public NumberToken( Formula formula )
	...
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public NumberToken( Formula formula, double value )
	//        //    : this( formula )
	...
	//        //{
	//        //    return new NumberToken( newOwningFormula, this.value );
	//        //}
	...
	//            NumberToken comparisonNumberToken = (NumberToken)comparisonToken;
	//            return this.value == comparisonNumberToken.value;
	//        }
