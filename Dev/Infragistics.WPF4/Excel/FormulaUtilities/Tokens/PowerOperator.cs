...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//    /// </summary>  
	//#endif
	//    internal class PowerOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public PowerOperator( Formula formula )
	...
	//        //{
	//        //    return new PowerOperator( newOwningFormula );
	//        //}
	...
	//        // This was incorrect, the power operator is left associative.
	...
	//        {
	//            get { return OperatorToken.Precendence4; }
	//        }

	//        public override Token Token
	//        {
	//            get { return Token.Power; }
	//        }
	//    }
