...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//internal class AttrSumToken : AttrTokenBase
	//{
	//    // MD 10/22/10 - TFS36696
	//    // We don't need to store the formula on the token anymore.
	//    //public AttrSumToken( Formula formula )
	//    //    : base( formula )
	//    public AttrSumToken()
	//        : base()
	//    {
	//        this.TokenClass = Function.SUM.ReturnClass;
	//    }
	...
	//    //{
	//    //    return new AttrSumToken( newOwningFormula );
	//    //}
	...
	//    {
	//        return Function.SUM.GetExpectedParameterClass( index );
	//    }
