...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Division operator. Divides the top operand by the second-to-top operand.
	//    /// </summary>  
	//#endif
	//    internal class DivOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public DivOperator( Formula formula )
	...
	//        //{
	//        //    return new DivOperator( newOwningFormula );
	//        //}
