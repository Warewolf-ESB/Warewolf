...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Equal operator. Evaluates TRUE if the top two operands are equal; evaluates to FALSE otherwise.
	//    /// </summary>
	//#endif
	//    internal class EQOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public EQOperator( Formula formula )
	...
	//        //{
	//        //    return new EQOperator( newOwningFormula );
	//        //}
