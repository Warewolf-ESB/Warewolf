...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Greater than or equal operator. Evaluates TRUE if the second-to-top operand is greater than or equal to 
	//    /// the top operand; evaluates to FALSE otherwise.
	//    /// </summary>
	//#endif
	//    internal class GEOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public GEOperator( Formula formula )
	...
	//        //{
	//        //    return new GEOperator( newOwningFormula );
	//        //}
