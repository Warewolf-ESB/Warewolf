...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Multiplication operator. Multiplies the top two operands.
	//    /// </summary>  
	//#endif
	//    internal class MulOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public MulOperator( Formula formula )
	...
	//        //{
	//        //    return new MulOperator( newOwningFormula );
	//        //}
	...
	//        {
	//            get { return OperatorToken.Precendence5; }
	//        }

	//        public override Token Token
	//        {
	//            get { return Token.Mul; }
	//        }
	//    }
