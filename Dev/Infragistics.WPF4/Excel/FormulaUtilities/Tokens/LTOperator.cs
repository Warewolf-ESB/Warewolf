...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Less than operator. Evaluates TRUE if the second-to-top operand is less than the top operand;
	//    /// evaluates to FALSE otherwise.
	//    /// </summary>
	//#endif
	//    internal class LTOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public LTOperator( Formula formula )
	...
	//        //{
	//        //    return new LTOperator( newOwningFormula );
	//        //}
