...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Less than or equal operator. Evaluates TRUE if the second-to-top operand is less than or equal to 
	//    /// the top operand; evaluates to FALSE otherwise.
	//    /// </summary>
	//#endif
	//    internal class LEOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public LEOperator( Formula formula )
	...
	//        //{
	//        //    return new LEOperator( newOwningFormula );
	//        //}
