...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// This token is only used to mark a matrix row separator when an 
	//    /// operator list is still in infix notation. It should never be saved.
	//    /// </summary>
	//#endif
	//    internal class MatrixRowSeparatorToken : FormulaToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public MatrixRowSeparatorToken( Formula formula )
	//        //    : base( formula, TokenClass.Control ) { }
	//        public MatrixRowSeparatorToken()
	...
	//        //{
	//        //    return new MatrixRowSeparatorToken( newOwningFormula );
	//        //}
	...
	//        {
	//            Utilities.DebugFail( "This should never have been called." );
	//            return 0;
	//        }
