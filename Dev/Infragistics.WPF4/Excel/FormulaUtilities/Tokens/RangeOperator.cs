...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Range operator. Computes the minimal bounding rectangle of the top two operands.
	//    /// This is the Excel colon operator.
	//    /// </summary> 
	//#endif
	//    internal class RangeOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public RangeOperator( Formula formula )
	...
	//        //{
	//        //    return new RangeOperator( newOwningFormula );
	//        //}
	...
	//        {
	//            return FormulaParser.RangeOperator;
	//        }

	//        public override int Precedence
	//        {
	//            get { return OperatorToken.Precendence0; }
	//        }

	//        public override Token Token
	//        {
	//            get { return Token.Range; }
	//        }
	//    }
