...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// This operator is only used to mark the start of an open paren when an 
	//    /// operator list is still in infix notation. It should never be saved.
	//    /// </summary>
	//#endif
	//    internal class OpenParenOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public OpenParenOperator( Formula formula )
	...
	//        //{
	//        //    return new OpenParenOperator( newOwningFormula );
	//        //}
