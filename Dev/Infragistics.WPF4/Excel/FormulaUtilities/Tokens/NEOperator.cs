...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Not equal operator. Evaluates TRUE if the top two operands are not equal; evaluates to FALSE otherwise.
	//    /// </summary>
	//#endif
	//    internal class NEOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public NEOperator( Formula formula )
	...
	//        //{
	//        //    return new NEOperator( newOwningFormula );
	//        //}
