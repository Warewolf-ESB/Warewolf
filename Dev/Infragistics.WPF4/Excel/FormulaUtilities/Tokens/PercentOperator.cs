...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Percent sign operator. Divides the top operand by 100.
	//    /// </summary>  
	//#endif
	//    internal class PercentOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public PercentOperator( Formula formula )
	...
	//        //{
	//        //    return new PercentOperator( newOwningFormula );
	//        //}
