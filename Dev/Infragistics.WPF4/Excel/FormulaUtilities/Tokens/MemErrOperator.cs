...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//internal class MemErrOperator : MemOperatorBase
	//{
	//    // MD 10/22/10 - TFS36696
	//    // We don't need to store the formula on the token anymore.
	//    //public MemErrOperator( Formula formula, TokenClass tokenClass )
	//    //    : base( formula, tokenClass ) { }
	//    public MemErrOperator(TokenClass tokenClass)
	//        : base(tokenClass) { }
	...
	//    //{
	//    //    MemErrOperator memErrOperator = new MemErrOperator( newOwningFormula, this.TokenClass );
	//    //    memErrOperator.SizeOfRefSubExpression = this.SizeOfRefSubExpression;
	//    //    return memErrOperator;
	//    //}
	...
	//            {
	//                case TokenClass.Array:		return Token.MemErrA;
	//                case TokenClass.Reference:	return Token.MemErrR;
	//                case TokenClass.Value:		return Token.MemErrV;

	//                default:
	//                    Utilities.DebugFail( "Invalid token class" );
	//                    return Token.MemErrV;
	//            }
	//        }
	//    }
	//}
