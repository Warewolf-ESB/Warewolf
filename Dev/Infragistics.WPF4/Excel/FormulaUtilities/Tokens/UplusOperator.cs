...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Unary plus operator. Has no effect on the operand on the top of the stack.
	//    /// </summary> 
	//#endif
	//    internal class UplusOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public UplusOperator( Formula formula )
	//        //    : base( formula, TokenClass.Value ) { }
	//        public UplusOperator()
	...
	//        //{
	//        //    return new UplusOperator( newOwningFormula );
	//        //}
	...
	//        {
	//            get { return OperatorToken.Precendence3; }
	//        }

	//        public override Token Token
	//        {
	//            get { return Token.Uplus; }
	//        }
	//    }
