...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Data table token. Indicates an interior cell in a data table.  When this token is
	//    /// present, it is the only token in the formula.
	//    /// </summary> 
	//#endif
	//    internal class TblToken : FormulaToken
	//    {
	...
	//        //public TblToken( Formula formula )
	...
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public TblToken( Formula formula, int firstColumn, int firstRow )
	//        //    : this( formula )
	//        // MD 4/12/11 - TFS67084
	//        // Use short instead of int so we don't have to cast.
	//        //public TblToken(int firstColumn, int firstRow)
	//        public TblToken(short firstColumn, int firstRow)
	//            : this()
	//        {
	...
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public TblToken( Formula formula, CellAddress cellAddress )
	//        //    : this( formula )
	//        public TblToken(CellAddress cellAddress)
	//            : this()
	//        {
	...
	//        //{
	//        //    return new TblToken( newOwningFormula, this.cellAddress.Clone() );
	//        //}
	...
	//        {
	//            return new TblToken(this.cellAddress);
	//        }
	...
	//            TblToken comparisonTblToken = (TblToken)comparisonToken;
	//            return this.cellAddress.Equals(comparisonTblToken.cellAddress);
	//        }
	...
	//            //return "<Data Table Interior, Source: " + this.cellAddress.ToString( sourceCell, cellReferenceMode ) + ">";
	//            return
	//                "<Data Table Interior, Source: " +
	//                // MD 10/22/10 - TFS36696
	//                // The token no longer stores the formula, so it needs to be passed into this method, and we can get the source cell and format from the formula.
