...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Intersection operator. Computes the intersection of the top two operands. 
	//    /// This is the Excel space operator.
	//    /// </summary>
	//#endif
	//    internal class IsectOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public IsectOperator( Formula formula )
	//        //    : base( formula, TokenClass.Reference ) { }
	//        public IsectOperator()
	...
	//        //{
	//        //    return new IsectOperator( newOwningFormula );
	//        //}
	...
	//        {
	//            get { return OperatorToken.Precendence1; }
	//        }

	//        public override Token Token
	//        {
	//            get { return Token.Isect; }
	//        }
	//    }
