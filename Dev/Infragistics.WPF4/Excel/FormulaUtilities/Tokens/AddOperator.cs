...
namespace Infragistics.Documents.Excel.FormulaUtilities.Tokens
{
	...
	//#if DEBUG
	//    /// <summary>
	//    /// Addition operator. Adds the top two operands.
	//    /// </summary> 
	//#endif
	//    internal class AddOperator : OperatorToken
	//    {
	//        // MD 10/22/10 - TFS36696
	//        // We don't need to store the formula on the token anymore.
	//        //public AddOperator( Formula formula )
	...
	//        //{
	//        //    return new AddOperator( newOwningFormula );
	//        //}
	...
	//        {
	//            get { return OperatorToken.Precendence6; }
	//        }

	//        public override Token Token
	//        {
	//            get { return Token.Add; }
	//        }
	//    }
