...
namespace Infragistics.Documents.Excel.FormulaUtilities.Constants
{
	...
	internal class NumberConstant : Constant
	{
		...
		//{
		//    return new NumberConstant( this.value );
		//}

		// MD 12/22/11 - 12.1 - Table Support
		public override bool Equals(object obj)
		{
			NumberConstant other = obj as NumberConstant;
		...
		{
			this.value = stream.ReadDoubleFromBuffer(ref data, ref dataIndex);
		}
