...

{
	internal class EvaluationResult<T>
	{
		...
		private FormulaToken tokenWithError;
		...
		public EvaluationResult( FormulaToken tokenWithError )
		{
		...
		public FormulaToken TokenWithError
		{
			get { return this.tokenWithError; }
		}
	}
}
