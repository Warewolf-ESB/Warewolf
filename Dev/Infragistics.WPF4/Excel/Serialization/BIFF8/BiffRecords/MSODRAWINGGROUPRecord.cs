...
{
	internal class MSODRAWINGGROUPRecord : Biff8RecordBase
	{
		...
		{
			DrawingGroupContainer record = new DrawingGroupContainer( manager );
			record.Save( manager );
		}

		public override BIFF8RecordType Type
		{
			get { return BIFF8RecordType.MSODRAWINGGROUP; }
		}
	}
}
