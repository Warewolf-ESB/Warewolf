...
{
	internal class STANDARDWIDTHRecord : Biff8RecordBase
	{
		public override void Load( BIFF8WorkbookSerializationManager manager )
		{
			...
			worksheet.DefaultColumnWidth = manager.CurrentRecordStream.ReadUInt16();

			// MD 3/21/12 - TFS104630
			// If we loaded a STANDARDWIDTH record, we should make sure to write it out as well on a round-tripped file.
		...
		{
			get { return BIFF8RecordType.STANDARDWIDTH; }
		}
	}
}
