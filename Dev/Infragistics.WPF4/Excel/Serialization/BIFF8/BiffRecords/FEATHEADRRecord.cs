...
namespace Infragistics.Documents.Excel.Serialization.BIFF8.BiffRecords
{
	...
	internal class FEATHEADRRecord : Biff8RecordBase
	{
		public override void Load(BIFF8WorkbookSerializationManager manager)
		{
			...
			Debug.Assert(isf == SharedFeatureType.Protection || isf == SharedFeatureType.Fec2 || isf == SharedFeatureType.Factoid, "The isf value is incorrect.");
		}
		...
		{
			get { return BIFF8RecordType.FEATHEADR; }
		}
	}
}
