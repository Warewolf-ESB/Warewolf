...
{
    internal class ClrSchemeElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "clrScheme";

        public const string QualifiedName =
            ThemePart.DefaultNamespace +
            XmlElementBase.NamespaceSeparator +
            ClrSchemeElement.LocalName;
        ...
        {
            get { return ClrSchemeElement.QualifiedName; }
        }
        ...
        {
            Utilities.DebugFail("Save() method for clrScheme element not yet implemented.");
