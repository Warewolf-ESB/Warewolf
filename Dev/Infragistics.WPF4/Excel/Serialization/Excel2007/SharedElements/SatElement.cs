...
{
    internal class SatElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "sat";

        public const string QualifiedName =
            ThemePart.DefaultNamespace +
            XmlElementBase.NamespaceSeparator +
            SatElement.LocalName;
        ...
        {
            get { return SatElement.QualifiedName; }
        }
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            int val = (int)XmlElementBase.GetAttributeValue(element.Attributes[SatElement.ValAttributeName], DataType.Int32, -1);
            if (val == -1)
            {
            ...
            try
            {
                ...
                //int newS = 255 * (val / 100000);
				int newS = Utilities.HLSMAX * val / 100000;
        ...
        {
            Utilities.DebugFail("Save() method for sat element not yet implemented.");
        }
