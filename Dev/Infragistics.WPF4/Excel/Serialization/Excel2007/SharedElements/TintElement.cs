...

{
    ...
    internal class TintElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "tint";

        public const string QualifiedName =
            ThemePart.DefaultNamespace +
            XmlElementBase.NamespaceSeparator +
            TintElement.LocalName;
        ...
        {
            get { return TintElement.QualifiedName; }
        }
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            int val = (int)XmlElementBase.GetAttributeValue(element.Attributes[TintElement.ValAttributeName], DataType.Int32, -1);
            if (val == -1)
            {
        ...
        {
            Utilities.DebugFail("Save() method for tint element not yet implemented.");
        }
