...

{
	internal class VariantElement : XmlElementBase
	{
		...
		protected override void Save( Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, ref string value )
		{
			...
			ST_VectorBaseType variantType = VariantBaseElement.GetVariantType( collectionContext.CurrentItem.GetType() );
			string elementQualifiedName = VariantBaseElement.GetVariantElementQualifiedName( variantType );
			XmlElementBase.AddElement( element, elementQualifiedName );
		}
	}
}
