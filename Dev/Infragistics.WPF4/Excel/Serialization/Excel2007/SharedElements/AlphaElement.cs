...
namespace Infragistics.Documents.Excel.Serialization.Excel2007.SharedElements
{
    ...
    internal class AlphaElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "alpha";

        public const string QualifiedName =
            ThemePart.DefaultNamespace +
            XmlElementBase.NamespaceSeparator +
            AlphaElement.LocalName;
        ...
        {
            get { return AlphaElement.QualifiedName; }
        }
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            int val = (int)XmlElementBase.GetAttributeValue(element.Attributes[AlphaElement.ValAttributeName], DataType.Int32, -1);
            if (val == -1)
            {
        ...
        {
            Utilities.DebugFail("Save() method for alpha element not yet implemented.");
        }
