...
{
    internal class LumElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "lum";

        public const string QualifiedName =
            ThemePart.DefaultNamespace +
            XmlElementBase.NamespaceSeparator +
            LumElement.LocalName;
        ...
        {
            get { return LumElement.QualifiedName; }
        }
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            int val = (int)XmlElementBase.GetAttributeValue(element.Attributes[LumElement.ValAttributeName], DataType.Int32, -1);
            if (val == -1)
            {
            ...
            try
            {
                ...
                //int newL = 255 * (val / 100000);
				int newL = Utilities.HLSMAX * val / 100000;
        ...
        {
            Utilities.DebugFail("Save() method for lum element not yet implemented.");
        }
