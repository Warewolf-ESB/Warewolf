...

{
    ...
    internal class GreenOffElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "greenOff";

        public const string QualifiedName =
            ThemePart.DefaultNamespace +
            XmlElementBase.NamespaceSeparator +
            GreenOffElement.LocalName;
        ...
        {
            get { return GreenOffElement.QualifiedName; }
        }
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            int val = (int)XmlElementBase.GetAttributeValue(element.Attributes[GreenOffElement.ValAttributeName], DataType.Int32, -1);
            if (val == -1)
            {
        ...
        {
            Utilities.DebugFail("Save() method for greenOff element not yet implemented.");
        }
