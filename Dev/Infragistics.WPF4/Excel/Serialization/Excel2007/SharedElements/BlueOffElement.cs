...

{
    ...
    internal class BlueOffElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "blueOff";

        public const string QualifiedName =
            ThemePart.DefaultNamespace +
            XmlElementBase.NamespaceSeparator +
            BlueOffElement.LocalName;
        ...
        {
            get { return BlueOffElement.QualifiedName; }
        }
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            int val = (int)XmlElementBase.GetAttributeValue(element.Attributes[BlueOffElement.ValAttributeName], DataType.Int32, -1);
            if (val == -1)
            {
        ...
        {
            Utilities.DebugFail("Save() method for blueOff element not yet implemented.");
        }
