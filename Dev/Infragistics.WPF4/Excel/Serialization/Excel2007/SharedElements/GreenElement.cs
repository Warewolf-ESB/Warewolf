...
{    
    ...
    internal class GreenElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "green";

        public const string QualifiedName =
            ThemePart.DefaultNamespace +
            XmlElementBase.NamespaceSeparator +
            GreenElement.LocalName;
        ...
        {
            get { return GreenElement.QualifiedName; }
        }
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            int val = (int)XmlElementBase.GetAttributeValue(element.Attributes[GreenElement.ValAttributeName], DataType.Int32, -1);
            if (val == -1)
            {
        ...
        {
            Utilities.DebugFail("Save() method for green element not yet implemented.");
        }
