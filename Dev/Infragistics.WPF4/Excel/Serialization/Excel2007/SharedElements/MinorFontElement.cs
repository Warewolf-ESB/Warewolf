...
{
	// MD 2/9/12 - TFS89375
	internal class MinorFontElement : XmlElementBase
	{
		#region XML Schema Fragment

		//<complexType name="CT_MinorFont">
		//  <sequence>
		...
		public const string LocalName = "minorFont";
		...
		{
			get { return MinorFontElement.QualifiedName; }
		}
		...
		protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
		{
			...
			manager.ContextStack.Push(manager.MinorFonts);
		}
