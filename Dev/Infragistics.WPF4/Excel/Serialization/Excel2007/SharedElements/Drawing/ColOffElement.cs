...

{
    ...
    internal class ColOffElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "colOff";
        ...
        {
            get { return ColOffElement.QualifiedName; }
        }
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            object convertedValue = XmlElementBase.GetValue( value, DataType.Long, 0 );

            //  Set the ColOffset property
            oneCellAnchor.CurrentCellPos.ColOffset = (long)convertedValue;
        }
        ...
        protected override void Save(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, ref string value)
        {
            ...
            value = cellAnchor.CurrentCellPos.ColOffset.ToString();
        }
