...

{
    ...
    internal class ToElement : ToFromElementBase
    {
        #region Constants

        public const string LocalName = "to";
        ...
        {
            get { return ToElement.QualifiedName; }
        }
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            cellAnchor.CurrentCellPos = cellAnchor.CellPosTo;
        }
        ...
        protected override void Save(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, ref string value)
        {
            ...
            serializationManager.CellAnchor.CurrentCellPos = serializationManager.CellAnchor.CellPosTo;
