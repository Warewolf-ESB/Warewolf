...
{
	// MD 11/8/11 - TFS85193
	internal class PElement : XmlElementBase
	{
		...
		public const string LocalName = "p";
		...
		{
			get { return PElement.QualifiedName; }
		}
		...
		protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
		{
			...
			FormattedTextParagraph paragraph = fs.Paragraphs.Add(string.Empty);
			manager.ContextStack.Push(paragraph);
		}
