...
{
	// MD 8/23/11 - TFS84306
	internal class NoFillElement : XmlElementBase
	{
		...
		{
			get { return NoFillElement.QualifiedName; }
		}
		...
		{
			// MD 7/5/12 - TFS115688
			// If this element is in the context of the extLst, don't do anything.
			if (manager.ContextStack[typeof(ExtLstContext)] != null)
				return;
