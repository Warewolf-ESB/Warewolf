...

{
	...
	internal class EndCxnElement : XmlElementBase
	{
		...
		public const string LocalName = "endCxn";
		...
		{
			get { return EndCxnElement.QualifiedName; }
		}
		...
		protected override void Load( Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode )
		{
			...
			foreach ( ExcelXmlAttribute attribute in element.Attributes )
			{
				...
				switch ( attributeName )
				{
					...
					case EndCxnElement.IdAttributeName:
					{
					...
					case EndCxnElement.IdxAttributeName:
					{
		...
		protected override void Save( Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, ref string value )
		{
			...
			XmlElementBase.AddAttribute(element, EndCxnElement.IdAttributeName, attributeValue);
			...
			XmlElementBase.AddAttribute(element, EndCxnElement.IdxAttributeName, attributeValue);
