...

{
    ...
    internal class NvGrpSpPrElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "nvGrpSpPr";
        ...
        {
            get { return NvGrpSpPrElement.QualifiedName; }
        }
