...

{
    ...
    internal class RedOffElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "redOff";

        public const string QualifiedName =
            ThemePart.DefaultNamespace +
            XmlElementBase.NamespaceSeparator +
            RedOffElement.LocalName;
        ...
        {
            get { return RedOffElement.QualifiedName; }
        }
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            int val = (int)XmlElementBase.GetAttributeValue(element.Attributes[RedOffElement.ValAttributeName], DataType.Int32, -1);
            if (val == -1)
            {
            ...
            try
            {
                // val should be between -100000 and 100000 where 0 = 0%, 100000 = 100%, and -100000 = -100%
                ...
                if (val > 255)
                    ...
                    val = 0;
                color = Color.FromArgb(color.A, (byte)val, color.G, color.B);
            }
            catch (Exception ex)
            {
        ...
        {
            Utilities.DebugFail("Save() method for redOff element not yet implemented.");
        }
