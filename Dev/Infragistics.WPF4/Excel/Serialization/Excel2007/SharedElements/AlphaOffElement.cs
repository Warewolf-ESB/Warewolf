...

{
    ...
    internal class AlphaOffElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "alphaOff";

        public const string QualifiedName =
            ThemePart.DefaultNamespace +
            XmlElementBase.NamespaceSeparator +
            AlphaOffElement.LocalName;
        ...
        {
            get { return AlphaOffElement.QualifiedName; }
        }
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            int val = (int)XmlElementBase.GetAttributeValue(element.Attributes[AlphaOffElement.ValAttributeName], DataType.Int32, -1);
            if (val == -1)
            {
        ...
        {
            Utilities.DebugFail("Save() method for alphaOff element not yet implemented.");
        }
