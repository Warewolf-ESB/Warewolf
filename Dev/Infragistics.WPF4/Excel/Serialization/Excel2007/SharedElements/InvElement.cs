...

{
    ...
    internal class InvElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "inv";

        public const string QualifiedName =
            ThemePart.DefaultNamespace +
            XmlElementBase.NamespaceSeparator +
            InvElement.LocalName;
        ...
        {
            get { return InvElement.QualifiedName; }
        }
        ...
        {
            Utilities.DebugFail("Save() method for inv element not yet implemented.");
        }
