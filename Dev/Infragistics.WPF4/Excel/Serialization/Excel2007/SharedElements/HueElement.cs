...
{
    internal class HueElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "hue";

        public const string QualifiedName =
            ThemePart.DefaultNamespace +
            XmlElementBase.NamespaceSeparator +
            HueElement.LocalName;
        ...
        {
            get { return HueElement.QualifiedName; }
        }
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            int val = (int)XmlElementBase.GetAttributeValue(element.Attributes[HueElement.ValAttributeName], DataType.Int32, -1);
            if (val == -1)
            {
            ...
            try
            {
                ...
                //int newH = val / 60000;
				int newH = (int)(Utilities.HLSMAX * ((val / 60000d) / 360d));
				
                color = Utilities.ConvertHLSToRGB(newH, l, s);
            }
            catch (Exception ex)
            {
        ...
        {
            Utilities.DebugFail("Save() method for hue element not yet implemented.");
        }
