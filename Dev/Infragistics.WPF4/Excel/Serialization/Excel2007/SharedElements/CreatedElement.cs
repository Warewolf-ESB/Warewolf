...
{
    internal class CreatedElement : XmlElementBase
	{
		#region Constants

		public const string LocalName = "created";

		public const string QualifiedName =
			CorePropertiesPart.DctermsNamespace +
			//XmlElementBase.NamespaceSeparator +
			CreatedElement.LocalName;

		public const string TypeAttributeDefaultValue = "dcterms:W3CDTF";
		...
		{
			get { return CreatedElement.QualifiedName; }
		}
		...
		protected override void Load( Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode )
		{
			...
			//
			//DateTime createdTime = PackageUtilities.ParseW3CDTFValue( value );
		}
