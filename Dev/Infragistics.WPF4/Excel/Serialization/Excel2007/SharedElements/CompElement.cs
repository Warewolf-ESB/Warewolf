...
{    
    ...
    internal class CompElement : XmlElementBase
    {
        #region Constants

        public const string LocalName = "comp";

        public const string QualifiedName =
            ThemePart.DefaultNamespace +
            XmlElementBase.NamespaceSeparator +
            CompElement.LocalName;
        ...
        {
            get { return CompElement.QualifiedName; }
        }
        ...
        {
            Utilities.DebugFail("Save() method for comp element not yet implemented.");
        }
