...
{
    internal class OddHeaderElement : XLSXElementBase
    {
        #region Constants
        ...
        public const string LocalName = "oddHeader";
        ...
        {
            get { return XLSXElementType.oddHeader; }
        }
        #endregion //Type
...
#region Infragistics Source Cleanup (Region)
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            string headerText = (string)XmlElementBase.GetValue(value, DataType.ST_Xstring, String.Empty);

            //  BF 8/8/08
            //  Get the PrintOptions reference off the context stack, and use that
            //worksheet.PrintOptions.Header = headerText;
...
#region Infragistics Source Cleanup (Region)
        ...
        protected override void Save(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, ref string value)
        {
            ...
            //  BF 8/8/08
            //  Get the PrintOptions reference off the context stack, and use that
            //value = worksheet.PrintOptions.Header;
            PrintOptions options = manager.ContextStack[typeof(PrintOptions)] as PrintOptions;            
            if ( options == null )
            {
                Debug.Assert( false, "Couldn't get expected context." );
