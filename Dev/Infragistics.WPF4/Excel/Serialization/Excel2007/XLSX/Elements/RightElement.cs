...

{
    ...
    //class RightElement : XLSXElementBase
	internal class RightElement : BorderSideElementBase
    {
        #region Constants

        public const string LocalName = "right";

        public const string QualifiedName =
            XLSXElementBase.DefaultXmlNamespace +
            XmlElementBase.NamespaceSeparator +
            RightElement.LocalName;
        ...
        {
            get { return XLSXElementType.right; }
        }
        #endregion Type
