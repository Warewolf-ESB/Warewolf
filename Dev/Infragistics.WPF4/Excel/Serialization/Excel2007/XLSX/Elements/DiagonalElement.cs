...
namespace Infragistics.Documents.Excel.Serialization.Excel2007.XLSX.Elements
{
    ...
    //class DiagonalElement : XLSXElementBase
	internal class DiagonalElement : BorderSideElementBase
    {
        #region Constants

        public const string LocalName = "diagonal";

        public const string QualifiedName =
            XLSXElementBase.DefaultXmlNamespace +
            XmlElementBase.NamespaceSeparator +
            DiagonalElement.LocalName;
        ...
        {
            get { return XLSXElementType.diagonal; }
        }
        #endregion Type
