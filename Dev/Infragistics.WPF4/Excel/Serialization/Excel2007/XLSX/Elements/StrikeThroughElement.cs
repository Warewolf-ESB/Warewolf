...
{
    class StrikeThroughElement : XLSXElementBase
    {
        #region Constants

        public const string LocalName = "strike";

        public const string QualifiedName =
            XLSXElementBase.DefaultXmlNamespace +
            XmlElementBase.NamespaceSeparator +
            StrikeThroughElement.LocalName;
        ...
        {
            get { return XLSXElementType.strike; }
        }
        #endregion Type
...
#region Infragistics Source Cleanup (Region)
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            foreach (ExcelXmlAttribute attribute in element.Attributes)
            {
                ...
                {
                    case StrikeThroughElement.ValAttributeName:
                        bool val = (bool)XLSXElementBase.GetAttributeValue(attribute, DataType.Boolean, true);
                        if (val)
                            fontData.Strikeout = ExcelDefaultableBoolean.True;
                        else
                            fontData.Strikeout = ExcelDefaultableBoolean.False;
                        break;

                    default:
                        Utilities.DebugFail("Unknown attribute type in the strike element: " + attributeName);
                        break;
                }
            }
            ...
            if (fontData.Strikeout == ExcelDefaultableBoolean.Default)
                fontData.Strikeout = ExcelDefaultableBoolean.True;
        }
...
#region Infragistics Source Cleanup (Region)
        ...
        protected override void Save(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, ref string value)
        {
            ...
            if (fontData != null)
            {
                ...
                if (fontData.Strikeout == ExcelDefaultableBoolean.False || fontData.Strikeout == ExcelDefaultableBoolean.Default)
                    XLSXElementBase.AddAttribute(element, BoldElement.ValAttributeName, XLSXElementBase.GetXmlString(false, DataType.Boolean));
            }
        }
		...
		{
			writer.WriteElementString(StrikeThroughElement.LocalName, null);
		} 
