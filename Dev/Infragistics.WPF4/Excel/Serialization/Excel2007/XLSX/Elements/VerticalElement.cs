...

{
    ...
    //class VerticalElement : XLSXElementBase
	internal class VerticalElement : BorderSideElementBase
    {
        #region Constants

        public const string LocalName = "vertical";

        public const string QualifiedName =
            XLSXElementBase.DefaultXmlNamespace +
            XmlElementBase.NamespaceSeparator +
            VerticalElement.LocalName;
        ...
        {
            get { return XLSXElementType.vertical; }
        }
        #endregion Type
