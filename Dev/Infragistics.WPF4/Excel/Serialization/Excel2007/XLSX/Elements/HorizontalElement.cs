...

{
    ...
    //class HorizontalElement : XLSXElementBase
	internal class HorizontalElement : BorderSideElementBase
    {
        #region Constants

        public const string LocalName = "horizontal";

        public const string QualifiedName =
            XLSXElementBase.DefaultXmlNamespace +
            XmlElementBase.NamespaceSeparator +
            HorizontalElement.LocalName;
        ...
        {
            get { return XLSXElementType.horizontal; }
        }
        #endregion Type
