...
namespace Infragistics.Documents.Excel.Serialization.Excel2007.XLSX.Elements
{
    ...
    internal class WorkbookProtectionElement : XLSXElementBase
    {
        ...
        public const string LocalName = "workbookProtection";
        ...
        public const string QualifiedName =
			...
			WorkbookProtectionElement.LocalName;

		private const string LockStructureAttributeName = "lockStructure";
        ...
        {
            get { return XLSXElementType.workbookProtection; }
        }
        #endregion //Type
...
#region Infragistics Source Cleanup (Region)
        ...
        protected override void Load(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, string value, ref bool isReaderOnNextNode)
        {
            ...
            foreach (ExcelXmlAttribute attribute in element.Attributes)
            {
                ...
                {
					case WorkbookProtectionElement.LockStructureAttributeName:
                    {
                        attributeValue = XmlElementBase.GetAttributeValue(attribute, DataType.Boolean, false);
                        manager.Workbook.Protected = (bool)attributeValue;                        
                    }
                    break;
...
#region Infragistics Source Cleanup (Region)
        ...
        protected override void Save(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, ref string value)
        {
            ...
            // Add the 'workbookProtection' attribute
			attributeValue = XmlElementBase.GetXmlString(workbook.Protected, DataType.Boolean, false, false);
            XmlElementBase.AddAttribute(element, WorkbookProtectionElement.LockStructureAttributeName, attributeValue);
        }
        #endregion //Save
