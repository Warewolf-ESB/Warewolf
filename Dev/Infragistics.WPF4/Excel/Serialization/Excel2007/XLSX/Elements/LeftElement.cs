...

{
    ...
    //class LeftElement : XLSXElementBase
	internal class LeftElement : BorderSideElementBase
    {
        #region Constants

        public const string LocalName = "left";

        public const string QualifiedName =
            XLSXElementBase.DefaultXmlNamespace +
            XmlElementBase.NamespaceSeparator +
            LeftElement.LocalName;
        ...
        {
            get { return XLSXElementType.left; }
        }
        #endregion Type
