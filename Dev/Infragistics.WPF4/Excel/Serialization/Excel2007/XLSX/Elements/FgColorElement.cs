...
{
    class FgColorElement : ColorElement
    {
        #region Constants

        public new const string LocalName = "fgColor";

        public new const string QualifiedName =
            XLSXElementBase.DefaultXmlNamespace +
            XmlElementBase.NamespaceSeparator +
            FgColorElement.LocalName;
        ...
        {
            get { return XLSXElementType.fgColor; }
        }
        #endregion Type
...
#region Infragistics Source Cleanup (Region)
        ...
        protected override void Save(Excel2007WorkbookSerializationManager manager, ExcelXmlElement element, ref string value)
        {
            ...
            if (patternFillInfo.ForegroundColor != null)
                this.SaveColorElement(patternFillInfo.ForegroundColor, manager, element, ref value);
        }
		...
		protected override void OnAfterLoadChildElements( Excel2007WorkbookSerializationManager manager, ElementDataCache elementCache )
        {
            ...
            patternFillInfo.ForegroundColor = colorInfo;
        }
