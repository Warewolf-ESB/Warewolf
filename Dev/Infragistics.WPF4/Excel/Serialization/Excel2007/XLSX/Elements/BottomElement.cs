...

{
    ...
    //class BottomElement : XLSXElementBase
	internal class BottomElement : BorderSideElementBase
    {
        #region Constants

        public const string LocalName = "bottom";

        public const string QualifiedName =
            XLSXElementBase.DefaultXmlNamespace +
            XmlElementBase.NamespaceSeparator +
            BottomElement.LocalName;
        ...
        {
            get { return XLSXElementType.bottom; }
        }
        #endregion Type
