...
{
	// MD 9/25/09 - TFS21642
	internal class ExcelXmlDeclaration : ExcelXmlNode
	{
		private string version;
		private string encoding;
		private string standalone;

		internal ExcelXmlDeclaration( string version, string encoding, string standalone, ExcelXmlDocument ownerDocument )
			: base( ownerDocument )
		{
		...
		public override void WriteStart()
		{
            ...
            string declaration = Utilities.GetXmlDeclaration( this.version, this.encoding, this.standalone );
