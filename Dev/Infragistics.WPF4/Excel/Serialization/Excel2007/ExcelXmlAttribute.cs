...
{
	// MD 9/25/09 - TFS21642
	internal class ExcelXmlAttribute : ExcelXmlNode
	{
		...
		internal ExcelXmlAttribute( string prefix, string localName, string namespaceURI, ExcelXmlDocument ownerDocument )
			: base( ownerDocument )
		{
		...
		public ExcelXmlDocument OwnerElement
		{
			get { return this.ParentNode as ExcelXmlDocument; }
		}
	}
}
