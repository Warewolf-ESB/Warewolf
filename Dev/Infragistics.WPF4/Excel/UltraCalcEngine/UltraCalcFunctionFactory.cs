...

{
            ...
            class UltraCalcFunctionFactory : IEnumerable
	{
		...
		public UltraCalcFunctionFactory()
		{
			...
			this.Add( new UltraCalcFunctionAddress() );
			this.Add( new UltraCalcFunctionAreas() );

			// MD 4/3/12 - TFS99854
			this.Add(new UltraCalcFunctionAverageIf());

			this.Add( new UltraCalcFunctionColumn() );
			this.Add( new UltraCalcFunctionColumns() );
			this.Add( new UltraCalcFunctionCorrel() );

			// MD 4/3/12 - TFS99854
			this.Add(new UltraCalcFunctionCountIf());

			this.Add( new UltraCalcFunctionCovar() );
			this.Add( new UltraCalcFunctionForecast() );

			// MD 7/9/10 - TFS35240
			this.Add(new UltraCalcFunctionHLookup());

			this.Add( new UltraCalcFunctionHyperlink() );
			this.Add( new UltraCalcFunctionIndex() );
			this.Add( new UltraCalcFunctionIndirect() );
			this.Add( new UltraCalcFunctionIntercept() );

			// MD 10/14/10 - TFS48845
			this.Add(new UltraCalcFunctionLookup());

			// MD 3/2/12 - TFS103729
			this.Add(new UltraCalcFunctionMatch());

			this.Add( new UltraCalcFunctionMdeterm() );
			this.Add( new UltraCalcFunctionMinverse() );
			this.Add( new UltraCalcFunctionMmult() );
			this.Add( new UltraCalcFunctionOffset() );
			this.Add( new UltraCalcFunctionPearson() );
			this.Add( new UltraCalcFunctionRow() );
			this.Add( new UltraCalcFunctionRows() );
			this.Add( new UltraCalcFunctionRsq() );
			this.Add( new UltraCalcFunctionSlope() );
			this.Add( new UltraCalcFunctionSteyx() );

			// MD 4/2/12 - TFS99854
			this.Add(new UltraCalcFunctionSumIf());

			this.Add( new UltraCalcFunctionSumproduct() );
			this.Add( new UltraCalcFunctionSumx2my2() );
			this.Add( new UltraCalcFunctionSumx2py2() );
			this.Add( new UltraCalcFunctionSumxmy2() );
			this.Add( new UltraCalcFunctionTranspose() );

			// MD 7/9/10 - TFS35240
			this.Add(new UltraCalcFunctionVLookup());

			this.Add( new UltraCalcFunctionXLIntersect() );
			this.Add( new UltraCalcFunctionXLRange() );
			this.Add( new UltraCalcFunctionXLUnion() );
