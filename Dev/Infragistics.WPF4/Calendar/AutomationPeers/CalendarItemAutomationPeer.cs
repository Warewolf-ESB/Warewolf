...
namespace Infragistics.AutomationPeers
{
        ...
        IInvokeProvider
    {
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="CalendarBase"/> class
        /// </summary>
        ...
        public CalendarItemAutomationPeer(CalendarItem owner)
            : base(owner)
        {
            this._calendar = CalendarBase.GetCalendar(owner.Group);
        }
        ...
        void IInvokeProvider.Invoke()
        {
            ...
            if (this._calendar.CurrentMode > this._calendar.MinCalendarModeResolved)
                _calendar.ExecuteCommand(CalendarCommandType.ZoomInCalendarMode, null, calendarItem);
        }
