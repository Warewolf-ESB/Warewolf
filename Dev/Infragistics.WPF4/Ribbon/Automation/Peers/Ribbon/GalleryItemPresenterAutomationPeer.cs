...
namespace Infragistics.Windows.Automation.Peers.Ribbon
{
    ...
    /// </summary>
    public class GalleryItemPresenterAutomationPeer : FrameworkElementAutomationPeer
    {
        #region Constructor
        /// <summary>
        /// Creates a new instance of the <see cref="GalleryItemPresenterAutomationPeer"/> class
        /// </summary>
        /// <param name="owner">The <see cref="GalleryItemPresenter"/> for which the peer is being created</param>
        public GalleryItemPresenterAutomationPeer(GalleryItemPresenter owner)
            : base(owner)
        {
        }
