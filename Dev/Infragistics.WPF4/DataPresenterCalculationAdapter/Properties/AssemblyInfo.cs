...
[assembly: Guid("8E052F7A-88DE-4A6D-8D9D-86596F8D1D8E")]
...
[assembly: InternalsVisibleTo("InfragisticsWPF4.DataPresenter.DataPresenterCalculationAdapter.UnitTests.v" + AssemblyVersion.MajorMinor)]
[assembly: InternalsVisibleTo("Infragistics.WPF.UnitTests")]

class AssemblyRef
{
	public const string BaseResourceName = "Infragistics.Windows.DataPresenter.Calculations.strings";

	internal const string AssemblyName = "InfragisticsWPF4.DataPresenter.CalculationAdapter.v" + AssemblyVersion.MajorMinor;
	internal const string AssemblyProduct = "Infragistics NetAdvantage for WPF";
	internal const string AssemblyDescriptionBase = "DataPresenterCalculationAdapter Component for WPF";
