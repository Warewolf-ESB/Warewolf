...
namespace Infragistics.Windows.Themes.Lipstick
{
	...
	/// <summary>
	/// Class used to supply style resources for the Lipstick theme for primitive elements that are shared
	/// </summary>
	public class Primitives : PrimitivesResourceSet<Primitives.Locator>
	{

		#region Instance static property

		private static Primitives g_Instance;
		...
		public class Locator : ResourceSetLocator
		{
			...
			public override string Grouping { get { return PrimitivesGeneric.Location.Grouping; } }
			/// <summary>The path to the embedded resources within the assembly</summary>
			public override string ResourcePath { get { return @"ResourceSets\Primitives\Primitives.xaml"; } }
		}
	}
