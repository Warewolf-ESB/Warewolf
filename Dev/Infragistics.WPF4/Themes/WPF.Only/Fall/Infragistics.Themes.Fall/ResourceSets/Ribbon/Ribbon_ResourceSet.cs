...
{
	/// <summary>
	/// Class used to supply Ribbon style resources for the Fall theme
	/// </summary>	
	public class Ribbon : RibbonResourceSet<Ribbon.Locator>
	{
		#region Instance static property

		private static Ribbon g_Instance;
		...
		public class Locator : ResourceSetLocator
		{
			...
			public override string Grouping { get { return RibbonGeneric.Location.Grouping; } }
			/// <summary>The path to the embedded resources within the assembly</summary>
			public override string ResourcePath { get { return @"ResourceSets\Ribbon\Ribbon.xaml"; } }
		}
	}
}
