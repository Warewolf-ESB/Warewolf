...
namespace Infragistics.Windows.Themes.ForestGreen
{
	...
	/// <summary>
	/// Class used to supply DataPresenter style resources for the ForestGreen theme
	/// </summary>
	public class DataPresenter : DataPresenterResourceSet<DataPresenter.Locator>
	{
		...
		public class Locator : ResourceSetLocator
		{
			...
			public override string Grouping { get { return DataPresenterGeneric.Location.Grouping; } }
