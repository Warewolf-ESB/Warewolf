...
{
	/// <summary>
	/// Class used to supply MonthCalendar style resources for the ForestGreen theme
	/// </summary>	
	public class MonthCalendar : EditorsResourceSet<MonthCalendar.Locator>
	{
		#region Instance static property

		private static MonthCalendar g_Instance;
		...
		public class Locator : ResourceSetLocator
		{
			...
			public override string ResourcePath { get { return @"ResourceSets\MonthCalendar\MonthCalendar.xaml"; } }
		}
	}
}
