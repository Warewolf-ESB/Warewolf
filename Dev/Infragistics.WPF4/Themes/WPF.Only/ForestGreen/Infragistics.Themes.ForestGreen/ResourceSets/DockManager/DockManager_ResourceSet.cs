...
{
	/// <summary>
	/// Class used to supply DockManager style resources for the ForestGreen theme
	/// </summary>	
	public class DockManager : DockManagerResourceSet<DockManager.Locator>
	{
		#region Instance static property

		private static DockManager g_Instance;
		...
		public class Locator : ResourceSetLocator
		{
			...
			public override string Grouping { get { return DockManagerGeneric.Instance.Grouping; } }
			/// <summary>The path to the embedded resources within the assembly</summary>
			public override string ResourcePath { get { return @"ResourceSets\DockManager\DockManager.xaml"; } }
		}
	}
}
