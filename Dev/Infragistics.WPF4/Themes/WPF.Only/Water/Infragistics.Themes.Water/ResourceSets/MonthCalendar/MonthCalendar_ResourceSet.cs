...
namespace Infragistics.Windows.Themes.Water
{
	/// <summary>
	/// Class used to supply MonthCalendar style resources for the Water theme
	/// </summary>	
	public class MonthCalendar : EditorsResourceSet<MonthCalendar.Locator>
	{
		...
		public class Locator : ResourceSetLocator
		{
			...
			public override string Theme { get { return "Water"; } }
