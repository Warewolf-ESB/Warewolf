...
{
    internal class SplineFragmentBucketCalculator : AnchoredCategoryBucketCalculator
    {
        internal SplineFragmentBucketCalculator(AnchoredCategorySeriesView view) : base(view) { }
        internal override float[] GetBucket(int bucket)
        {
            ...
            SplineFragmentBase fragment = this.AnchoredView.AnchoredModel as SplineFragmentBase;
