...
namespace Infragistics.Controls.Charts
{
    ...
    public class LineFragment : FragmentBase
    {
        ...
        {
            DefaultStyleKey = typeof(LineFragment);
        }
        ...
        internal LineFragmentView LineFragmentView { get; set; }
        /// <summary>
        ...
        protected internal override void OnViewCreated(SeriesView view)
        {
            ...
            LineFragmentView = (LineFragmentView)view;
        }
        #endregion
        ...
        protected internal override void ClearRendering(bool wipeClean, SeriesView view)
        {
            ...
            var lineFragmentView = (LineFragmentView)view;
        ...
        internal override void RenderFrame(CategoryFrame frame, CategorySeriesView view)
        {
            ...
            LineFragmentView lineFragmentView = view as LineFragmentView;

            LineRasterizer.RasterizePolylinePaths(lineFragmentView.polyline0, lineFragmentView.polygon01, lineFragmentView.polyline1, frame.Buckets.Count,
                x0, y0, x1, y1, UnknownValuePlotting.LinearInterpolate, GetLineClipper(x0, frame.Buckets.Count - 1, view.Viewport, view.WindowRect),
