...
{
    internal class PolarAreaSeriesView
        : PolarLineSeriesBaseView
    {
        protected PolarAreaSeries PolarAreaModel { get; set; }
        public PolarAreaSeriesView(PolarAreaSeries model)
            : base(model)
        {
            PolarAreaModel = model;
        }

        private Path polyline = new Path();
        ...
        internal void ClearPolarArea()
        {
            polygon.Data = null;
            polyline.Data = null;
        }

        internal void RenderPolarArea(IList<Point> points, double Resolution)
        {
            PolarAreaModel.CurrentRenderer.Render(polyline, points, Resolution);
            PolarAreaModel.CurrentRenderer.Render(polygon, points, Resolution);
        }
    }
}
