...
namespace Infragistics.Controls.Charts
{
    ...
    /// </summary>
    public sealed class PolarSplineAreaSeries
        : PolarLineSeriesBase
    {
        /// <summary>
        ...
        protected internal override void OnViewCreated(SeriesView view)
        {
            ...
            PolarSplineAreaView = (PolarSplineAreaSeriesView)view;
        }
        internal PolarSplineAreaSeriesView PolarSplineAreaView { get; set; }
        ...
        {
            DefaultStyleKey = typeof(PolarSplineAreaSeries);
        }
        ...
        {
            var splineAreaView = (PolarSplineAreaSeriesView)view; 
        ...
        internal override void RenderPoints(PolarFrame frame, PolarBaseView view)
        {
            ...
            var polarSplineAreaView = (PolarSplineAreaSeriesView)view;
            polarSplineAreaView.RenderPolarSplineArea(frame.Points, Stiffness);
        ...
        public static readonly DependencyProperty StiffnessProperty = DependencyProperty.Register(
            StiffnessPropertyName, 
            typeof(double), 
            typeof(PolarSplineAreaSeries),
            new PropertyMetadata(0.5, (sender, e) =>
            {
                (sender as PolarSplineAreaSeries).RaisePropertyChanged(StiffnessPropertyName, e.OldValue, e.NewValue);
            }));
        #endregion
