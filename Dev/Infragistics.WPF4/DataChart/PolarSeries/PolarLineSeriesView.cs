...
{
    internal class PolarLineSeriesView
        : PolarLineSeriesBaseView
    {
        protected PolarLineSeries PolarLineModel { get; set; }
        public PolarLineSeriesView(PolarLineSeries model)
            : base(model)
        {
            PolarLineModel = model;
        }
        ...
        public override void AttachUI(Canvas rootCanvas)
        {
            ...
            polyline.SetBinding(Shape.StrokeProperty, new Binding(Series.ActualBrushPropertyName) { Source = Model });
            ...
            VisualInformationManager.SetIsMainGeometryVisual(polyline, true);
        ...
        internal void ClearPolarLine()
        {
            polyline.Data = null;
        }

        internal void RenderPolarLine(System.Collections.Generic.List<Point> points, double resolution)
        {
            PolarLineModel.CurrentRenderer.Render(polyline, points, resolution);
        }
