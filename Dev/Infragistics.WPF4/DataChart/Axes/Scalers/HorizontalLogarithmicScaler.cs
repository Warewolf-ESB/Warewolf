...
namespace Infragistics.Controls.Charts
{
    ...
    /// </summary>
    public class HorizontalLogarithmicScaler : LogarithmicScaler
    {
...
#region Infragistics Source Cleanup (Region)
            ...
            if (unscaledValue <= 0)
            {
                scaledValue = (Math.Log(CachedActualMinimumValue) - LogActualMinimumValue) / (LogActualMaximumValue - LogActualMinimumValue);
            }
            else
            {
