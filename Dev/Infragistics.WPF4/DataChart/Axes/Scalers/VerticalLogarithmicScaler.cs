...
namespace Infragistics.Controls.Charts
{
    ...
    /// </summary>
    public class VerticalLogarithmicScaler : LogarithmicScaler
    {
...
#region Infragistics Source Cleanup (Region)
        ...
        {
            double unscaledValue = windowRect.Top + windowRect.Height * (scaledValue - viewportRect.Top) / viewportRect.Height;
