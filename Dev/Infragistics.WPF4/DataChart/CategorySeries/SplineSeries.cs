...
namespace Infragistics.Controls.Charts
{
    ...
    /// </summary>
    public sealed class SplineSeries : SplineSeriesBase
    {
        /// <summary>
        ...
        protected internal override void OnViewCreated(SeriesView view)
        {
            ...
            SplineView = (SplineSeriesView)view;
        }
        internal SplineSeriesView SplineView { get; set; }
        ...
        protected internal override void ClearRendering(bool wipeClean, SeriesView view)
        {
            ...
            var splineView = (SplineSeriesView)view;
...
#region Infragistics Source Cleanup (Region)
            ...
            splineView.RasterizeSpline(
                frame.Buckets.Count, 
                x0, y0, x1, y1, 
                UnknownValuePlotting.DontPlot, 
                GetLineClipper(x0, frame.Buckets.Count - 1, view.Viewport, view.WindowRect), 
