...
{
    internal class AreaSeriesView
        : AnchoredCategorySeriesView
    {
        protected AreaSeries AreaModel { get; set; }
        public AreaSeriesView(AreaSeries model)
            : base(model)
        {
            AreaModel = model;
        }
            ...
            UnknownValuePlotting unknownValuePlotting)
        {
            ...
            AnchoredModel.LineRasterizer.RasterizePolygonPaths(polygon0, polyline0, polygon1, polyline1,
                count,
                x0, y0,
                x1, y1,
                bucketSize,
