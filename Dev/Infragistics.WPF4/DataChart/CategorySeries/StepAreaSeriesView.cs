...
{
    internal class StepAreaSeriesView
        : AnchoredCategorySeriesView
    {
        protected StepAreaSeries StepAreaModel { get; set; }
        public StepAreaSeriesView(StepAreaSeries model)
            : base(model)
        {
            StepAreaModel = model;
        }
            ...
            UnknownValuePlotting unknownValuePlotting)
        {
            ...
            AnchoredModel.LineRasterizer.RasterizePolygonPaths(
                polygon0, polyline0, polygon1, polyline1, 
                count, 
                x0, y0, 
                x1, y1, 
