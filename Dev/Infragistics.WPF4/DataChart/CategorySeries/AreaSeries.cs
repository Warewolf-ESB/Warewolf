...
namespace Infragistics.Controls.Charts
{
    ...
    /// </summary>
    public sealed class AreaSeries : HorizontalAnchoredCategorySeries
    {
        /// <summary>
        ...
        protected internal override void OnViewCreated(SeriesView view)
        {
            ...
            AreaView = (AreaSeriesView)view;
        }
        internal AreaSeriesView AreaView { get; set; }
        ...
        public AreaSeries()
        {
            DefaultStyleKey = typeof(AreaSeries);
        }
        ...
        protected internal override void ClearRendering(bool wipeClean, SeriesView view)
        {
            ...
            var areaView = (AreaSeriesView)view;
...
#region Infragistics Source Cleanup (Region)
            ...
            areaView.RasterizeArea(
                frame.Buckets.Count, 
                x0, y0, x1, y1, 
                bucketSize, Resolution, 
                (p0,l0,p01,l1,f) => TerminatePolygon(p0, frame.Buckets.Count, view), 
        ...
        /// </summary>
        public static readonly DependencyProperty UnknownValuePlottingProperty = DependencyProperty.Register(UnknownValuePlottingPropertyName, typeof(UnknownValuePlotting), typeof(AreaSeries), new PropertyMetadata(UnknownValuePlotting.DontPlot, (sender, e) =>
        {
            (sender as AreaSeries).RaisePropertyChanged(UnknownValuePlottingPropertyName, e.OldValue, e.NewValue);
        }));
        /// <summary>
