...
{
    internal class RangeColumnSeriesView
        : RangeCategorySeriesView
    {
        protected RangeColumnSeries RangeColumnModel { get; set; }
        public RangeColumnSeriesView(RangeColumnSeries model)
            : base(model)
        {
            RangeColumnModel = model;
        ...
        internal Rectangle ColumnCreate()
        {
            ...
            column.SetBinding(Rectangle.RadiusXProperty, new Binding(RangeColumnSeries.RadiusXPropertyName) { Source = Model });
            column.SetBinding(Rectangle.RadiusYProperty, new Binding(RangeColumnSeries.RadiusYPropertyName) { Source = Model });
        ...
        internal void PositionRectangle(Rectangle rectangle, double left, double top)
        {
            rectangle.RenderTransform = new TranslateTransform() { X = left, Y = top };
        }
