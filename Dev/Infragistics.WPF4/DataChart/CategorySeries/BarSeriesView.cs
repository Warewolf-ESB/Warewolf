...
{
    internal class BarSeriesView
        : AnchoredCategorySeriesView
    {
        protected internal BarSeries BarModel { get; set; }
        public BarSeriesView(BarSeries model)
            : base(model)
        {
            BarModel = model;
            Columns =
            ...
            TrendLineManager = new BarTrendLineManager();
        }
        ...
        internal Rectangle ColumnCreate()
        {
            ...
            column.SetBinding(Rectangle.RadiusXProperty, new Binding(BarSeries.RadiusXPropertyName) { Source = Model });
            column.SetBinding(Rectangle.RadiusYProperty, new Binding(BarSeries.RadiusYPropertyName) { Source = Model });
        ...
        internal void SetColumnPosition(Rectangle column, double x, double y)
        {
            column.RenderTransform = new TranslateTransform { X = x, Y = y };
        }
