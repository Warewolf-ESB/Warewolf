...
{
    internal class StepLineSeriesView
        : AnchoredCategorySeriesView
    {
        protected StepLineSeries StepModel { get; set; }
        public StepLineSeriesView(StepLineSeries model)
            : base(model)
        {
            StepModel = model;
        }
        ...
        internal void RasterizeStepLine(
            int count, 
            ...
            double resolution)
        {
            ...
            AnchoredModel.LineRasterizer.RasterizePolylinePaths(
