...
{
    internal class SplineSeriesView
        : SplineSeriesBaseView
    {
        protected SplineSeries SplineModel { get; set; }
        public SplineSeriesView(SplineSeries model)
            : base(model)
        {
            SplineModel = model;
        }
        ...
        internal void ClearSplineLines()
        {
            polygon01.Data = null;
            polyline0.Data = null;
            polyline1.Data = null;
            ...
            double resolution)
        {
            ...
            AnchoredModel.LineRasterizer.RasterizePolylinePaths(polyline0, polygon01, polyline1,
                count, 
                x0, y0, 
                x1, y1, 
