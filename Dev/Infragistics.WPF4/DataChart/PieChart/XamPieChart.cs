...
namespace Infragistics.Controls.Charts
{
    ...
    public class XamPieChart:PieChartBase
    {
        internal override PieChartBaseView CreateView()
        {
            return new XamPieChartView(this);
        }
        internal override void OnViewCreated(PieChartBaseView view)
        {
            base.OnViewCreated(view);

            PieChartView = (XamPieChartView)view;
        }
        internal XamPieChartView PieChartView { get; set; }
        ...
        public XamPieChart()
        {
            ...
            DefaultStyleKey = typeof(XamPieChart);
