...
namespace Infragistics.Controls.Charts
{
    ...
    /// </remarks>
    public class FastStochasticOscillatorIndicator : StrategyBasedIndicator
    {
        /// <summary>
        ...
        protected override IndicatorCalculationStrategy CalculationStrategy
        {
            get
            {
                return new CalculationStrategies.FastStochasticOscillatorIndicatorStrategy();
            }
        }
        ...
        protected override Type StyleKeyType
        {
            get
            {
                return typeof(FastStochasticOscillatorIndicator);
            }
        }
        ...
        public static readonly DependencyProperty PeriodProperty =
            CreatePeriodProperty(14, typeof(FastStochasticOscillatorIndicator));
...
namespace Infragistics.Controls.Charts.CalculationStrategies
{
    ...
    /// </summary>
    /// <remarks>
    /// For definition of indicator see: <see cref="FastStochasticOscillatorIndicator"/>
    /// </remarks>
    public class FastStochasticOscillatorIndicatorStrategy : IndicatorCalculationStrategy
    {
        ...
        /// </summary>
        public FastStochasticOscillatorIndicatorStrategy()
        {
            ...
            FinancialCalculationSupportingCalculations supportingCalculations)
        {
            ...
            int i = 0;
            foreach (double value in percentK)
            {
