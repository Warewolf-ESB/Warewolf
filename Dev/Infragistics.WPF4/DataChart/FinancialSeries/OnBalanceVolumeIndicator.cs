...
namespace Infragistics.Controls.Charts
{
    ...
    /// </para>
    /// </remarks>
    public class OnBalanceVolumeIndicator : StrategyBasedIndicator
    {
        /// <summary>
        ...
        protected override IndicatorCalculationStrategy CalculationStrategy
        {
            get
            {
                return new CalculationStrategies.OnBalanceVolumeIndicatorStrategy();
            }
        }
        ...
        protected override Type StyleKeyType
        {
            get
            {
                return typeof(OnBalanceVolumeIndicator);
            }
        }
    }
}
...
namespace Infragistics.Controls.Charts.CalculationStrategies
{
    ...
    /// </summary>
    /// <remarks>
    /// For definition of indicator see: <see cref="OnBalanceVolumeIndicator"/>
    /// </remarks>
    public class OnBalanceVolumeIndicatorStrategy : IndicatorCalculationStrategy
    {
        /// <summary>
            ...
            FinancialCalculationSupportingCalculations supportingCalculations)
        {
            ...
            {
                obv = volumeColumn[0];
                indicatorColumn[0] = obv;
            }

            for (int i = 1; i < n; ++i)
            {
                switch (Math.Sign(closeColumn[i] - closeColumn[i - 1]))
                {
                    case -1:
                        obv -= volumeColumn[i];
                        break;
