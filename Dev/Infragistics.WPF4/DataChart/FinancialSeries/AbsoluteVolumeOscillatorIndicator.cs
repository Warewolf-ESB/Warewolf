...
namespace Infragistics.Controls.Charts
{
    ...
    /// </remarks>
    public class AbsoluteVolumeOscillatorIndicator : StrategyBasedIndicator
    {
        /// <summary>
        ...
        protected override IndicatorCalculationStrategy CalculationStrategy
        {
            get
            {
                return new CalculationStrategies.AbsoluteVolumeOscillatorIndicatorStrategy();
            }
        }
        ...
        protected override System.Type StyleKeyType
        {
            get
            {
                return typeof(AbsoluteVolumeOscillatorIndicator);
            }
        }
        ...
        public static readonly DependencyProperty ShortPeriodProperty = 
            CreateShortPeriodProperty(10, typeof(AbsoluteVolumeOscillatorIndicator));
...
#region Infragistics Source Cleanup (Region)
        ...
        public static readonly DependencyProperty LongPeriodProperty =
            CreateLongPeriodProperty(30, typeof(AbsoluteVolumeOscillatorIndicator));
...
namespace Infragistics.Controls.Charts.CalculationStrategies
{
    ...
    /// </remarks>
    public class AbsoluteVolumeOscillatorIndicatorStrategy : IndicatorCalculationStrategy
    {
        /// <summary>
            ...
            FinancialCalculationSupportingCalculations supportingCalculations)
        {
            ...
            {
                double pvo = shortEma.Current - longEma.Current;

                indicatorColumn[i] = supportingCalculations.MakeSafe(pvo);
                ++i;
            }
