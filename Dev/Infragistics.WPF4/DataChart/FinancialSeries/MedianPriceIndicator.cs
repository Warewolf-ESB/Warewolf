...
namespace Infragistics.Controls.Charts
{
    ...
    /// </remarks>
    public class MedianPriceIndicator : ItemwiseStrategyBasedIndicator
    {
        /// <summary>
        ...
        internal override ItemwiseIndicatorCalculationStrategy ItemwiseStrategy
        {
            get
            {
                return new CalculationStrategies.MedianPriceIndicatorStrategy();
            }
        }
        ...
        protected override Type StyleKeyType
        {
            get
            {
                return typeof(MedianPriceIndicator);
            }
        }
    }
}
...
namespace Infragistics.Controls.Charts.CalculationStrategies
{
    ...
    /// </summary>
    /// <remarks>
    /// For definition of indicator see: <see cref="MedianPriceIndicator"/>
    /// </remarks>
    public class MedianPriceIndicatorStrategy : ItemwiseIndicatorCalculationStrategy
    {
        /// <summary>
            ...
            int currentIndex)
        {
            dataSource.IndicatorColumn[currentIndex] =
                (dataSource.HighColumn[currentIndex] + dataSource.LowColumn[currentIndex]) / 2.0;
            return true;
        }
    }
}
