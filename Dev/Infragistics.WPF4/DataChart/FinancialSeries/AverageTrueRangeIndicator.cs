...
namespace Infragistics.Controls.Charts
{
    ...
    /// </remarks>
    public sealed class AverageTrueRangeIndicator : StrategyBasedIndicator
    {
        /// <summary>
        ...
        protected override IndicatorCalculationStrategy CalculationStrategy
        {
            get 
            {
                return new CalculationStrategies.AverageTrueRangeIndicatorStrategy();
            }
        }
        ...
        protected override System.Type StyleKeyType
        {
            get
            {
                return typeof(AverageTrueRangeIndicator);
            }
        }
        ...
        public static readonly DependencyProperty PeriodProperty = 
            CreatePeriodProperty(14, typeof(AverageTrueRangeIndicator));
...
namespace Infragistics.Controls.Charts.CalculationStrategies
{
    ...
    /// </summary>
    /// <remarks>
    /// For definition of indicator see: <see cref="AverageTrueRangeIndicator"/>
    /// </remarks>
    public class AverageTrueRangeIndicatorStrategy : IndicatorCalculationStrategy
    {
            ...
            FinancialCalculationSupportingCalculations supportingCalculations)
        {
            ...
            foreach (double atr in
                supportingCalculations.EMA.Strategy(dataSource.TrueRange, dataSource.Period))
            {
                dataSource.IndicatorColumn[i] = atr;
                ++i;
            }
