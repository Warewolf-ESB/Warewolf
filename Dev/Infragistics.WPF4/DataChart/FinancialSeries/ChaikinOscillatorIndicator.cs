...
namespace Infragistics.Controls.Charts
{
    ...
    /// </remarks>
    public class ChaikinOscillatorIndicator : StrategyBasedIndicator
    {
        /// <summary>
        ...
        protected override IndicatorCalculationStrategy CalculationStrategy
        {
            get
            {
                return new CalculationStrategies.ChaikinOscillatorIndicatorStrategy();
            }
        }
        ...
        protected override Type StyleKeyType
        {
            get
            {
                return typeof(ChaikinOscillatorIndicator);
            }
        }
        ...
        public static readonly DependencyProperty ShortPeriodProperty =
            CreateShortPeriodProperty(3, typeof(ChaikinOscillatorIndicator));
        ...
        public static readonly DependencyProperty LongPeriodProperty =
            CreateLongPeriodProperty(10, typeof(ChaikinOscillatorIndicator));
...
namespace Infragistics.Controls.Charts.CalculationStrategies
{
    ...
    /// </summary>
    /// <remarks>
    /// For definition of indicator see: <see cref="ChaikinOscillatorIndicator"/>
    /// </remarks>
    public class ChaikinOscillatorIndicatorStrategy
        : IndicatorCalculationStrategy
    {
        internal StreamingIndicatorCalculationStrategy AccumulationDistributionStrategy { get; set; }
        ...
        {
            AccumulationDistributionStrategy = new AccumulationDistributionIndicatorStrategy();
        }
            ...
            FinancialCalculationSupportingCalculations supportingCalculations)
        {
            ...
            list.AddRange(AccumulationDistributionStrategy.BasedOn(dataSource,
            ...
            FinancialCalculationSupportingCalculations supportingCalculations)
        {
            ...
            IEnumerable<double> accDist =
                AccumulationDistributionStrategy.ProvideStream(dataSource, supportingCalculations);

            IEnumerator<double> emaShort =
                supportingCalculations.EMA.Strategy(accDist, dataSource.ShortPeriod)
                .GetEnumerator();
            IEnumerator<double> emaLong =
                supportingCalculations.EMA.Strategy(accDist, dataSource.LongPeriod)
                .GetEnumerator();

            int i = 0;
            while (emaShort.MoveNext() && emaLong.MoveNext())
            {
                indicatorColumn[i] = emaShort.Current - emaLong.Current;
                i++;
            }
