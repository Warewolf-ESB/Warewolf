...
namespace Infragistics.Controls.Charts
{
    ...
    /// </para>
    /// </remarks>
    public class MarketFacilitationIndexIndicator : ItemwiseStrategyBasedIndicator
    {
        /// <summary>
        ...
        internal override ItemwiseIndicatorCalculationStrategy ItemwiseStrategy
        {
            get
            {
                return new CalculationStrategies.MarketFacilitationIndexIndicatorStrategy();
            }
        }
        ...
        protected override Type StyleKeyType
        {
            get
            {
                return typeof(MarketFacilitationIndexIndicator);
            }
        }
    }
}
...
namespace Infragistics.Controls.Charts.CalculationStrategies
{
    ...
    /// </summary>
    /// <remarks>
    /// For definition of indicator see: <see cref="MarketFacilitationIndexIndicator"/>
    /// </remarks>
    public class MarketFacilitationIndexIndicatorStrategy : ItemwiseIndicatorCalculationStrategy
    {
        /// <summary>
        ...
        public override bool CalculateIndicatorItem(FinancialCalculationDataSource dataSource,
            ...
            int currentIndex)
        {
            dataSource.IndicatorColumn[currentIndex] = supportingCalculations.MakeSafe(
                (dataSource.HighColumn[currentIndex] - dataSource.LowColumn[currentIndex])
                    / dataSource.VolumeColumn[currentIndex]);
            return true;
        }
    }
}
