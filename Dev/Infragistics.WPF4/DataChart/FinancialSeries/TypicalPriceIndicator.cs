...
namespace Infragistics.Controls.Charts
{
    ...
    public class TypicalPriceIndicator : StrategyBasedIndicator
    {
        ...
        protected override IndicatorCalculationStrategy CalculationStrategy
        {
            get
            {
                return new CalculationStrategies.TypicalPriceIndicatorStrategy();
            }
        }
        ...
        protected override Type StyleKeyType
        {
            get
            {
                return typeof(TypicalPriceIndicator);
            }
        }
    }
}
...
namespace Infragistics.Controls.Charts.CalculationStrategies
{
    ...
    /// </summary>
    /// <remarks>
    /// For definition of indicator see: <see cref="TypicalPriceIndicator"/>
    /// </remarks>
    public class TypicalPriceIndicatorStrategy : IndicatorCalculationStrategy
    {
        /// <summary>
