...
namespace Infragistics.Controls.Charts
{
    ...
    /// </remarks>
    public class StandardDeviationIndicator : StrategyBasedIndicator
    {
        /// <summary>
        ...
        protected override IndicatorCalculationStrategy CalculationStrategy
        {
            get
            {
                return new CalculationStrategies.StandardDeviationIndicatorStrategy();
            }
        }
        ...
        protected override Type StyleKeyType
        {
            get
            {
                return typeof(StandardDeviationIndicator);
            }
        }
        ...
        public static readonly DependencyProperty PeriodProperty =
            CreatePeriodProperty(20, typeof(StandardDeviationIndicator));
...
namespace Infragistics.Controls.Charts.CalculationStrategies
{
    ...
    /// </summary>
    /// <remarks>
    /// For definition of indicator see: <see cref="StandardDeviationIndicator"/>
    /// </remarks>
    public class StandardDeviationIndicatorStrategy : IndicatorCalculationStrategy
    {
        /// <summary>
        ...
        public override bool CalculateIndicator(FinancialCalculationDataSource dataSource,
            FinancialCalculationSupportingCalculations supportingCalculations)
        {
            IEnumerator<double> stddev =
                supportingCalculations.STDEV.Strategy(dataSource.TypicalColumn, dataSource.Period)
                .GetEnumerator();
            ...
            {
                indicatorColumn[i] = stddev.Current;
                i++;
            }
