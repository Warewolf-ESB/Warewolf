...
namespace Infragistics.Controls.Charts
{
    ...
    /// </remarks>
    public class NegativeVolumeIndexIndicator : StrategyBasedIndicator
    {
        /// <summary>
        ...
        protected override IndicatorCalculationStrategy CalculationStrategy
        {
            get
            {
                return new CalculationStrategies.NegativeVolumeIndexIndicatorStrategy();
            }
        }
        ...
        protected override Type StyleKeyType
        {
            get
            {
                return typeof(NegativeVolumeIndexIndicator);
            }
        }
    }
}
...
namespace Infragistics.Controls.Charts.CalculationStrategies
{
    ...
    /// </summary>
    /// <remarks>
    /// For definition of indicator see: <see cref="NegativeVolumeIndexIndicator"/>
    /// </remarks>
    public class NegativeVolumeIndexIndicatorStrategy : IndicatorCalculationStrategy
    {
        /// <summary>
        ...
        public override bool CalculateIndicator(FinancialCalculationDataSource dataSource, FinancialCalculationSupportingCalculations supportingCalculations)
        {
            ...
            double nvi = 0.0;
            double newValue = 0.0;
            double yesterdayNVI = 0.0;

            if (indicatorColumn.Count > 0)
            {
                indicatorColumn[0] = nvi;
            }
