...
namespace Infragistics.Windows.Design.DataPresenter
{
    ...
    /// </summary>
    public class DataPresenterAdornerProvider : GenericAdornerProvider
    {
        #region Constructors
        ...
        /// </summary>
        public DataPresenterAdornerProvider()
        {
            string assemblyName 	= Assembly.GetExecutingAssembly().GetName().Name;
            string resourceFileName = @"SmartTags/DataPresenter/CustomEditors/CustomPropertyEditors.xaml";
		...
		{
			get { return new Type [] { typeof(FieldLayoutSettings),
										typeof(FieldSettings),
										typeof(XamDataCards),
										typeof(XamDataCarousel),
										typeof(XamDataGrid),
										typeof(XamDataPresenter),
									};
			}
		}
