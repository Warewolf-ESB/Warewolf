...
namespace Infragistics.Windows.Design.DataPresenter
{
    ...
    public static class Association
    {
        ...
        {
            #region EDITABLE AREA FOR INFRAGISTICS COMPANY DEVELOPERS

            if (controlType == typeof(XamDataPresenter))
                return typeof(DALXamDataPresenter);
			else
			if (controlType == typeof(XamDataGrid))
				return typeof(DALXamDataGrid);
			else
			if (controlType == typeof(XamDataCards))
				return typeof(DALXamDataCards);
			else
			if (controlType == typeof(XamDataCarousel))
				return typeof(DALXamDataCarousel);

            #endregion EDITABLE AREA FOR INFRAGISTICS COMPANY DEVELOPERS
