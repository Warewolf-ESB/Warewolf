...
class AssemblyRef
{
	public const string BaseResourceName = "Infragistics.Windows.Design.DataPresenter.strings";
...
#region Infragistics Source Cleanup (Region)
    ...
    internal const string AssemblyName = "InfragisticsWPF4.DataPresenter.v" + AssemblyVersion.MajorMinor + ".Design.VS2012";
	...
	internal const string AssemblyDescriptionBase = "Multi-Format Data Presentation Component for WPF - Design Assembly";
