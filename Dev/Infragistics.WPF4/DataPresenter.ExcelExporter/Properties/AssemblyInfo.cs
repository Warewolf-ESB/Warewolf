...
[assembly: AssemblyTrademark("DataPresenterExcelExporter™")]
...
[assembly: XmlnsPrefix("http://infragistics.com/ExcelExporter", "igExcelExporter")]
[assembly: XmlnsDefinition("http://infragistics.com/ExcelExporter", "Infragistics.Windows.DataPresenter.ExcelExporter")]
...
class AssemblyRef
{
	// JM 03-26-10 TFS29061 - Make sure the BaseResourceName is in sync with the assembly's default namespace 'Infragistics.Windows.DataPresenter.ExcelExporter'
    //public const string BaseResourceName = "Infragistics.Windows.strings";
	public const string BaseResourceName = "Infragistics.Windows.DataPresenter.ExcelExporter.strings";

	internal const string AssemblyName = AssemblyVersion.AssemblyNamePrefix + ".DataPresenter.ExcelExporter" + AssemblyVersion.AssemblyNameSuffix;

    internal const string AssemblyProduct = "Infragistics NetAdvantage for WPF";
    internal const string AssemblyDescriptionBase = "Data Presentation Excel Exporting Component for WPF";
