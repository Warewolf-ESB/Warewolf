...
class AssemblyRef
{
	public const string BaseResourceName = "Infragistics.Windows.Design.strings";
...
#region Infragistics Source Cleanup (Region)
    ...
    internal const string AssemblyName = "InfragisticsWPF4.v" + AssemblyVersion.MajorMinor + ".Design";




    internal const string AssemblyProduct = "Infragistics NetAdvantage for WPF";
	internal const string AssemblyDescriptionBase = "Infragistics Shared Components for WPF - Design Assembly";
