...
//       below.
//-----------------------------------------------------------------
namespace Infragistics.Windows.Tiles // change this line only to the unigue namespace of this assembly
{
    /// <summary>
...
#pragma warning restore 436
        ...
        /// <summary>
        /// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource for the tooltip of the close button in the <see cref="Tile"/>
        /// </summary>
        ...
        /// <summary>
        /// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource for the tooltip of the collapse button in the <see cref="Tile"/>
        /// </summary>
        public static DynamicResourceString CollapseButtonToolTip
        {
            get { return GetDynamicResourceString("CollapseButtonToolTip"); }
        }

        /// <summary>
        /// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource for the tooltip of the expand button in the <see cref="Tile"/>
        /// </summary>
        public static DynamicResourceString ExpandButtonToolTip
        {
            get { return GetDynamicResourceString("ExpandButtonToolTip"); }
        }

        /// <summary>
        /// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource for the tooltip of the maximize button in the <see cref="Tile"/>
        /// </summary>
        ...
        /// <summary>
        /// Returns a <see cref="DynamicResourceString"/> instance that contains the localized resource for the tooltip of the minimize button in the <see cref="Tile"/>
        /// </summary>
