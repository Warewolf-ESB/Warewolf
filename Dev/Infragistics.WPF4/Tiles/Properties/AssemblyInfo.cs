...
[assembly: AssemblyTrademark("XamTiles™")]
...
[assembly: AssemblyResourceSetLoader(typeof(TilesAssemblyResourceSetLoader))]
[assembly: AssemblyThemeGroupingNameAttribute(TilesGeneric.GroupingName)]
...
class AssemblyRef
{
    public const string BaseResourceName = "Infragistics.Windows.Tiles.strings";

	internal const string AssemblyName = AssemblyVersion.AssemblyNamePrefix + ".Tiles" + AssemblyVersion.AssemblyNameSuffix;

    internal const string AssemblyProduct = "Infragistics NetAdvantage for WPF";
    internal const string AssemblyDescriptionBase = "Infragistics XamTilesControl for WPF";
