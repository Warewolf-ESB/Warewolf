...
namespace Warewolf.UITests
{
    ...
    public class ConfigureSettingsperfomanceCounter
    {
        ...
        public void ConfigureSettingPerfomanceCounter()
        {
            ...
            Assert.AreEqual(serviceName, UIMap.MainStudioWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.SettingsWizardTab.WorksurfaceContext.SettingsView.TabList.PerfomanceCounterTab.PerfmonViewContent.ResourceTable.Row1.ResourceCell.ResourceTextBox.DisplayText, "Resource Name is not set to Dice after selecting Dice from Service picker");
        }
