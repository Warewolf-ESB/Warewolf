...
namespace Warewolf.UITests
{
    ...
    public class Refresh
    {
        ...
        public void RefreshExplorerAfterDeletingResourceFromDiskUITest()
        {
            ...
            Assert.IsFalse(UIMap.MainStudioWindow.DockManager.SplitPaneLeft.Explorer.ExplorerTree.localhost.FirstItem.FirstSubItem.ItemEdit.Text.Contains(WorkflowName), "Workflow exists in explorer tree after deleting from disk.");
        }
