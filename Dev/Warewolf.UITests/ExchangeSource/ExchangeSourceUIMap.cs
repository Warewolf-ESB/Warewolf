...
namespace Warewolf.UITests.ExchangeSource.ExchangeSourceUIMapClasses
{
    ...
    public partial class ExchangeSourceUIMap
    {
        ...
        public void Enter_Text_Into_Exchange_Tab()
        {
            ...
            MainStudioWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.ExchangeSourceTab.SendTestModelsCustom.UserNameTextBox.Text = "IntegrationTester@TheUnlimited.co.za";
