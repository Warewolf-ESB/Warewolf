...
namespace Warewolf.UITests
{
    ...
    {
        private const string DataSplit = "Data - Data Split";
        
        [TestMethod]
        [TestCategory("Workflow Testing")]
        public void SettingTestStepToMockDoesNotAffectTestOutput()
        {
            UIMap.Filter_Explorer(DataSplit);
            UIMap.DoubleClick_Explorer_Localhost_Second_Item();
            ...
            UIMap.Click_MockRadioButton_On_DataSplitAssign_TestStep();
