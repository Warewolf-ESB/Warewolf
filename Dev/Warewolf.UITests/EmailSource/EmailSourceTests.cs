...
namespace Warewolf.UITests
{
    ...
    public class EmailSourceTests
    {
        ...
        public void EmailSource_CreateSourceUITests()
        {
            ...
            Assert.IsTrue(UIMap.MainStudioWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.EmailSourceTabPage.SendTestModelsCustom.ToTextBoxEdit.ItemImage.Exists, "Connection test Failed");
