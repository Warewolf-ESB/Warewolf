...
namespace Warewolf.UITests.WorkflowTab.Tools.Resources.ResourcesToolsUIMapClasses
{
    ...
    public class ClassNameComboBox : WpfComboBox
    {
        ...
        public WpfListItem RandomClassName
        {
            get
            {
                if ((this.mRandomClassName == null))
                {
                    this.mRandomClassName = new WpfListItem(this);
                    #region Search Criteria
                    this.mRandomClassName.SearchProperties[WpfListItem.PropertyNames.Name] = "{\"MethodName\":null,\"AssemblyLocation\":\"GAC:mscorlib, Version=2.0.0.0, Culture=neu" +
                        "tral, PublicKeyToken=b77a5c561934e089, processorArchitecture=AMD64\",\"AssemblyNam" +
                        "e\":\"\",\"FullName\":\"System.Random\",\"JsonObject\":\"{}\"}";
                    this.mRandomClassName.WindowTitles.Add("Warewolf (DEV2\\NKOSINATHI.SANGWENI)");
                    #endregion
                }
                return this.mRandomClassName;
            }
        }
        #endregion
        ...
        private WpfListItem mRandomClassName;
        #endregion
    }
    ...
    public class UIFlowchartCustom : WpfCustom
    {
        ...
        #region Properties
        public UIDsfEnhancedDotNetDllCustom UIDsfEnhancedDotNetDllCustom
        {
            get
            {
                if ((this.mUIDsfEnhancedDotNetDllCustom == null))
                {
                    this.mUIDsfEnhancedDotNetDllCustom = new UIDsfEnhancedDotNetDllCustom(this);
                }
        ...
        #region Fields
        private UIDsfEnhancedDotNetDllCustom mUIDsfEnhancedDotNetDllCustom;
        #endregion
    }
    
    [GeneratedCode("Coded UITest Builder", "14.0.23107.0")]
    public class UIDsfEnhancedDotNetDllCustom : WpfCustom
    {
        
        public UIDsfEnhancedDotNetDllCustom(UITestControl searchLimitContainer) : 
                base(searchLimitContainer)
        {
            #region Search Criteria
            this.SearchProperties[WpfControl.PropertyNames.ClassName] = "Uia.DotNetDllDesigner";
    ...
    public class UILargeViewContentCustom : WpfCustom
    {
        ...
        #region Properties
        public WpfComboBox UINamespaceComboBoxComboBox
        {
            get
            {
                if ((this.mUINamespaceComboBoxComboBox == null))
                {
                    this.mUINamespaceComboBoxComboBox = new WpfComboBox(this);
                    #region Search Criteria
                    this.mUINamespaceComboBoxComboBox.SearchProperties[WpfComboBox.PropertyNames.AutomationId] = "NamespaceComboBox";
                    this.mUINamespaceComboBoxComboBox.WindowTitles.Add("Warewolf (DEV2\\NKOSINATHI.SANGWENI)");
                    #endregion
                }
        ...
        #region Fields
        private WpfComboBox mUINamespaceComboBoxComboBox;
        #endregion
    }
}
