...
namespace Warewolf.UITests.Tools.Utility
{
    ...
    public class Calculate
    {
        ...
        {
            Assert.IsTrue(ToolsUIMap.MainStudioWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.WorkflowTab.WorkSurfaceContext.WorkflowDesignerView.DesignerView.ScrollViewerPane.ActivityTypeDesigner.WorkflowItemPresenter.Flowchart.Calculate.Exists, "Calculate Tool on the design surface does not exist");
            //Small View
            ...
            //Large View
            ToolsUIMap.Open_Calculate_Tool_Large_View();
            ...
            Assert.IsTrue(ToolsUIMap.MainStudioWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.WorkflowTab.WorkSurfaceContext.WorkflowDesignerView.DesignerView.ScrollViewerPane.ActivityTypeDesigner.WorkflowItemPresenter.Flowchart.Calculate.DoneButton.Exists, "Done Button does not exist on design surface.");
            //Enter SomeVariable
            ToolsUIMap.Enter_SomeVariable_Into_CalculateTool_FXCombobox();
            ...
            ToolsUIMap.Click_CalculateTool_DoneButton();
        ...
        public void MyTestInitialize()
        {
            ...
            ToolsUIMap.Drag_Toolbox_Calculate_Onto_DesignSurface();
        }
