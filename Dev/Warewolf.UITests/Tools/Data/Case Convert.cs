...
namespace Warewolf.UITests.Tools.Data
{
    ...
    public class Case_Convert
    {
        ...
        {
            Assert.IsTrue(ToolsUIMap.MainStudioWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.WorkflowTab.WorkSurfaceContext.WorkflowDesignerView.DesignerView.ScrollViewerPane.ActivityTypeDesigner.WorkflowItemPresenter.Flowchart.CaseConvert.Exists, "Case Conversion on the design surface does not exist");
            //Small View
            ...
            //Large View
            ToolsUIMap.Open_CaseConvertTool_LargeView();
            ...
            ToolsUIMap.Open_CaseConvertTool_QVIView();
        ...
        public void MyTestInitialize()
        {
            ...
            ToolsUIMap.Drag_Toolbox_Case_Conversion_Onto_DesignSurface();
        }
