...
namespace Warewolf.UITests
{
    ...
    public class Create_List_Item
    {
        ...
        public void Sharepoint_CreateListItem_SmallView_UITest()
        {
        ...
        [TestMethod]
        [TestCategory("Sharepoint Tools")]
        public void Sharepoint_CreateListItem_LargeView_UITest()
        {
            UIMap.Open_SharepointCreateTool_LargeView();
        ...
        [TestMethod]
        [TestCategory("Sharepoint Tools")]
        public void NewSource_From_SharepointCreateListItemTool_UITest()
        {
            UIMap.Open_SharepointCreateTool_LargeView();
