...
namespace Warewolf.UITests
{
    ...
    public class Delete_File
    {
        ...
        public void Sharepoint_DeleteFile_SmallView_UITest()
        {
        ...
        [TestMethod]
        [TestCategory("Sharepoint Tools")]
        public void Sharepoint_DeleteItem_LargeView_UITest()
        {
        ...
        [TestMethod]
        [TestCategory("Sharepoint Tools")]
        public void NewSource_From_SharepointDeleteFileTool_UITest()
        {
            UIMap.Open_SharepointDeleteFileTool_LargeView();
