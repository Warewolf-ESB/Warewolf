...
namespace Warewolf.UITests
{
    ...
    public class Read_Folder
    {
        ...
        public void Sharepoint_ReadFolder_SmallView_UITest()
        {
        ...
        [TestMethod]
        [TestCategory("Sharepoint Tools")]
        public void Sharepoint_ReadFolder_LargeView_UITest()
        {
        ...
        [TestMethod]
        [TestCategory("Sharepoint Tools")]
        public void NewSource_From_SharepointReadFolderTool_UITest()
        {
            UIMap.Open_SharepointReadFolderTool_LargeView();
