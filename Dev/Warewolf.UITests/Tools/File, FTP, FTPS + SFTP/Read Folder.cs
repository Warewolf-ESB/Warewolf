...
namespace Warewolf.UITests.Tools
{
    ...
    public class Read_Folder
    {
        ...
        {
            Assert.IsTrue(ToolsUIMap.MainStudioWindow.DockManager.SplitPaneMiddle.TabManSplitPane.TabMan.WorkflowTab.WorkSurfaceContext.WorkflowDesignerView.DesignerView.ScrollViewerPane.ActivityTypeDesigner.WorkflowItemPresenter.Flowchart.FolderRead.Exists, "Read folder tool on the design surface does not exist");
            // Small View
            ...
            // Large View
            ToolsUIMap.Open_ReadFolderTool_LargeView();
        ...
        public void MyTestInitialize()
        {
            ...
            ToolsUIMap.Drag_Toolbox_Read_Folder_Onto_DesignSurface();
        }
