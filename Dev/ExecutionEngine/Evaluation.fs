...
//        env.RecordSets.[r.Name].Data.[PositionColumn] |> Seq.max |> fun ax-> evalNumberOfExecutes (ax|>AtomToInt) t env
...
//   
//    let col1 = PublicFunctions.EvalEnvExpression  decision.Col1 env |> EvalResultToString
//    let col2 = PublicFunctions.EvalEnvExpression  decision.Col2 env |> EvalResultToString
//    let col3 = PublicFunctions.EvalEnvExpression  decision.Col3 env |> EvalResultToString
