...
Scenario: Creating New Web Source 
   ...
   And I type Address as "http://TFSBLD.dev2.local/IntegrationTestSite"
   And I type Default Query as "/GetCountries.ashx?extension=json&prefix=a"
   Then "New Web Service Source *" tab is opened
   And TestQuery is "http://TFSBLD.dev2.local/IntegrationTestSite/GetCountries.ashx?extension=json&prefix=a"
   And "Save" is "Enabled"
   ...
   Then the browser window opens with "http://TFSBLD.dev2.local/IntegrationTestSite/GetCountries.ashx?extension=json&prefix=a"
...
Scenario: Editing saved Web Source 
   ...
   And title is "Test"
   And Address is "http://TFSBLD.dev2.local/IntegrationTestSite"
   ...
   And Password field is "Collapsed"
   And "Save" is "Enabled"
   When I change Address to "http://TFSBLD.dev2.local/IntegrationTestSite"
