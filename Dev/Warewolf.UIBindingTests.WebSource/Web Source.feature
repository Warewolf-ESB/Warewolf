...
Scenario: Creating New Web Source 
   ...
   And I type Address as "http://172.27.14.55/IntegrationTestSite"
   And I type Default Query as "/GetCountries.ashx?extension=json&prefix=a"
   Then "New Web Service Source *" tab is opened
   And TestQuery is "http://172.27.14.55/IntegrationTestSite/GetCountries.ashx?extension=json&prefix=a"
   And "Save" is "Enabled"
   ...
   Then the browser window opens with "http://172.27.14.55/IntegrationTestSite/GetCountries.ashx?extension=json&prefix=a"
...
Scenario: Editing saved Web Source 
   ...
   And title is "Test"
   And Address is "http://172.27.14.55/IntegrationTestSite"
   ...
   And Password field is "Collapsed"
   And "Save" is "Enabled"
   When I change Address to "http://172.27.14.55/IntegrationTestSite"
