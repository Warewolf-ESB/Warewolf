...
namespace Dev2.Studio.Views.Diagnostics
{
    ...
    public partial class DebugOutputView
    {
        ...
        {
            InitializeComponent();
            DebugOutputTree.ItemContainerGenerator.StatusChanged += new EventHandler(ItemContainerGenerator_StatusChanged);
        }
        ...
        void ItemContainerGenerator_StatusChanged(object sender, EventArgs e)
        {
            ...
            if (viewmodel != null)
            {
                if (DebugOutputTree.Items.Count == viewmodel.ContentItemCount)
                {
