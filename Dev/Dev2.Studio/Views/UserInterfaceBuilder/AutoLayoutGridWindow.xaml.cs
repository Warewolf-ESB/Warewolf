...
namespace Dev2.Studio.Views.UserInterfaceBuilder
{
    ...
    /// </summary>
    public partial class AutoLayoutGridWindow
    {
        ...
        public AutoLayoutGridWindow(ILayoutGridViewModel viewModel)
        {
            ...
            //viewModel.Browser.BrowserObject = webBrowser;
        ...
        private void AutoLayoutGridWindow_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void UpdateWebpagePreview(object o)
        {
