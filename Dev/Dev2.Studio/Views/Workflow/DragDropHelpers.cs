        ...
        public bool PreventDrop(IDataObject dataObject)
        {
            ...
            if(workflowDesignerViewModel != null)
            {
                ...
                if(explorerItemModel != null)
                {
                    ...
                    {
                        CustomContainer.Get<IPopupController>().Show(Resources.Languages.Core.DragRemoteNotSupported, Resources.Languages.Core.DragRemoteNotSupportedHeader, MessageBoxButton.OK, MessageBoxImage.Error, null);
                        return true;
                    }
