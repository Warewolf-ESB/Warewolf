...
namespace Dev2.Studio.AppResources.AttachedProperties
{
    public static class AttachedPropertyHelper
    {
                                                  ...
                                                  IContextualResourceModel resource, string iconPath)
        {
            ...
            UIElementTabActionContext.SetTabActionContext(workflowDesignerWindow, TabActionContext.Workflow);
        ...
        {
            UIElementTabActionContext.SetTabActionContext(view, TabActionContext.DeployResources);
