...
// ReSharper restore CheckNamespace
{
    ...
    public class DebugOutputViewModel : SimpleBaseViewModel
    {
        ...
        public string DebugImage
        {
            get
            {
                return IsProcessing ? Resources.Languages.Core.Pack_Uri_Stop_Image : Resources.Languages.Core.Pack_Uri_Debug_Image;
            }
        }
        ...
        public string DebugText
        {
            get
            {
                return IsProcessing ? Resources.Languages.Core.Ribbon_StopExecution : Resources.Languages.Core.Ribbon_Debug;
            }
        }
        ...
        void AddItemToTreeImpl(IDebugState content)
        {
            ...
            if(_lastStep != null && DebugStatus == DebugStatus.Finished && content.StateType == StateType.Message)
            {
                ...
                AddItemToTreeImpl(new DebugState { StateType = StateType.Message, Message = Resources.Languages.Services.CompilerMessage_ExecutionInterrupted, ParentID = lastDebugStateProcessed.ParentID });
