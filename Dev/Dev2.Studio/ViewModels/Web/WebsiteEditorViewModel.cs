...
{
    public class WebsiteEditorViewModel : BaseWorkSurfaceViewModel, IWebsiteEditorViewModel
    {
        ...
        public ObservableCollection<IResourceModel> WebpageServices
        {
            get
            {
                ...
                {
                    ObservableCollection<IResourceModel> itemList = _webActivity.ResourceModel.Environment.ResourceRepository.All()
        ...
        public void UpdateModelItem()
        {
            if(!string.IsNullOrEmpty(Html) && _webActivity != null && _webActivity.ResourceModel != null && _webActivity.ResourceModel.Environment != null)
            {
                ...
                foreach(dynamic tag in tagItems)
                {
                    ...
                    {
                        type = tag.type;
                        res = _webActivity.ResourceModel.Environment.ResourceRepository.All().FirstOrDefault(c => c.ResourceName.Equals(type, StringComparison.InvariantCultureIgnoreCase));
                        if(res != null)
                        {
        ...
        private void SetDefaultWebpage()
        {
            if(_webActivity != null && _webActivity.ResourceModel != null && _webActivity.ResourceModel.Environment != null)
            {
                ...
                var webpageService = _webActivity.ResourceModel.Environment.ResourceRepository.All().FirstOrDefault(c => c.ResourceName.Equals(defaultWebPage, StringComparison.InvariantCultureIgnoreCase));
        ...
        {
            get { return WorkSurfaceContext.Website; }
        }
    }
