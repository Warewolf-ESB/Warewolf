...
namespace Dev2.Common.Tests
{
    ...
    public class ServerSettingsTests
    {
        ...
        public void ServerSettingsData_Get_AppConfig_Configuration()
        {
            ...
            Assert.AreEqual(12, settings.GetType().GetProperties(System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.Instance).Length);
			...
			Assert.AreEqual(false, settings.EnablePerformanceCounters);
		}
