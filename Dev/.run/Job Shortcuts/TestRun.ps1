...
"@ | Out-File -LiteralPath "C:\ftps_entrypoint.py" -Encoding utf8 -Force
	...
	if ($StartSFTPServer.IsPresent) {
		if (!(Test-Path "C:\sftp_home\dev2\FORFILERENAMETESTING")) {
			New-Item -ItemType Directory -Path "C:\sftp_home\dev2\FORFILERENAMETESTING"
		}
		if (!(Test-Path "C:\sftp_home\dev2\FORUNZIPTESTING")) {
			New-Item -ItemType Directory -Path "C:\sftp_home\dev2\FORUNZIPTESTING"
		}
		if (!(Test-Path "C:\sftp_home\dev2\FORCOPYFILETESTING")) {
			New-Item -ItemType Directory -Path "C:\sftp_home\dev2\FORCOPYFILETESTING"
		}
		if (!(Test-Path "C:\sftp_home\dev2\FORCREATEFILETESTING")) {
			New-Item -ItemType Directory -Path "C:\sftp_home\dev2\FORCREATEFILETESTING"
		}
		if (!(Test-Path "C:\sftp_home\dev2\FORDELETEFILETESTING")) {
			New-Item -ItemType Directory -Path "C:\sftp_home\dev2\FORDELETEFILETESTING"
		}
		if (!(Test-Path "C:\sftp_home\dev2\FORMOVEFILETESTING")) {
			New-Item -ItemType Directory -Path "C:\sftp_home\dev2\FORMOVEFILETESTING"
		}
		if (!(Test-Path "C:\sftp_home\dev2\FORRENAMETESTING")) {
			New-Item -ItemType Directory -Path "C:\sftp_home\dev2\FORRENAMETESTING"
		}
		if (!(Test-Path "C:\sftp_home\dev2\FORTESTING")) {
			New-Item -ItemType Directory -Path "C:\sftp_home\dev2\FORTESTING"
		}
		if (!(Test-Path "C:\sftp_home\dev2\FORWRITEFILETESTING")) {
			New-Item -ItemType Directory -Path "C:\sftp_home\dev2\FORWRITEFILETESTING"
		}
		if (!(Test-Path "C:\sftp_home\dev2\FORZIPTESTING")) {
			New-Item -ItemType Directory -Path "C:\sftp_home\dev2\FORZIPTESTING"
		}
