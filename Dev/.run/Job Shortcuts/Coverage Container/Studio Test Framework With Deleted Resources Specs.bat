...
echo ^&".\Job Shortcuts\TestRun.ps1" -RetryCount 6 -Projects Dev2.Activities.Specs -Category StudioTestFrameworkWithDeletedResources -PreTestRunScript "StartAsService.ps1 -Cleanup -ResourcesPath ServerTests" -PostTestRunScript ReverseDeployLog.ps1 -Coverage>>"%~dp0..\..\..\TestResults\RunTestsEntrypoint.ps1"
