...
echo ^&".\Job Shortcuts\TestRun.ps1" -RetryCount 6 -Projects Warewolf.UI.Tests -Category "Deploy Filtering" -PreTestRunScript "StartAsService.ps1 -Cleanup -ResourcesPath UITests" -PostTestRunScript ReverseDeployLog.ps1>>"%~dp0..\..\..\TestResults\RunTestsEntrypoint.ps1"
