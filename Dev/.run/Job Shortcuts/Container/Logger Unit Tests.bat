...
echo ^&".\Job Shortcuts\TestRun.ps1" -RetryCount 6 -Projects Warewolf.Logger.Tests>>"%~dp0..\..\..\TestResults\RunTestsEntrypoint.ps1"
...
powershell -NoProfile -NoLogo -ExecutionPolicy Bypass -NoExit -File "%~dp0..\TestRun.ps1" -RetryCount 6 -Projects Warewolf.Logger.Tests -InContainer
)