...
powershell -NoProfile -NoLogo -ExecutionPolicy Bypass -NoExit -File "%~dp0..\TestRun.ps1" -RetryCount 6 -Projects Warewolf.Tools.Specs -Category FileRenameFromFTPS -InContainer -UNCPassword Dev2@dmin123
)