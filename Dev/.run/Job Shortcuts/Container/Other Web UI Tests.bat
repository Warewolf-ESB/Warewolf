...
echo ^&".\Job Shortcuts\TestRun.ps1" -RetryCount 6 -Projects Warewolf.Web.UI.Tests -ExcludeCategories ExecutionLogging,NoWarewolfServer>>"%~dp0..\..\..\TestResults\RunTestsEntrypoint.ps1"
