...
decisionType == enDecisionType.IsRegEx ||
decisionType == enDecisionType.NotRegEx ||
decisionType == enDecisionType.IsEqual ||
decisionType == enDecisionType.IsNotEqual ||
decisionType == enDecisionType.IsLessThan ||
decisionType == enDecisionType.IsLessThanOrEqual ||
decisionType == enDecisionType.IsGreaterThan ||
decisionType == enDecisionType.IsGreaterThanOrEqual ||
decisionType == enDecisionType.IsContains ||
decisionType == enDecisionType.NotContain ||
decisionType == enDecisionType.IsEndsWith ||
decisionType == enDecisionType.NotEndsWith ||
decisionType == enDecisionType.IsStartsWith ||
decisionType == enDecisionType.NotStartsWith ||
decisionType == enDecisionType.IsBetween ||
decisionType == enDecisionType.NotBetween ||
decisionType == enDecisionType.IsBinary ||
decisionType == enDecisionType.IsNotBinary ||
