...
namespace Dev2.Data.SystemTemplates
{
    public static class DataListConstants
    {
        ...
        public readonly static Dev2DecisionStack DefaultStack = new Dev2DecisionStack() { TheStack = new List<Dev2Decision>() { DefaultDecision }, Mode = Dev2DecisionMode.AND, TrueArmText = "True", FalseArmText = "False", DisplayText = "Is True?" };
