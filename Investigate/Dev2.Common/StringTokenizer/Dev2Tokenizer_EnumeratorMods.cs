...
//        //readonly CharEnumerator _tokenParts;
...
//            //_tokenParts = candiateString.GetEnumerator();
//            //_tokenParts = new char[1];
//            _ops = ops;
//            _opPointer = 0;
//            _hasMoreOps = true;
//            _isReversed = reversed;
//            int tmpLen = candiateString.Length;
//            if (!_isReversed) {
//                _startIdx = 0;
//            }
//            else {
...
//            //while(_tokenParts.MoveNext())
//            //{
//            //    result.Append(_tokenParts.Current);
//            //}
