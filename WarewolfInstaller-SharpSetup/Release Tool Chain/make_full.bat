...
@echo "Waiting for Manual Obfuscation To Complete."
@set /P waitKey=Press Any Key When Ready...
...
@set /P waitKey=Press Any Key When Ready... This may not work via a bat file ;(
...
"C:\Development\WarewolfInstaller-SharpSetup\Release Tool Chain\version.bat"
...
@echo -Sign Installer-
delete "C:\Development\WarewolfInstaller-SharpSetup\Debug\Warewolf-%1%.exe"
move "C:\Development\WarewolfInstaller-SharpSetup\Debug\Warewolf_Installer.exe" "C:\Development\WarewolfInstaller-SharpSetup\Debug\Warewolf-%1%.exe"
"C:\Program Files (x86)\Windows Kits\8.0\bin\x86\signtool.exe" sign /f "C:\Development\WarewolfInstaller-SharpSetup\Release Tool Chain\Warewolf Cert.pfx" /p 5678 "C:\Development\WarewolfInstaller-SharpSetup\Debug\Warewolf-%1%.exe"
copy "C:\Development\WarewolfInstaller-SharpSetup\Debug\Warewolf-%1%.exe" Z:\Installations